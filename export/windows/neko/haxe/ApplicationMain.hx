...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "haxeflixel_experimentation", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "haxeflixel_experimentation";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "haxeflixel_experimentation", null, { width: 1280, height: 720 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "510",
			company: "HaxeFlixel",
			file: "haxeflixel_experimentation",
			fps: 60,
			name: "haxeflixel_experimentation",
			...
			windows: [
				
				{
					...
					resizable: true,
					stencilBuffer: false,
					title: "haxeflixel_experimentation",
					vsync: true,
					width: 1280,
					x: null,
					y: null
