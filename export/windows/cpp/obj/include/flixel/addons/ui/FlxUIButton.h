...
class HXCPP_CLASS_ATTRIBUTES FlxUIButton_obj : public  ::flixel::addons::ui::FlxUITypedButton_obj
{
	...
	public:
		...
		void __construct(hx::Null< Float >  __o_X,hx::Null< Float >  __o_Y,::String Label, ::Dynamic OnClick, ::Dynamic __o_LoadDefaultGraphics, ::Dynamic __o_LoadBlank);
		...
		static hx::ObjectPtr< FlxUIButton_obj > __new(hx::Null< Float >  __o_X,hx::Null< Float >  __o_Y,::String Label, ::Dynamic OnClick, ::Dynamic __o_LoadDefaultGraphics, ::Dynamic __o_LoadBlank);
		static hx::ObjectPtr< FlxUIButton_obj > __alloc(hx::Ctx *_hx_ctx,hx::Null< Float >  __o_X,hx::Null< Float >  __o_Y,::String Label, ::Dynamic OnClick, ::Dynamic __o_LoadDefaultGraphics, ::Dynamic __o_LoadBlank);
