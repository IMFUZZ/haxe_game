...
class HXCPP_CLASS_ATTRIBUTES FlxUIMouse_obj : public  ::flixel::input::mouse::FlxMouse_obj
{
	...
	public:
		...
		static hx::ObjectPtr< FlxUIMouse_obj > __new( ::openfl::_legacy::display::Sprite CursorContainer);
		static hx::ObjectPtr< FlxUIMouse_obj > __alloc(hx::Ctx *_hx_ctx, ::openfl::_legacy::display::Sprite CursorContainer);
		...
		::String __ToString() const { return HX_HCSTRING("FlxUIMouse","\x1f","\xdd","\x1a","\x00"); }
