...
class HXCPP_CLASS_ATTRIBUTES FlxUI9SliceSprite_obj : public  ::flixel::addons::ui::FlxUISprite_obj
{
	...
	public:
		...
		void __construct(Float X,Float Y, ::Dynamic Graphic, ::openfl::_legacy::geom::Rectangle Rect,::Array< int > Slice9,hx::Null< int >  __o_Tile,hx::Null< bool >  __o_Smooth,::String __o_Id,hx::Null< Float >  __o_Ratio, ::flixel::math::FlxPoint Resize_point,hx::Null< int >  __o_Resize_axis,hx::Null< bool >  __o_DeferResize);
