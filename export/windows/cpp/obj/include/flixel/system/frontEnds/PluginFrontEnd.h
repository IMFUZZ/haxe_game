...
class HXCPP_CLASS_ATTRIBUTES  PluginFrontEnd_obj : public hx::Object{
	...
	public:
		...
		virtual ::flixel::addons::nape::FlxNapeSpace add_flixel_addons_nape_FlxNapeSpace( ::flixel::addons::nape::FlxNapeSpace Plugin);
		Dynamic add_flixel_addons_nape_FlxNapeSpace_dyn();
