...
HX_STACK_THIS(this)
{
	...
	super::__construct();
	HX_STACK_LINE(16)
	this->_eventEvents = Array_obj< ::Dynamic >::__new();
	HX_STACK_LINE(17)
	Dynamic tmp = this->_onComplete_dyn();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(17)
	this->start((int)480,tmp,(int)0);
}
;
	return null();
}
...
{
		HX_STACK_FRAME("Clock","_onComplete",0x58259b57,"Clock._onComplete","Clock.hx",21,0x2c6789d0)
		HX_STACK_THIS(this)
...
Dynamic numberOfDays = __o_numberOfDays.Default(1);
	HX_STACK_FRAME("Clock","addDay",0x8682d57b,"Clock.addDay","Clock.hx",24,0x2c6789d0)
	HX_STACK_THIS(this)
...
int Clock_obj::addTimeEvent( ::TimeEvent a_timeEvent,Dynamic a_Event){
	HX_STACK_FRAME("Clock","addTimeEvent",0x1b46dd2c,"Clock.addTimeEvent","Clock.hx",57,0x2c6789d0)
	HX_STACK_THIS(this)
...
void Clock_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(_dayStates,"_dayStates");
	HX_MARK_MEMBER_NAME(_eventEvents,"_eventEvents");
...
void Clock_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(_dayStates,"_dayStates");
	HX_VISIT_MEMBER_NAME(_eventEvents,"_eventEvents");
...
Dynamic Clock_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"_dayStates") ) { return _dayStates; }
		break;
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"_eventEvents") ) { return _eventEvents; }
...
Dynamic Clock_obj::__SetField(const ::String &inName,const Dynamic &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"_dayStates") ) { _dayStates=inValue.Cast< ::haxe::IMap >(); return inValue; }
		break;
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"_eventEvents") ) { _eventEvents=inValue.Cast< Array< ::Dynamic > >(); return inValue; }
	}
...
void Clock_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("_dayStates","\x7f","\x2c","\x42","\x50"));
	outFields->push(HX_HCSTRING("_eventEvents","\xd4","\x48","\xc1","\x4f"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::haxe::IMap*/ ,(int)offsetof(Clock_obj,_dayStates),HX_HCSTRING("_dayStates","\x7f","\x2c","\x42","\x50")},
	{hx::fsObject /*Array< ::Dynamic >*/ ,(int)offsetof(Clock_obj,_eventEvents),HX_HCSTRING("_eventEvents","\xd4","\x48","\xc1","\x4f")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String sMemberFields[] = {
	...
	HX_HCSTRING("_dayStates","\x7f","\x2c","\x42","\x50"),
	HX_HCSTRING("_eventEvents","\xd4","\x48","\xc1","\x4f"),
