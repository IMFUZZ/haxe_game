...
bool FlxVector_obj::isPerpendicular( ::flixel::math::FlxVector v){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 179)		return (::Math_obj::abs(((this->x * v->x) + (this->y * v->y))) < ((Float)9.9999999999999984e-015));
            	}
...
bool FlxVector_obj::isParallel( ::flixel::math::FlxVector v){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(v,"v")
HXLINE( 201)		return (::Math_obj::abs(((this->x * v->y) - (this->y * v->x))) < ((Float)9.9999999999999984e-015));
            	}
...
bool FlxVector_obj::isNormalized(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 240)		return (::Math_obj::abs((((this->x * this->x) + (this->y * this->y)) - (int)1)) < ((Float)9.9999999999999984e-015));
            	}
...
Float FlxVector_obj::ratio( ::flixel::math::FlxVector a, ::flixel::math::FlxVector b, ::flixel::math::FlxVector v){
            	...
            	HX_STACK_ARG(b,"b")
            	HX_STACK_ARG(v,"v")
HXLINE( 386)		if ((::Math_obj::abs(((this->x * v->y) - (this->y * v->x))) < ((Float)9.9999999999999984e-015))) {
...
HXLINE( 387)			_hx_tmp = (((v->x * v->x) + (v->y * v->y)) < ((Float)9.9999999999999984e-015));
            		}
            		else {
