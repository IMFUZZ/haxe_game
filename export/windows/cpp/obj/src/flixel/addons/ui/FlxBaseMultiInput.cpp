...
HX_DEFINE_STACK_FRAME(_hx_pos_496c6bf68154a4c5_37_destroy,"flixel.addons.ui.FlxBaseMultiInput","destroy",0xd1b0b76f,"flixel.addons.ui.FlxBaseMultiInput.destroy","flixel/addons/ui/FlxBaseMultiInput.hx",37,0x748f1d1c)
HX_DEFINE_STACK_FRAME(_hx_pos_496c6bf68154a4c5_44_checkJustPressed,"flixel.addons.ui.FlxBaseMultiInput","checkJustPressed",0x0bc4b0d9,"flixel.addons.ui.FlxBaseMultiInput.checkJustPressed","flixel/addons/ui/FlxBaseMultiInput.hx",44,0x748f1d1c)
HX_DEFINE_STACK_FRAME(_hx_pos_496c6bf68154a4c5_50_checkJustReleased,"flixel.addons.ui.FlxBaseMultiInput","checkJustReleased",0x472c1aa6,"flixel.addons.ui.FlxBaseMultiInput.checkJustReleased","flixel/addons/ui/FlxBaseMultiInput.hx",50,0x748f1d1c)
HX_DEFINE_STACK_FRAME(_hx_pos_496c6bf68154a4c5_56_checkPressed,"flixel.addons.ui.FlxBaseMultiInput","checkPressed",0x898ff825,"flixel.addons.ui.FlxBaseMultiInput.checkPressed","flixel/addons/ui/FlxBaseMultiInput.hx",56,0x748f1d1c)
HX_DEFINE_STACK_FRAME(_hx_pos_496c6bf68154a4c5_66_justPressed,"flixel.addons.ui.FlxBaseMultiInput","justPressed",0x26c076cb,"flixel.addons.ui.FlxBaseMultiInput.justPressed","flixel/addons/ui/FlxBaseMultiInput.hx",66,0x748f1d1c)
HX_DEFINE_STACK_FRAME(_hx_pos_496c6bf68154a4c5_75_justReleased,"flixel.addons.ui.FlxBaseMultiInput","justReleased",0xc87d8874,"flixel.addons.ui.FlxBaseMultiInput.justReleased","flixel/addons/ui/FlxBaseMultiInput.hx",75,0x748f1d1c)
HX_DEFINE_STACK_FRAME(_hx_pos_496c6bf68154a4c5_84_pressed,"flixel.addons.ui.FlxBaseMultiInput","pressed",0xe7115d17,"flixel.addons.ui.FlxBaseMultiInput.pressed","flixel/addons/ui/FlxBaseMultiInput.hx",84,0x748f1d1c)
HX_DEFINE_STACK_FRAME(_hx_pos_496c6bf68154a4c5_88_equals,"flixel.addons.ui.FlxBaseMultiInput","equals",0x1edc296a,"flixel.addons.ui.FlxBaseMultiInput.equals","flixel/addons/ui/FlxBaseMultiInput.hx",88,0x748f1d1c)
HX_DEFINE_STACK_FRAME(_hx_pos_496c6bf68154a4c5_137_passCombosAndForbiddens,"flixel.addons.ui.FlxBaseMultiInput","passCombosAndForbiddens",0x9987f990,"flixel.addons.ui.FlxBaseMultiInput.passCombosAndForbiddens","flixel/addons/ui/FlxBaseMultiInput.hx",137,0x748f1d1c)
HX_DEFINE_STACK_FRAME(_hx_pos_496c6bf68154a4c5_150_checkCombos,"flixel.addons.ui.FlxBaseMultiInput","checkCombos",0xdd515842,"flixel.addons.ui.FlxBaseMultiInput.checkCombos","flixel/addons/ui/FlxBaseMultiInput.hx",150,0x748f1d1c)
HX_DEFINE_STACK_FRAME(_hx_pos_496c6bf68154a4c5_156_checkForbiddens,"flixel.addons.ui.FlxBaseMultiInput","checkForbiddens",0x356abfb7,"flixel.addons.ui.FlxBaseMultiInput.checkForbiddens","flixel/addons/ui/FlxBaseMultiInput.hx",156,0x748f1d1c)
namespace flixel{
namespace addons{
namespace ui{
...
bool FlxBaseMultiInput_obj::justPressed(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  66)		if (this->checkJustPressed()) {
HXLINE(  66)			return this->passCombosAndForbiddens(null(),null());
            		}
            		else {
...
bool FlxBaseMultiInput_obj::justReleased(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  75)		if (this->checkJustReleased()) {
HXLINE(  75)			if (hx::IsNotNull( this->forbiddens )) {
HXLINE(  75)				return this->checkForbiddens(false);
            			}
            			else {
...
bool FlxBaseMultiInput_obj::pressed(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  84)		if (this->checkPressed()) {
HXLINE(  84)			return this->passCombosAndForbiddens(null(),null());
            		}
            		else {
...
HXDLIN( 111)			HX_VARI( ::Array< int >,_g1) = this->combos;
HXDLIN( 111)			while((_g < _g1->length)){
HXLINE( 111)				HX_VARI( int,i) = _g1->__get(_g);
...
HXLINE( 121)			HX_VARI_NAME( int,_g2,"_g") = (int)0;
HXDLIN( 121)			HX_VARI_NAME( ::Array< int >,_g11,"_g1") = this->forbiddens;
HXDLIN( 121)			while((_g2 < _g11->length)){
HXLINE( 121)				HX_VARI_NAME( int,i1,"i") = _g11->__get(_g2);
...
HXLINE( 139)		HX_VAR( bool,passCombos);
...
HXLINE( 141)		HX_VAR( bool,passForbiddens);
