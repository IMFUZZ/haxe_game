...
HX_DEFINE_STACK_FRAME(_hx_pos_9f4560912681d6f0_21_clone,"flixel.addons.ui.BorderDef","clone",0xc2319f37,"flixel.addons.ui.BorderDef.clone","flixel/addons/ui/BorderDef.hx",21,0xa0e6b257)
HX_DEFINE_STACK_FRAME(_hx_pos_9f4560912681d6f0_25_apply,"flixel.addons.ui.BorderDef","apply",0x9e0a1148,"flixel.addons.ui.BorderDef.apply","flixel/addons/ui/BorderDef.hx",25,0xa0e6b257)
HX_DEFINE_STACK_FRAME(_hx_pos_9f4560912681d6f0_31_fromXML,"flixel.addons.ui.BorderDef","fromXML",0xcb72d8e7,"flixel.addons.ui.BorderDef.fromXML","flixel/addons/ui/BorderDef.hx",31,0xa0e6b257)
namespace flixel{
namespace addons{
namespace ui{
...
bool BorderDef_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::addons::ui::BorderDef BorderDef_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  21)		return  ::flixel::addons::ui::BorderDef_obj::__alloc( HX_CTX ,this->style,this->color,this->size,this->quality);
            	}
...
HXLINE(  32)		HX_VARI( ::String,border_str) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("border",ec,4c,1a,64),null(),null());
HXLINE(  34)		HX_VARI( int,border_color) = ::flixel::addons::ui::U_obj::xml_color(data,HX_("border_color",90,7e,e8,6e),true,(int)0);
HXLINE(  35)		HX_VARI( Float,border_size) = ::flixel::addons::ui::U_obj::xml_f(data,HX_("border_size",34,18,b0,f8),(int)1);
HXLINE(  38)		HX_VARI(  ::flixel::addons::ui::BorderDef,borderDef) =  ::flixel::addons::ui::BorderDef_obj::__alloc( HX_CTX ,::flixel::text::FlxTextBorderStyle_obj::NONE_dyn(),border_color,border_size,::flixel::addons::ui::U_obj::xml_f(data,HX_("border_quality",2c,77,d7,ad),(int)0));
...
HXLINE(  52)				HX_VARI(  ::Dynamic,return_val) = ::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(border_str);
...
HXLINE(  57)					HX_VARI_NAME(  ::Dynamic,return_val1,"return_val") = ::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(border_str);
...
HXLINE(  62)						HX_VARI_NAME(  ::Dynamic,return_val2,"return_val") = ::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(border_str);
