...
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_44_set_skipButtonUpdate,"flixel.addons.ui.FlxUICheckBox","set_skipButtonUpdate",0x88caa7cd,"flixel.addons.ui.FlxUICheckBox.set_skipButtonUpdate","flixel/addons/ui/FlxUICheckBox.hx",44,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_51_set_params,"flixel.addons.ui.FlxUICheckBox","set_params",0xd67a1a99,"flixel.addons.ui.FlxUICheckBox.set_params","flixel/addons/ui/FlxUICheckBox.hx",51,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_63_set_color,"flixel.addons.ui.FlxUICheckBox","set_color",0x10dbdd70,"flixel.addons.ui.FlxUICheckBox.set_color","flixel/addons/ui/FlxUICheckBox.hx",63,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_159_setLabel,"flixel.addons.ui.FlxUICheckBox","setLabel",0xd38df688,"flixel.addons.ui.FlxUICheckBox.setLabel","flixel/addons/ui/FlxUICheckBox.hx",159,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_160_getLabel,"flixel.addons.ui.FlxUICheckBox","getLabel",0x25309d14,"flixel.addons.ui.FlxUICheckBox.getLabel","flixel/addons/ui/FlxUICheckBox.hx",160,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_163_set_visible,"flixel.addons.ui.FlxUICheckBox","set_visible",0x9960c1bf,"flixel.addons.ui.FlxUICheckBox.set_visible","flixel/addons/ui/FlxUICheckBox.hx",163,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_170_anchorTime,"flixel.addons.ui.FlxUICheckBox","anchorTime",0xb5482238,"flixel.addons.ui.FlxUICheckBox.anchorTime","flixel/addons/ui/FlxUICheckBox.hx",170,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_173_set_textX,"flixel.addons.ui.FlxUICheckBox","set_textX",0xd418b718,"flixel.addons.ui.FlxUICheckBox.set_textX","flixel/addons/ui/FlxUICheckBox.hx",173,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_179_set_textY,"flixel.addons.ui.FlxUICheckBox","set_textY",0xd418b719,"flixel.addons.ui.FlxUICheckBox.set_textY","flixel/addons/ui/FlxUICheckBox.hx",179,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_186_anchorLabelX,"flixel.addons.ui.FlxUICheckBox","anchorLabelX",0xdbea9ecf,"flixel.addons.ui.FlxUICheckBox.anchorLabelX","flixel/addons/ui/FlxUICheckBox.hx",186,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_192_anchorLabelY,"flixel.addons.ui.FlxUICheckBox","anchorLabelY",0xdbea9ed0,"flixel.addons.ui.FlxUICheckBox.anchorLabelY","flixel/addons/ui/FlxUICheckBox.hx",192,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_198_destroy,"flixel.addons.ui.FlxUICheckBox","destroy",0xc5a03224,"flixel.addons.ui.FlxUICheckBox.destroy","flixel/addons/ui/FlxUICheckBox.hx",198,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_215_get_text,"flixel.addons.ui.FlxUICheckBox","get_text",0x225f07cc,"flixel.addons.ui.FlxUICheckBox.get_text","flixel/addons/ui/FlxUICheckBox.hx",215,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_217_set_text,"flixel.addons.ui.FlxUICheckBox","set_text",0xd0bc6140,"flixel.addons.ui.FlxUICheckBox.set_text","flixel/addons/ui/FlxUICheckBox.hx",217,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_223_update,"flixel.addons.ui.FlxUICheckBox","update",0x52efd41f,"flixel.addons.ui.FlxUICheckBox.update","flixel/addons/ui/FlxUICheckBox.hx",223,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_242_set_checked,"flixel.addons.ui.FlxUICheckBox","set_checked",0x0960fc74,"flixel.addons.ui.FlxUICheckBox.set_checked","flixel/addons/ui/FlxUICheckBox.hx",242,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_250__clickCheck,"flixel.addons.ui.FlxUICheckBox","_clickCheck",0xbe94b6a9,"flixel.addons.ui.FlxUICheckBox._clickCheck","flixel/addons/ui/FlxUICheckBox.hx",250,0xab9d9a07)
HX_DEFINE_STACK_FRAME(_hx_pos_ce87859da0fe064b_41_boot,"flixel.addons.ui.FlxUICheckBox","boot",0xe43d00c8,"flixel.addons.ui.FlxUICheckBox.boot","flixel/addons/ui/FlxUICheckBox.hx",41,0xab9d9a07)
namespace flixel{
namespace addons{
namespace ui{
...
HXLINE(  96)		this->button =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,(int)0,(int)0,Label,this->_clickCheck_dyn(),null(),null());
...
HXLINE( 100)		this->button->up_color = (int)16777215;
HXLINE( 101)		this->button->down_color = (int)16777215;
HXLINE( 102)		this->button->over_color = (int)16777215;
HXLINE( 103)		this->button->up_toggle_color = (int)16777215;
HXLINE( 104)		this->button->down_toggle_color = (int)16777215;
HXLINE( 105)		this->button->over_toggle_color = (int)16777215;
...
HXDLIN( 109)		this->max_width = ::Std_obj::_hx_int(((_hx_tmp3 + this->box_space) + LabelW));
...
HXLINE( 119)		if (::Std_obj::is(Check,hx::ClassOf< ::flixel::FlxSprite >())) {
...
HXLINE( 139)		this->button->setAllLabelOffsets((int)0,(int)0);
HXLINE( 141)		this->set_x(X);
HXLINE( 142)		this->set_y(Y);
HXLINE( 144)		this->set_textX((int)0);
HXLINE( 145)		this->set_textY((int)0);
            	}
...
HXLINE(  58)		this->params->push( ::Dynamic(hx::Anon_obj::Create(2)
...
HXLINE(  68)		return this->super::set_color(Value);
 ...
 ::flixel::addons::ui::FlxUIText FlxUICheckBox_obj::setLabel( ::flixel::addons::ui::FlxUIText t){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_159_setLabel)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(t,"t")
HXLINE( 159)		if (hx::IsNull( this->button )) {
HXLINE( 159)			return null();
            		}
HXDLIN( 159)		this->button->set_label(t).StaticCast<  ::flixel::addons::ui::FlxUIText >();
HXDLIN( 159)		return this->button->label;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUICheckBox_obj,setLabel,return )
 ...
 ::flixel::addons::ui::FlxUIText FlxUICheckBox_obj::getLabel(){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_160_getLabel)
            	HX_STACK_THIS(this)
HXLINE( 160)		if (hx::IsNull( this->button )) {
HXLINE( 160)			return null();
            		}
HXDLIN( 160)		return this->button->label;
            	}
...
bool FlxUICheckBox_obj::set_visible(bool Value){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_163_set_visible)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Value,"Value")
HXLINE( 165)		this->visible = Value;
HXLINE( 166)		return this->visible;
            	}


void FlxUICheckBox_obj::anchorTime( ::flixel::util::FlxTimer f){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_170_anchorTime)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
HXLINE( 170)		this->anchorLabelY();
            	}
...
Float FlxUICheckBox_obj::set_textX(Float n){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_173_set_textX)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(n,"n")
HXLINE( 174)		this->textX = n;
HXLINE( 175)		this->anchorLabelX();
HXLINE( 176)		return this->textX;
            	}
...
Float FlxUICheckBox_obj::set_textY(Float n){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_179_set_textY)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(n,"n")
HXLINE( 180)		this->textY = n;
HXLINE( 181)		this->anchorLabelY();
HXLINE( 182)		return this->textY;
            	}
...
void FlxUICheckBox_obj::anchorLabelX(){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_186_anchorLabelX)
            	HX_STACK_THIS(this)
HXLINE( 186)		if (hx::IsNotNull( this->button )) {
HXLINE( 187)			 ::flixel::math::FlxPoint _hx_tmp = ( ( ::flixel::FlxSprite)(this->button->label) )->offset;
HXDLIN( 187)			Float _hx_tmp1 = this->box->get_width();
HXDLIN( 187)			_hx_tmp->set_x(-(((_hx_tmp1 + this->box_space) + this->textX)));
            		}
            	}
...
void FlxUICheckBox_obj::anchorLabelY(){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_192_anchorLabelY)
            	HX_STACK_THIS(this)
HXLINE( 192)		if (hx::IsNotNull( this->button )) {
HXLINE( 193)			 ::flixel::addons::ui::FlxUIButton _hx_tmp = this->button;
HXDLIN( 193)			Float _hx_tmp1 = this->box->y;
HXDLIN( 193)			Float _hx_tmp2 = this->box->get_height();
HXDLIN( 193)			Float _hx_tmp3 = (_hx_tmp1 + ((Float)(_hx_tmp2 - this->button->get_height()) / (Float)(int)2));
HXDLIN( 193)			_hx_tmp->set_y((_hx_tmp3 + this->textY));
            		}
            	}
...
void FlxUICheckBox_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_198_destroy)
            	HX_STACK_THIS(this)
HXLINE( 199)		this->super::destroy();
HXLINE( 200)		if (hx::IsNotNull( this->mark )) {
HXLINE( 201)			this->mark->destroy();
HXLINE( 202)			this->mark = null();
            		}
HXLINE( 204)		if (hx::IsNotNull( this->box )) {
HXLINE( 205)			this->box->destroy();
HXLINE( 206)			this->box = null();
            		}
HXLINE( 208)		if (hx::IsNotNull( this->button )) {
HXLINE( 209)			this->button->destroy();
HXLINE( 210)			this->button = null();
            		}
            	}


::String FlxUICheckBox_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_215_get_text)
            	HX_STACK_THIS(this)
HXLINE( 215)		return ( ( ::flixel::text::FlxText)(this->button->label) )->text;
            	}
...
::String FlxUICheckBox_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_217_set_text)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE( 218)		( ( ::flixel::text::FlxText)(this->button->label) )->set_text(value);
HXLINE( 219)		this->checkbox_dirty = true;
...
void FlxUICheckBox_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_223_update)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE( 224)		this->super::update(elapsed);
HXLINE( 226)		if (this->checkbox_dirty) {
HXLINE( 227)			if (hx::IsNotNull( ( ( ::flixel::addons::ui::FlxUIText)(this->button->label) ) )) {
HXLINE( 228)				if (::Std_obj::is(this->button->label,hx::ClassOf< ::flixel::addons::ui::FlxUIText >())) {
HXLINE( 230)					( ( ::flixel::addons::ui::FlxUIText)(this->button->label) )->drawFrame(null());
            				}
HXLINE( 232)				this->anchorLabelX();
HXLINE( 233)				this->anchorLabelY();
HXLINE( 234)				 ::flixel::addons::ui::FlxUIButton _hx_tmp = this->button;
HXDLIN( 234)				Float _hx_tmp1 = (this->box->frameWidth + this->box_space);
HXDLIN( 234)				_hx_tmp->set_width((_hx_tmp1 + ( ( ::flixel::text::FlxText)(this->button->label) )->textField->get_textWidth()));
HXLINE( 235)				this->checkbox_dirty = false;
            			}
            		}
            	}
...
bool FlxUICheckBox_obj::set_checked(bool b){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_242_set_checked)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(b,"b")
HXLINE( 243)		this->mark->set_visible(b);
HXLINE( 244)		return (this->checked = b);
            	}
...
void FlxUICheckBox_obj::_clickCheck(){
            	HX_STACKFRAME(&_hx_pos_ce87859da0fe064b_250__clickCheck)
            	HX_STACK_THIS(this)
HXLINE( 251)		if (!(this->visible)) {
HXLINE( 252)			return;
            		}
HXLINE( 254)		this->set_checked(!(this->checked));
HXLINE( 255)		if (hx::IsNotNull( this->callback )) {
HXLINE( 257)			this->callback();
            		}
HXLINE( 259)		if (this->broadcastToFlxUI) {
HXLINE( 261)			::flixel::addons::ui::FlxUI_obj::event(HX_("click_check_box",dd,c1,1e,a8),hx::ObjectPtr<OBJ_>(this),this->checked,this->params);
            		}
            	}
...
hx::Val FlxUICheckBox_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"textX") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_textX(inValue) );textX=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"textY") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_textY(inValue) );textY=inValue.Cast< Float >(); return inValue; }
		break;
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"checked") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_checked(inValue) );checked=inValue.Cast< bool >(); return inValue; }
		break;
	case 8:
...
HXLINE(  41)		CLICK_EVENT = HX_("click_check_box",dd,c1,1e,a8);
            	}
}
