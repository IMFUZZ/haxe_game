...
HX_DEFINE_STACK_FRAME(_hx_pos_22e81ddbc10a4d63_37_set_resize_ratio,"flixel.addons.ui.FlxUISprite","set_resize_ratio",0xbe28f3f1,"flixel.addons.ui.FlxUISprite.set_resize_ratio","flixel/addons/ui/FlxUISprite.hx",37,0xc16e6665)
HX_DEFINE_STACK_FRAME(_hx_pos_22e81ddbc10a4d63_43_set_resize_point,"flixel.addons.ui.FlxUISprite","set_resize_point",0xa0947336,"flixel.addons.ui.FlxUISprite.set_resize_point","flixel/addons/ui/FlxUISprite.hx",43,0xc16e6665)
HX_DEFINE_STACK_FRAME(_hx_pos_22e81ddbc10a4d63_59_recycle,"flixel.addons.ui.FlxUISprite","recycle",0x37d621df,"flixel.addons.ui.FlxUISprite.recycle","flixel/addons/ui/FlxUISprite.hx",59,0xc16e6665)
HX_DEFINE_STACK_FRAME(_hx_pos_22e81ddbc10a4d63_65_resize,"flixel.addons.ui.FlxUISprite","resize",0x58d785a8,"flixel.addons.ui.FlxUISprite.resize","flixel/addons/ui/FlxUISprite.hx",65,0xc16e6665)
HX_DEFINE_STACK_FRAME(_hx_pos_22e81ddbc10a4d63_107_loadGraphicAtScale,"flixel.addons.ui.FlxUISprite","loadGraphicAtScale",0x16f15949,"flixel.addons.ui.FlxUISprite.loadGraphicAtScale","flixel/addons/ui/FlxUISprite.hx",107,0xc16e6665)
HX_DEFINE_STACK_FRAME(_hx_pos_22e81ddbc10a4d63_124_loadGraphic,"flixel.addons.ui.FlxUISprite","loadGraphic",0x778a00ee,"flixel.addons.ui.FlxUISprite.loadGraphic","flixel/addons/ui/FlxUISprite.hx",124,0xc16e6665)
HX_DEFINE_STACK_FRAME(_hx_pos_22e81ddbc10a4d63_134_destroy,"flixel.addons.ui.FlxUISprite","destroy",0x24d03ec6,"flixel.addons.ui.FlxUISprite.destroy","flixel/addons/ui/FlxUISprite.hx",134,0xc16e6665)
HX_DEFINE_STACK_FRAME(_hx_pos_22e81ddbc10a4d63_141_loadFromScaledGraphic,"flixel.addons.ui.FlxUISprite","loadFromScaledGraphic",0xde4b092a,"flixel.addons.ui.FlxUISprite.loadFromScaledGraphic","flixel/addons/ui/FlxUISprite.hx",141,0xc16e6665)
HX_DEFINE_STACK_FRAME(_hx_pos_22e81ddbc10a4d63_27_boot,"flixel.addons.ui.FlxUISprite","boot",0x13bd9ae6,"flixel.addons.ui.FlxUISprite.boot","flixel/addons/ui/FlxUISprite.hx",27,0xc16e6665)
HX_DEFINE_STACK_FRAME(_hx_pos_22e81ddbc10a4d63_28_boot,"flixel.addons.ui.FlxUISprite","boot",0x13bd9ae6,"flixel.addons.ui.FlxUISprite.boot","flixel/addons/ui/FlxUISprite.hx",28,0xc16e6665)
HX_DEFINE_STACK_FRAME(_hx_pos_22e81ddbc10a4d63_29_boot,"flixel.addons.ui.FlxUISprite","boot",0x13bd9ae6,"flixel.addons.ui.FlxUISprite.boot","flixel/addons/ui/FlxUISprite.hx",29,0xc16e6665)
namespace flixel{
namespace addons{
namespace ui{
...
HXLINE(  46)			HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
void FlxUISprite_obj::resize(Float w,Float h){
            	...
            	HX_STACK_ARG(w,"w")
            	HX_STACK_ARG(h,"h")
HXLINE(  66)		HX_VARI( Float,old_width) = this->get_width();
HXLINE(  67)		HX_VARI( Float,old_height) = this->get_height();
HXLINE(  69)		if ((this->resize_ratio > (int)0)) {
HXLINE(  72)			if ((::Math_obj::abs((((Float)w / (Float)h) - this->resize_ratio)) > ((Float)0.0001))) {
...
HXLINE(  87)			HX_VARI( ::String,newKey) = ::flixel::addons::ui::U_obj::loadScaledImage(this->_originalKey,w,h,null());
...
HXLINE(  94)		HX_VARI( Float,diff_w) = (this->get_width() - old_width);
HXLINE(  95)		HX_VARI( Float,diff_h) = (this->get_height() - old_height);
HXLINE(  97)		if (hx::IsNotNull( this->resize_point )) {
HXLINE( 100)			HX_VARI( Float,delta_y) = (diff_h * this->resize_point->y);
HXLINE( 101)			{
HXLINE( 101)				HX_VARI(  ::flixel::addons::ui::FlxUISprite,_g) = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 101)				_g->set_x((_g->x - (diff_w * this->resize_point->x)));
            			}
HXLINE( 102)			{
HXLINE( 102)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUISprite,_g1,"_g") = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 125)		HX_VARI(  ::flixel::FlxSprite,sprite) = this->super::loadGraphic(Graphic,Animated,Width,Height,Unique,Key);
...
bool Unique = __o_Unique.Default(false);
            	...
            	HX_STACK_ARG(Unique,"Unique")
            	HX_STACK_ARG(Key,"Key")
HXLINE( 141)		this->super::loadGraphic(Graphic,Animated,Width,Height,Unique,Key);
            	}
...
hx::Val FlxUISprite_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"resize_ratio") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_resize_ratio(inValue) );resize_ratio=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"resize_point") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_resize_point(inValue) );resize_point=inValue.Cast<  ::flixel::math::FlxPoint >(); return inValue; }
...
HXLINE(  27)		RESIZE_RATIO_X = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_22e81ddbc10a4d63_28_boot)
HXLINE(  28)		RESIZE_RATIO_Y = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_22e81ddbc10a4d63_29_boot)
HXLINE(  29)		RESIZE_RATIO_UNKNOWN = (int)-1;
            	}
}
