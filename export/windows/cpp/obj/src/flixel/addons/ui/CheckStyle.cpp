...
HX_DEFINE_STACK_FRAME(_hx_pos_b952e0391651718d_505_new,"flixel.addons.ui.CheckStyle","new",0xda9b8dcc,"flixel.addons.ui.CheckStyle.new","flixel/addons/ui/FlxUIRadioGroup.hx",505,0x807a4586)
HX_DEFINE_STACK_FRAME(_hx_pos_b952e0391651718d_513_applyToCheck,"flixel.addons.ui.CheckStyle","applyToCheck",0x906b6693,"flixel.addons.ui.CheckStyle.applyToCheck","flixel/addons/ui/FlxUIRadioGroup.hx",513,0x807a4586)
namespace flixel{
namespace addons{
namespace ui{
...
void CheckStyle_obj::__construct( ::Dynamic CheckColor, ::flixel::addons::ui::FontDef Font,::String Align, ::Dynamic Color, ::flixel::addons::ui::BorderDef Border){
            	HX_STACKFRAME(&_hx_pos_b952e0391651718d_505_new)
            	HX_STACK_THIS(this)
...
HXLINE( 506)		this->checkColor = null();
HXLINE( 509)		this->checkColor = CheckColor;
HXLINE( 510)		super::__construct(Font,Align,Color,Border);
            	}
...
void CheckStyle_obj::applyToCheck( ::flixel::addons::ui::FlxUICheckBox c){
            	HX_STACKFRAME(&_hx_pos_b952e0391651718d_513_applyToCheck)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(c,"c")
HXLINE( 514)		if (hx::IsNotNull( this->checkColor )) {
HXLINE( 515)			c->set_color(this->checkColor);
            		}
HXLINE( 517)		this->apply(( ( ::flixel::text::FlxText)(c->button->label) ));
            	}
