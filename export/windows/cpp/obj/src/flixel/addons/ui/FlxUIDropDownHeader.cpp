...
HX_DEFINE_STACK_FRAME(_hx_pos_015f8e5857f13f23_460_new,"flixel.addons.ui.FlxUIDropDownHeader","new",0x97950645,"flixel.addons.ui.FlxUIDropDownHeader.new","flixel/addons/ui/FlxUIDropDownMenu.hx",460,0x238549da)
static const int _hx_array_data_73217fd3_1[] = {
	(int)1,(int)1,(int)14,(int)14,
};
HX_DEFINE_STACK_FRAME(_hx_pos_015f8e5857f13f23_501_destroy,"flixel.addons.ui.FlxUIDropDownHeader","destroy",0x07c8b95f,"flixel.addons.ui.FlxUIDropDownHeader.destroy","flixel/addons/ui/FlxUIDropDownMenu.hx",501,0x238549da)
namespace flixel{
namespace addons{
namespace ui{
...
int Width = __o_Width.Default(120);
            	HX_GC_STACKFRAME(&_hx_pos_015f8e5857f13f23_460_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Width,"Width")
            	HX_STACK_ARG(Background,"Background")
            	HX_STACK_ARG(Text,"Text")
            	HX_STACK_ARG(Button,"Button")
HXLINE( 461)		super::__construct(null(),null());
HXLINE( 463)		this->background = Background;
HXLINE( 464)		this->text = Text;
HXLINE( 465)		this->button = Button;
HXLINE( 468)		if (hx::IsNull( this->background )) {
HXLINE( 469)			this->background =  ::flixel::addons::ui::FlxUI9SliceSprite_obj::__alloc( HX_CTX ,(int)0,(int)0,HX_("flixel/flixel-ui/img/box.png",dd,a4,cf,5b), ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,Width,(int)20),::Array_obj< int >::fromData( _hx_array_data_73217fd3_1,4),null(),null(),null(),null(),null(),null(),null());
            		}
HXLINE( 473)		if (hx::IsNull( this->button )) {
HXLINE( 474)			this->button =  ::flixel::addons::ui::FlxUISpriteButton_obj::__alloc( HX_CTX ,(int)0,(int)0, ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(int)0,(int)0,HX_("flixel/flixel-ui/img/dropdown_mark.png",cd,eb,34,3e)),null());
HXLINE( 475)			 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp = this->button;
HXDLIN( 475)			_hx_tmp->loadGraphicSlice9(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("flixel/flixel-ui/img/button_thin.png",58,62,55,9f)),(int)80,(int)20,::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::util::FlxStringUtil_obj::toIntArray(HX_("6,6,11,11",c0,1f,fa,07))),(int)0,(int)-1,false,(int)18,(int)18,null());
            		}
HXLINE( 479)		 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp1 = this->button;
HXDLIN( 479)		Float _hx_tmp2 = this->background->get_height();
HXDLIN( 479)		_hx_tmp1->resize(_hx_tmp2,this->background->get_height());
HXLINE( 480)		 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp3 = this->button;
HXDLIN( 480)		Float _hx_tmp4 = this->background->x;
HXDLIN( 480)		Float _hx_tmp5 = (_hx_tmp4 + this->background->get_width());
HXDLIN( 480)		_hx_tmp3->set_x((_hx_tmp5 - this->button->get_width()));
HXLINE( 483)		this->button->set_width(Width);
HXLINE( 484)		{
HXLINE( 484)			HX_VARI(  ::flixel::math::FlxPoint,_g) = this->button->offset;
HXDLIN( 484)			_g->set_x((_g->x - (Width - this->button->frameWidth)));
            		}
HXLINE( 485)		this->button->set_x(this->offset->x);
HXLINE( 486)		{
HXLINE( 486)			HX_VARI_NAME(  ::flixel::math::FlxPoint,_g1,"_g") = ( ( ::flixel::FlxSprite)(this->button->label) )->offset;
HXDLIN( 486)			_g1->set_x((_g1->x + this->button->offset->x));
            		}
HXLINE( 489)		if (hx::IsNull( this->text )) {
HXLINE( 490)			this->text =  ::flixel::addons::ui::FlxUIText_obj::__alloc( HX_CTX ,(int)0,(int)0,::Std_obj::_hx_int(this->background->get_width()),null(),null(),null());
            		}
HXLINE( 492)		this->text->setPosition((int)2,(int)4);
HXLINE( 493)		this->text->set_color((int)-16777216);
HXLINE( 495)		this->add(this->background);
HXLINE( 496)		this->add(this->button);
HXLINE( 497)		this->add(this->text);
            	}
...
void FlxUIDropDownHeader_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_015f8e5857f13f23_501_destroy)
            	HX_STACK_THIS(this)
HXLINE( 502)		this->super::destroy();
HXLINE( 504)		this->background = ( ( ::flixel::FlxSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->background)) );
HXLINE( 505)		this->text = ( ( ::flixel::addons::ui::FlxUIText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->text)) );
HXLINE( 506)		this->button = ( ( ::flixel::addons::ui::FlxUISpriteButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->button)) );
            	}
