...
HX_DEFINE_STACK_FRAME(_hx_pos_a7149303f8aeff86_18_copy,"flixel.addons.ui.StrNameLabel","copy",0x988eaeba,"flixel.addons.ui.StrNameLabel.copy","flixel/addons/ui/StrNameLabel.hx",18,0x6ee2b614)
HX_DEFINE_STACK_FRAME(_hx_pos_a7149303f8aeff86_34_toString,"flixel.addons.ui.StrNameLabel","toString",0x67af2a31,"flixel.addons.ui.StrNameLabel.toString","flixel/addons/ui/StrNameLabel.hx",34,0x6ee2b614)
HX_DEFINE_STACK_FRAME(_hx_pos_a7149303f8aeff86_21_sortByLabel,"flixel.addons.ui.StrNameLabel","sortByLabel",0x3fcb0c7a,"flixel.addons.ui.StrNameLabel.sortByLabel","flixel/addons/ui/StrNameLabel.hx",21,0x6ee2b614)
HX_DEFINE_STACK_FRAME(_hx_pos_a7149303f8aeff86_27_sortByName,"flixel.addons.ui.StrNameLabel","sortByName",0x2e612685,"flixel.addons.ui.StrNameLabel.sortByName","flixel/addons/ui/StrNameLabel.hx",27,0x6ee2b614)
namespace flixel{
namespace addons{
namespace ui{
...
bool StrNameLabel_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::addons::ui::StrNameLabel StrNameLabel_obj::copy(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  18)		return  ::flixel::addons::ui::StrNameLabel_obj::__alloc( HX_CTX ,this->name,this->label);
            	}
...
HXDLIN(  35)		HX_VARI(  ::flixel::util::LabelValuePair,_this) = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN(  35)		_this->label = HX_("name",4b,72,ff,48);
HXDLIN(  35)		_this->value = value;
HXLINE(  36)		 ::Dynamic value1 = this->label;
HXDLIN(  36)		HX_VARI_NAME(  ::flixel::util::LabelValuePair,_this1,"_this") = ::flixel::util::LabelValuePair_obj::_pool->get();
