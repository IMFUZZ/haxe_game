...
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_43_get_size,"flixel.addons.ui.FontDef","get_size",0x452657d3,"flixel.addons.ui.FontDef.get_size","flixel/addons/ui/FontDef.hx",43,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_52_set_size,"flixel.addons.ui.FontDef","set_size",0xf383b147,"flixel.addons.ui.FontDef.set_size","flixel/addons/ui/FontDef.hx",52,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_62_clone,"flixel.addons.ui.FontDef","clone",0x2d9e7834,"flixel.addons.ui.FontDef.clone","flixel/addons/ui/FontDef.hx",62,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_104_applyTxt,"flixel.addons.ui.FontDef","applyTxt",0x9e13352b,"flixel.addons.ui.FontDef.applyTxt","flixel/addons/ui/FontDef.hx",104,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_110_applyFlx,"flixel.addons.ui.FontDef","applyFlx",0x9e088b2d,"flixel.addons.ui.FontDef.applyFlx","flixel/addons/ui/FontDef.hx",110,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_134_apply,"flixel.addons.ui.FontDef","apply",0x0976ea45,"flixel.addons.ui.FontDef.apply","flixel/addons/ui/FontDef.hx",134,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_151_fromStr,"flixel.addons.ui.FontDef","fromStr",0x8e8201fe,"flixel.addons.ui.FontDef.fromStr","flixel/addons/ui/FontDef.hx",151,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_215_stripFontExtensions,"flixel.addons.ui.FontDef","stripFontExtensions",0x4ace96d2,"flixel.addons.ui.FontDef.stripFontExtensions","flixel/addons/ui/FontDef.hx",215,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_225_getFontExtension,"flixel.addons.ui.FontDef","getFontExtension",0x3c4339c3,"flixel.addons.ui.FontDef.getFontExtension","flixel/addons/ui/FontDef.hx",225,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_236_fixFontName,"flixel.addons.ui.FontDef","fixFontName",0x0fe78ac6,"flixel.addons.ui.FontDef.fixFontName","flixel/addons/ui/FontDef.hx",236,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_267_getFontStyle,"flixel.addons.ui.FontDef","getFontStyle",0x0566d975,"flixel.addons.ui.FontDef.getFontStyle","flixel/addons/ui/FontDef.hx",267,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_283_setFontStyle,"flixel.addons.ui.FontDef","setFontStyle",0x1a5ffce9,"flixel.addons.ui.FontDef.setFontStyle","flixel/addons/ui/FontDef.hx",283,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_334_toString,"flixel.addons.ui.FontDef","toString",0xb186cc35,"flixel.addons.ui.FontDef.toString","flixel/addons/ui/FontDef.hx",334,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_74_copyFromTextField,"flixel.addons.ui.FontDef","copyFromTextField",0xa0f3d465,"flixel.addons.ui.FontDef.copyFromTextField","flixel/addons/ui/FontDef.hx",74,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_93_copyFromFlxText,"flixel.addons.ui.FontDef","copyFromFlxText",0x2447f7d7,"flixel.addons.ui.FontDef.copyFromFlxText","flixel/addons/ui/FontDef.hx",93,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_302_fromXML,"flixel.addons.ui.FontDef","fromXML",0x8e85ab24,"flixel.addons.ui.FontDef.fromXML","flixel/addons/ui/FontDef.hx",302,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_23_boot,"flixel.addons.ui.FontDef","boot",0xb73ac73b,"flixel.addons.ui.FontDef.boot","flixel/addons/ui/FontDef.hx",23,0x96f2befa)
...
HX_DEFINE_DYNAMIC_FUNC1(FontDef_obj,set_size,return )
 ...
 ::flixel::addons::ui::FontDef FontDef_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  63)		HX_VAR(  ::flixel::addons::ui::BorderDef,newBorder);
...
HXLINE(  64)		HX_VAR(  ::openfl::_legacy::text::TextFormat,newFormat);
...
HXLINE(  69)		HX_VARI(  ::flixel::addons::ui::FontDef,newThis) =  ::flixel::addons::ui::FontDef_obj::__alloc( HX_CTX ,this->name,this->extension,this->file,newFormat,newBorder);
...
HXLINE( 111)		HX_VARI( ::String,flxTxtAlign) = null();
HXLINE( 113)		if (hx::IsNotNull( this->format->align )) {
HXLINE( 115)			::String _hx_switch_0 = this->format->align;
...
HXLINE( 160)		HX_VARI( ::String,style) = this->getFontStyle(str);
HXLINE( 161)		this->setFontStyle(style);
HXLINE( 163)		HX_VARI( ::String,extension) = HX_("",00,00,00,00);
HXLINE( 166)		{
HXLINE( 166)			HX_VARI( int,_g) = (int)0;
HXDLIN( 166)			HX_VARI( ::Array< ::String >,_g1) = ::flixel::addons::ui::FontDef_obj::EXTENSIONS;
HXDLIN( 166)			while((_g < _g1->length)){
HXLINE( 166)				HX_VARI( ::String,ext) = _g1->__get(_g);
HXDLIN( 166)				_g = (_g + (int)1);
HXLINE( 167)				if ((str.indexOf(ext,null()) != (int)-1)) {
HXLINE( 168)					if (::openfl::_legacy::Assets_obj::exists((str + HX_("",00,00,00,00)),::openfl::_legacy::AssetType_obj::FONT_dyn())) {
HXLINE( 169)						this->name = ::StringTools_obj::replace(str,HX_("",00,00,00,00),HX_("",00,00,00,00));
HXLINE( 170)						this->file = str;
HXLINE( 171)						extension = ext;
...
HXLINE( 178)		if ((extension == HX_("",00,00,00,00))) {
HXLINE( 179)			HX_VARI_NAME( int,_g2,"_g") = (int)0;
HXDLIN( 179)			HX_VARI_NAME( ::Array< ::String >,_g11,"_g1") = ::flixel::addons::ui::FontDef_obj::EXTENSIONS;
HXDLIN( 179)			while((_g2 < _g11->length)){
HXLINE( 179)				HX_VARI_NAME( ::String,ext1,"ext") = _g11->__get(_g2);
HXDLIN( 179)				_g2 = (_g2 + (int)1);
HXLINE( 180)				if (::openfl::_legacy::Assets_obj::exists((str + ext1),::openfl::_legacy::AssetType_obj::FONT_dyn())) {
HXLINE( 181)					extension = ext1;
HXLINE( 182)					this->name = str;
HXLINE( 183)					this->file = (str + ext1);
HXLINE( 184)					extension = ext1;
...
HXLINE( 191)			str = this->stripFontExtensions(str);
HXLINE( 193)			if ((this->getFontStyle(str) != HX_("",00,00,00,00))) {
HXLINE( 194)				str = str.substr((str.length - (int)1),(int)1);
HXLINE( 195)				this->fromStr(str,(recursion + (int)1));
HXLINE( 196)				return;
            			}
            			else {
HXLINE( 199)				this->fromStr(str,(recursion + (int)1));
HXLINE( 200)				return;
            			}
            		}
HXLINE( 204)		this->setFontStyle(style);
            	}
...
::String FontDef_obj::stripFontExtensions(::String str){
            	HX_STACKFRAME(&_hx_pos_6202c8c3d680a662_215_stripFontExtensions)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(str,"str")
HXLINE( 216)		if (hx::IsNull( str )) {
HXLINE( 216)			return str;
            		}
HXLINE( 217)		{
HXLINE( 217)			HX_VARI( int,_g) = (int)0;
HXDLIN( 217)			HX_VARI( ::Array< ::String >,_g1) = ::flixel::addons::ui::FontDef_obj::EXTENSIONS;
HXDLIN( 217)			while((_g < _g1->length)){
HXLINE( 217)				HX_VARI( ::String,ext) = _g1->__get(_g);
HXDLIN( 217)				_g = (_g + (int)1);
HXLINE( 218)				bool _hx_tmp;
HXDLIN( 218)				if (hx::IsNotNull( str )) {
HXLINE( 218)					_hx_tmp = (str.indexOf(ext,null()) != (int)-1);
            				}
            				else {
HXLINE( 218)					_hx_tmp = false;
            				}
HXDLIN( 218)				if (_hx_tmp) {
HXLINE( 219)					str = ::StringTools_obj::replace(str,ext,HX_("",00,00,00,00));
            				}
            			}
            		}
HXLINE( 222)		return str;
            	}
...
::String FontDef_obj::getFontExtension(::String str){
            	HX_STACKFRAME(&_hx_pos_6202c8c3d680a662_225_getFontExtension)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(str,"str")
HXLINE( 226)		if (hx::IsNull( str )) {
HXLINE( 226)			return HX_("",00,00,00,00);
            		}
HXLINE( 227)		{
HXLINE( 227)			HX_VARI( int,_g) = (int)0;
HXDLIN( 227)			HX_VARI( ::Array< ::String >,_g1) = ::flixel::addons::ui::FontDef_obj::EXTENSIONS;
HXDLIN( 227)			while((_g < _g1->length)){
HXLINE( 227)				HX_VARI( ::String,ext) = _g1->__get(_g);
HXDLIN( 227)				_g = (_g + (int)1);
HXLINE( 228)				if ((str.indexOf(ext,null()) != (int)-1)) {
HXLINE( 229)					return ext;
            				}
            			}
            		}
HXLINE( 232)		return str;
            	}
...
void FontDef_obj::fixFontName(){
            	HX_STACKFRAME(&_hx_pos_6202c8c3d680a662_236_fixFontName)
            	HX_STACK_THIS(this)
HXLINE( 237)		HX_VARI( ::String,fontStyle) = this->getFontStyle(this->file);
HXLINE( 238)		HX_VARI( ::String,extension) = this->getFontExtension(this->file);
HXLINE( 239)		HX_VARI( ::String,fontbase) = this->stripFontExtensions(this->file);
HXLINE( 240)		if ((fontStyle != HX_("",00,00,00,00))) {
HXLINE( 242)			fontbase = fontbase.substr((int)0,(fontbase.length - (int)1));
            		}
HXLINE( 244)		HX_VARI( ::String,styleStr) = HX_("",00,00,00,00);
HXLINE( 245)		bool _hx_tmp;
HXDLIN( 245)		if (this->format->bold) {
HXLINE( 245)			_hx_tmp = this->format->italic;
            		}
            		else {
HXLINE( 245)			_hx_tmp = false;
            		}
HXDLIN( 245)		if (_hx_tmp) {
HXLINE( 247)			styleStr = HX_("z",7a,00,00,00);
            		}
            		else {
HXLINE( 249)			if (this->format->bold) {
HXLINE( 251)				styleStr = HX_("b",62,00,00,00);
            			}
            			else {
HXLINE( 253)				if (this->format->italic) {
HXLINE( 255)					styleStr = HX_("i",69,00,00,00);
            				}
            			}
            		}
HXLINE( 258)		this->file = ((fontbase + styleStr) + extension);
            	}
...
::String FontDef_obj::getFontStyle(::String str){
            	HX_STACKFRAME(&_hx_pos_6202c8c3d680a662_267_getFontStyle)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(str,"str")
HXLINE( 268)		if (hx::IsNull( str )) {
HXLINE( 268)			return HX_("",00,00,00,00);
            		}
HXLINE( 269)		str = this->stripFontExtensions(str);
HXLINE( 270)		HX_VARI( ::String,lastChar) = str.substr((str.length - (int)1),(int)1);
HXLINE( 271)		bool _hx_tmp;
HXDLIN( 271)		if ((lastChar != HX_("",00,00,00,00))) {
HXLINE( 271)			_hx_tmp = hx::IsNotNull( lastChar );
            		}
            		else {
HXLINE( 271)			_hx_tmp = false;
            		}
HXDLIN( 271)		if (_hx_tmp) {
HXLINE( 272)			lastChar = lastChar.toLowerCase();
HXLINE( 273)			::String _hx_switch_0 = lastChar;
            			if (  (_hx_switch_0==HX_("b",62,00,00,00)) ){
HXLINE( 274)				return HX_("b",62,00,00,00);
HXDLIN( 274)				goto _hx_goto_16;
            			}
            			if (  (_hx_switch_0==HX_("i",69,00,00,00)) ){
HXLINE( 275)				return HX_("i",69,00,00,00);
HXDLIN( 275)				goto _hx_goto_16;
            			}
            			if (  (_hx_switch_0==HX_("z",7a,00,00,00)) ){
HXLINE( 276)				return HX_("z",7a,00,00,00);
HXDLIN( 276)				goto _hx_goto_16;
            			}
            			/* default */{
HXLINE( 277)				return HX_("",00,00,00,00);
            			}
            			_hx_goto_16:;
            		}
HXLINE( 280)		return HX_("",00,00,00,00);
            	}
...
void FontDef_obj::setFontStyle(::String str){
            	HX_STACKFRAME(&_hx_pos_6202c8c3d680a662_283_setFontStyle)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(str,"str")
HXLINE( 284)		str = str.toLowerCase();
HXLINE( 285)		::String _hx_switch_0 = str;
            		if (  (_hx_switch_0==HX_("b",62,00,00,00)) ||  (_hx_switch_0==HX_("bold",85,81,1b,41)) ){
HXLINE( 287)			this->format->bold = true;
HXLINE( 288)			this->format->italic = false;
HXLINE( 286)			goto _hx_goto_18;
            		}
...
HXLINE( 293)			this->format->bold = true;
HXLINE( 294)			this->format->italic = true;
HXLINE( 292)			goto _hx_goto_18;
            		}
            		if (  (_hx_switch_0==HX_("i",69,00,00,00)) ||  (_hx_switch_0==HX_("italic",f0,2e,64,06)) ){
HXLINE( 290)			this->format->bold = false;
HXLINE( 291)			this->format->italic = true;
HXLINE( 289)			goto _hx_goto_18;
            		}
            		/* default */{
HXLINE( 296)			this->format->bold = false;
HXLINE( 297)			this->format->italic = false;
            		}
            		_hx_goto_18:;
HXLINE( 299)		this->fixFontName();
            	}
...
::String FontDef_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_6202c8c3d680a662_334_toString)
            	HX_STACK_THIS(this)
HXLINE( 334)		::String _hx_tmp = ((HX_("{name:",34,f1,69,c4) + this->name) + HX_(",size:",ad,e8,8c,14));
HXDLIN( 334)		::String _hx_tmp1 = ((_hx_tmp + this->get_size()) + HX_(",file:",92,be,4c,98));
HXDLIN( 334)		::String _hx_tmp2 = ((((_hx_tmp1 + this->file) + HX_(",extension:",07,eb,aa,af)) + this->extension) + HX_(",format:",77,5e,da,b3));
HXDLIN( 334)		::String _hx_tmp3 = ((_hx_tmp2 + ::Std_obj::string(this->format)) + HX_(",border:",22,9f,94,07));
HXDLIN( 334)		return ((_hx_tmp3 + ::Std_obj::string(this->border)) + HX_("}",7d,00,00,00));
            	}
...
::Array< ::String > FontDef_obj::EXTENSIONS;
 ...
 ::flixel::addons::ui::FontDef FontDef_obj::copyFromTextField( ::openfl::_legacy::text::TextField t){
            	...
            	HX_STACK_ARG(t,"t")
HXLINE(  75)		HX_VARI(  ::openfl::_legacy::text::TextFormat,dtf) = t->get_defaultTextFormat();
HXLINE(  76)		HX_VARI(  ::flixel::addons::ui::FontDef,fd) =  ::flixel::addons::ui::FontDef_obj::__alloc( HX_CTX ,HX_("",00,00,00,00),null(),null(),null(),null());
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FontDef_obj,copyFromTextField,return )
 ...
 ::flixel::addons::ui::FontDef FontDef_obj::copyFromFlxText( ::flixel::text::FlxText t){
            	...
            	HX_STACK_ARG(t,"t")
HXLINE(  94)		HX_VARI(  ::flixel::addons::ui::FontDef,fd) = ::flixel::addons::ui::FontDef_obj::copyFromTextField(t->textField);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FontDef_obj,copyFromFlxText,return )
 ...
 ::flixel::addons::ui::FontDef FontDef_obj::fromXML( ::Xml data){
            	HX_GC_STACKFRAME(&_hx_pos_6202c8c3d680a662_302_fromXML)
            	HX_STACK_ARG(data,"data")
HXLINE( 303)		HX_VARI( ::String,fontFace) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("font",cf,5d,c0,43),null(),null());
HXLINE( 304)		HX_VARI( ::String,fontStyle) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("style",31,a5,1d,84),null(),null());
HXLINE( 305)		HX_VARI( ::String,fontFile) = null();
HXLINE( 306)		if ((fontFace != HX_("",00,00,00,00))) {
HXLINE( 308)			fontFile = ::flixel::addons::ui::U_obj::font(fontFace,fontStyle,null());
            		}
HXLINE( 310)		HX_VARI_NAME( ::String,fontStyle1,"fontStyle") = ::flixel::addons::ui::U_obj::xml_str(data,HX_("style",31,a5,1d,84),null(),null());
HXLINE( 311)		HX_VARI( int,fontSize) = ::flixel::addons::ui::U_obj::xml_i(data,HX_("size",c1,a0,53,4c),(int)8);
HXLINE( 312)		HX_VARI( int,fontColor) = ::flixel::addons::ui::U_obj::xml_color(data,HX_("color",63,71,5c,4a),true,(int)-1);
HXLINE( 314)		HX_VAR( ::String,align);
HXDLIN( 314)		::String _hx_switch_0 = ::flixel::addons::ui::U_obj::xml_str(data,HX_("align",c5,56,91,21),null(),null()).toLowerCase();
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE( 314)			align = HX_("center",d5,25,db,05);
HXDLIN( 314)			goto _hx_goto_23;
            		}
            		if (  (_hx_switch_0==HX_("justify",50,df,b5,83)) ){
HXLINE( 314)			align = HX_("justify",50,df,b5,83);
HXDLIN( 314)			goto _hx_goto_23;
            		}
            		if (  (_hx_switch_0==HX_("left",07,08,b0,47)) ){
HXLINE( 314)			align = HX_("left",07,08,b0,47);
HXDLIN( 314)			goto _hx_goto_23;
            		}
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 314)			align = HX_("right",dc,0b,64,e9);
HXDLIN( 314)			goto _hx_goto_23;
            		}
            		/* default */{
HXLINE( 314)			align = HX_("left",07,08,b0,47);
            		...
            		_hx_goto_23:;
HXLINE( 322)		HX_VARI(  ::flixel::addons::ui::FontDef,fd) =  ::flixel::addons::ui::FontDef_obj::__alloc( HX_CTX ,::flixel::addons::ui::U_obj::xml_str(data,HX_("font",cf,5d,c0,43),null(),null()),HX_(".ttf",78,3b,c0,1e),fontFile,null(),null());
HXLINE( 323)		fd->format->color = fontColor;
HXLINE( 324)		fd->format->size = fontSize;
HXLINE( 325)		fd->format->align = align;
HXLINE( 326)		fd->set_size(fontSize);
HXLINE( 327)		fd->setFontStyle(fontStyle1);
HXLINE( 328)		fd->border = ::flixel::addons::ui::BorderDef_obj::fromXML(data);
HXLINE( 329)		return fd;
            	}
...
HXLINE(  23)		EXTENSIONS = ::Array_obj< ::String >::fromData( _hx_array_data_9b2dfa05_26,2);
            	}
}
