...
HX_DEFINE_STACK_FRAME(_hx_pos_774c2f74f08363c0_37_destroy,"flixel.addons.ui.FlxUIGroup","destroy",0x25c62f36,"flixel.addons.ui.FlxUIGroup.destroy","flixel/addons/ui/FlxUIGroup.hx",37,0xd49587d3)
HX_DEFINE_STACK_FRAME(_hx_pos_774c2f74f08363c0_40_add,"flixel.addons.ui.FlxUIGroup","add",0x7dd5265d,"flixel.addons.ui.FlxUIGroup.add","flixel/addons/ui/FlxUIGroup.hx",40,0xd49587d3)
HX_DEFINE_STACK_FRAME(_hx_pos_774c2f74f08363c0_48_remove,"flixel.addons.ui.FlxUIGroup","remove",0xd69eb588,"flixel.addons.ui.FlxUIGroup.remove","flixel/addons/ui/FlxUIGroup.hx",48,0xd49587d3)
HX_DEFINE_STACK_FRAME(_hx_pos_774c2f74f08363c0_58_setScrollFactor,"flixel.addons.ui.FlxUIGroup","setScrollFactor",0xef2c5dba,"flixel.addons.ui.FlxUIGroup.setScrollFactor","flixel/addons/ui/FlxUIGroup.hx",58,0xd49587d3)
HX_DEFINE_STACK_FRAME(_hx_pos_774c2f74f08363c0_67_hasThis,"flixel.addons.ui.FlxUIGroup","hasThis",0x1d802914,"flixel.addons.ui.FlxUIGroup.hasThis","flixel/addons/ui/FlxUIGroup.hx",67,0xd49587d3)
HX_DEFINE_STACK_FRAME(_hx_pos_774c2f74f08363c0_82_calcBounds,"flixel.addons.ui.FlxUIGroup","calcBounds",0xdbe23c2e,"flixel.addons.ui.FlxUIGroup.calcBounds","flixel/addons/ui/FlxUIGroup.hx",82,0xd49587d3)
HX_DEFINE_STACK_FRAME(_hx_pos_774c2f74f08363c0_124_floorAll,"flixel.addons.ui.FlxUIGroup","floorAll",0x028cf8f9,"flixel.addons.ui.FlxUIGroup.floorAll","flixel/addons/ui/FlxUIGroup.hx",124,0xd49587d3)
namespace flixel{
namespace addons{
namespace ui{
...
HXLINE(  41)		HX_VARI(  ::flixel::FlxSprite,Object) = ( ( ::flixel::FlxSprite)(_tmp_Object) );
HXDLIN(  41)		HX_VARI(  ::flixel::FlxSprite,obj) = ( ( ::flixel::FlxSprite)(this->super::add(Object)) );
...
HXLINE(  49)		HX_VARI(  ::flixel::FlxSprite,Object) = ( ( ::flixel::FlxSprite)(_tmp_Object) );
HXDLIN(  49)		HX_VARI(  ::flixel::FlxSprite,obj) = ( ( ::flixel::FlxSprite)(this->super::remove(Object,Splice)) );
...
HXDLIN(  58)		HX_VARI( ::Array< ::Dynamic>,_g1) = this->group->members;
HXDLIN(  58)		while((_g < _g1->length)){
HXLINE(  58)			HX_VARI(  ::flixel::FlxSprite,obj) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
...
HXDLIN(  68)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->group->members;
HXDLIN(  68)			while((_g < _g1->length)){
HXLINE(  68)				HX_VARI(  ::flixel::FlxSprite,obj) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
...
HXLINE(  82)			_hx_tmp = (this->group->members->get_length() > (int)0);
            		}
            		else {
HXLINE(  82)			_hx_tmp = false;
            		}
HXDLIN(  82)		if (_hx_tmp) {
HXLINE(  83)			HX_VARI( Float,left) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(  84)			HX_VARI( Float,right) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE(  85)			HX_VARI( Float,top) = ::Math_obj::POSITIVE_INFINITY;
HXLINE(  86)			HX_VARI( Float,bottom) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE(  87)			{
HXLINE(  87)				HX_VARI( int,_g) = (int)0;
HXDLIN(  87)				HX_VARI( ::Array< ::Dynamic>,_g1) = this->group->members;
HXDLIN(  87)				while((_g < _g1->length)){
HXLINE(  87)					HX_VARI(  ::flixel::FlxSprite,fb) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
...
HXLINE(  91)							if ((fb->x < left)) {
HXLINE(  91)								left = fb->x;
            							}
HXLINE(  92)							HX_VARI( Float,flui) = fb->x;
HXDLIN(  92)							if (((flui + fb->get_width()) > right)) {
HXLINE(  92)								HX_VARI_NAME( Float,flui1,"flui") = fb->x;
HXDLIN(  92)								right = (flui1 + fb->get_width());
            							}
HXLINE(  93)							if ((fb->y < top)) {
HXLINE(  93)								top = fb->y;
            							}
HXLINE(  94)							HX_VARI_NAME( Float,flui2,"flui") = fb->y;
HXDLIN(  94)							if (((flui2 + fb->get_height()) > bottom)) {
HXLINE(  94)								HX_VARI_NAME( Float,flui3,"flui") = fb->y;
HXDLIN(  94)								bottom = (flui3 + fb->get_height());
            							}
            						}
            						else {
HXLINE(  95)							if (::Std_obj::is(fb,hx::ClassOf< ::flixel::FlxSprite >())) {
HXLINE(  97)								if ((fb->x < left)) {
HXLINE(  97)									left = fb->x;
            								}
HXLINE(  98)								if ((fb->x > right)) {
HXLINE(  98)									right = fb->x;
            								}
HXLINE(  99)								if ((fb->y < top)) {
HXLINE(  99)									top = fb->y;
            								}
HXLINE( 100)								if ((fb->y > bottom)) {
HXLINE( 100)									bottom = fb->y;
            								}
            							}
            						}
            					}
...
void FlxUIGroup_obj::floorAll(){
            	HX_STACKFRAME(&_hx_pos_774c2f74f08363c0_124_floorAll)
            	HX_STACK_THIS(this)
HXLINE( 124)		HX_VARI( int,_g) = (int)0;
HXDLIN( 124)		HX_VARI( ::Array< ::Dynamic>,_g1) = this->group->members;
HXDLIN( 124)		while((_g < _g1->length)){
HXLINE( 124)			HX_VARI(  ::flixel::FlxSprite,fb) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 124)			_g = (_g + (int)1);
HXLINE( 126)			fb->set_x(::Math_obj::floor(fb->x));
HXLINE( 127)			fb->set_y(::Math_obj::floor(fb->y));
            		}
            	}
