...
HX_DEFINE_STACK_FRAME(_hx_pos_ba596dbc4e329499_498_new,"flixel.addons.ui._FlxUITooltipManager.FlxUITooltipEntry","new",0x3b938adb,"flixel.addons.ui._FlxUITooltipManager.FlxUITooltipEntry.new","flixel/addons/ui/FlxUITooltipManager.hx",498,0x892d3fe0)
HX_DEFINE_STACK_FRAME(_hx_pos_ba596dbc4e329499_512_destroy,"flixel.addons.ui._FlxUITooltipManager.FlxUITooltipEntry","destroy",0xc57440f5,"flixel.addons.ui._FlxUITooltipManager.FlxUITooltipEntry.destroy","flixel/addons/ui/FlxUITooltipManager.hx",512,0x892d3fe0)
namespace flixel{
namespace addons{
namespace ui{
...
void FlxUITooltipEntry_obj::__construct(::Dynamic Btn, ::Dynamic Data, ::flixel::FlxObject Obj){
            	HX_STACKFRAME(&_hx_pos_ba596dbc4e329499_498_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Btn,"Btn")
            	HX_STACK_ARG(Data,"Data")
            	HX_STACK_ARG(Obj,"Obj")
HXLINE( 499)		this->btn = Btn;
HXLINE( 500)		this->data = Data;
HXLINE( 501)		this->obj = Obj;
HXLINE( 502)		this->count = (int)0;
HXLINE( 503)		this->enabled = true;
HXLINE( 504)		if (hx::IsNotNull( this->data )) {
HXLINE( 506)			if (hx::IsNull( this->data->__Field(HX_("delay",83,d7,26,d7),hx::paccDynamic) )) {
HXLINE( 506)				this->data->__SetField(HX_("delay",83,d7,26,d7),(int)-1,hx::paccDynamic);
            			}
HXLINE( 507)			if (hx::IsNull( this->data->__Field(HX_("moving",8e,f2,af,cc),hx::paccDynamic) )) {
HXLINE( 507)				this->data->__SetField(HX_("moving",8e,f2,af,cc),false,hx::paccDynamic);
            			}
            		}
            	}
...
void FlxUITooltipEntry_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_ba596dbc4e329499_512_destroy)
            	HX_STACK_THIS(this)
HXLINE( 513)		this->count = (int)0;
HXLINE( 514)		this->obj = null();
HXLINE( 515)		this->btn = null();
HXLINE( 516)		this->data->__SetField(HX_("anchor",75,3a,71,60),null(),hx::paccDynamic);
HXLINE( 517)		this->data->__SetField(HX_("style",31,a5,1d,84),null(),hx::paccDynamic);
HXLINE( 518)		this->data = null();
            	}
