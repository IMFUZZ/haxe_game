...
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_39_set_params,"flixel.addons.ui.FlxUINumericStepper","set_params",0xbd02dad8,"flixel.addons.ui.FlxUINumericStepper.set_params","flixel/addons/ui/FlxUINumericStepper.hx",39,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_45_set_skipButtonUpdate,"flixel.addons.ui.FlxUINumericStepper","set_skipButtonUpdate",0x707fcccc,"flixel.addons.ui.FlxUINumericStepper.set_skipButtonUpdate","flixel/addons/ui/FlxUINumericStepper.hx",45,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_53_set_color,"flixel.addons.ui.FlxUINumericStepper","set_color",0x15562a11,"flixel.addons.ui.FlxUINumericStepper.set_color","flixel/addons/ui/FlxUINumericStepper.hx",53,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_66_set_min,"flixel.addons.ui.FlxUINumericStepper","set_min",0x8923a2c0,"flixel.addons.ui.FlxUINumericStepper.set_min","flixel/addons/ui/FlxUINumericStepper.hx",66,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_72_set_max,"flixel.addons.ui.FlxUINumericStepper","set_max",0x89239bd2,"flixel.addons.ui.FlxUINumericStepper.set_max","flixel/addons/ui/FlxUINumericStepper.hx",72,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_78_set_value,"flixel.addons.ui.FlxUINumericStepper","set_value",0xfcb2381f,"flixel.addons.ui.FlxUINumericStepper.set_value","flixel/addons/ui/FlxUINumericStepper.hx",78,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_94_set_decimals,"flixel.addons.ui.FlxUINumericStepper","set_decimals",0xbb56b2d4,"flixel.addons.ui.FlxUINumericStepper.set_decimals","flixel/addons/ui/FlxUINumericStepper.hx",94,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_101_set_isPercent,"flixel.addons.ui.FlxUINumericStepper","set_isPercent",0xa2c7cfa9,"flixel.addons.ui.FlxUINumericStepper.set_isPercent","flixel/addons/ui/FlxUINumericStepper.hx",101,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_107_set_stack,"flixel.addons.ui.FlxUINumericStepper","set_stack",0x4f051ff6,"flixel.addons.ui.FlxUINumericStepper.set_stack","flixel/addons/ui/FlxUINumericStepper.hx",107,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_145_decimalize,"flixel.addons.ui.FlxUINumericStepper","decimalize",0x151fa4b8,"flixel.addons.ui.FlxUINumericStepper.decimalize","flixel/addons/ui/FlxUINumericStepper.hx",145,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_223__onInputTextEvent,"flixel.addons.ui.FlxUINumericStepper","_onInputTextEvent",0x97f1d1ec,"flixel.addons.ui.FlxUINumericStepper._onInputTextEvent","flixel/addons/ui/FlxUINumericStepper.hx",223,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_251__onPlus,"flixel.addons.ui.FlxUINumericStepper","_onPlus",0xcab59143,"flixel.addons.ui.FlxUINumericStepper._onPlus","flixel/addons/ui/FlxUINumericStepper.hx",251,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_257__onMinus,"flixel.addons.ui.FlxUINumericStepper","_onMinus",0xd7f4da67,"flixel.addons.ui.FlxUINumericStepper._onMinus","flixel/addons/ui/FlxUINumericStepper.hx",257,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_264__doCallback,"flixel.addons.ui.FlxUINumericStepper","_doCallback",0xf5f9d69a,"flixel.addons.ui.FlxUINumericStepper._doCallback","flixel/addons/ui/FlxUINumericStepper.hx",264,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_31_boot,"flixel.addons.ui.FlxUINumericStepper","boot",0xdb47f7c7,"flixel.addons.ui.FlxUINumericStepper.boot","flixel/addons/ui/FlxUINumericStepper.hx",31,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_32_boot,"flixel.addons.ui.FlxUINumericStepper","boot",0xdb47f7c7,"flixel.addons.ui.FlxUINumericStepper.boot","flixel/addons/ui/FlxUINumericStepper.hx",32,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_34_boot,"flixel.addons.ui.FlxUINumericStepper","boot",0xdb47f7c7,"flixel.addons.ui.FlxUINumericStepper.boot","flixel/addons/ui/FlxUINumericStepper.hx",34,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_35_boot,"flixel.addons.ui.FlxUINumericStepper","boot",0xdb47f7c7,"flixel.addons.ui.FlxUINumericStepper.boot","flixel/addons/ui/FlxUINumericStepper.hx",35,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_36_boot,"flixel.addons.ui.FlxUINumericStepper","boot",0xdb47f7c7,"flixel.addons.ui.FlxUINumericStepper.boot","flixel/addons/ui/FlxUINumericStepper.hx",36,0xbef22206)
namespace flixel{
namespace addons{
namespace ui{
...
HXLINE( 180)			HX_VARI(  ::flixel::addons::ui::FlxUIInputText,fuit) = ( ( ::flixel::addons::ui::FlxUIInputText)(this->text_field) );
...
HXLINE( 193)		HX_VARI( int,btnSize) = ((int)1 + TextField->get_height());
...
HXLINE(  54)		HX_VARI( int,Value) = _tmp_Value;
...
HXLINE(  59)			( ( ::flixel::addons::ui::FlxInputText)(this->text_field) )->set_backgroundColor(Value);
            		}
            		else {
...
HXLINE(  83)			HX_VARI( Float,displayValue) = this->value;
...
HXDLIN(  86)				HX_VARI( Float,tens) = ::Math_obj::pow((int)10,this->decimals);
...
HXDLIN(  88)				HX_VARI_NAME( Float,tens1,"tens") = ::Math_obj::pow((int)10,this->decimals);
...
HXLINE( 109)		HX_VARI( int,btnSize) = (int)10;
HXLINE( 110)		HX_VARI( int,offsetX) = (int)0;
HXLINE( 111)		HX_VARI( int,offsetY) = (int)0;
...
HXLINE( 146)		HX_VARI( Float,tens) = ::Math_obj::pow((int)10,digits);
...
HXLINE( 230)		HX_VARI( int,numDecimals) = (int)0;
HXLINE( 231)		{
HXLINE( 231)			HX_VARI( int,_g1) = (int)0;
HXDLIN( 231)			HX_VARI( int,_g) = text.length;
HXDLIN( 231)			while((_g1 < _g)){
HXLINE( 231)				_g1 = (_g1 + (int)1);
HXLINE( 234)				if ((text.charAt((_g1 - (int)1)) == HX_(".",2e,00,00,00))) {
HXLINE( 236)					numDecimals = (numDecimals + (int)1);
            				}
            			}
            		}
HXLINE( 240)		HX_VAR( bool,justAddedDecimal);
HXDLIN( 240)		if ((numDecimals == (int)1)) {
HXLINE( 240)			HX_VARI_NAME( int,justAddedDecimal1,"justAddedDecimal") = text.indexOf(HX_(".",2e,00,00,00),null());
HXDLIN( 240)			justAddedDecimal = (justAddedDecimal1 == (text.length - (int)1));
            		}
            		else {
HXLINE( 240)			justAddedDecimal = false;
            		}
HXLINE( 243)		if (!(justAddedDecimal)) {
HXLINE( 245)			this->set_value(::Std_obj::parseFloat(text));
HXLINE( 246)			this->_doCallback(HX_("edit_numeric_stepper",ea,96,04,5c));
HXLINE( 247)			this->_doCallback(HX_("change_numeric_stepper",50,0a,cc,bb));
            		}
            	}
...
void FlxUINumericStepper_obj::_onPlus(){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_251__onPlus)
            	HX_STACK_THIS(this)
HXLINE( 252)		{
HXLINE( 252)			HX_VARI(  ::flixel::addons::ui::FlxUINumericStepper,_g) = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 252)			_g->set_value((_g->value + this->stepSize));
            		}
HXLINE( 253)		this->_doCallback(HX_("click_numeric_stepper",28,25,65,6e));
HXLINE( 254)		this->_doCallback(HX_("change_numeric_stepper",50,0a,cc,bb));
            	}
...
void FlxUINumericStepper_obj::_onMinus(){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_257__onMinus)
            	HX_STACK_THIS(this)
HXLINE( 258)		{
HXLINE( 258)			HX_VARI(  ::flixel::addons::ui::FlxUINumericStepper,_g) = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 258)			_g->set_value((_g->value - this->stepSize));
            		}
HXLINE( 259)		this->_doCallback(HX_("click_numeric_stepper",28,25,65,6e));
HXLINE( 260)		this->_doCallback(HX_("change_numeric_stepper",50,0a,cc,bb));
            	}
...
void FlxUINumericStepper_obj::_doCallback(::String event_name){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_264__doCallback)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(event_name,"event_name")
HXLINE( 264)		if (this->broadcastToFlxUI) {
HXLINE( 265)			::flixel::addons::ui::FlxUI_obj::event(event_name,hx::ObjectPtr<OBJ_>(this),this->value,this->params);
            		}
            	}
...
hx::Val FlxUINumericStepper_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"min") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_min(inValue) );min=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"max") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_max(inValue) );max=inValue.Cast< Float >(); return inValue; }
		break;
	case 5:
		...
		if (HX_FIELD_EQ(inName,"stack") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_stack(inValue) );stack=inValue.Cast< int >(); return inValue; }
		break;
	case 6:
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"decimals") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_decimals(inValue) );decimals=inValue.Cast< int >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"isPercent") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_isPercent(inValue) );isPercent=inValue.Cast< bool >(); return inValue; }
		break;
	case 10:
...
HXLINE(  31)		STACK_VERTICAL = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_32_boot)
HXLINE(  32)		STACK_HORIZONTAL = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_34_boot)
HXLINE(  34)		CLICK_EVENT = HX_("click_numeric_stepper",28,25,65,6e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_35_boot)
HXLINE(  35)		EDIT_EVENT = HX_("edit_numeric_stepper",ea,96,04,5c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_36_boot)
HXLINE(  36)		CHANGE_EVENT = HX_("change_numeric_stepper",50,0a,cc,bb);
            	}
}
