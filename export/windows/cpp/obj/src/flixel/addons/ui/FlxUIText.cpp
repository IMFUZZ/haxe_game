...
HX_DEFINE_STACK_FRAME(_hx_pos_e806b787b3227c3b_28_resize,"flixel.addons.ui.FlxUIText","resize",0x42437940,"flixel.addons.ui.FlxUIText.resize","flixel/addons/ui/FlxUIText.hx",28,0x557f53bd)
HX_DEFINE_STACK_FRAME(_hx_pos_e806b787b3227c3b_95_set_minimumHeight,"flixel.addons.ui.FlxUIText","set_minimumHeight",0xb1233fec,"flixel.addons.ui.FlxUIText.set_minimumHeight","flixel/addons/ui/FlxUIText.hx",95,0x557f53bd)
HX_DEFINE_STACK_FRAME(_hx_pos_e806b787b3227c3b_105_set_params,"flixel.addons.ui.FlxUIText","set_params",0xcdb7becf,"flixel.addons.ui.FlxUIText.set_params","flixel/addons/ui/FlxUIText.hx",105,0x557f53bd)
HX_DEFINE_STACK_FRAME(_hx_pos_e806b787b3227c3b_111_clone,"flixel.addons.ui.FlxUIText","clone",0xab5f6191,"flixel.addons.ui.FlxUIText.clone","flixel/addons/ui/FlxUIText.hx",111,0x557f53bd)
namespace flixel{
namespace addons{
namespace ui{
...
void FlxUIText_obj::resize(Float w,Float h){
            	...
            	HX_STACK_ARG(w,"w")
            	HX_STACK_ARG(h,"h")
HXLINE(  29)		HX_VARI( int,sign) = (int)1;
...
HXLINE(  43)		HX_VARI( int,old_size) = ::Std_obj::_hx_int(this->_defaultFormat->size);
HXLINE(  44)		HX_VARI( Float,diff) = this->get_height();
HXDLIN(  44)		HX_VARI_NAME( Float,diff1,"diff") = (diff - this->graphic->bitmap->get_height());
HXLINE(  52)		HX_VARI( int,failsafe) = (int)0;
HXLINE(  54)		HX_VARI( int,numLines) = this->textField->get_numLines();
...
HXLINE(  59)			{
HXLINE(  59)				HX_VARI(  ::flixel::addons::ui::FlxUIText,_g) = hx::ObjectPtr<OBJ_>(this);
...
HXLINE(  62)				{
HXLINE(  62)					HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,_g1,"_g") = hx::ObjectPtr<OBJ_>(this);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxUIText_obj,set_params,return )
 ...
 ::flixel::FlxSprite FlxUIText_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 112)		HX_VARI(  ::flixel::addons::ui::FlxUIText,newText) =  ::flixel::addons::ui::FlxUIText_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE( 113)		newText->set_width(this->get_width());
HXLINE( 114)		newText->set_height(this->get_height());
HXLINE( 116)		HX_VARI( ::String,theFont) = this->_font;
...
hx::Val FlxUIText_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"minimumHeight") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_minimumHeight(inValue) );minimumHeight=inValue.Cast< Float >(); return inValue; }
		break;
	case 16:
