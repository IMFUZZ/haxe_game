...
HX_DEFINE_STACK_FRAME(_hx_pos_04bb584d68aa991f_32_destroy,"flixel.addons.transition.TransitionEffect","destroy",0xa4713082,"flixel.addons.transition.TransitionEffect.destroy","flixel/addons/transition/TransitionEffect.hx",32,0x3e20d347)
HX_DEFINE_STACK_FRAME(_hx_pos_04bb584d68aa991f_38_start,"flixel.addons.transition.TransitionEffect","start",0x4c4905ea,"flixel.addons.transition.TransitionEffect.start","flixel/addons/transition/TransitionEffect.hx",38,0x3e20d347)
HX_DEFINE_STACK_FRAME(_hx_pos_04bb584d68aa991f_52_setStatus,"flixel.addons.transition.TransitionEffect","setStatus",0xf8fc51fc,"flixel.addons.transition.TransitionEffect.setStatus","flixel/addons/transition/TransitionEffect.hx",52,0x3e20d347)
HX_DEFINE_STACK_FRAME(_hx_pos_04bb584d68aa991f_58_delayThenFinish,"flixel.addons.transition.TransitionEffect","delayThenFinish",0xfca603fb,"flixel.addons.transition.TransitionEffect.delayThenFinish","flixel/addons/transition/TransitionEffect.hx",58,0x3e20d347)
HX_DEFINE_STACK_FRAME(_hx_pos_04bb584d68aa991f_62_onFinish,"flixel.addons.transition.TransitionEffect","onFinish",0xd3e44a4a,"flixel.addons.transition.TransitionEffect.onFinish","flixel/addons/transition/TransitionEffect.hx",62,0x3e20d347)
namespace flixel{
namespace addons{
...
void TransitionEffect_obj::delayThenFinish(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  58)		 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(this->_finalDelayTime,this->onFinish_dyn(),null());
            	}
