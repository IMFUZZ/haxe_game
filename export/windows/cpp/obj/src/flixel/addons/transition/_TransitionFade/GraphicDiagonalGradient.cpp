...
HX_DEFINE_STACK_FRAME(_hx_pos_fe2b968c2b5efc43_1_boot,"flixel.addons.transition._TransitionFade.GraphicDiagonalGradient","boot",0xf23c0021,"flixel.addons.transition._TransitionFade.GraphicDiagonalGradient.boot","?",1,0x0000003f)
namespace flixel{
namespace addons{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::addons::transition::_TransitionFade::GraphicDiagonalGradient_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_addons_transition__TransitionFade_GraphicDiagonalGradient",43,3b,8c,88);
            	}
}
