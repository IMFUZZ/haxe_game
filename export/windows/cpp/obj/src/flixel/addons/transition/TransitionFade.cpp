...
HX_DEFINE_STACK_FRAME(_hx_pos_85f0573c4a29b283_41_destroy,"flixel.addons.transition.TransitionFade","destroy",0x16001b2d,"flixel.addons.transition.TransitionFade.destroy","flixel/addons/transition/TransitionFade.hx",41,0x307a6abc)
HX_DEFINE_STACK_FRAME(_hx_pos_85f0573c4a29b283_47_start,"flixel.addons.transition.TransitionFade","start",0xbc9d5fd5,"flixel.addons.transition.TransitionFade.start","flixel/addons/transition/TransitionFade.hx",47,0x307a6abc)
HX_DEFINE_STACK_FRAME(_hx_pos_85f0573c4a29b283_77_setTweenValues,"flixel.addons.transition.TransitionFade","setTweenValues",0x069b0e58,"flixel.addons.transition.TransitionFade.setTweenValues","flixel/addons/transition/TransitionFade.hx",77,0x307a6abc)
HX_DEFINE_STACK_FRAME(_hx_pos_85f0573c4a29b283_143_makeSprite,"flixel.addons.transition.TransitionFade","makeSprite",0x080a6440,"flixel.addons.transition.TransitionFade.makeSprite","flixel/addons/transition/TransitionFade.hx",143,0x307a6abc)
HX_DEFINE_STACK_FRAME(_hx_pos_85f0573c4a29b283_192_getGradient,"flixel.addons.transition.TransitionFade","getGradient",0xadab8059,"flixel.addons.transition.TransitionFade.getGradient","flixel/addons/transition/TransitionFade.hx",192,0x307a6abc)
HX_DEFINE_STACK_FRAME(_hx_pos_85f0573c4a29b283_210_finishTween,"flixel.addons.transition.TransitionFade","finishTween",0x9dee50cb,"flixel.addons.transition.TransitionFade.finishTween","flixel/addons/transition/TransitionFade.hx",210,0x307a6abc)
namespace flixel{
namespace addons{
...
HXLINE(  52)		::String _hx_switch_0 = this->tweenStr;
...
HXDLIN(  56)			goto _hx_goto_2;
            		...
            		_hx_goto_2:;
HXLINE(  58)		::String _hx_switch_1 = this->tweenStr2;
...
HXDLIN(  62)			goto _hx_goto_3;
            		...
            		_hx_goto_3:;
HXLINE(  65)		HX_VARI(  ::Dynamic,Values) =  ::Dynamic(hx::Anon_obj::Create(0));
...
HX_DEFINE_DYNAMIC_FUNC3(TransitionFade_obj,setTweenValues,(void))
 ...
 ::flixel::FlxSprite TransitionFade_obj::makeSprite(Float DirX,Float DirY){
            	...
            	HX_STACK_ARG(DirX,"DirX")
            	HX_STACK_ARG(DirY,"DirY")
HXLINE( 144)		HX_VARI(  ::flixel::FlxSprite,s) =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(int)0,(int)0,null());
HXLINE( 145)		HX_VARI( Float,locX) = (int)0;
HXLINE( 146)		HX_VARI( Float,locY) = (int)0;
HXLINE( 147)		HX_VARI( int,angle) = (int)0;
HXLINE( 148)		HX_VARI(  ::openfl::_legacy::display::BitmapData,pixels) = null();
...
HXLINE( 161)				HX_VARI(  ::openfl::_legacy::display::BitmapData,gvert) = ::flixel::util::FlxGradient_obj::createGradientBitmapData((int)1,::flixel::FlxG_obj::height,::Array_obj< int >::__new(2)->init(0,this->_data->color)->init(1,(int)0),(int)1,angle,null());
...
HXLINE( 174)					HX_VARI(  ::openfl::_legacy::display::BitmapData,ghorz) = ::flixel::util::FlxGradient_obj::createGradientBitmapData(::flixel::FlxG_obj::width,(int)1,::Array_obj< int >::__new(2)->init(0,this->_data->color)->init(1,(int)0),(int)1,angle,null());
...
HX_DEFINE_DYNAMIC_FUNC2(TransitionFade_obj,makeSprite,return )
 ...
 ::openfl::_legacy::display::BitmapData TransitionFade_obj::getGradient(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 195)		HX_VARI(  ::openfl::_legacy::display::BitmapData,gdiag) = ( ( ::openfl::_legacy::display::BitmapData)( ::flixel::addons::transition::_TransitionFade::GraphicDiagonalGradient_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null())) );
HXLINE( 196)		HX_VARI(  ::openfl::_legacy::display::BitmapData,gdiag_scaled) =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,(::flixel::FlxG_obj::width * (int)2),(::flixel::FlxG_obj::height * (int)2),true,null(),null());
HXLINE( 197)		HX_VARI(  ::openfl::_legacy::geom::Matrix,m) =  ::openfl::_legacy::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE( 198)		int _hx_tmp = gdiag_scaled->get_width();
HXDLIN( 198)		Float _hx_tmp1 = ((Float)_hx_tmp / (Float)gdiag->get_width());
HXDLIN( 198)		int _hx_tmp2 = gdiag_scaled->get_height();
HXDLIN( 198)		m->scale(_hx_tmp1,((Float)_hx_tmp2 / (Float)gdiag->get_height()));
HXLINE( 199)		gdiag_scaled->draw(gdiag,m,null(),null(),null(),true);
HXLINE( 201)		HX_VARI(  ::openfl::_legacy::display::BitmapData,final_pixels) =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,(::flixel::FlxG_obj::width * (int)3),(::flixel::FlxG_obj::height * (int)3),true,this->_data->color,null());
HXLINE( 202)		 ::openfl::_legacy::geom::Rectangle _hx_tmp3 = gdiag_scaled->get_rect();
HXDLIN( 202)		int _hx_tmp4 = final_pixels->get_width();
HXDLIN( 202)		int _hx_tmp5 = (_hx_tmp4 - gdiag_scaled->get_width());
HXDLIN( 202)		int _hx_tmp6 = final_pixels->get_height();
HXDLIN( 202)		final_pixels->copyChannel(gdiag_scaled,_hx_tmp3, ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,_hx_tmp5,(_hx_tmp6 - gdiag_scaled->get_height())),(int)1,(int)8);
HXLINE( 203)		gdiag->dispose();
HXLINE( 204)		gdiag_scaled->dispose();
HXLINE( 205)		return final_pixels;
            	}
...
void TransitionFade_obj::finishTween( ::flixel::tweens::FlxTween f){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(f,"f")
HXLINE( 210)		this->delayThenFinish();
            	}
