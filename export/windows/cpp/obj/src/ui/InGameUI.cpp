...
HX_DEFINE_STACK_FRAME(_hx_pos_6c9915696fc5a1fe_20_new,"ui.InGameUI","new",0xbfba3977,"ui.InGameUI.new","ui/InGameUI.hx",20,0x6bef4f78)
HX_DEFINE_STACK_FRAME(_hx_pos_6c9915696fc5a1fe_14_new,"ui.InGameUI","new",0xbfba3977,"ui.InGameUI.new","ui/InGameUI.hx",14,0x6bef4f78)
HX_DEFINE_STACK_FRAME(_hx_pos_6c9915696fc5a1fe_34_update,"ui.InGameUI","update",0x61faa552,"ui.InGameUI.update","ui/InGameUI.hx",34,0x6bef4f78)
HX_DEFINE_STACK_FRAME(_hx_pos_6c9915696fc5a1fe_40_setHealthBar,"ui.InGameUI","setHealthBar",0x5c97869e,"ui.InGameUI.setHealthBar","ui/InGameUI.hx",40,0x6bef4f78)
HX_DEFINE_STACK_FRAME(_hx_pos_6c9915696fc5a1fe_48_showInventory,"ui.InGameUI","showInventory",0x41b3c5b6,"ui.InGameUI.showInventory","ui/InGameUI.hx",48,0x6bef4f78)
namespace ui{

void InGameUI_obj::__construct( ::Player player){
            		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_hx_Closure_0, ::ui::InGameUI,_gthis) HXARGC(0)
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_6c9915696fc5a1fe_20_new)
HXLINE(  20)			_gthis->callEvent(HX_("ONCLICK",a9,7e,42,cb),_gthis,HX_("SHOW_INVENTORY",7a,fd,af,71),null());
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_GC_STACKFRAME(&_hx_pos_6c9915696fc5a1fe_14_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(player,"player")
HXLINE(  14)		HX_VARI(  ::ui::InGameUI,_gthis) = hx::ObjectPtr<OBJ_>(this);
HXLINE(  15)		super::__construct(null(),player,null(),null(),null(),null());
HXLINE(  16)		this->scrollFactor->set_x((int)0);
HXLINE(  17)		this->scrollFactor->set_y((int)0);
HXLINE(  19)		this->inventoryButton =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,(int)100,(int)100,HX_("Inventory",7c,56,89,ea), ::Dynamic(new _hx_Closure_0(_gthis)),null(),null());
HXLINE(  22)		this->add(this->inventoryButton);
HXLINE(  24)		this->mainTextBox =  ::flixel::addons::ui::FlxUIText_obj::__alloc( HX_CTX ,(int)0,(int)50,(int)100,HX_("",00,00,00,00),(int)8,true);
HXLINE(  31)		this->add(this->mainTextBox);
            	}
...
void InGameUI_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6c9915696fc5a1fe_34_update)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE(  35)		this->super::update(elapsed);
HXLINE(  36)		 ::flixel::addons::ui::FlxUIText _hx_tmp = this->mainTextBox;
HXDLIN(  36)		::String _hx_tmp1 = ((HX_("Time : ",b9,1c,0c,a6) + ::Shared_obj::clock->getCurrentHour()) + HX_(":",3a,00,00,00));
HXDLIN(  36)		_hx_tmp->set_text((_hx_tmp1 + ::Shared_obj::clock->getCurrentMinute()));
            	}


void InGameUI_obj::setHealthBar( ::characters::Character character){
            	HX_GC_STACKFRAME(&_hx_pos_6c9915696fc5a1fe_40_setHealthBar)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(character,"character")
HXLINE(  40)		if (hx::IsNull( this->healthBar )) {
HXLINE(  41)			this->healthBar =  ::flixel::addons::ui::FlxUIBar_obj::__alloc( HX_CTX ,(int)0,(int)350,null(),(int)100,(int)10,character,HX_("health",9c,28,06,fd),(int)0,(int)100,null());
HXLINE(  42)			this->add(this->healthBar);
            		}
            		else {
HXLINE(  44)			this->healthBar->setParent(character,HX_("health",9c,28,06,fd),null(),null(),null());
            		}
            	}
...
void InGameUI_obj::showInventory( ::items::Inventory inventory){
            	HX_STACKFRAME(&_hx_pos_6c9915696fc5a1fe_48_showInventory)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(inventory,"inventory")
HXLINE(  49)		::haxe::Log_obj::trace(HX_("Size of inventory : ",14,bd,7b,6e),hx::SourceInfo(HX_("InGameUI.hx",f3,9a,9f,c4),49,HX_("ui.InGameUI",05,b2,bc,5e),HX_("showInventory",df,79,d4,38)));
HXLINE(  50)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  50)		int _hx_tmp1 = inventory->getSize();
HXDLIN(  50)		_hx_tmp(_hx_tmp1,hx::SourceInfo(HX_("InGameUI.hx",f3,9a,9f,c4),50,HX_("ui.InGameUI",05,b2,bc,5e),HX_("showInventory",df,79,d4,38)));
            	}
