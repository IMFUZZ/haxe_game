...
HXLINE(  11)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,(int)1280,(int)720,hx::ClassOf< ::states::TitleScreenState >(),(int)1,(int)60,(int)60,false,true));
HXLINE(  12)		this->addChild( ::debug::SystemUsage_obj::__alloc( HX_CTX ,null(),null(),null()));
            	}
