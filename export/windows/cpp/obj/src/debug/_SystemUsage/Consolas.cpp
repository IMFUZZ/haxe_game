...
{
HX_STACK_FRAME("debug._SystemUsage.Consolas","new",0x8be51ab2,"debug._SystemUsage.Consolas.new","debug/SystemUsage.hx",13,0x178995e8)
HX_STACK_THIS(this)
...
{
	resourceName= HX_HCSTRING("NME_font_debug__SystemUsage_Consolas","\xe9","\x67","\xb1","\x59");
}
