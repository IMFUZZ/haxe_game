...
{
HX_STACK_FRAME("SystemUsage","new",0x1b961d84,"SystemUsage.new","SystemUsage.hx",15,0xb7ccfe6c)
HX_STACK_THIS(this)
...
int a_color = __o_a_color.Default(16777215);
{
	...
	super::__construct();
	HX_STACK_LINE(24)
	::openfl::_legacy::text::Font_obj::registerFont(hx::ClassOf< ::_SystemUsage::Consolas >());
	HX_STACK_LINE(25)
	::_SystemUsage::Consolas tmp = ::_SystemUsage::Consolas_obj::__new(null(),null(),null());		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(25)
...
{
		HX_STACK_FRAME("SystemUsage","_onEnter",0xf59bf556,"SystemUsage._onEnter","SystemUsage.hx",35,0xb7ccfe6c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(36)
...
void SystemUsage_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("SystemUsage","\x92","\x4b","\xd8","\x92");
