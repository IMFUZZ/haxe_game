...
HX_DEFINE_STACK_FRAME(_hx_pos_962053f530a64077_120_parse,"haxe.xml.Parser","parse",0x937905c3,"haxe.xml.Parser.parse","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",120,0xbc28dcd7)
HX_DEFINE_STACK_FRAME(_hx_pos_962053f530a64077_127_doParse,"haxe.xml.Parser","doParse",0x2e9a6a38,"haxe.xml.Parser.doParse","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",127,0xbc28dcd7)
HX_DEFINE_STACK_FRAME(_hx_pos_962053f530a64077_104_boot,"haxe.xml.Parser","boot",0x0af6f0a2,"haxe.xml.Parser.boot","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",104,0xbc28dcd7)
namespace haxe{
namespace xml{
...
HXLINE( 136)		HX_VARI(  ::StringBuf,buf) =  ::StringBuf_obj::__alloc( HX_CTX );
...
HXLINE( 195)					switch((int)(c)){
            						case (int)33: {
HXLINE( 198)							if ((str.cca((p + (int)1)) == (int)91)) {
...
HXDLIN( 207)								if ((str.cca((p + (int)1)) != (int)68)) {
HXLINE( 207)									_hx_tmp = (str.cca((p + (int)1)) == (int)100);
            								}
            								else {
...
HXDLIN( 215)									if ((str.cca((p + (int)1)) == (int)45)) {
HXLINE( 215)										_hx_tmp1 = (str.cca((p + (int)2)) != (int)45);
            									}
            									else {
...
HXLINE( 268)						if (xml->exists(tmp)) {
HXLINE( 269)							HX_STACK_DO_THROW( ::haxe::xml::XmlParserException_obj::__alloc( HX_CTX ,((HX_("Duplicate attribute [",22,75,cb,05) + tmp) + HX_("]",5d,00,00,00)),str,p));
            						}
...
HXLINE( 295)					switch((int)(c)){
            						case (int)38: {
HXLINE( 297)							{
HXLINE( 297)								HX_VARI(  ::Dynamic,len) = (p - start);
...
HXLINE( 297)									HX_VARI_NAME( ::Array< ::String >,buf1,"buf") = buf->b;
...
HXLINE( 305)									{
HXLINE( 305)										HX_VARI_NAME(  ::Dynamic,len1,"len") = (p - start);
...
HXLINE( 305)											HX_VARI_NAME( ::Array< ::String >,buf2,"buf") = buf->b;
HXDLIN( 305)											buf2->push(str.substr(start,len1));
            										}
            									}
HXLINE( 306)									HX_VARI( ::String,val) = buf->toString();
...
HXLINE( 304)							if ((c == attrValQuote)) {
HXLINE( 305)								{
HXLINE( 305)									HX_VARI_NAME(  ::Dynamic,len2,"len") = (p - start);
HXDLIN( 305)									if (hx::IsNotNull( buf->charBuf )) {
HXLINE( 305)										buf->flush();
            									}
HXDLIN( 305)									if (hx::IsNull( buf->b )) {
...
HXLINE( 305)										HX_VARI_NAME( ::Array< ::String >,buf3,"buf") = buf->b;
HXDLIN( 305)										buf3->push(str.substr(start,len2));
            									}
            								}
HXLINE( 306)								HX_VARI_NAME( ::String,val1,"val") = buf->toString();
HXLINE( 307)								buf =  ::StringBuf_obj::__alloc( HX_CTX );
...
HXLINE( 174)						{
HXLINE( 174)							HX_VARI_NAME(  ::Dynamic,len3,"len") = (p - start);
...
HXLINE( 174)								HX_VARI_NAME( ::Array< ::String >,buf4,"buf") = buf->b;
HXDLIN( 174)								buf4->push(str.substr(start,len3));
            							}
            						}
HXLINE( 175)						HX_VARI(  ::Xml,child) = ::Xml_obj::createPCData(buf->toString());
...
HXLINE( 181)							{
HXLINE( 181)								HX_VARI_NAME(  ::Dynamic,len4,"len") = (p - start);
...
HXLINE( 181)									HX_VARI_NAME( ::Array< ::String >,buf5,"buf") = buf->b;
...
HXLINE( 366)						_hx_tmp23 = (str.cca((p + (int)1)) == (int)62);
            					}
            					else {
...
HXLINE( 370)						{
HXLINE( 370)							parent->addChild(::Xml_obj::createProcessingInstruction(str.substr((start + (int)1),((p - start) - (int)2))));
...
HXLINE( 349)						_hx_tmp25 = (str.cca((p + (int)1)) == (int)45);
            					}
            					else {
HXLINE( 349)						_hx_tmp25 = false;
            					}
HXDLIN( 349)					if (_hx_tmp25) {
HXLINE( 349)						_hx_tmp24 = (str.cca((p + (int)2)) == (int)62);
            					}
            					else {
...
HXLINE( 187)						_hx_tmp28 = (str.cca((p + (int)1)) == (int)93);
            					}
            					else {
HXLINE( 187)						_hx_tmp28 = false;
            					}
HXDLIN( 187)					if (_hx_tmp28) {
HXLINE( 187)						_hx_tmp27 = (str.cca((p + (int)2)) == (int)62);
            					}
            					else {
...
HXLINE( 190)						{
HXLINE( 190)							parent->addChild(::Xml_obj::createCData(str.substr(start,(p - start))));
...
HXLINE( 404)								{
HXLINE( 404)									HX_VARI( ::String,x) = ((HX_("&",26,00,00,00) + s) + HX_(";",3b,00,00,00));
...
HXLINE( 404)										HX_VARI_NAME( ::Array< ::String >,buf6,"buf") = buf->b;
HXDLIN( 404)										buf6->push(::Std_obj::string(x));
            									}
            								}
            							}
            							else {
HXLINE( 406)								HX_VARI_NAME( ::String,x1,"x") = ( (::String)(::haxe::xml::Parser_obj::escapes->get(s)) );
...
HXLINE( 406)									HX_VARI_NAME( ::Array< ::String >,buf7,"buf") = buf->b;
HXDLIN( 406)									buf7->push(::Std_obj::string(x1));
            								}
            							}
            						}
...
HXLINE( 414)							{
HXLINE( 414)								HX_VARI_NAME(  ::Dynamic,len5,"len") = (p - start);
...
HXLINE( 414)									HX_VARI_NAME( ::Array< ::String >,buf8,"buf") = buf->b;
HXDLIN( 414)									buf8->push(str.substr(start,len5));
            								}
            							}
...
HXLINE( 432)				{
HXLINE( 432)					HX_VARI_NAME(  ::Dynamic,len6,"len") = (p - start);
...
HXLINE( 432)						HX_VARI_NAME( ::Array< ::String >,buf9,"buf") = buf->b;
HXDLIN( 432)						buf9->push(str.substr(start,len6));
            					}
            				}
...
HXLINE( 440)			{
HXLINE( 440)				HX_VARI_NAME(  ::Dynamic,len7,"len") = (p - start);
...
HXLINE( 440)					HX_VARI_NAME( ::Array< ::String >,buf10,"buf") = buf->b;
HXDLIN( 440)					buf10->push(str.substr(start,len7));
            				}
            			}
...
HXLINE( 105)			HX_VARI(  ::haxe::ds::StringMap,h) =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
