...
HX_DEFINE_STACK_FRAME(_hx_pos_10a3b7f702bd6cce_100_resolve,"haxe.xml._Fast.NodeListAccess","resolve",0x21d97d94,"haxe.xml._Fast.NodeListAccess.resolve","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Fast.hx",100,0x60a2153a)
namespace haxe{
namespace xml{
namespace _Fast{
...
HXLINE( 101)		HX_VARI(  ::List,l) =  ::List_obj::__alloc( HX_CTX );
HXLINE( 102)		{
HXLINE( 102)			HX_VARI(  ::Dynamic,x) = this->_hx___x->elementsNamed(name);
HXDLIN( 102)			while(( (bool)(x->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 103)				l->add( ::haxe::xml::Fast_obj::__alloc( HX_CTX ,x->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()));
            			}
            		}
HXLINE( 104)		return l;
            	}
