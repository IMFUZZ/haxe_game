...
HX_DEFINE_STACK_FRAME(_hx_pos_bc1e3a125215c6c2_98_toString,"haxe.xml.XmlParserException","toString",0xed7c2ce2,"haxe.xml.XmlParserException.toString","C:\\HaxeToolkit\\haxe\\std/haxe/xml/Parser.hx",98,0xbc28dcd7)
namespace haxe{
namespace xml{
...
HXLINE(  86)				HX_VARI( int,c) = xml.cca((_g1 - (int)1));
