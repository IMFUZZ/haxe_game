...
Void ZPP_OptionType_obj::append( ::zpp_nape::util::ZNPList_ZPP_CbType list,Dynamic val){
{
		...
		HX_STACK_LINE(318)
		bool tmp1 = ::Std_obj::is(tmp,hx::ClassOf< ::nape::callbacks::CbType >());		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(318)
		if ((tmp1)){
			HX_STACK_LINE(319)
			::nape::callbacks::CbType cb = val;		HX_STACK_VAR(cb,"cb");
			HX_STACK_LINE(320)
			::zpp_nape::util::ZNPList_ZPP_CbType tmp2 = list;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(320)
			::zpp_nape::callbacks::ZPP_CbType tmp3 = cb->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(320)
			this->append_type(tmp2,tmp3);
		}
		else{
			HX_STACK_LINE(322)
			Dynamic tmp2 = val;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(322)
			bool tmp3 = ::Std_obj::is(tmp2,hx::ClassOf< ::nape::callbacks::CbTypeList >());		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(322)
			if ((tmp3)){
				HX_STACK_LINE(323)
				...
				{
					HX_STACK_LINE(324)
					::nape::callbacks::CbTypeIterator tmp4;		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(324)
					{
						HX_STACK_LINE(324)
						cbs->zpp_inner->valmod();
						HX_STACK_LINE(324)
						::nape::callbacks::CbTypeList tmp5 = cbs;		HX_STACK_VAR(tmp5,"tmp5");
						HX_STACK_LINE(324)
						tmp4 = ::nape::callbacks::CbTypeIterator_obj::get(tmp5);
					}
					HX_STACK_LINE(324)
					::nape::callbacks::CbTypeIterator _g = tmp4;		HX_STACK_VAR(_g,"_g");
					HX_STACK_LINE(324)
					while((true)){
						HX_STACK_LINE(324)
						bool tmp5;		HX_STACK_VAR(tmp5,"tmp5");
						...
						{
							HX_STACK_LINE(324)
							::zpp_nape::util::ZPP_CbTypeList tmp6 = _g->zpp_inner->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
							HX_STACK_LINE(324)
							tmp6->valmod();
							HX_STACK_LINE(324)
							...
							HX_STACK_LINE(324)
							{
								...
								HX_STACK_LINE(324)
								bool tmp8 = _this->zpp_inner->zip_length;		HX_STACK_VAR(tmp8,"tmp8");
								HX_STACK_LINE(324)
								if ((tmp8)){
									HX_STACK_LINE(324)
									...
									{
										HX_STACK_LINE(324)
										::zpp_nape::util::ZNPList_ZPP_CbType tmp9 = _this->zpp_inner->inner;		HX_STACK_VAR(tmp9,"tmp9");
										HX_STACK_LINE(324)
										_this->zpp_inner->user_length = tmp9->length;
									}
								}
								HX_STACK_LINE(324)
								tmp7 = _this->zpp_inner->user_length;
							}
							HX_STACK_LINE(324)
							...
							HX_STACK_LINE(324)
							bool tmp8 = (_g->zpp_i < length);		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(324)
							if ((tmp8)){
								HX_STACK_LINE(324)
								tmp5 = true;
								...
								{
									HX_STACK_LINE(324)
									::nape::callbacks::CbTypeIterator tmp9 = ::nape::callbacks::CbTypeIterator_obj::zpp_pool;		HX_STACK_VAR(tmp9,"tmp9");
									HX_STACK_LINE(324)
									_g->zpp_next = tmp9;
									HX_STACK_LINE(324)
						...
						HX_STACK_LINE(324)
						::nape::callbacks::CbType tmp7;		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(324)
						{
							HX_STACK_LINE(324)
							_g->zpp_critical = false;
							HX_STACK_LINE(324)
							int tmp8 = (_g->zpp_i)++;		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(324)
							tmp7 = _g->zpp_inner->at(tmp8);
						}
						HX_STACK_LINE(324)
						::nape::callbacks::CbType cb = tmp7;		HX_STACK_VAR(cb,"cb");
						HX_STACK_LINE(324)
						::zpp_nape::util::ZNPList_ZPP_CbType tmp8 = list;		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(324)
						::zpp_nape::callbacks::ZPP_CbType tmp9 = cb->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(324)
						this->append_type(tmp8,tmp9);
					}
				}
			}
			else{
				...
				if ((tmp5)){
					...
					HX_STACK_LINE(334)
					{
						...
						while((true)){
							HX_STACK_LINE(334)
							bool tmp6 = (_g < cbs->__Field(HX_HCSTRING("length","\xe6","\x94","\x07","\x9f"), hx::paccDynamic ));		HX_STACK_VAR(tmp6,"tmp6");
							HX_STACK_LINE(334)
							...
							HX_STACK_LINE(334)
							Dynamic tmp8 = cbs->__GetItem(_g);		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(334)
							Dynamic cb = tmp8;		HX_STACK_VAR(cb,"cb");
							HX_STACK_LINE(334)
							++(_g);
							HX_STACK_LINE(340)
							...
							HX_STACK_LINE(341)
							::zpp_nape::callbacks::ZPP_CbType tmp10 = cbx->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(341)
