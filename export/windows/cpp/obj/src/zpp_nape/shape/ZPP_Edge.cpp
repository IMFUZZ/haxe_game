...
Void ZPP_Edge_obj::lnorm_validate( ){
{
		...
		HX_STACK_LINE(240)
		{
			...
			HX_STACK_LINE(241)
			::nape::geom::Vec2 tmp2 = this->wrap_lnorm;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(241)
			tmp2->zpp_inner->x = tmp1;
			HX_STACK_LINE(242)
			Float tmp3 = this->lnormy;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(242)
...
Void ZPP_Edge_obj::gnorm_validate( ){
{
		...
		HX_STACK_LINE(266)
		{
			...
			::zpp_nape::shape::ZPP_Polygon tmp = this->polygon;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(266)
			::zpp_nape::shape::ZPP_Polygon _this = tmp;		HX_STACK_VAR(_this,"_this");
			HX_STACK_LINE(266)
		...
		{
			HX_STACK_LINE(268)
			Float tmp = this->gnormx;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(268)
