...
Void ZPP_Polygon_obj::lverts_post_adder( ::nape::geom::Vec2 x){
{
		...
		HX_STACK_LINE(206)
		{
			...
			while((true)){
				...
				{
					HX_STACK_LINE(211)
					bool tmp4 = (i == x->zpp_inner);		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(211)
					if ((tmp4)){
						HX_STACK_LINE(211)
						break;
						...
						HX_STACK_LINE(213)
						bool tmp5 = (ite == null());		HX_STACK_VAR(tmp5,"tmp5");
						HX_STACK_LINE(213)
						...
						HX_STACK_LINE(214)
						::zpp_nape::util::ZNPNode_ZPP_Edge tmp8;		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(214)
						if ((tmp7)){
							HX_STACK_LINE(214)
		...
		HX_STACK_LINE(220)
		::zpp_nape::geom::ZPP_Vec2 vec = tmp1;		HX_STACK_VAR(vec,"vec");
		HX_STACK_LINE(221)
		::zpp_nape::geom::ZPP_Vec2 tmp2 = this->gverts;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(221)
		::zpp_nape::geom::ZPP_Vec2 tmp3 = ite;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(221)
		::zpp_nape::geom::ZPP_Vec2 tmp4 = vec;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(221)
		tmp2->insert(tmp3,tmp4);
		HX_STACK_LINE(222)
		::zpp_nape::geom::ZPP_Vec2 tmp5 = this->lverts;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(222)
		::zpp_nape::geom::ZPP_Vec2 tmp6 = tmp5->next->next;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(222)
		...
		if ((tmp7)){
			...
			if ((tmp11)){
				...
				HX_STACK_LINE(225)
				{
					...
					if ((tmp13)){
						HX_STACK_LINE(227)
						::zpp_nape::shape::ZPP_Edge tmp14 = ::zpp_nape::shape::ZPP_Edge_obj::__new();		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(227)
						ed = tmp14;
					}
					else{
						HX_STACK_LINE(233)
						::zpp_nape::shape::ZPP_Edge tmp14 = ::zpp_nape::shape::ZPP_Edge_obj::zpp_pool;		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(233)
						ed = tmp14;
						HX_STACK_LINE(234)
				...
				HX_STACK_LINE(243)
				::zpp_nape::util::ZNPList_ZPP_Edge tmp12 = this->edges;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(243)
				::zpp_nape::shape::ZPP_Edge tmp13 = ed;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(243)
				tmp12->add(tmp13);
				HX_STACK_LINE(244)
				...
				HX_STACK_LINE(245)
				{
					...
					if ((tmp15)){
						HX_STACK_LINE(247)
						::zpp_nape::shape::ZPP_Edge tmp16 = ::zpp_nape::shape::ZPP_Edge_obj::__new();		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(247)
						ed1 = tmp16;
					}
					else{
						HX_STACK_LINE(253)
						::zpp_nape::shape::ZPP_Edge tmp16 = ::zpp_nape::shape::ZPP_Edge_obj::zpp_pool;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(253)
						ed1 = tmp16;
						HX_STACK_LINE(254)
				...
				HX_STACK_LINE(263)
				::zpp_nape::util::ZNPList_ZPP_Edge tmp14 = this->edges;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(263)
				::zpp_nape::shape::ZPP_Edge tmp15 = ed1;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(263)
				tmp14->add(tmp15);
				HX_STACK_LINE(264)
				...
				::zpp_nape::util::ZNPList_ZPP_Edge tmp12 = this->edges;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(286)
				::zpp_nape::util::ZNPNode_ZPP_Edge tmp13 = ite2;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(286)
		...
		HX_STACK_LINE(290)
		Dynamic tmp8 = this->gverts_pa_validate_dyn();		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(290)
		vec->_validate = tmp8;
	}
return null();
...
Void ZPP_Polygon_obj::getlverts( ){
{
		...
		HX_STACK_LINE(326)
		bool tmp10 = this->reverse_flag;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(326)
		::nape::geom::Vec2List tmp11 = this->wrap_lverts;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(326)
		tmp11->zpp_inner->reverse_flag = tmp10;
	}
return null();
}
...
Void ZPP_Polygon_obj::__validate_aabb( ){
{
		...
		::zpp_nape::geom::ZPP_Vec2 tmp = this->gverts;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(1176)
		::zpp_nape::geom::ZPP_Vec2 p0 = tmp->next;		HX_STACK_VAR(p0,"p0");
		HX_STACK_LINE(1177)
		{
			HX_STACK_LINE(1178)
			::zpp_nape::geom::ZPP_AABB tmp1 = this->aabb;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(1178)
			tmp1->minx = p0->x;
			HX_STACK_LINE(1179)
		...
		HX_STACK_LINE(1217)
		{
			...
			::zpp_nape::geom::ZPP_Vec2 tmp1 = this->gverts;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(1218)
			::zpp_nape::geom::ZPP_Vec2 tmp2 = tmp1->next->next;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(1218)
			...
			while((true)){
				...
				HX_STACK_LINE(1221)
				{
					...
					HX_STACK_LINE(1222)
					::zpp_nape::geom::ZPP_AABB tmp6 = this->aabb;		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(1222)
					Float tmp7 = tmp6->minx;		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(1222)
					...
					HX_STACK_LINE(1223)
					Float tmp11 = tmp10->maxx;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(1223)
					...
					HX_STACK_LINE(1224)
					Float tmp15 = tmp14->miny;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(1224)
					...
					HX_STACK_LINE(1225)
					Float tmp19 = tmp18->maxy;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(1225)
					bool tmp20 = (tmp17 > tmp19);		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(1225)
					if ((tmp20)){
...
Void ZPP_Polygon_obj::__validate_angDrag( ){
{
		...
		::zpp_nape::util::ZNPList_ZPP_Edge tmp = this->edges;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(1400)
		::zpp_nape::util::ZNPNode_ZPP_Edge ei = tmp->head;		HX_STACK_VAR(ei,"ei");
		HX_STACK_LINE(1401)
		...
		HX_STACK_LINE(1402)
		{
			...
			::zpp_nape::geom::ZPP_Vec2 tmp1 = this->lverts;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(1404)
			::zpp_nape::geom::ZPP_Vec2 cx_itei = tmp1->next;		HX_STACK_VAR(cx_itei,"cx_itei");
			HX_STACK_LINE(1405)
			...
			while((true)){
				...
				HX_STACK_LINE(1409)
				{
					...
					{
						HX_STACK_LINE(1416)
						Float tmp4 = (v->x - u->x);		HX_STACK_VAR(tmp4,"tmp4");
						HX_STACK_LINE(1416)
						dx = tmp4;
						HX_STACK_LINE(1417)
						Float tmp5 = (v->y - u->y);		HX_STACK_VAR(tmp5,"tmp5");
						HX_STACK_LINE(1417)
						dy = tmp5;
					}
					HX_STACK_LINE(1419)
					Float tmp4 = edge->length;		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(1419)
					Float tmp5 = ::nape::Config_obj::fluidAngularDragFriction;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(1419)
					Float tmp6 = (tmp4 * tmp5);		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(1419)
					::zpp_nape::phys::ZPP_Material tmp7 = this->material;		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(1419)
					Float tmp8 = tmp7->dynamicFriction;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(1419)
					Float tmp9 = (tmp6 * tmp8);		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(1419)
					Float tmp10 = edge->lprojection;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(1419)
					Float tmp11 = (tmp9 * tmp10);		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(1419)
					Float tmp12 = edge->lprojection;		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(1419)
					Float tmp13 = (tmp11 * tmp12);		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(1419)
					hx::AddEq(accum,tmp13);
					HX_STACK_LINE(1420)
					Float tmp14 = (u->y * edge->lnormx);		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(1420)
					Float tmp15 = (u->x * edge->lnormy);		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(1420)
					Float tmp16 = (tmp14 - tmp15);		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(1420)
					Float tmp17 = -(tmp16);		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(1420)
					Float tmp18 = (dy * edge->lnormx);		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(1420)
					Float tmp19 = (dx * edge->lnormy);		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(1420)
					Float tmp20 = (tmp18 - tmp19);		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(1420)
					Float tmp21 = (Float(tmp17) / Float(tmp20));		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(1420)
					...
					if ((tmp22)){
						HX_STACK_LINE(1422)
						bool tmp23 = (t > (int)1);		HX_STACK_VAR(tmp23,"tmp23");
						HX_STACK_LINE(1422)
						...
						HX_STACK_LINE(1422)
						Float ta = tmp24;		HX_STACK_VAR(ta,"ta");
						HX_STACK_LINE(1423)
						...
						HX_STACK_LINE(1445)
						{
							...
							HX_STACK_LINE(1455)
							Float tmp25 = (dx * t1);		HX_STACK_VAR(tmp25,"tmp25");
							HX_STACK_LINE(1455)
							hx::AddEq(cx,tmp25);
							HX_STACK_LINE(1456)
							Float tmp26 = (dy * t1);		HX_STACK_VAR(tmp26,"tmp26");
							HX_STACK_LINE(1456)
							hx::AddEq(cy,tmp26);
						}
						HX_STACK_LINE(1458)
						Float tmp25 = (edge->lnormy * u->x);		HX_STACK_VAR(tmp25,"tmp25");
						HX_STACK_LINE(1458)
						Float tmp26 = (edge->lnormx * u->y);		HX_STACK_VAR(tmp26,"tmp26");
						HX_STACK_LINE(1458)
						Float tmp27 = (tmp25 - tmp26);		HX_STACK_VAR(tmp27,"tmp27");
						HX_STACK_LINE(1458)
						Float dota = tmp27;		HX_STACK_VAR(dota,"dota");
						HX_STACK_LINE(1459)
						Float tmp28 = (edge->lnormy * cx);		HX_STACK_VAR(tmp28,"tmp28");
						HX_STACK_LINE(1459)
						Float tmp29 = (edge->lnormx * cy);		HX_STACK_VAR(tmp29,"tmp29");
						HX_STACK_LINE(1459)
						Float tmp30 = (tmp28 - tmp29);		HX_STACK_VAR(tmp30,"tmp30");
						HX_STACK_LINE(1459)
						Float dotb = tmp30;		HX_STACK_VAR(dotb,"dotb");
						HX_STACK_LINE(1460)
						Float tmp31 = (dotb * dotb);		HX_STACK_VAR(tmp31,"tmp31");
						HX_STACK_LINE(1460)
						Float tmp32 = dotb;		HX_STACK_VAR(tmp32,"tmp32");
						HX_STACK_LINE(1460)
						Float tmp33 = (tmp31 * tmp32);		HX_STACK_VAR(tmp33,"tmp33");
						HX_STACK_LINE(1460)
						Float tmp34 = (dota * dota);		HX_STACK_VAR(tmp34,"tmp34");
						HX_STACK_LINE(1460)
						Float tmp35 = dota;		HX_STACK_VAR(tmp35,"tmp35");
						HX_STACK_LINE(1460)
						Float tmp36 = (tmp34 * tmp35);		HX_STACK_VAR(tmp36,"tmp36");
						HX_STACK_LINE(1460)
						Float tmp37 = (tmp33 - tmp36);		HX_STACK_VAR(tmp37,"tmp37");
						HX_STACK_LINE(1460)
						Float tmp38 = (dotb - dota);		HX_STACK_VAR(tmp38,"tmp38");
						HX_STACK_LINE(1460)
						Float tmp39 = ((int)3 * tmp38);		HX_STACK_VAR(tmp39,"tmp39");
						HX_STACK_LINE(1460)
						Float tmp40 = (Float(tmp37) / Float(tmp39));		HX_STACK_VAR(tmp40,"tmp40");
						HX_STACK_LINE(1460)
						Float dots = tmp40;		HX_STACK_VAR(dots,"dots");
						HX_STACK_LINE(1461)
						Float tmp41 = (dots * ta);		HX_STACK_VAR(tmp41,"tmp41");
						HX_STACK_LINE(1461)
						Float tmp42 = edge->length;		HX_STACK_VAR(tmp42,"tmp42");
						HX_STACK_LINE(1461)
						Float tmp43 = (tmp41 * tmp42);		HX_STACK_VAR(tmp43,"tmp43");
						HX_STACK_LINE(1461)
						Float tmp44 = ::nape::Config_obj::fluidAngularDrag;		HX_STACK_VAR(tmp44,"tmp44");
						HX_STACK_LINE(1461)
						Float tmp45 = (tmp43 * tmp44);		HX_STACK_VAR(tmp45,"tmp45");
						HX_STACK_LINE(1461)
						hx::AddEq(accum,tmp45);
					}
					HX_STACK_LINE(1463)
					bool tmp23 = (t < (int)1);		HX_STACK_VAR(tmp23,"tmp23");
					HX_STACK_LINE(1463)
					if ((tmp23)){
						...
						HX_STACK_LINE(1464)
						Float tb = tmp25;		HX_STACK_VAR(tb,"tb");
						HX_STACK_LINE(1465)
						Float cx = ((Float)0.0);		HX_STACK_VAR(cx,"cx");
						HX_STACK_LINE(1466)
						Float cy = ((Float)0.0);		HX_STACK_VAR(cy,"cy");
						...
						HX_STACK_LINE(1487)
						{
							...
							HX_STACK_LINE(1497)
							Float tmp26 = (dx * t1);		HX_STACK_VAR(tmp26,"tmp26");
							HX_STACK_LINE(1497)
							hx::AddEq(cx,tmp26);
							HX_STACK_LINE(1498)
							Float tmp27 = (dy * t1);		HX_STACK_VAR(tmp27,"tmp27");
							HX_STACK_LINE(1498)
							hx::AddEq(cy,tmp27);
						}
						HX_STACK_LINE(1500)
						Float tmp26 = (edge->lnormy * cx);		HX_STACK_VAR(tmp26,"tmp26");
						HX_STACK_LINE(1500)
						Float tmp27 = (edge->lnormx * cy);		HX_STACK_VAR(tmp27,"tmp27");
						HX_STACK_LINE(1500)
						Float tmp28 = (tmp26 - tmp27);		HX_STACK_VAR(tmp28,"tmp28");
						HX_STACK_LINE(1500)
						Float dota = tmp28;		HX_STACK_VAR(dota,"dota");
						HX_STACK_LINE(1501)
						Float tmp29 = (edge->lnormy * v->x);		HX_STACK_VAR(tmp29,"tmp29");
						HX_STACK_LINE(1501)
						Float tmp30 = (edge->lnormx * v->y);		HX_STACK_VAR(tmp30,"tmp30");
						HX_STACK_LINE(1501)
						Float tmp31 = (tmp29 - tmp30);		HX_STACK_VAR(tmp31,"tmp31");
						HX_STACK_LINE(1501)
						Float dotb = tmp31;		HX_STACK_VAR(dotb,"dotb");
						HX_STACK_LINE(1502)
						Float tmp32 = (dotb * dotb);		HX_STACK_VAR(tmp32,"tmp32");
						HX_STACK_LINE(1502)
						Float tmp33 = dotb;		HX_STACK_VAR(tmp33,"tmp33");
						HX_STACK_LINE(1502)
						Float tmp34 = (tmp32 * tmp33);		HX_STACK_VAR(tmp34,"tmp34");
						HX_STACK_LINE(1502)
						Float tmp35 = (dota * dota);		HX_STACK_VAR(tmp35,"tmp35");
						HX_STACK_LINE(1502)
						Float tmp36 = dota;		HX_STACK_VAR(tmp36,"tmp36");
						HX_STACK_LINE(1502)
						Float tmp37 = (tmp35 * tmp36);		HX_STACK_VAR(tmp37,"tmp37");
						HX_STACK_LINE(1502)
						Float tmp38 = (tmp34 - tmp37);		HX_STACK_VAR(tmp38,"tmp38");
						HX_STACK_LINE(1502)
						Float tmp39 = (dotb - dota);		HX_STACK_VAR(tmp39,"tmp39");
						HX_STACK_LINE(1502)
						Float tmp40 = ((int)3 * tmp39);		HX_STACK_VAR(tmp40,"tmp40");
						HX_STACK_LINE(1502)
						Float tmp41 = (Float(tmp38) / Float(tmp40));		HX_STACK_VAR(tmp41,"tmp41");
						HX_STACK_LINE(1502)
						Float dots = tmp41;		HX_STACK_VAR(dots,"dots");
						HX_STACK_LINE(1503)
						Float tmp42 = dots;		HX_STACK_VAR(tmp42,"tmp42");
						HX_STACK_LINE(1503)
						Float tmp43 = ::nape::Config_obj::fluidVacuumDrag;		HX_STACK_VAR(tmp43,"tmp43");
						HX_STACK_LINE(1503)
						Float tmp44 = (tmp42 * tmp43);		HX_STACK_VAR(tmp44,"tmp44");
						HX_STACK_LINE(1503)
						Float tmp45 = ((int)1 - tb);		HX_STACK_VAR(tmp45,"tmp45");
						HX_STACK_LINE(1503)
						Float tmp46 = (tmp44 * tmp45);		HX_STACK_VAR(tmp46,"tmp46");
						HX_STACK_LINE(1503)
						Float tmp47 = edge->length;		HX_STACK_VAR(tmp47,"tmp47");
						HX_STACK_LINE(1503)
						Float tmp48 = (tmp46 * tmp47);		HX_STACK_VAR(tmp48,"tmp48");
						HX_STACK_LINE(1503)
						Float tmp49 = ::nape::Config_obj::fluidAngularDrag;		HX_STACK_VAR(tmp49,"tmp49");
						HX_STACK_LINE(1503)
						Float tmp50 = (tmp48 * tmp49);		HX_STACK_VAR(tmp50,"tmp50");
						HX_STACK_LINE(1503)
						hx::AddEq(accum,tmp50);
					}
				}
				HX_STACK_LINE(1506)
				{
		...
		HX_STACK_LINE(1617)
		Float tmp1 = accum;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(1617)
		Float tmp2 = this->inertia;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(1617)
		Float tmp3 = perim;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(1617)
...
Void ZPP_Polygon_obj::__validate_localCOM( ){
{
		...
		::zpp_nape::geom::ZPP_Vec2 tmp = this->lverts;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(1625)
		::zpp_nape::geom::ZPP_Vec2 tmp1 = tmp->next->next;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(1625)
		bool tmp2 = (tmp1 == null());		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(1625)
		if ((tmp2)){
			...
			::zpp_nape::geom::ZPP_Vec2 tmp3 = this->lverts;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(1626)
			Float tmp4 = tmp3->next->x;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(1626)
			this->localCOMx = tmp4;
			HX_STACK_LINE(1627)
			::zpp_nape::geom::ZPP_Vec2 tmp5 = this->lverts;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(1627)
			Float tmp6 = tmp5->next->y;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(1627)
			this->localCOMy = tmp6;
			HX_STACK_LINE(1636)
			{
			...
			::zpp_nape::geom::ZPP_Vec2 tmp4 = tmp3->next->next;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(1645)
			::zpp_nape::geom::ZPP_Vec2 tmp5 = tmp4->next;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(1645)
			bool tmp6 = (tmp5 == null());		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(1645)
			if ((tmp6)){
				HX_STACK_LINE(1646)
				{
					...
					::zpp_nape::geom::ZPP_Vec2 tmp7 = this->lverts;		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(1647)
					Float tmp8 = tmp7->next->x;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(1647)
					this->localCOMx = tmp8;
					HX_STACK_LINE(1648)
					::zpp_nape::geom::ZPP_Vec2 tmp9 = this->lverts;		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(1648)
					Float tmp10 = tmp9->next->y;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(1648)
					this->localCOMy = tmp10;
					HX_STACK_LINE(1657)
					{
					}
				}
				HX_STACK_LINE(1666)
				{
					...
					::zpp_nape::geom::ZPP_Vec2 tmp7 = this->lverts;		HX_STACK_VAR(tmp7,"tmp7");
					HX_STACK_LINE(1676)
					::zpp_nape::geom::ZPP_Vec2 tmp8 = tmp7->next->next;		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(1676)
				...
				HX_STACK_LINE(1715)
				{
					...
					while((true)){
						...
						{
							HX_STACK_LINE(1724)
							Float tmp10 = v->x;		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(1724)
							Float tmp11 = (w->y - u->y);		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(1724)
							Float tmp12 = (tmp10 * tmp11);		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(1724)
							hx::AddEq(area,tmp12);
							HX_STACK_LINE(1725)
							Float tmp13 = (w->y * v->x);		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(1725)
							Float tmp14 = (w->x * v->y);		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(1725)
							Float tmp15 = (tmp13 - tmp14);		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(1725)
							Float cf = tmp15;		HX_STACK_VAR(cf,"cf");
							HX_STACK_LINE(1726)
							Float tmp16 = (v->x + w->x);		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(1726)
							Float tmp17 = cf;		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(1726)
							Float tmp18 = (tmp16 * tmp17);		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(1726)
							hx::AddEq(this->localCOMx,tmp18);
							HX_STACK_LINE(1727)
							Float tmp19 = (v->y + w->y);		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(1727)
							Float tmp20 = cf;		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(1727)
							Float tmp21 = (tmp19 * tmp20);		HX_STACK_VAR(tmp21,"tmp21");
							HX_STACK_LINE(1727)
							hx::AddEq(this->localCOMy,tmp21);
						}
						HX_STACK_LINE(1729)
						u = v;
						HX_STACK_LINE(1730)
					...
					HX_STACK_LINE(1735)
					{
						...
						HX_STACK_LINE(1736)
						Float tmp10 = (w->y - u->y);		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(1736)
						Float tmp11 = (tmp9 * tmp10);		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(1736)
						hx::AddEq(area,tmp11);
						HX_STACK_LINE(1737)
						Float tmp12 = (w->y * v->x);		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(1737)
						Float tmp13 = (w->x * v->y);		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(1737)
						Float tmp14 = (tmp12 - tmp13);		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(1737)
						Float cf = tmp14;		HX_STACK_VAR(cf,"cf");
						HX_STACK_LINE(1738)
						Float tmp15 = (v->x + w->x);		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(1738)
						Float tmp16 = cf;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(1738)
						Float tmp17 = (tmp15 * tmp16);		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(1738)
						hx::AddEq(this->localCOMx,tmp17);
						HX_STACK_LINE(1739)
						Float tmp18 = (v->y + w->y);		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(1739)
						Float tmp19 = cf;		HX_STACK_VAR(tmp19,"tmp19");
						HX_STACK_LINE(1739)
						Float tmp20 = (tmp18 * tmp19);		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(1739)
						hx::AddEq(this->localCOMy,tmp20);
					}
					HX_STACK_LINE(1741)
					u = v;
					HX_STACK_LINE(1742)
					...
					HX_STACK_LINE(1745)
					{
						...
						Float tmp9 = v->x;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(1746)
						Float tmp10 = (w1->y - u->y);		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(1746)
						Float tmp11 = (tmp9 * tmp10);		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(1746)
						hx::AddEq(area,tmp11);
						HX_STACK_LINE(1747)
						Float tmp12 = (w1->y * v->x);		HX_STACK_VAR(tmp12,"tmp12");
						HX_STACK_LINE(1747)
						Float tmp13 = (w1->x * v->y);		HX_STACK_VAR(tmp13,"tmp13");
						HX_STACK_LINE(1747)
						Float tmp14 = (tmp12 - tmp13);		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(1747)
						Float cf = tmp14;		HX_STACK_VAR(cf,"cf");
						HX_STACK_LINE(1748)
						Float tmp15 = (v->x + w1->x);		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(1748)
						Float tmp16 = cf;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(1748)
						Float tmp17 = (tmp15 * tmp16);		HX_STACK_VAR(tmp17,"tmp17");
						...
						hx::AddEq(this->localCOMx,tmp17);
						HX_STACK_LINE(1749)
						Float tmp18 = (v->y + w1->y);		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(1749)
						Float tmp19 = cf;		HX_STACK_VAR(tmp19,"tmp19");
						HX_STACK_LINE(1749)
						Float tmp20 = (tmp18 * tmp19);		HX_STACK_VAR(tmp20,"tmp20");
				...
				HX_STACK_LINE(1752)
				Float tmp7 = ((int)3 * area);		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(1752)
...
Void ZPP_Polygon_obj::localCOM_validate( ){
{
		...
		if ((tmp)){
			...
			if ((tmp3)){
				...
				HX_STACK_LINE(1772)
				::zpp_nape::geom::ZPP_Vec2 tmp6 = tmp5->next;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(1772)
				bool tmp7 = (tmp6 == null());		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(1772)
				if ((tmp7)){
					...
					if ((tmp10)){
						...
						HX_STACK_LINE(1772)
						{
							...
							::zpp_nape::geom::ZPP_Vec2 tmp11 = _this->lverts->next;		HX_STACK_VAR(tmp11,"tmp11");
							HX_STACK_LINE(1772)
							Float tmp12 = tmp11->next->x;		HX_STACK_VAR(tmp12,"tmp12");
							HX_STACK_LINE(1772)
							Float tmp13 = t;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(1772)
							Float tmp14 = (tmp12 * tmp13);		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(1772)
							hx::AddEq(_this->localCOMx,tmp14);
							HX_STACK_LINE(1772)
							::zpp_nape::geom::ZPP_Vec2 tmp15 = _this->lverts->next;		HX_STACK_VAR(tmp15,"tmp15");
							HX_STACK_LINE(1772)
							Float tmp16 = tmp15->next->y;		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(1772)
							Float tmp17 = t;		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(1772)
							Float tmp18 = (tmp16 * tmp17);		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(1772)
							hx::AddEq(_this->localCOMy,tmp18);
						}
						HX_STACK_LINE(1772)
						{
							HX_STACK_LINE(1772)
						...
						HX_STACK_LINE(1772)
						{
							...
							HX_STACK_LINE(1772)
							{
								...
								Float tmp13 = v->x;		HX_STACK_VAR(tmp13,"tmp13");
								HX_STACK_LINE(1772)
								Float tmp14 = (w1->y - u->y);		HX_STACK_VAR(tmp14,"tmp14");
								HX_STACK_LINE(1772)
								Float tmp15 = (tmp13 * tmp14);		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(1772)
								hx::AddEq(area,tmp15);
								HX_STACK_LINE(1772)
								Float tmp16 = (w1->y * v->x);		HX_STACK_VAR(tmp16,"tmp16");
								HX_STACK_LINE(1772)
								Float tmp17 = (w1->x * v->y);		HX_STACK_VAR(tmp17,"tmp17");
								HX_STACK_LINE(1772)
								Float tmp18 = (tmp16 - tmp17);		HX_STACK_VAR(tmp18,"tmp18");
								HX_STACK_LINE(1772)
								Float cf = tmp18;		HX_STACK_VAR(cf,"cf");
								HX_STACK_LINE(1772)
								Float tmp19 = (v->x + w1->x);		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(1772)
								Float tmp20 = cf;		HX_STACK_VAR(tmp20,"tmp20");
								HX_STACK_LINE(1772)
								Float tmp21 = (tmp19 * tmp20);		HX_STACK_VAR(tmp21,"tmp21");
								...
								hx::AddEq(_this->localCOMx,tmp21);
								HX_STACK_LINE(1772)
								Float tmp22 = (v->y + w1->y);		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(1772)
								Float tmp23 = cf;		HX_STACK_VAR(tmp23,"tmp23");
								HX_STACK_LINE(1772)
								Float tmp24 = (tmp22 * tmp23);		HX_STACK_VAR(tmp24,"tmp24");
						...
						HX_STACK_LINE(1772)
						Float tmp11 = ((int)3 * area);		HX_STACK_VAR(tmp11,"tmp11");
						HX_STACK_LINE(1772)
