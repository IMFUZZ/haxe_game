...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(321)
	::zpp_nape::util::ZNPList_ZPP_Constraint tmp7 = ::zpp_nape::util::ZNPList_ZPP_Constraint_obj::__new();		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(321)
	this->constraints = tmp7;
	HX_STACK_LINE(322)
	::zpp_nape::util::ZNPList_ZPP_Constraint tmp8 = this->constraints;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(322)
	::nape::constraint::ConstraintList tmp9 = ::zpp_nape::util::ZPP_ConstraintList_obj::get(tmp8,null());		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(322)
	this->wrap_constraints = tmp9;
	HX_STACK_LINE(323)
	Dynamic tmp10 = this->constraints_adder_dyn();		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(323)
	::nape::constraint::ConstraintList tmp11 = this->wrap_constraints;		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(323)
	tmp11->zpp_inner->adder = tmp10;
	HX_STACK_LINE(324)
	Dynamic tmp12 = this->constraints_subber_dyn();		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(324)
	::nape::constraint::ConstraintList tmp13 = this->wrap_constraints;		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(324)
	tmp13->zpp_inner->subber = tmp12;
	HX_STACK_LINE(328)
	::zpp_nape::util::ZNPList_ZPP_Compound tmp14 = ::zpp_nape::util::ZNPList_ZPP_Compound_obj::__new();		HX_STACK_VAR(tmp14,"tmp14");
	HX_STACK_LINE(328)
	this->compounds = tmp14;
	HX_STACK_LINE(329)
	::zpp_nape::util::ZNPList_ZPP_Compound tmp15 = this->compounds;		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(329)
	::nape::phys::CompoundList tmp16 = ::zpp_nape::util::ZPP_CompoundList_obj::get(tmp15,null());		HX_STACK_VAR(tmp16,"tmp16");
	HX_STACK_LINE(329)
	this->wrap_compounds = tmp16;
	HX_STACK_LINE(330)
	Dynamic tmp17 = this->compounds_adder_dyn();		HX_STACK_VAR(tmp17,"tmp17");
	HX_STACK_LINE(330)
	::nape::phys::CompoundList tmp18 = this->wrap_compounds;		HX_STACK_VAR(tmp18,"tmp18");
	HX_STACK_LINE(330)
	tmp18->zpp_inner->adder = tmp17;
	HX_STACK_LINE(331)
	Dynamic tmp19 = this->compounds_subber_dyn();		HX_STACK_VAR(tmp19,"tmp19");
	HX_STACK_LINE(331)
	::nape::phys::CompoundList tmp20 = this->wrap_compounds;		HX_STACK_VAR(tmp20,"tmp20");
	HX_STACK_LINE(331)
	tmp20->zpp_inner->subber = tmp19;
}
;
	return null();
}
...
bool ZPP_Compound_obj::compounds_adder( ::nape::phys::Compound x){
	...
	if ((tmp1)){
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(290)
			tmp4->wrap_compounds->remove(tmp5);
		}
		else{
			HX_STACK_LINE(291)
			::zpp_nape::space::ZPP_Space tmp4 = x->zpp_inner->space;		HX_STACK_VAR(tmp4,"tmp4");
		...
		x->zpp_inner->compound = hx::ObjectPtr<OBJ_>(this);
		HX_STACK_LINE(293)
		int tmp4 = this->depth;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(293)
		int tmp5 = (tmp4 + (int)1);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(293)
		x->zpp_inner->depth = tmp5;
		HX_STACK_LINE(294)
		::zpp_nape::space::ZPP_Space tmp6 = this->space;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(294)
		...
		if ((tmp7)){
			...
			HX_STACK_LINE(294)
			::zpp_nape::phys::ZPP_Compound tmp9 = x->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(294)
			tmp8->addCompound(tmp9);
		}
		HX_STACK_LINE(295)
		return true;
	}
