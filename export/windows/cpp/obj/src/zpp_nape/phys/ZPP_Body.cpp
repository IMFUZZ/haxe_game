...
Void ZPP_Body_obj::pos_invalidate( ::zpp_nape::geom::ZPP_Vec2 pos){
{
		...
		HX_STACK_LINE(489)
		Float tmp1 = pos->x;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(489)
		bool tmp2 = (tmp == tmp1);		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(489)
		...
		if ((tmp2)){
			HX_STACK_LINE(489)
			Float tmp4 = this->posy;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(489)
			Float tmp5 = tmp4;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(489)
			Float tmp6 = pos->y;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(489)
			tmp3 = (tmp5 == tmp6);
		}
		else{
			...
			HX_STACK_LINE(510)
			{
				HX_STACK_LINE(510)
				{
					...
					while((true)){
						...
						{
							HX_STACK_LINE(510)
							int tmp8 = s->type;		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(510)
...
Void ZPP_Body_obj::validate_aabb( ){
{
		...
		if ((tmp)){
			...
			HX_STACK_LINE(1005)
			{
				...
				tmp2->maxx = tmp1;
				HX_STACK_LINE(1007)
				Float tmp3 = ::Math_obj::NEGATIVE_INFINITY;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(1007)
				::zpp_nape::geom::ZPP_AABB tmp4 = this->aabb;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(1007)
				tmp4->maxy = tmp3;
			...
			HX_STACK_LINE(1025)
			{
				...
				while((true)){
					...
					HX_STACK_LINE(1029)
					{
						...
						{
							HX_STACK_LINE(1030)
							bool tmp4 = s->zip_aabb;		HX_STACK_VAR(tmp4,"tmp4");
							HX_STACK_LINE(1030)
							if ((tmp4)){
								HX_STACK_LINE(1030)
								bool tmp5 = (s->body != null());		HX_STACK_VAR(tmp5,"tmp5");
								HX_STACK_LINE(1030)
								if ((tmp5)){
									HX_STACK_LINE(1030)
									s->zip_aabb = false;
											...
											if ((tmp9)){
												...
												if ((tmp10)){
													...
													HX_STACK_LINE(1030)
													{
														...
														HX_STACK_LINE(1030)
														::zpp_nape::geom::ZPP_Vec2 cx_ite1 = tmp12;		HX_STACK_VAR(cx_ite1,"cx_ite1");
														HX_STACK_LINE(1030)
														while((true)){
															HX_STACK_LINE(1030)
						...
						HX_STACK_LINE(1031)
						{
							...
							HX_STACK_LINE(1031)
							bool tmp5 = (x->minx < _this->minx);		HX_STACK_VAR(tmp5,"tmp5");
							HX_STACK_LINE(1031)
							if ((tmp5)){
								HX_STACK_LINE(1031)
								_this->minx = x->minx;
							...
							HX_STACK_LINE(1031)
							bool tmp6 = (x->maxx > _this->maxx);		HX_STACK_VAR(tmp6,"tmp6");
							HX_STACK_LINE(1031)
							if ((tmp6)){
								HX_STACK_LINE(1031)
								_this->maxx = x->maxx;
							...
							HX_STACK_LINE(1031)
							bool tmp7 = (x->miny < _this->miny);		HX_STACK_VAR(tmp7,"tmp7");
							HX_STACK_LINE(1031)
							if ((tmp7)){
								HX_STACK_LINE(1031)
								_this->miny = x->miny;
							...
							HX_STACK_LINE(1031)
							bool tmp8 = (x->maxy > _this->maxy);		HX_STACK_VAR(tmp8,"tmp8");
							HX_STACK_LINE(1031)
							if ((tmp8)){
								HX_STACK_LINE(1031)
								_this->maxy = x->maxy;
...
Void ZPP_Body_obj::clear( ){
{
		...
		while((true)){
			...
			::zpp_nape::util::ZNPList_ZPP_Shape tmp5 = this->shapes;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(1217)
			::zpp_nape::shape::ZPP_Shape tmp6 = tmp5->pop_unsafe();		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(1217)
			::zpp_nape::shape::ZPP_Shape s = tmp6;		HX_STACK_VAR(s,"s");
			HX_STACK_LINE(1218)
			{
				HX_STACK_LINE(1219)
				s->removedFromBody();
		...
		HX_STACK_LINE(1345)
		Float tmp = this->rot = (int)0;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(1345)
		Float tmp1 = this->pre_rot = tmp;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(1345)
		Float tmp2 = this->kinangvel = tmp1;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(1345)
		Float tmp3 = this->torque = tmp2;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(1345)
		this->angvel = tmp3;
		HX_STACK_LINE(1346)
		{
			HX_STACK_LINE(1346)
			{
				...
				while((true)){
					...
					{
						HX_STACK_LINE(1346)
						int tmp7 = s->type;		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(1346)
						int tmp8 = ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_POLYGON;		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(1346)
		...
		this->massMode = tmp4;
		HX_STACK_LINE(1370)
		int tmp5 = ::zpp_nape::util::ZPP_Flags_obj::id_GravMassMode_DEFAULT;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(1370)
		this->gravMassMode = tmp5;
		HX_STACK_LINE(1371)
		this->gravMassScale = ((Float)1.0);
		HX_STACK_LINE(1372)
		int tmp6 = ::zpp_nape::util::ZPP_Flags_obj::id_InertiaMode_DEFAULT;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(1372)
		this->inertiaMode = tmp6;
		HX_STACK_LINE(1373)
		this->norotate = false;
		HX_STACK_LINE(1374)
		this->nomove = false;
