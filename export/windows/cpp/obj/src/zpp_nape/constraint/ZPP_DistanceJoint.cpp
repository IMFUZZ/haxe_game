...
Void ZPP_DistanceJoint_obj::draw( ::nape::util::Debug g){
{
		...
		HX_STACK_ARG(g,"g")
		HX_STACK_LINE(1289)
		::nape::constraint::DistanceJoint tmp = this->outer_zn;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(1289)
		::nape::constraint::DistanceJoint me = tmp;		HX_STACK_VAR(me,"me");
		HX_STACK_LINE(1290)
		...
		HX_STACK_LINE(1292)
		::nape::geom::Vec2 tmp11 = a1;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(1292)
		::nape::geom::Vec2 tmp12 = a2->sub(tmp11,null());		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(1292)
		::nape::geom::Vec2 n = tmp12;		HX_STACK_VAR(n,"n");
		HX_STACK_LINE(1293)
		...
		HX_STACK_LINE(1293)
		Float nl = tmp13;		HX_STACK_VAR(nl,"nl");
		HX_STACK_LINE(1294)
		bool tmp14 = (nl != (int)0);		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(1294)
		if ((tmp14)){
			HX_STACK_LINE(1295)
			Float tmp15 = (Float((int)1) / Float(nl));		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(1295)
			n->muleq(tmp15);
			HX_STACK_LINE(1296)
			::nape::geom::Vec2 tmp16 = a2;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(1296)
			::nape::geom::Vec2 tmp17 = a1->add(tmp16,null());		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(1296)
			::nape::geom::Vec2 tmp18 = tmp17->muleq(((Float)0.5));		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(1296)
			::nape::geom::Vec2 mid = tmp18;		HX_STACK_VAR(mid,"mid");
			HX_STACK_LINE(1297)
			Float tmp19 = this->jointMin;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(1297)
			Float tmp20 = (tmp19 * ((Float)0.5));		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(1297)
			::nape::geom::Vec2 tmp21 = n->mul(tmp20,true);		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(1297)
			::nape::geom::Vec2 tmp22 = mid->sub(tmp21,null());		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(1297)
			::nape::geom::Vec2 min1 = tmp22;		HX_STACK_VAR(min1,"min1");
			HX_STACK_LINE(1298)
			Float tmp23 = this->jointMin;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(1298)
			Float tmp24 = (tmp23 * ((Float)0.5));		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(1298)
			::nape::geom::Vec2 tmp25 = n->mul(tmp24,true);		HX_STACK_VAR(tmp25,"tmp25");
			HX_STACK_LINE(1298)
			::nape::geom::Vec2 tmp26 = mid->add(tmp25,null());		HX_STACK_VAR(tmp26,"tmp26");
			HX_STACK_LINE(1298)
			::nape::geom::Vec2 min2 = tmp26;		HX_STACK_VAR(min2,"min2");
			HX_STACK_LINE(1299)
			Float tmp27 = this->jointMax;		HX_STACK_VAR(tmp27,"tmp27");
			HX_STACK_LINE(1299)
			Float tmp28 = (tmp27 * ((Float)0.5));		HX_STACK_VAR(tmp28,"tmp28");
			HX_STACK_LINE(1299)
			::nape::geom::Vec2 tmp29 = n->mul(tmp28,true);		HX_STACK_VAR(tmp29,"tmp29");
			HX_STACK_LINE(1299)
			::nape::geom::Vec2 tmp30 = mid->sub(tmp29,null());		HX_STACK_VAR(tmp30,"tmp30");
			HX_STACK_LINE(1299)
			::nape::geom::Vec2 max1 = tmp30;		HX_STACK_VAR(max1,"max1");
			HX_STACK_LINE(1300)
			Float tmp31 = this->jointMax;		HX_STACK_VAR(tmp31,"tmp31");
			HX_STACK_LINE(1300)
			Float tmp32 = (tmp31 * ((Float)0.5));		HX_STACK_VAR(tmp32,"tmp32");
			HX_STACK_LINE(1300)
			::nape::geom::Vec2 tmp33 = n->mul(tmp32,true);		HX_STACK_VAR(tmp33,"tmp33");
			HX_STACK_LINE(1300)
			::nape::geom::Vec2 tmp34 = mid->add(tmp33,null());		HX_STACK_VAR(tmp34,"tmp34");
			HX_STACK_LINE(1300)
			::nape::geom::Vec2 max2 = tmp34;		HX_STACK_VAR(max2,"max2");
			HX_STACK_LINE(1301)
			::nape::geom::Vec2 tmp35 = min1;		HX_STACK_VAR(tmp35,"tmp35");
			HX_STACK_LINE(1301)
			::nape::geom::Vec2 tmp36 = min2;		HX_STACK_VAR(tmp36,"tmp36");
			HX_STACK_LINE(1301)
			g->drawLine(tmp35,tmp36,(int)16776960);
			HX_STACK_LINE(1302)
			::nape::geom::Vec2 tmp37 = max1;		HX_STACK_VAR(tmp37,"tmp37");
			HX_STACK_LINE(1302)
			::nape::geom::Vec2 tmp38 = min1;		HX_STACK_VAR(tmp38,"tmp38");
			HX_STACK_LINE(1302)
			g->drawLine(tmp37,tmp38,(int)65535);
			HX_STACK_LINE(1303)
			::nape::geom::Vec2 tmp39 = max2;		HX_STACK_VAR(tmp39,"tmp39");
			HX_STACK_LINE(1303)
			::nape::geom::Vec2 tmp40 = min2;		HX_STACK_VAR(tmp40,"tmp40");
			HX_STACK_LINE(1303)
			g->drawLine(tmp39,tmp40,(int)65535);
			HX_STACK_LINE(1304)
			bool tmp41 = this->stiff;		HX_STACK_VAR(tmp41,"tmp41");
			HX_STACK_LINE(1304)
			bool tmp42 = !(tmp41);		HX_STACK_VAR(tmp42,"tmp42");
			HX_STACK_LINE(1304)
			if ((tmp42)){
				HX_STACK_LINE(1305)
				Float tmp43 = nl;		HX_STACK_VAR(tmp43,"tmp43");
				HX_STACK_LINE(1305)
				...
				if ((tmp45)){
					HX_STACK_LINE(1306)
					::nape::geom::Vec2 tmp46 = max1;		HX_STACK_VAR(tmp46,"tmp46");
					HX_STACK_LINE(1306)
					::nape::geom::Vec2 tmp47 = a1;		HX_STACK_VAR(tmp47,"tmp47");
					HX_STACK_LINE(1306)
					g->drawSpring(tmp46,tmp47,(int)65535,null(),null());
					HX_STACK_LINE(1307)
					::nape::geom::Vec2 tmp48 = max2;		HX_STACK_VAR(tmp48,"tmp48");
					HX_STACK_LINE(1307)
					::nape::geom::Vec2 tmp49 = a2;		HX_STACK_VAR(tmp49,"tmp49");
					HX_STACK_LINE(1307)
					g->drawSpring(tmp48,tmp49,(int)65535,null(),null());
				}
				else{
					HX_STACK_LINE(1309)
					Float tmp46 = nl;		HX_STACK_VAR(tmp46,"tmp46");
					HX_STACK_LINE(1309)
					...
					if ((tmp48)){
						HX_STACK_LINE(1310)
						::nape::geom::Vec2 tmp49 = min1;		HX_STACK_VAR(tmp49,"tmp49");
						HX_STACK_LINE(1310)
						::nape::geom::Vec2 tmp50 = a1;		HX_STACK_VAR(tmp50,"tmp50");
						HX_STACK_LINE(1310)
						g->drawSpring(tmp49,tmp50,(int)16776960,null(),null());
						HX_STACK_LINE(1311)
						::nape::geom::Vec2 tmp51 = min2;		HX_STACK_VAR(tmp51,"tmp51");
						HX_STACK_LINE(1311)
						::nape::geom::Vec2 tmp52 = a2;		HX_STACK_VAR(tmp52,"tmp52");
						HX_STACK_LINE(1311)
						g->drawSpring(tmp51,tmp52,(int)16776960,null(),null());
					}
				}
			}
			HX_STACK_LINE(1314)
			{
				...
				HX_STACK_LINE(1314)
				{
					...
					{
						HX_STACK_LINE(1314)
						bool tmp43 = (o->outer != null());		HX_STACK_VAR(tmp43,"tmp43");
						HX_STACK_LINE(1314)
						if ((tmp43)){
							HX_STACK_LINE(1314)
		...
		HX_STACK_LINE(1320)
		::nape::geom::Vec2 tmp15 = a1;		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(1320)
		g->drawFilledCircle(tmp15,(int)2,(int)255);
		HX_STACK_LINE(1321)
		::nape::geom::Vec2 tmp16 = a2;		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(1321)
		g->drawFilledCircle(tmp16,(int)2,(int)16711680);
		HX_STACK_LINE(1322)
		{
			HX_STACK_LINE(1322)
