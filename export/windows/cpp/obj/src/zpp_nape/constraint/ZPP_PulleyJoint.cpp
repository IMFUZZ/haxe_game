...
Void ZPP_PulleyJoint_obj::draw( ::nape::util::Debug g){
{
		...
		HX_STACK_ARG(g,"g")
		HX_STACK_LINE(2193)
		::nape::constraint::PulleyJoint tmp = this->outer_zn;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(2193)
		::nape::constraint::PulleyJoint me = tmp;		HX_STACK_VAR(me,"me");
		HX_STACK_LINE(2194)
		::zpp_nape::phys::ZPP_Body tmp1 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(2194)
		...
		{
			HX_STACK_LINE(2194)
			::nape::geom::Vec2 tmp5 = me->zpp_inner_zn->wrap_a1;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(2194)
			bool tmp6 = (tmp5 == null());		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(2194)
			if ((tmp6)){
			...
			HX_STACK_LINE(2194)
			tmp4 = me->zpp_inner_zn->wrap_a1;
		}
		HX_STACK_LINE(2194)
		::nape::geom::Vec2 tmp5 = tmp3->localPointToWorld(tmp4,null());		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(2194)
		::nape::geom::Vec2 a1 = tmp5;		HX_STACK_VAR(a1,"a1");
		HX_STACK_LINE(2195)
		::zpp_nape::phys::ZPP_Body tmp6 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(2195)
		bool tmp7 = (tmp6 == null());		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(2195)
		...
		if ((tmp7)){
			...
			HX_STACK_LINE(2195)
			::zpp_nape::phys::ZPP_Body tmp9 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(2195)
			tmp8 = tmp9->outer;
		}
		HX_STACK_LINE(2195)
		...
		{
			HX_STACK_LINE(2195)
			::nape::geom::Vec2 tmp10 = me->zpp_inner_zn->wrap_a2;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(2195)
			...
			HX_STACK_LINE(2195)
			tmp9 = me->zpp_inner_zn->wrap_a2;
		}
		HX_STACK_LINE(2195)
		::nape::geom::Vec2 tmp10 = tmp8->localPointToWorld(tmp9,null());		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(2195)
		::nape::geom::Vec2 a2 = tmp10;		HX_STACK_VAR(a2,"a2");
		HX_STACK_LINE(2196)
		::zpp_nape::phys::ZPP_Body tmp11 = me->zpp_inner_zn->b3;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(2196)
		...
		if ((tmp12)){
			...
			HX_STACK_LINE(2196)
			::zpp_nape::phys::ZPP_Body tmp14 = me->zpp_inner_zn->b3;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(2196)
			tmp13 = tmp14->outer;
		}
		HX_STACK_LINE(2196)
		...
		{
			HX_STACK_LINE(2196)
			::nape::geom::Vec2 tmp15 = me->zpp_inner_zn->wrap_a3;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(2196)
			...
			HX_STACK_LINE(2196)
			tmp14 = me->zpp_inner_zn->wrap_a3;
		}
		HX_STACK_LINE(2196)
		::nape::geom::Vec2 tmp15 = tmp13->localPointToWorld(tmp14,null());		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(2196)
		::nape::geom::Vec2 a3 = tmp15;		HX_STACK_VAR(a3,"a3");
		HX_STACK_LINE(2197)
		::zpp_nape::phys::ZPP_Body tmp16 = me->zpp_inner_zn->b4;		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(2197)
		...
		if ((tmp17)){
			...
			HX_STACK_LINE(2197)
			::zpp_nape::phys::ZPP_Body tmp19 = me->zpp_inner_zn->b4;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(2197)
			tmp18 = tmp19->outer;
		}
		HX_STACK_LINE(2197)
		...
		{
			HX_STACK_LINE(2197)
			::nape::geom::Vec2 tmp20 = me->zpp_inner_zn->wrap_a4;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(2197)
			...
			HX_STACK_LINE(2197)
			tmp19 = me->zpp_inner_zn->wrap_a4;
		}
		HX_STACK_LINE(2197)
		::nape::geom::Vec2 tmp20 = tmp18->localPointToWorld(tmp19,null());		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(2197)
		::nape::geom::Vec2 a4 = tmp20;		HX_STACK_VAR(a4,"a4");
		HX_STACK_LINE(2198)
		::nape::geom::Vec2 tmp21 = a1;		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(2198)
		::nape::geom::Vec2 tmp22 = a2->sub(tmp21,null());		HX_STACK_VAR(tmp22,"tmp22");
		HX_STACK_LINE(2198)
		::nape::geom::Vec2 n12 = tmp22;		HX_STACK_VAR(n12,"n12");
		HX_STACK_LINE(2199)
		::nape::geom::Vec2 tmp23 = a3;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(2199)
		::nape::geom::Vec2 tmp24 = a4->sub(tmp23,null());		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(2199)
		::nape::geom::Vec2 n34 = tmp24;		HX_STACK_VAR(n34,"n34");
		HX_STACK_LINE(2200)
		...
		HX_STACK_LINE(2200)
		{
			...
			Float tmp32 = (tmp28 + tmp31);		HX_STACK_VAR(tmp32,"tmp32");
			HX_STACK_LINE(2200)
			tmp25 = ::Math_obj::sqrt(tmp32);
		}
		HX_STACK_LINE(2200)
		Float nl12 = tmp25;		HX_STACK_VAR(nl12,"nl12");
		HX_STACK_LINE(2201)
		Float tmp26;		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(2201)
		{
			...
			HX_STACK_LINE(2201)
			tmp26 = ::Math_obj::sqrt(tmp33);
		}
		HX_STACK_LINE(2201)
		Float nl34 = tmp26;		HX_STACK_VAR(nl34,"nl34");
		HX_STACK_LINE(2202)
		::nape::util::Debug tmp27 = g;		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(2202)
		::nape::geom::Vec2 tmp28 = a1;		HX_STACK_VAR(tmp28,"tmp28");
		HX_STACK_LINE(2202)
		::nape::geom::Vec2 tmp29 = a2;		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(2202)
		::nape::geom::Vec2 tmp30 = n12;		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(2202)
		Float tmp31 = nl12;		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(2202)
		Float tmp32 = nl34;		HX_STACK_VAR(tmp32,"tmp32");
		HX_STACK_LINE(2202)
		Float tmp33 = this->ratio;		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(2202)
		Float tmp34 = (tmp32 * tmp33);		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(2202)
		this->drawLink(tmp27,tmp28,tmp29,tmp30,tmp31,tmp34,((Float)1.0),(int)16776960,(int)65535);
		HX_STACK_LINE(2203)
		::nape::util::Debug tmp35 = g;		HX_STACK_VAR(tmp35,"tmp35");
		HX_STACK_LINE(2203)
		::nape::geom::Vec2 tmp36 = a3;		HX_STACK_VAR(tmp36,"tmp36");
		HX_STACK_LINE(2203)
		::nape::geom::Vec2 tmp37 = a4;		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(2203)
		::nape::geom::Vec2 tmp38 = n34;		HX_STACK_VAR(tmp38,"tmp38");
		HX_STACK_LINE(2203)
		Float tmp39 = nl34;		HX_STACK_VAR(tmp39,"tmp39");
		HX_STACK_LINE(2203)
		Float tmp40 = nl12;		HX_STACK_VAR(tmp40,"tmp40");
		HX_STACK_LINE(2203)
		Float tmp41 = this->ratio;		HX_STACK_VAR(tmp41,"tmp41");
		HX_STACK_LINE(2203)
		Float tmp42 = (Float((int)1) / Float(tmp41));		HX_STACK_VAR(tmp42,"tmp42");
		HX_STACK_LINE(2203)
		this->drawLink(tmp35,tmp36,tmp37,tmp38,tmp39,tmp40,tmp42,(int)65535,(int)16711935);
		HX_STACK_LINE(2204)
		::nape::geom::Vec2 tmp43 = a1;		HX_STACK_VAR(tmp43,"tmp43");
		HX_STACK_LINE(2204)
		g->drawFilledCircle(tmp43,(int)2,(int)255);
		HX_STACK_LINE(2205)
		::nape::geom::Vec2 tmp44 = a2;		HX_STACK_VAR(tmp44,"tmp44");
		HX_STACK_LINE(2205)
		g->drawFilledCircle(tmp44,(int)2,(int)16711680);
		HX_STACK_LINE(2206)
		::nape::geom::Vec2 tmp45 = a3;		HX_STACK_VAR(tmp45,"tmp45");
		HX_STACK_LINE(2206)
		g->drawFilledCircle(tmp45,(int)2,(int)65280);
		HX_STACK_LINE(2207)
		::nape::geom::Vec2 tmp46 = a4;		HX_STACK_VAR(tmp46,"tmp46");
		HX_STACK_LINE(2207)
		g->drawFilledCircle(tmp46,(int)2,(int)16711935);
		HX_STACK_LINE(2208)
		{
			HX_STACK_LINE(2208)
			...
			HX_STACK_LINE(2208)
			{
				...
				{
					HX_STACK_LINE(2208)
					bool tmp47 = (o->outer != null());		HX_STACK_VAR(tmp47,"tmp47");
					HX_STACK_LINE(2208)
					if ((tmp47)){
						HX_STACK_LINE(2208)
...
{
		HX_STACK_FRAME("zpp_nape.constraint.ZPP_PulleyJoint","drawLink",0x418402d0,"zpp_nape.constraint.ZPP_PulleyJoint.drawLink","zpp_nape/constraint/PulleyJoint.hx",2216,0xdaffcadd)
		HX_STACK_THIS(this)
		HX_STACK_ARG(g,"g")
		HX_STACK_ARG(a1,"a1")
		HX_STACK_ARG(a2,"a2")
		...
		HX_STACK_ARG(cb,"cb")
		HX_STACK_LINE(2217)
		bool tmp = (nl != (int)0);		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(2217)
		if ((tmp)){
			HX_STACK_LINE(2218)
			Float tmp1 = (Float((int)1) / Float(nl));		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(2218)
			n->muleq(tmp1);
			HX_STACK_LINE(2219)
			::nape::geom::Vec2 tmp2 = a2;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(2219)
			::nape::geom::Vec2 tmp3 = a1->add(tmp2,null());		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(2219)
			::nape::geom::Vec2 tmp4 = tmp3->muleq(((Float)0.5));		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(2219)
			::nape::geom::Vec2 mid = tmp4;		HX_STACK_VAR(mid,"mid");
			HX_STACK_LINE(2220)
			Float tmp5 = this->jointMin;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(2220)
			Float tmp6 = bias;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(2220)
			Float tmp7 = (tmp5 - tmp6);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(2220)
			...
			Float tmp9 = (tmp7 * tmp8);		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(2220)
			Float cmin = tmp9;		HX_STACK_VAR(cmin,"cmin");
			HX_STACK_LINE(2221)
			bool tmp10 = (cmin < (int)0);		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(2221)
			if ((tmp10)){
				HX_STACK_LINE(2221)
				cmin = (int)0;
			...
			HX_STACK_LINE(2222)
			Float tmp11 = this->jointMax;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(2222)
			Float tmp12 = bias;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(2222)
			Float tmp13 = (tmp11 - tmp12);		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(2222)
			Float tmp14 = scale;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(2222)
			Float tmp15 = (tmp13 * tmp14);		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(2222)
			Float cmax = tmp15;		HX_STACK_VAR(cmax,"cmax");
			HX_STACK_LINE(2223)
			bool tmp16 = (cmax < (int)0);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(2223)
			if ((tmp16)){
				HX_STACK_LINE(2223)
				cmax = (int)0;
			...
			HX_STACK_LINE(2224)
			Float tmp17 = (cmin * ((Float)0.5));		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(2224)
			::nape::geom::Vec2 tmp18 = n->mul(tmp17,true);		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(2224)
			::nape::geom::Vec2 tmp19 = mid->sub(tmp18,null());		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(2224)
			::nape::geom::Vec2 min1 = tmp19;		HX_STACK_VAR(min1,"min1");
			HX_STACK_LINE(2225)
			Float tmp20 = (cmin * ((Float)0.5));		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(2225)
			::nape::geom::Vec2 tmp21 = n->mul(tmp20,true);		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(2225)
			::nape::geom::Vec2 tmp22 = mid->add(tmp21,null());		HX_STACK_VAR(tmp22,"tmp22");
			HX_STACK_LINE(2225)
			::nape::geom::Vec2 min2 = tmp22;		HX_STACK_VAR(min2,"min2");
			HX_STACK_LINE(2226)
			Float tmp23 = (cmax * ((Float)0.5));		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(2226)
			::nape::geom::Vec2 tmp24 = n->mul(tmp23,true);		HX_STACK_VAR(tmp24,"tmp24");
			HX_STACK_LINE(2226)
			::nape::geom::Vec2 tmp25 = mid->sub(tmp24,null());		HX_STACK_VAR(tmp25,"tmp25");
			HX_STACK_LINE(2226)
			::nape::geom::Vec2 max1 = tmp25;		HX_STACK_VAR(max1,"max1");
			HX_STACK_LINE(2227)
			Float tmp26 = (cmax * ((Float)0.5));		HX_STACK_VAR(tmp26,"tmp26");
			HX_STACK_LINE(2227)
			::nape::geom::Vec2 tmp27 = n->mul(tmp26,true);		HX_STACK_VAR(tmp27,"tmp27");
			HX_STACK_LINE(2227)
			::nape::geom::Vec2 tmp28 = mid->add(tmp27,null());		HX_STACK_VAR(tmp28,"tmp28");
			HX_STACK_LINE(2227)
			::nape::geom::Vec2 max2 = tmp28;		HX_STACK_VAR(max2,"max2");
			HX_STACK_LINE(2228)
			::nape::geom::Vec2 tmp29 = min1;		HX_STACK_VAR(tmp29,"tmp29");
			HX_STACK_LINE(2228)
			::nape::geom::Vec2 tmp30 = min2;		HX_STACK_VAR(tmp30,"tmp30");
			HX_STACK_LINE(2228)
			int tmp31 = ca;		HX_STACK_VAR(tmp31,"tmp31");
			HX_STACK_LINE(2228)
			g->drawLine(tmp29,tmp30,tmp31);
			HX_STACK_LINE(2229)
			::nape::geom::Vec2 tmp32 = max1;		HX_STACK_VAR(tmp32,"tmp32");
			HX_STACK_LINE(2229)
			::nape::geom::Vec2 tmp33 = min1;		HX_STACK_VAR(tmp33,"tmp33");
			HX_STACK_LINE(2229)
			int tmp34 = cb;		HX_STACK_VAR(tmp34,"tmp34");
			HX_STACK_LINE(2229)
			g->drawLine(tmp32,tmp33,tmp34);
			HX_STACK_LINE(2230)
			::nape::geom::Vec2 tmp35 = max2;		HX_STACK_VAR(tmp35,"tmp35");
			HX_STACK_LINE(2230)
			::nape::geom::Vec2 tmp36 = min2;		HX_STACK_VAR(tmp36,"tmp36");
			HX_STACK_LINE(2230)
			int tmp37 = cb;		HX_STACK_VAR(tmp37,"tmp37");
			HX_STACK_LINE(2230)
			g->drawLine(tmp35,tmp36,tmp37);
			HX_STACK_LINE(2231)
			bool tmp38 = this->stiff;		HX_STACK_VAR(tmp38,"tmp38");
			HX_STACK_LINE(2231)
			bool tmp39 = !(tmp38);		HX_STACK_VAR(tmp39,"tmp39");
			HX_STACK_LINE(2231)
			if ((tmp39)){
				HX_STACK_LINE(2232)
				bool tmp40 = (nl > cmax);		HX_STACK_VAR(tmp40,"tmp40");
				HX_STACK_LINE(2232)
				if ((tmp40)){
					HX_STACK_LINE(2233)
					::nape::geom::Vec2 tmp41 = max1;		HX_STACK_VAR(tmp41,"tmp41");
					HX_STACK_LINE(2233)
					::nape::geom::Vec2 tmp42 = a1;		HX_STACK_VAR(tmp42,"tmp42");
					HX_STACK_LINE(2233)
					int tmp43 = cb;		HX_STACK_VAR(tmp43,"tmp43");
					HX_STACK_LINE(2233)
					g->drawSpring(tmp41,tmp42,tmp43,null(),null());
					HX_STACK_LINE(2234)
					::nape::geom::Vec2 tmp44 = max2;		HX_STACK_VAR(tmp44,"tmp44");
					HX_STACK_LINE(2234)
					::nape::geom::Vec2 tmp45 = a2;		HX_STACK_VAR(tmp45,"tmp45");
					HX_STACK_LINE(2234)
					int tmp46 = cb;		HX_STACK_VAR(tmp46,"tmp46");
					HX_STACK_LINE(2234)
					g->drawSpring(tmp44,tmp45,tmp46,null(),null());
				}
				else{
					HX_STACK_LINE(2236)
					bool tmp41 = (nl < cmin);		HX_STACK_VAR(tmp41,"tmp41");
					HX_STACK_LINE(2236)
					if ((tmp41)){
						HX_STACK_LINE(2237)
						::nape::geom::Vec2 tmp42 = min1;		HX_STACK_VAR(tmp42,"tmp42");
						HX_STACK_LINE(2237)
						::nape::geom::Vec2 tmp43 = a1;		HX_STACK_VAR(tmp43,"tmp43");
						HX_STACK_LINE(2237)
						int tmp44 = ca;		HX_STACK_VAR(tmp44,"tmp44");
						HX_STACK_LINE(2237)
						g->drawSpring(tmp42,tmp43,tmp44,null(),null());
						HX_STACK_LINE(2238)
						::nape::geom::Vec2 tmp45 = min2;		HX_STACK_VAR(tmp45,"tmp45");
						HX_STACK_LINE(2238)
						::nape::geom::Vec2 tmp46 = a2;		HX_STACK_VAR(tmp46,"tmp46");
						HX_STACK_LINE(2238)
						int tmp47 = ca;		HX_STACK_VAR(tmp47,"tmp47");
						HX_STACK_LINE(2238)
						g->drawSpring(tmp45,tmp46,tmp47,null(),null());
					}
				}
			}
			HX_STACK_LINE(2241)
			{
				...
				HX_STACK_LINE(2241)
				{
					...
					{
						HX_STACK_LINE(2241)
						bool tmp40 = (o->outer != null());		HX_STACK_VAR(tmp40,"tmp40");
						HX_STACK_LINE(2241)
						if ((tmp40)){
							HX_STACK_LINE(2241)
							o->outer->zpp_inner = null();
