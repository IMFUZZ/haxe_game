									...
									if ((tmp35)){
										...
										HX_STACK_LINE(1322)
										{
											...
											HX_STACK_LINE(1332)
											{
												...
												o->vertex = null();
												HX_STACK_LINE(1332)
												::zpp_nape::geom::ZPP_SimpleSeg tmp36 = o->segment2 = null();		HX_STACK_VAR(tmp36,"tmp36");
												HX_STACK_LINE(1332)
												o->segment = tmp36;
												HX_STACK_LINE(1332)
												o->node = null();
											...
											HX_STACK_LINE(1333)
											::zpp_nape::geom::ZPP_SimpleEvent tmp36 = ::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool;		HX_STACK_VAR(tmp36,"tmp36");
											HX_STACK_LINE(1333)
											o->next = tmp36;
											HX_STACK_LINE(1334)
											::zpp_nape::geom::ZPP_SimpleEvent_obj::zpp_pool = o;
								...
								if ((tmp42)){
									...
									HX_STACK_LINE(1531)
									{
										...
										HX_STACK_LINE(1541)
										{
											...
											o->vertex = null();
											HX_STACK_LINE(1541)
											::zpp_nape::geom::ZPP_SimpleSeg tmp43 = o->segment2 = null();		HX_STACK_VAR(tmp43,"tmp43");
											HX_STACK_LINE(1541)
											o->segment = tmp43;
											HX_STACK_LINE(1541)
											o->node = null();
