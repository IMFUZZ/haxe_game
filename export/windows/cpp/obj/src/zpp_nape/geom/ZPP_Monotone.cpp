		...
		HX_STACK_LINE(509)
		{
			...
			switch( (int)(tmp13)){
				...
				case (int)1: {
					...
					HX_STACK_LINE(516)
					int tmp14 = e->helper->type;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(516)
					bool tmp15 = (tmp14 == (int)2);		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(516)
					if ((tmp15)){
						HX_STACK_LINE(517)
						::zpp_nape::geom::ZPP_PartitionVertex tmp16 = v;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(517)
						::zpp_nape::geom::ZPP_PartitionVertex tmp17 = e->helper;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(517)
						poly->add_diagonal(tmp16,tmp17);
					}
					HX_STACK_LINE(519)
					::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex tmp16 = ::zpp_nape::geom::ZPP_Monotone_obj::edges;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(519)
					::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex tmp17 = e->node;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(519)
					tmp16->remove_node(tmp17);
				}
				;break;
				case (int)3: {
					HX_STACK_LINE(523)
				...
				case (int)2: {
					...
					tmp16->remove_node(tmp17);
					HX_STACK_LINE(578)
					::zpp_nape::geom::ZPP_PartitionVertex tmp18;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(578)
					{
						HX_STACK_LINE(579)
						::zpp_nape::geom::ZPP_PartitionVertex ret = null();		HX_STACK_VAR(ret,"ret");
						HX_STACK_LINE(580)
						{
							...
							HX_STACK_LINE(589)
							bool tmp20 = tmp19->empty();		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(589)
							bool tmp21 = !(tmp20);		HX_STACK_VAR(tmp21,"tmp21");
							HX_STACK_LINE(589)
							if ((tmp21)){
								HX_STACK_LINE(590)
								::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex tmp22 = ::zpp_nape::geom::ZPP_Monotone_obj::edges;		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(590)
								::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex set_ite = tmp22->parent;		HX_STACK_VAR(set_ite,"set_ite");
								HX_STACK_LINE(591)
								while((true)){
									HX_STACK_LINE(591)
									bool tmp23 = (set_ite->prev != null());		HX_STACK_VAR(tmp23,"tmp23");
									HX_STACK_LINE(591)
									bool tmp24 = !(tmp23);		HX_STACK_VAR(tmp24,"tmp24");
									HX_STACK_LINE(591)
									if ((tmp24)){
								...
								while((true)){
									HX_STACK_LINE(592)
									bool tmp23 = (set_ite != null());		HX_STACK_VAR(tmp23,"tmp23");
									HX_STACK_LINE(592)
									bool tmp24 = !(tmp23);		HX_STACK_VAR(tmp24,"tmp24");
									HX_STACK_LINE(592)
									if ((tmp24)){
									...
									{
										HX_STACK_LINE(595)
										::zpp_nape::geom::ZPP_PartitionVertex tmp25 = elt;		HX_STACK_VAR(tmp25,"tmp25");
										HX_STACK_LINE(595)
										::zpp_nape::geom::ZPP_PartitionVertex tmp26 = v;		HX_STACK_VAR(tmp26,"tmp26");
										HX_STACK_LINE(595)
										bool tmp27 = ::zpp_nape::geom::ZPP_PartitionVertex_obj::vert_lt(tmp25,tmp26);		HX_STACK_VAR(tmp27,"tmp27");
										HX_STACK_LINE(595)
									...
									HX_STACK_LINE(600)
									bool tmp25 = (set_ite->next != null());		HX_STACK_VAR(tmp25,"tmp25");
									HX_STACK_LINE(600)
									if ((tmp25)){
										HX_STACK_LINE(601)
										set_ite = set_ite->next;
										...
										while((true)){
											HX_STACK_LINE(602)
											bool tmp26 = (set_ite->prev != null());		HX_STACK_VAR(tmp26,"tmp26");
											HX_STACK_LINE(602)
										...
										while((true)){
											HX_STACK_LINE(605)
											bool tmp26 = (set_ite->parent != null());		HX_STACK_VAR(tmp26,"tmp26");
											HX_STACK_LINE(605)
											bool tmp27;		HX_STACK_VAR(tmp27,"tmp27");
											HX_STACK_LINE(605)
											if ((tmp26)){
												HX_STACK_LINE(605)
												::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex tmp28 = set_ite;		HX_STACK_VAR(tmp28,"tmp28");
												HX_STACK_LINE(605)
												::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex tmp29 = set_ite->parent->next;		HX_STACK_VAR(tmp29,"tmp29");
												HX_STACK_LINE(605)
												::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex tmp30 = tmp29;		HX_STACK_VAR(tmp30,"tmp30");
												HX_STACK_LINE(605)
												tmp27 = (tmp28 == tmp30);
											}
											else{
					...
					HX_STACK_LINE(578)
					::zpp_nape::geom::ZPP_PartitionVertex e1 = tmp18;		HX_STACK_VAR(e1,"e1");
					HX_STACK_LINE(613)
					bool tmp19 = (e1 != null());		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(613)
					if ((tmp19)){
						HX_STACK_LINE(617)
						int tmp20 = e1->helper->type;		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(617)
						...
						if ((tmp21)){
							...
							::zpp_nape::geom::ZPP_PartitionVertex tmp22 = v;		HX_STACK_VAR(tmp22,"tmp22");
							HX_STACK_LINE(618)
							::zpp_nape::geom::ZPP_PartitionVertex tmp23 = e1->helper;		HX_STACK_VAR(tmp23,"tmp23");
							HX_STACK_LINE(618)
				...
				case (int)4: {
					...
					if ((tmp15)){
						HX_STACK_LINE(627)
						int tmp16 = pre->helper->type;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(627)
						bool tmp17 = (tmp16 == (int)2);		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(627)
						if ((tmp17)){
							HX_STACK_LINE(627)
							::zpp_nape::geom::ZPP_PartitionVertex tmp18 = v;		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(627)
							::zpp_nape::geom::ZPP_PartitionVertex tmp19 = pre->helper;		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(627)
							poly->add_diagonal(tmp18,tmp19);
						}
						HX_STACK_LINE(628)
						::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex tmp18 = ::zpp_nape::geom::ZPP_Monotone_obj::edges;		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(628)
						::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex tmp19 = pre->node;		HX_STACK_VAR(tmp19,"tmp19");
						HX_STACK_LINE(628)
						tmp18->remove_node(tmp19);
						HX_STACK_LINE(632)
						::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex tmp20 = ::zpp_nape::geom::ZPP_Monotone_obj::edges;		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(632)
						::zpp_nape::geom::ZPP_PartitionVertex tmp21 = v;		HX_STACK_VAR(tmp21,"tmp21");
						HX_STACK_LINE(632)
						::zpp_nape::util::ZPP_Set_ZPP_PartitionVertex tmp22 = tmp20->insert(tmp21);		HX_STACK_VAR(tmp22,"tmp22");
						HX_STACK_LINE(632)
						v->node = tmp22;
						HX_STACK_LINE(633)
						v->helper = v;
						...
						HX_STACK_LINE(674)
						int tmp17 = e->helper->type;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(674)
						...
						if ((tmp18)){
							...
							HX_STACK_LINE(675)
							::zpp_nape::geom::ZPP_PartitionVertex tmp20 = e->helper;		HX_STACK_VAR(tmp20,"tmp20");
							HX_STACK_LINE(675)
