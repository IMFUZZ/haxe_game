...
::Clock Shared_obj::clock;

::CustomController Shared_obj::controller;

::Darkness Shared_obj::darkness;
...
{
		HX_STACK_FRAME("Shared","init",0x721eed59,"Shared.init","Shared.hx",148,0x60c9b919)
		HX_STACK_LINE(149)
		::Player tmp = ::Player_obj::__new((int)100,(int)100);		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(149)
		::Shared_obj::player = tmp;
		HX_STACK_LINE(150)
		::Clock tmp1 = ::Clock_obj::__new();		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(150)
		::Shared_obj::clock = tmp1;
		HX_STACK_LINE(151)
		::CustomController tmp2 = ::CustomController_obj::__new();		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(151)
		::Shared_obj::controller = tmp2;
		HX_STACK_LINE(152)
		::Darkness tmp3 = ::Darkness_obj::__new((int)0,(int)0);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(152)
		::Shared_obj::darkness = tmp3;
	}
return null();
}
...
bool Shared_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"darkness") ) { outValue = darkness; return true;  }
		break;
	case 10:
...
bool Shared_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"clock") ) { clock=ioValue.Cast< ::Clock >(); return true; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"player") ) { player=ioValue.Cast< ::Player >(); return true; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"darkness") ) { darkness=ioValue.Cast< ::Darkness >(); return true; }
		break;
	case 10:
...
static hx::StaticInfo sStaticStorageInfo[] = {
	...
	{hx::fsObject /*::Clock*/ ,(void *) &Shared_obj::clock,HX_HCSTRING("clock","\xce","\x09","\x63","\x48")},
	{hx::fsObject /*::CustomController*/ ,(void *) &Shared_obj::controller,HX_HCSTRING("controller","\x9c","\x98","\xbe","\x04")},
	{hx::fsObject /*::Darkness*/ ,(void *) &Shared_obj::darkness,HX_HCSTRING("darkness","\x0d","\x48","\xe8","\x92")},
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(Shared_obj::darkness,"darkness");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Shared_obj::darkness,"darkness");
...
struct _Function_0_1{
	inline static ::haxe::ds::IntMap Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","Shared.hx",12,0x60c9b919)
		{
			HX_STACK_LINE(12)
...
struct _Function_0_2{
	inline static ::haxe::ds::IntMap Block( ){
		HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","Shared.hx",109,0x60c9b919)
		{
			HX_STACK_LINE(109)
			::haxe::ds::IntMap tmp;		HX_STACK_VAR(tmp,"tmp");
			HX_STACK_LINE(109)
