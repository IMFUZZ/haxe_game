...
::nape::shape::Edge EdgeList_obj::at( int index){
		...
		HX_STACK_LINE(370)
		{
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(370)
				{
					...
					HX_STACK_LINE(370)
					int tmp10 = tmp9->inner->length;		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(370)
					::zpp_nape::util::ZPP_EdgeList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(370)
					tmp11->user_length = tmp10;
				}
			}
			HX_STACK_LINE(370)
			::zpp_nape::util::ZPP_EdgeList tmp8 = this->zpp_inner;		HX_STACK_VAR(tmp8,"tmp8");
	...
	if ((tmp3)){
		...
		if ((tmp8)){
			...
			::zpp_nape::util::ZPP_EdgeList tmp10 = this->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZPP_EdgeList tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZNPNode_ZPP_Edge tmp12 = tmp11->at_ite;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(372)
			tmp9 = (tmp12 == null());
		}
		else{
		...
		if ((tmp9)){
			...
			HX_STACK_LINE(374)
			::zpp_nape::util::ZNPNode_ZPP_Edge tmp13 = tmp11->inner->iterator_at(tmp12);		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(374)
			...
			while((true)){
				...
				HX_STACK_LINE(379)
				::zpp_nape::util::ZNPNode_ZPP_Edge tmp17 = tmp16->at_ite->next;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(379)
		...
		if ((tmp9)){
			...
			::zpp_nape::util::ZPP_EdgeList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(386)
			::zpp_nape::util::ZNPNode_ZPP_Edge tmp12 = tmp11->inner->head;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(386)
			::zpp_nape::util::ZPP_EdgeList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(386)
			tmp13->at_ite = tmp12;
			...
			while((true)){
				...
				::zpp_nape::util::ZPP_EdgeList tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(388)
				::zpp_nape::shape::ZPP_Edge tmp15 = tmp14->at_ite->elt;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(388)
				::zpp_nape::shape::ZPP_Edge x = tmp15;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(389)
				break;
				HX_STACK_LINE(390)
				::zpp_nape::util::ZPP_EdgeList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
		...
		while((true)){
			...
			while((true)){
				...
				HX_STACK_LINE(397)
				::zpp_nape::shape::ZPP_Edge tmp20 = tmp19->at_ite->elt;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(397)
				::zpp_nape::shape::ZPP_Edge x = tmp20;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(398)
				break;
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_EdgeList tmp21 = this->zpp_inner;		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZNPNode_ZPP_Edge tmp22 = tmp21->at_ite->next;		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(399)
	...
	::zpp_nape::util::ZPP_EdgeList tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(403)
	::zpp_nape::shape::ZPP_Edge tmp5 = tmp4->at_ite->elt;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(403)
	::nape::shape::Edge tmp6 = tmp5->wrapper();		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(403)
	return tmp6;
}
...
bool EdgeList_obj::push( ::nape::shape::Edge obj){
	...
	if ((tmp4)){
		...
		::zpp_nape::util::ZPP_EdgeList tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(424)
		::nape::shape::Edge tmp7 = obj;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(424)
	...
	if ((tmp6)){
		...
		if ((tmp8)){
			...
			::zpp_nape::util::ZPP_EdgeList tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(426)
			::zpp_nape::shape::ZPP_Edge tmp10 = obj->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(426)
			...
			::zpp_nape::util::ZPP_EdgeList tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(428)
			::zpp_nape::util::ZNPNode_ZPP_Edge tmp10 = tmp9->push_ite;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(428)
			...
			if ((tmp11)){
				...
				HX_STACK_LINE(428)
				{
					...
					::zpp_nape::util::ZPP_EdgeList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(428)
					::zpp_nape::util::ZNPNode_ZPP_Edge tmp14 = tmp13->inner->head;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(428)
					tmp12 = (tmp14 == null());
				}
				HX_STACK_LINE(428)
			...
			::zpp_nape::util::ZPP_EdgeList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_Edge tmp14 = tmp13->push_ite;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(429)
			::zpp_nape::shape::ZPP_Edge tmp15 = obj->zpp_inner;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_Edge tmp16 = tmp12->inner->insert(tmp14,tmp15);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZPP_EdgeList tmp17 = this->zpp_inner;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(429)
		...
		if ((tmp12)){
			...
			::zpp_nape::util::ZPP_EdgeList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(432)
			::nape::shape::Edge tmp14 = obj;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(432)
...
::nape::shape::Edge EdgeList_obj::pop( ){
	...
	if ((tmp3)){
		...
		ret = tmp5->elt;
		HX_STACK_LINE(492)
		::nape::shape::Edge tmp6 = ret->wrapper();		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(492)
		::nape::shape::Edge retx = tmp6;		HX_STACK_VAR(retx,"retx");
		HX_STACK_LINE(493)
		::zpp_nape::util::ZPP_EdgeList tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(493)
		...
		if ((tmp9)){
			...
			::zpp_nape::util::ZPP_EdgeList tmp10 = this->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(493)
			::nape::shape::Edge tmp11 = retx;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(493)
			tmp10->subber(tmp11);
		}
		HX_STACK_LINE(494)
		...
		::zpp_nape::util::ZPP_EdgeList tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(497)
		::zpp_nape::util::ZNPNode_ZPP_Edge tmp5 = tmp4->at_ite;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(497)
		...
		if ((tmp6)){
			...
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ZPP_Edge tmp10 = tmp9->at_ite->next;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ZPP_Edge tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(497)
			tmp7 = (tmp11 == null());
		}
		else{
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_Edge tmp10;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(498)
		if ((tmp9)){
			HX_STACK_LINE(498)
			tmp10 = null();
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_Edge ite = tmp10;		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(499)
		bool tmp11 = (ite == null());		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(499)
		::zpp_nape::shape::ZPP_Edge tmp12;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(499)
		if ((tmp11)){
			HX_STACK_LINE(499)
			::zpp_nape::util::ZPP_EdgeList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
		...
		ret = tmp12;
		HX_STACK_LINE(500)
		::nape::shape::Edge tmp13 = ret->wrapper();		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(500)
		::nape::shape::Edge retx = tmp13;		HX_STACK_VAR(retx,"retx");
		HX_STACK_LINE(501)
		::zpp_nape::util::ZPP_EdgeList tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(501)
		...
		if ((tmp16)){
			...
			::zpp_nape::util::ZPP_EdgeList tmp17 = this->zpp_inner;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(501)
			::nape::shape::Edge tmp18 = retx;		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(501)
			tmp17->subber(tmp18);
		}
		HX_STACK_LINE(502)
		...
		if ((tmp19)){
			...
			::zpp_nape::util::ZPP_EdgeList tmp20 = this->zpp_inner;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(502)
			::zpp_nape::util::ZNPNode_ZPP_Edge tmp21 = ite;		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(502)
	...
	tmp4->invalidate();
	HX_STACK_LINE(505)
	::nape::shape::Edge tmp5 = ret->wrapper();		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(505)
	::nape::shape::Edge retx = tmp5;		HX_STACK_VAR(retx,"retx");
	HX_STACK_LINE(506)
	::nape::shape::Edge tmp6 = retx;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(506)
	return tmp6;
}
...
bool EdgeList_obj::remove( ::nape::shape::Edge obj){
	...
	HX_STACK_LINE(585)
	{
		...
		HX_STACK_LINE(587)
		{
			...
			::zpp_nape::util::ZPP_EdgeList tmp2 = this->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_ZPP_Edge tmp3 = tmp2->inner->head;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_ZPP_Edge cx_ite = tmp3;		HX_STACK_VAR(cx_ite,"cx_ite");
			HX_STACK_LINE(589)
			while((true)){
				HX_STACK_LINE(589)
		...
		if ((tmp1)){
			...
			while((true)){
				...
				HX_STACK_LINE(619)
				{
					...
					::zpp_nape::util::ZPP_EdgeList tmp3 = this->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
					HX_STACK_LINE(619)
					::zpp_nape::util::ZNPNode_ZPP_Edge tmp4 = tmp3->inner->head;		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(619)
					tmp2 = (tmp4 == null());
				}
				HX_STACK_LINE(619)
...
Void EdgeList_obj::merge( ::nape::shape::EdgeList xs){
{
		...
		HX_STACK_LINE(688)
		{
			...
			xs->zpp_inner->valmod();
			HX_STACK_LINE(688)
			::nape::shape::EdgeList tmp1 = xs;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(688)
			tmp = ::nape::shape::EdgeIterator_obj::get(tmp1);
		}
		HX_STACK_LINE(688)
		...
		while((true)){
			...
			HX_STACK_LINE(688)
			::nape::shape::Edge x = tmp3;		HX_STACK_VAR(x,"x");
			HX_STACK_LINE(689)
			::nape::shape::Edge tmp4 = x;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(689)
...
::nape::shape::EdgeList EdgeList_obj::foreach( Dynamic lambda){
	...
	HX_STACK_LINE(736)
	::nape::shape::EdgeIterator it = tmp;		HX_STACK_VAR(it,"it");
	HX_STACK_LINE(737)
	while((true)){
		HX_STACK_LINE(737)
		bool tmp1;		HX_STACK_VAR(tmp1,"tmp1");
		...
		{
			HX_STACK_LINE(737)
			::zpp_nape::util::ZPP_EdgeList tmp2 = it->zpp_inner->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(737)
			tmp2->valmod();
			HX_STACK_LINE(737)
			int tmp3;		HX_STACK_VAR(tmp3,"tmp3");
...
::nape::shape::EdgeList EdgeList_obj::filter( Dynamic lambda){
	...
	while((true)){
		...
		HX_STACK_LINE(785)
		::nape::shape::Edge tmp5 = this->at(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(785)
		::nape::shape::Edge x = tmp5;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(786)
		try
		{
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			HX_STACK_LINE(787)
			::nape::shape::Edge tmp6 = x;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(787)
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(788)
				::nape::shape::Edge tmp8 = x;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(788)
				this->remove(tmp8);
			}
		}
