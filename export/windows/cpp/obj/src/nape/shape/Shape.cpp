			...
			HX_STACK_LINE(319)
			{
				...
				if ((tmp4)){
					...
					if ((tmp8)){
						...
						::zpp_nape::shape::ZPP_Shape tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(319)
						tmp9->circle->setupLocalCOM();
					}
					else{
						HX_STACK_LINE(319)
						::zpp_nape::shape::ZPP_Shape tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(319)
						tmp9->polygon->setupLocalCOM();
					}
				}
				HX_STACK_LINE(319)
				::zpp_nape::shape::ZPP_Shape tmp5 = this->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(319)
				tmp1 = tmp5->wrap_localCOM;
			}
			HX_STACK_LINE(319)
...
::nape::phys::Material Shape_obj::set_material( ::nape::phys::Material material){
	...
	HX_STACK_LINE(361)
	{
		...
		::zpp_nape::shape::ZPP_Shape tmp1 = this->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(366)
		::zpp_nape::phys::ZPP_Material tmp2 = material->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(366)
		tmp1->setMaterial(tmp2);
	}
	HX_STACK_LINE(368)
	::zpp_nape::shape::ZPP_Shape tmp = this->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(368)
...
::nape::dynamics::InteractionFilter Shape_obj::set_filter( ::nape::dynamics::InteractionFilter filter){
	...
	HX_STACK_LINE(381)
	{
		...
		::zpp_nape::shape::ZPP_Shape tmp1 = this->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(386)
		::zpp_nape::dynamics::ZPP_InteractionFilter tmp2 = filter->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(386)
		tmp1->setFilter(tmp2);
	}
	HX_STACK_LINE(388)
...
::nape::phys::FluidProperties Shape_obj::set_fluidProperties( ::nape::phys::FluidProperties fluidProperties){
	...
	HX_STACK_LINE(406)
	{
		...
		::zpp_nape::shape::ZPP_Shape tmp = this->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(410)
		::zpp_nape::phys::ZPP_FluidProperties tmp1 = fluidProperties->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(410)
		tmp->setFluid(tmp1);
	}
	HX_STACK_LINE(412)
...
::nape::shape::Shape Shape_obj::translate( ::nape::geom::Vec2 translation){
	...
	HX_STACK_LINE(500)
	Float tmp1 = translation->lsq();		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(500)
	...
	if ((tmp2)){
		...
		if ((tmp6)){
			...
			HX_STACK_LINE(501)
			{
				...
				HX_STACK_LINE(501)
				tmp9 = translation->zpp_inner->y;
			}
			HX_STACK_LINE(501)
			tmp7->circle->__translate(tmp8,tmp9);
		}
		else{
			HX_STACK_LINE(502)
			::zpp_nape::shape::ZPP_Shape tmp7 = this->zpp_inner;		HX_STACK_VAR(tmp7,"tmp7");
			...
			HX_STACK_LINE(502)
			tmp7->polygon->__translate(tmp8,tmp9);
		}
	}
	HX_STACK_LINE(504)
	{
		...
		bool tmp3;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(506)
		tmp3 = translation->zpp_inner->weak;
		HX_STACK_LINE(505)
		if ((tmp3)){
			HX_STACK_LINE(508)
			{
...
::nape::shape::Shape Shape_obj::scale( Float scalex,Float scaley){
	...
	if ((tmp4)){
		HX_STACK_LINE(537)
		Float tmp5 = (scalex * scalex);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(537)
		Float tmp6 = (scaley * scaley);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(537)
		Float tmp7 = (tmp5 - tmp6);		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(537)
		Float d = tmp7;		HX_STACK_VAR(d,"d");
		HX_STACK_LINE(538)
		Float tmp8 = (d * d);		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(538)
		...
		if ((tmp12)){
			...
			HX_STACK_LINE(539)
			Float tmp14 = scalex;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(539)
			Float tmp15 = scaley;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(539)
			tmp13->circle->__scale(tmp14,tmp15);
		}
		else{
		}
	}
		...
		HX_STACK_LINE(547)
		Float tmp7 = scaley;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(547)
		tmp5->polygon->__scale(tmp6,tmp7);
	}
	HX_STACK_LINE(548)
	return hx::ObjectPtr<OBJ_>(this);
}
...
::nape::shape::Shape Shape_obj::rotate( Float angle){
	...
	HX_STACK_LINE(565)
	Float tmp3 = ((int)2 * tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(565)
	Float tmp4 = hx::Mod(tmp1,tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(565)
	Float dr = tmp4;		HX_STACK_VAR(dr,"dr");
	HX_STACK_LINE(566)
	bool tmp5 = (dr != ((Float)0.0));		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(566)
	if ((tmp5)){
		HX_STACK_LINE(567)
		...
		if ((tmp13)){
			...
			::zpp_nape::shape::ZPP_Shape tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(569)
			Float tmp15 = sin;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(569)
			Float tmp16 = cos;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(569)
			tmp14->circle->__rotate(tmp15,tmp16);
		}
		else{
			HX_STACK_LINE(570)
			::zpp_nape::shape::ZPP_Shape tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
			...
			Float tmp16 = cos;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(570)
			tmp14->polygon->__rotate(tmp15,tmp16);
		}
	}
	HX_STACK_LINE(572)
	return hx::ObjectPtr<OBJ_>(this);
...
::nape::shape::Shape Shape_obj::transform( ::nape::geom::Mat23 matrix){
	...
	if ((tmp4)){
		HX_STACK_LINE(594)
		bool tmp5 = matrix->equiorthogonal();		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(594)
		if ((tmp5)){
			HX_STACK_LINE(595)
			::zpp_nape::shape::ZPP_Shape tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
		...
		::zpp_nape::shape::ZPP_Shape tmp5 = this->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(603)
		::nape::geom::Mat23 tmp6 = matrix;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(603)
		tmp5->polygon->__transform(tmp6);
	}
	HX_STACK_LINE(604)
	return hx::ObjectPtr<OBJ_>(this);
}
...
bool Shape_obj::contains( ::nape::geom::Vec2 point){
	...
	::zpp_nape::shape::ZPP_Shape tmp1 = this->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(632)
	::zpp_nape::geom::ZPP_Vec2 tmp2 = point->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(632)
	bool tmp3 = ::zpp_nape::geom::ZPP_Collide_obj::shapeContains(tmp1,tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(632)
	bool ret = tmp3;		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(633)
	{
		HX_STACK_LINE(634)
		bool tmp4;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(635)
		tmp4 = point->zpp_inner->weak;
		HX_STACK_LINE(634)
		if ((tmp4)){
			HX_STACK_LINE(637)
			{
