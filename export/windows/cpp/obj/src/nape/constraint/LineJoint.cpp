	...
	HX_STACK_LINE(446)
	{
		HX_STACK_LINE(446)
		{
			...
			HX_STACK_LINE(446)
			{
				...
				::zpp_nape::constraint::ZPP_LineJoint tmp5 = this->zpp_inner_zn;		HX_STACK_VAR(tmp5,"tmp5");
				HX_STACK_LINE(446)
				::nape::geom::Vec2 tmp6 = tmp5->wrap_n;		HX_STACK_VAR(tmp6,"tmp6");
				HX_STACK_LINE(446)
				bool tmp7 = (tmp6 == null());		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(446)
				if ((tmp7)){
...
::nape::geom::MatMN LineJoint_obj::impulse( ){
	...
	HX_STACK_LINE(459)
	::nape::geom::MatMN tmp11 = ret;		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(459)
	return tmp11;
}
