...
Float ratio = __o_ratio.Default(((Float)1.0));
{
	...
	HX_STACK_LINE(340)
	{
		HX_STACK_LINE(340)
		{
			...
			HX_STACK_LINE(340)
			Float tmp6 = tmp5->rate;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(340)
			Float tmp7 = rate;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(340)
...
Float MotorJoint_obj::set_rate( Float rate){
	...
	HX_STACK_LINE(300)
	{
		...
		::zpp_nape::constraint::ZPP_MotorJoint tmp1 = this->zpp_inner_zn;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(307)
		Float tmp2 = tmp1->rate;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(307)
		Float tmp3 = rate;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(307)
		bool tmp4 = (tmp2 != tmp3);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(307)
		if ((tmp4)){
