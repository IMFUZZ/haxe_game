...
::nape::callbacks::CbEvent Listener_obj::set_event( ::nape::callbacks::CbEvent event){
	...
	HX_STACK_LINE(199)
	{
		...
		if ((tmp4)){
			...
			if ((tmp7)){
				HX_STACK_LINE(206)
				tmp8 = ::zpp_nape::util::ZPP_Flags_obj::id_CbEvent_BEGIN;
			}
			else{
				HX_STACK_LINE(206)
				::nape::callbacks::CbEvent tmp9 = event;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(206)
				::nape::callbacks::CbEvent tmp10;		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(206)
				{
					HX_STACK_LINE(206)
					::nape::callbacks::CbEvent tmp11 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_ONGOING;		HX_STACK_VAR(tmp11,"tmp11");
					HX_STACK_LINE(206)
					...
					if ((tmp12)){
						...
						HX_STACK_LINE(206)
						::zpp_nape::util::ZPP_Flags_obj::CbEvent_ONGOING = tmp13;
						HX_STACK_LINE(206)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(206)
					tmp10 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_ONGOING;
				}
				HX_STACK_LINE(206)
				...
				if ((tmp11)){
					HX_STACK_LINE(206)
					tmp8 = ::zpp_nape::util::ZPP_Flags_obj::id_CbEvent_ONGOING;
				}
				else{
					HX_STACK_LINE(206)
					::nape::callbacks::CbEvent tmp12 = event;		HX_STACK_VAR(tmp12,"tmp12");
					HX_STACK_LINE(206)
					::nape::callbacks::CbEvent tmp13;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(206)
					{
						HX_STACK_LINE(206)
						::nape::callbacks::CbEvent tmp14 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_END;		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(206)
						...
						if ((tmp15)){
							...
							::zpp_nape::util::ZPP_Flags_obj::internal = true;
							HX_STACK_LINE(206)
							::nape::callbacks::CbEvent tmp16 = ::nape::callbacks::CbEvent_obj::__new();		HX_STACK_VAR(tmp16,"tmp16");
							HX_STACK_LINE(206)
							::zpp_nape::util::ZPP_Flags_obj::CbEvent_END = tmp16;
							HX_STACK_LINE(206)
							::zpp_nape::util::ZPP_Flags_obj::internal = false;
						}
						HX_STACK_LINE(206)
						tmp13 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_END;
					}
					HX_STACK_LINE(206)
					...
					if ((tmp14)){
						HX_STACK_LINE(206)
						tmp8 = ::zpp_nape::util::ZPP_Flags_obj::id_CbEvent_END;
					}
					else{
						HX_STACK_LINE(206)
						::nape::callbacks::CbEvent tmp15 = event;		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(206)
						::nape::callbacks::CbEvent tmp16;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(206)
						{
							HX_STACK_LINE(206)
							::nape::callbacks::CbEvent tmp17 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_SLEEP;		HX_STACK_VAR(tmp17,"tmp17");
							HX_STACK_LINE(206)
							...
							if ((tmp18)){
								...
								::zpp_nape::util::ZPP_Flags_obj::internal = true;
								HX_STACK_LINE(206)
								::nape::callbacks::CbEvent tmp19 = ::nape::callbacks::CbEvent_obj::__new();		HX_STACK_VAR(tmp19,"tmp19");
								HX_STACK_LINE(206)
								::zpp_nape::util::ZPP_Flags_obj::CbEvent_SLEEP = tmp19;
								HX_STACK_LINE(206)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(206)
							tmp16 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_SLEEP;
						}
						HX_STACK_LINE(206)
						...
						if ((tmp17)){
							HX_STACK_LINE(206)
							tmp8 = ::zpp_nape::util::ZPP_Flags_obj::id_CbEvent_SLEEP;
						}
						else{
							HX_STACK_LINE(206)
							::nape::callbacks::CbEvent tmp18 = event;		HX_STACK_VAR(tmp18,"tmp18");
							HX_STACK_LINE(206)
							::nape::callbacks::CbEvent tmp19;		HX_STACK_VAR(tmp19,"tmp19");
							HX_STACK_LINE(206)
							{
								HX_STACK_LINE(206)
								::nape::callbacks::CbEvent tmp20 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_WAKE;		HX_STACK_VAR(tmp20,"tmp20");
								HX_STACK_LINE(206)
								...
								if ((tmp21)){
									...
									::zpp_nape::util::ZPP_Flags_obj::internal = true;
									HX_STACK_LINE(206)
									::nape::callbacks::CbEvent tmp22 = ::nape::callbacks::CbEvent_obj::__new();		HX_STACK_VAR(tmp22,"tmp22");
									HX_STACK_LINE(206)
									::zpp_nape::util::ZPP_Flags_obj::CbEvent_WAKE = tmp22;
									HX_STACK_LINE(206)
									::zpp_nape::util::ZPP_Flags_obj::internal = false;
								}
								HX_STACK_LINE(206)
								tmp19 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_WAKE;
							}
							HX_STACK_LINE(206)
							...
							if ((tmp20)){
								HX_STACK_LINE(206)
								tmp8 = ::zpp_nape::util::ZPP_Flags_obj::id_CbEvent_WAKE;
							}
							else{
								HX_STACK_LINE(206)
								::nape::callbacks::CbEvent tmp21 = event;		HX_STACK_VAR(tmp21,"tmp21");
								HX_STACK_LINE(206)
								::nape::callbacks::CbEvent tmp22;		HX_STACK_VAR(tmp22,"tmp22");
								HX_STACK_LINE(206)
								{
									HX_STACK_LINE(206)
									::nape::callbacks::CbEvent tmp23 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_PRE;		HX_STACK_VAR(tmp23,"tmp23");
									HX_STACK_LINE(206)
									...
									if ((tmp24)){
										...
										::zpp_nape::util::ZPP_Flags_obj::internal = true;
										HX_STACK_LINE(206)
										::nape::callbacks::CbEvent tmp25 = ::nape::callbacks::CbEvent_obj::__new();		HX_STACK_VAR(tmp25,"tmp25");
										HX_STACK_LINE(206)
										::zpp_nape::util::ZPP_Flags_obj::CbEvent_PRE = tmp25;
										HX_STACK_LINE(206)
										::zpp_nape::util::ZPP_Flags_obj::internal = false;
									}
									HX_STACK_LINE(206)
									tmp22 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_PRE;
								}
								HX_STACK_LINE(206)
								...
								if ((tmp23)){
									HX_STACK_LINE(206)
									tmp8 = ::zpp_nape::util::ZPP_Flags_obj::id_CbEvent_PRE;
								}
								else{
									HX_STACK_LINE(206)
									tmp8 = ::zpp_nape::util::ZPP_Flags_obj::id_CbEvent_BREAK;
								}
							}
						}
					}
			...
			HX_STACK_LINE(206)
			int xevent = tmp8;		HX_STACK_VAR(xevent,"xevent");
			HX_STACK_LINE(207)
			::zpp_nape::callbacks::ZPP_Listener tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(207)
			int tmp10 = xevent;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(207)
			tmp9->swapEvent(tmp10);
		}
	}
	HX_STACK_LINE(210)
	::zpp_nape::callbacks::ZPP_Listener tmp = this->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
...
::String Listener_obj::toString( ){
	...
	HX_STACK_LINE(278)
	int tmp5 = ::zpp_nape::util::ZPP_Flags_obj::id_ListenerType_BODY;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(278)
	...
	if ((tmp6)){
		...
		HX_STACK_LINE(279)
		::zpp_nape::callbacks::ZPP_BodyListener body = tmp7->body;		HX_STACK_VAR(body,"body");
		HX_STACK_LINE(280)
		::String tmp8 = (HX_HCSTRING("BodyListener{","\x65","\xb6","\x16","\x4d") + event);		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(280)
		::String tmp9 = (tmp8 + HX_HCSTRING("::","\xc0","\x32","\x00","\x00"));		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(280)
		::zpp_nape::callbacks::ZPP_BodyListener tmp10 = body->outer_zn->zpp_inner_zn;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(280)
		::nape::callbacks::OptionType tmp11 = tmp10->options->outer;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(280)
		...
		HX_STACK_LINE(282)
		int tmp9 = ::zpp_nape::util::ZPP_Flags_obj::id_ListenerType_CONSTRAINT;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(282)
		...
		if ((tmp10)){
			...
			HX_STACK_LINE(283)
			::zpp_nape::callbacks::ZPP_ConstraintListener con = tmp11->constraint;		HX_STACK_VAR(con,"con");
			HX_STACK_LINE(284)
			::String tmp12 = (HX_HCSTRING("ConstraintListener{","\x4a","\x49","\x80","\xba") + event);		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(284)
			::String tmp13 = (tmp12 + HX_HCSTRING("::","\xc0","\x32","\x00","\x00"));		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(284)
			::zpp_nape::callbacks::ZPP_ConstraintListener tmp14 = con->outer_zn->zpp_inner_zn;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(284)
			::nape::callbacks::OptionType tmp15 = tmp14->options->outer;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(284)
			::String tmp16 = ::Std_obj::string(tmp15);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(284)
			::String tmp17 = (tmp13 + tmp16);		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(284)
			::String tmp18 = (tmp17 + HX_HCSTRING("}","\x7d","\x00","\x00","\x00"));		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(284)
			return tmp18;
		}
		else{
			...
			::zpp_nape::callbacks::ZPP_Listener tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(287)
			::zpp_nape::callbacks::ZPP_InteractionListener con = tmp11->interaction;		HX_STACK_VAR(con,"con");
			HX_STACK_LINE(288)
			...
			HX_STACK_LINE(288)
			{
				...
				switch( (int)(tmp13)){
					case (int)1: {
						HX_STACK_LINE(289)
						tmp12 = HX_HCSTRING("COLLISION","\x52","\x18","\x93","\xd6");
					}
					;break;
					case (int)2: {
						HX_STACK_LINE(290)
						tmp12 = HX_HCSTRING("SENSOR","\x3a","\xde","\x12","\x1e");
					}
					;break;
					case (int)4: {
						HX_STACK_LINE(291)
						tmp12 = HX_HCSTRING("FLUID","\xea","\x91","\x89","\x80");
					}
					;break;
					default: {
						HX_STACK_LINE(292)
						tmp12 = HX_HCSTRING("ALL","\x01","\x95","\x31","\x00");
					}
				}
			}
			HX_STACK_LINE(288)
			::String itype = tmp12;		HX_STACK_VAR(itype,"itype");
			HX_STACK_LINE(294)
			...
			HX_STACK_LINE(294)
			int tmp15 = ::zpp_nape::util::ZPP_Flags_obj::id_ListenerType_INTERACTION;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(294)
			...
			if ((tmp16)){
				HX_STACK_LINE(294)
				::String tmp18 = (HX_HCSTRING("InteractionListener{","\x75","\xef","\x2a","\x76") + event);		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(294)
				::String tmp19 = (tmp18 + HX_HCSTRING("#","\x23","\x00","\x00","\x00"));		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(294)
				::String tmp20 = itype;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(294)
				::String tmp21 = (tmp19 + tmp20);		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(294)
				::String tmp22 = (tmp21 + HX_HCSTRING("::","\xc0","\x32","\x00","\x00"));		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(294)
				::zpp_nape::callbacks::ZPP_InteractionListener tmp23 = con->outer_zni->zpp_inner_zn;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(294)
				::nape::callbacks::OptionType tmp24 = tmp23->options1->outer;		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(294)
				::String tmp25 = ::Std_obj::string(tmp24);		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(294)
				::String tmp26 = (tmp22 + tmp25);		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(294)
				::String tmp27 = (tmp26 + HX_HCSTRING(":","\x3a","\x00","\x00","\x00"));		HX_STACK_VAR(tmp27,"tmp27");
				HX_STACK_LINE(294)
				::zpp_nape::callbacks::ZPP_InteractionListener tmp28 = con->outer_zni->zpp_inner_zn;		HX_STACK_VAR(tmp28,"tmp28");
				HX_STACK_LINE(294)
				::nape::callbacks::OptionType tmp29 = tmp28->options2->outer;		HX_STACK_VAR(tmp29,"tmp29");
				HX_STACK_LINE(294)
				::String tmp30 = ::Std_obj::string(tmp29);		HX_STACK_VAR(tmp30,"tmp30");
				HX_STACK_LINE(294)
				::String tmp31 = (tmp27 + tmp30);		HX_STACK_VAR(tmp31,"tmp31");
				HX_STACK_LINE(294)
				tmp17 = (tmp31 + HX_HCSTRING("}","\x7d","\x00","\x00","\x00"));
			}
			else{
				HX_STACK_LINE(294)
				::String tmp18 = (HX_HCSTRING("PreListener{","\x04","\x95","\xa0","\x61") + itype);		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(294)
				::String tmp19 = (tmp18 + HX_HCSTRING("::","\xc0","\x32","\x00","\x00"));		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(294)
				::zpp_nape::callbacks::ZPP_InteractionListener tmp20 = con->outer_znp->zpp_inner_zn;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(294)
				...
				HX_STACK_LINE(294)
				::zpp_nape::callbacks::ZPP_InteractionListener tmp25 = con->outer_znp->zpp_inner_zn;		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(294)
				...
				HX_STACK_LINE(294)
				tmp17 = (tmp28 + HX_HCSTRING("}","\x7d","\x00","\x00","\x00"));
			}
			HX_STACK_LINE(294)
			::String tmp18 = (tmp17 + HX_HCSTRING(" precedence=","\xd3","\x06","\x48","\x66"));		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(294)
			::zpp_nape::callbacks::ZPP_Listener tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(294)
			int tmp20 = tmp19->precedence;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(294)
