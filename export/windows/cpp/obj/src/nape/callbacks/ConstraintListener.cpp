...
int precedence = __o_precedence.Default(0);
{
	...
	HX_STACK_LINE(262)
	{
		...
		if ((tmp3)){
			...
			HX_STACK_LINE(262)
			::zpp_nape::util::ZPP_Flags_obj::CbEvent_WAKE = tmp4;
			HX_STACK_LINE(262)
			::zpp_nape::util::ZPP_Flags_obj::internal = false;
		}
		HX_STACK_LINE(262)
		tmp1 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_WAKE;
	}
	HX_STACK_LINE(262)
	...
	if ((tmp2)){
		...
		{
			HX_STACK_LINE(263)
			::nape::callbacks::CbEvent tmp5 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_SLEEP;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(263)
			...
			if ((tmp6)){
				...
				HX_STACK_LINE(263)
				::zpp_nape::util::ZPP_Flags_obj::CbEvent_SLEEP = tmp7;
				HX_STACK_LINE(263)
				::zpp_nape::util::ZPP_Flags_obj::internal = false;
			}
			HX_STACK_LINE(263)
			tmp4 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_SLEEP;
		}
		HX_STACK_LINE(263)
		...
		if ((tmp5)){
			...
			{
				HX_STACK_LINE(264)
				::nape::callbacks::CbEvent tmp8 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_BREAK;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(264)
				...
				if ((tmp9)){
					...
					HX_STACK_LINE(264)
					::zpp_nape::util::ZPP_Flags_obj::CbEvent_BREAK = tmp10;
					HX_STACK_LINE(264)
					::zpp_nape::util::ZPP_Flags_obj::internal = false;
				}
				HX_STACK_LINE(264)
				tmp7 = ::zpp_nape::util::ZPP_Flags_obj::CbEvent_BREAK;
			}
			HX_STACK_LINE(264)
	...
	HX_STACK_LINE(270)
	Dynamic tmp3 = options;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(270)
	::nape::callbacks::OptionType tmp4 = ::zpp_nape::callbacks::ZPP_OptionType_obj::argument(tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(270)
	int tmp5 = xevent;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(270)
	Dynamic tmp6 = handler;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(270)
	::zpp_nape::callbacks::ZPP_ConstraintListener tmp7 = ::zpp_nape::callbacks::ZPP_ConstraintListener_obj::__new(tmp4,tmp5,tmp6);		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(270)
	this->zpp_inner_zn = tmp7;
	HX_STACK_LINE(271)
	::zpp_nape::callbacks::ZPP_ConstraintListener tmp8 = this->zpp_inner_zn;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(271)
	this->zpp_inner = tmp8;
	HX_STACK_LINE(272)
	...
	HX_STACK_LINE(273)
	::zpp_nape::callbacks::ZPP_ConstraintListener tmp10 = this->zpp_inner_zn;		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(273)
	tmp10->outer_zn = hx::ObjectPtr<OBJ_>(this);
	HX_STACK_LINE(274)
