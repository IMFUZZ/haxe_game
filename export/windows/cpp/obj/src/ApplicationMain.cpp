...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(29)
		::openfl::_legacy::Lib_obj::setPackage(HX_HCSTRING("HaxeFlixel","\x42","\x8f","\x0c","\xac"),HX_HCSTRING("haxeflixel_experimentation","\x1b","\xdf","\x6f","\x1e"),HX_HCSTRING("com.example.myapp","\x84","\x30","\x57","\xc1"),HX_HCSTRING("0.0.1","\x35","\x3d","\xc8","\xc1"));
		HX_STACK_LINE(133)
		...
		HX_STACK_LINE(52)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)1280,(int)720,(int)60,(int)0,tmp22,HX_HCSTRING("haxeflixel_experimentation","\x1b","\xdf","\x6f","\x1e"),null(),null());
	}
return null();
}
