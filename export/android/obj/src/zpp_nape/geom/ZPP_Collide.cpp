										...
										HX_STACK_LINE(2130)
										{
											...
											if ((tmp29)){
												...
												if ((tmp32)){
													...
													HX_STACK_LINE(2130)
													::zpp_nape::geom::ZPP_Vec2 tmp34 = tmp33->next;		HX_STACK_VAR(tmp34,"tmp34");
													HX_STACK_LINE(2130)
													...
													if ((tmp35)){
														...
														::zpp_nape::geom::ZPP_Vec2 tmp36 = _this1->lverts->next;		HX_STACK_VAR(tmp36,"tmp36");
														HX_STACK_LINE(2130)
														::zpp_nape::geom::ZPP_Vec2 tmp37 = tmp36->next->next;		HX_STACK_VAR(tmp37,"tmp37");
														HX_STACK_LINE(2130)
														...
														if ((tmp38)){
															HX_STACK_LINE(2130)
															{
																...
																HX_STACK_LINE(2130)
																_this1->localCOMx = tmp39->x;
																HX_STACK_LINE(2130)
																::zpp_nape::geom::ZPP_Vec2 tmp40 = _this1->lverts->next;		HX_STACK_VAR(tmp40,"tmp40");
																HX_STACK_LINE(2130)
																_this1->localCOMy = tmp40->y;
																HX_STACK_LINE(2130)
																{
																}
															}
															HX_STACK_LINE(2130)
															{
																...
																::zpp_nape::geom::ZPP_Vec2 tmp39 = _this1->lverts->next;		HX_STACK_VAR(tmp39,"tmp39");
																HX_STACK_LINE(2130)
																Float tmp40 = tmp39->next->x;		HX_STACK_VAR(tmp40,"tmp40");
																HX_STACK_LINE(2130)
																...
																HX_STACK_LINE(2130)
																::zpp_nape::geom::ZPP_Vec2 tmp43 = _this1->lverts->next;		HX_STACK_VAR(tmp43,"tmp43");
																HX_STACK_LINE(2130)
																Float tmp44 = tmp43->next->y;		HX_STACK_VAR(tmp44,"tmp44");
																HX_STACK_LINE(2130)
															...
															HX_STACK_LINE(2130)
															{
																...
																::zpp_nape::geom::ZPP_Vec2 tmp39 = _this1->lverts->next;		HX_STACK_VAR(tmp39,"tmp39");
																HX_STACK_LINE(2130)
																::zpp_nape::geom::ZPP_Vec2 cx_ite = tmp39;		HX_STACK_VAR(cx_ite,"cx_ite");
																HX_STACK_LINE(2130)
																::zpp_nape::geom::ZPP_Vec2 u = cx_ite;		HX_STACK_VAR(u,"u");
																HX_STACK_LINE(2130)
																cx_ite = cx_ite->next;
																...
																while((true)){
																	...
																	HX_STACK_LINE(2130)
																	{
																		...
																		Float tmp50 = (tmp48 * tmp49);		HX_STACK_VAR(tmp50,"tmp50");
																		HX_STACK_LINE(2130)
																		hx::AddEq(_this1->localCOMx,tmp50);
																		HX_STACK_LINE(2130)
																		...
																		Float tmp53 = (tmp51 * tmp52);		HX_STACK_VAR(tmp53,"tmp53");
																		HX_STACK_LINE(2130)
																		hx::AddEq(_this1->localCOMy,tmp53);
																	}
																	HX_STACK_LINE(2130)
																	u = v;
																	HX_STACK_LINE(2130)
															...
															HX_STACK_LINE(2130)
															Float tmp39 = ((int)3 * area);		HX_STACK_VAR(tmp39,"tmp39");
															HX_STACK_LINE(2130)
