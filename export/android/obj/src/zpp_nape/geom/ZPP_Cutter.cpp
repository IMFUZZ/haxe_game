								...
								if ((tmp37)){
									...
									HX_STACK_LINE(1142)
									{
										...
										HX_STACK_LINE(1142)
										{
											...
											{
												HX_STACK_LINE(1142)
												bool tmp39 = (o1->outer != null());		HX_STACK_VAR(tmp39,"tmp39");
												HX_STACK_LINE(1142)
												if ((tmp39)){
													HX_STACK_LINE(1142)
								...
								if ((tmp42)){
									...
									HX_STACK_LINE(1166)
									{
										...
										HX_STACK_LINE(1166)
										{
											...
											{
												HX_STACK_LINE(1166)
												bool tmp44 = (o1->outer != null());		HX_STACK_VAR(tmp44,"tmp44");
												HX_STACK_LINE(1166)
												if ((tmp44)){
													HX_STACK_LINE(1166)
													o1->outer->zpp_inner = null();
										...
										if ((tmp50)){
											...
											HX_STACK_LINE(1226)
											{
												...
												HX_STACK_LINE(1226)
												{
													...
													{
														HX_STACK_LINE(1226)
														bool tmp52 = (o1->outer != null());		HX_STACK_VAR(tmp52,"tmp52");
														HX_STACK_LINE(1226)
														if ((tmp52)){
															HX_STACK_LINE(1226)
															o1->outer->zpp_inner = null();
									...
									if ((tmp39)){
										...
										HX_STACK_LINE(1374)
										{
											...
											HX_STACK_LINE(1374)
											{
												...
												{
													HX_STACK_LINE(1374)
													bool tmp41 = (o1->outer != null());		HX_STACK_VAR(tmp41,"tmp41");
													HX_STACK_LINE(1374)
													if ((tmp41)){
														HX_STACK_LINE(1374)
														o1->outer->zpp_inner = null();
											...
											if ((tmp47)){
												...
												HX_STACK_LINE(1434)
												{
													...
													HX_STACK_LINE(1434)
													{
														...
														{
															HX_STACK_LINE(1434)
															bool tmp49 = (o1->outer != null());		HX_STACK_VAR(tmp49,"tmp49");
															HX_STACK_LINE(1434)
															if ((tmp49)){
																HX_STACK_LINE(1434)
																o1->outer->zpp_inner = null();
											...
											if ((tmp52)){
												...
												HX_STACK_LINE(1458)
												{
													...
													HX_STACK_LINE(1458)
													{
														...
														{
															HX_STACK_LINE(1458)
															bool tmp54 = (o1->outer != null());		HX_STACK_VAR(tmp54,"tmp54");
															HX_STACK_LINE(1458)
															if ((tmp54)){
																HX_STACK_LINE(1458)
																o1->outer->zpp_inner = null();
