...
::nape::dynamics::Arbiter ZPP_SpaceArbiterList_obj::at( int index){
	...
	if ((tmp)){
		...
		HX_STACK_LINE(334)
		int tmp2 = accum_length;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(334)
		int tmp3 = this->lengths->__get((int)0);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(334)
		...
		if ((tmp5)){
			HX_STACK_LINE(335)
			int tmp6 = (index - accum_length);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(335)
			int offset = tmp6;		HX_STACK_VAR(offset,"offset");
			HX_STACK_LINE(336)
			int tmp7 = offset;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(336)
			int tmp8 = this->at_index_0;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(336)
			...
			if ((tmp10)){
				HX_STACK_LINE(336)
				::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp12 = this->ite_0;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(336)
				::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp13 = tmp12;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(336)
				tmp11 = (tmp13 == null());
			}
			else{
			...
			if ((tmp11)){
				...
				this->at_index_0 = (int)0;
				HX_STACK_LINE(338)
				::zpp_nape::space::ZPP_Space tmp12 = this->space;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(338)
				::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp13 = tmp12->c_arbiters_true->head;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(338)
				this->ite_0 = tmp13;
				HX_STACK_LINE(339)
				while((true)){
					HX_STACK_LINE(340)
					::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp14 = this->ite_0;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(340)
					::zpp_nape::dynamics::ZPP_ColArbiter x = tmp14->elt;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(341)
			...
			::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp12 = this->ite_0;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(354)
			::nape::dynamics::Arbiter tmp13 = tmp12->elt->wrapper();		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(354)
			ret = tmp13;
		}
		else{
	...
	if ((tmp1)){
		...
		HX_STACK_LINE(359)
		int tmp3 = accum_length;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(359)
		int tmp4 = this->lengths->__get((int)1);		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(359)
		...
		if ((tmp6)){
			HX_STACK_LINE(360)
			int tmp7 = (index - accum_length);		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(360)
			int offset = tmp7;		HX_STACK_VAR(offset,"offset");
			HX_STACK_LINE(361)
			int tmp8 = offset;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(361)
			int tmp9 = this->at_index_1;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(361)
			...
			if ((tmp11)){
				HX_STACK_LINE(361)
				::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp13 = this->ite_1;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(361)
				::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp14 = tmp13;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(361)
				tmp12 = (tmp14 == null());
			}
			else{
			...
			if ((tmp12)){
				...
				this->at_index_1 = (int)0;
				HX_STACK_LINE(363)
				::zpp_nape::space::ZPP_Space tmp13 = this->space;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(363)
				::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp14 = tmp13->c_arbiters_false->head;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(363)
				this->ite_1 = tmp14;
				HX_STACK_LINE(364)
				while((true)){
					HX_STACK_LINE(365)
					::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp15 = this->ite_1;		HX_STACK_VAR(tmp15,"tmp15");
					HX_STACK_LINE(365)
					::zpp_nape::dynamics::ZPP_ColArbiter x = tmp15->elt;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(366)
					bool tmp16 = x->active;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(366)
					if ((tmp16)){
						HX_STACK_LINE(366)
						break;
			...
			::zpp_nape::util::ZNPNode_ZPP_ColArbiter tmp13 = this->ite_1;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(379)
			::nape::dynamics::Arbiter tmp14 = tmp13->elt->wrapper();		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(379)
			ret = tmp14;
		}
		else{
	...
	if ((tmp2)){
		...
		HX_STACK_LINE(384)
		int tmp4 = accum_length;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(384)
		int tmp5 = this->lengths->__get((int)2);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(384)
		...
		if ((tmp7)){
			HX_STACK_LINE(385)
			int tmp8 = (index - accum_length);		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(385)
			int offset = tmp8;		HX_STACK_VAR(offset,"offset");
			HX_STACK_LINE(386)
			int tmp9 = offset;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(386)
			int tmp10 = this->at_index_2;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(386)
			...
			if ((tmp12)){
				HX_STACK_LINE(386)
				::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp14 = this->ite_2;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(386)
				::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp15 = tmp14;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(386)
				tmp13 = (tmp15 == null());
			}
			else{
			...
			if ((tmp13)){
				...
				HX_STACK_LINE(388)
				::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp15 = tmp14->f_arbiters->head;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(388)
				this->ite_2 = tmp15;
				HX_STACK_LINE(389)
				while((true)){
					HX_STACK_LINE(390)
					::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp16 = this->ite_2;		HX_STACK_VAR(tmp16,"tmp16");
					HX_STACK_LINE(390)
					::zpp_nape::dynamics::ZPP_FluidArbiter x = tmp16->elt;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(391)
					bool tmp17 = x->active;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(391)
					if ((tmp17)){
						HX_STACK_LINE(391)
						break;
			...
			while((true)){
				...
				HX_STACK_LINE(395)
				int tmp15 = offset;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(395)
			...
			::zpp_nape::util::ZNPNode_ZPP_FluidArbiter tmp14 = this->ite_2;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(404)
			::nape::dynamics::Arbiter tmp15 = tmp14->elt->wrapper();		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(404)
			ret = tmp15;
		}
		else{
	...
	if ((tmp3)){
		...
		HX_STACK_LINE(409)
		int tmp6 = this->lengths->__get((int)3);		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(409)
		...
		if ((tmp8)){
			...
			HX_STACK_LINE(411)
			int tmp11 = this->at_index_3;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(411)
			...
			if ((tmp13)){
				HX_STACK_LINE(411)
				::zpp_nape::util::ZNPNode_ZPP_SensorArbiter tmp15 = this->ite_3;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(411)
				::zpp_nape::util::ZNPNode_ZPP_SensorArbiter tmp16 = tmp15;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(411)
				tmp14 = (tmp16 == null());
			}
			else{
			...
			if ((tmp14)){
				...
				HX_STACK_LINE(413)
				::zpp_nape::util::ZNPNode_ZPP_SensorArbiter tmp16 = tmp15->s_arbiters->head;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(413)
				this->ite_3 = tmp16;
				HX_STACK_LINE(414)
				while((true)){
					HX_STACK_LINE(415)
					::zpp_nape::util::ZNPNode_ZPP_SensorArbiter tmp17 = this->ite_3;		HX_STACK_VAR(tmp17,"tmp17");
					HX_STACK_LINE(415)
					::zpp_nape::dynamics::ZPP_SensorArbiter x = tmp17->elt;		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(416)
					bool tmp18 = x->active;		HX_STACK_VAR(tmp18,"tmp18");
					HX_STACK_LINE(416)
					if ((tmp18)){
	...
	HX_STACK_LINE(433)
	::nape::dynamics::Arbiter tmp4 = ret;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(433)
	return tmp4;
}
