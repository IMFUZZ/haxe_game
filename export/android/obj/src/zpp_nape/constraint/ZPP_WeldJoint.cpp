...
Void ZPP_WeldJoint_obj::draw( ::nape::util::Debug g){
{
		...
		HX_STACK_ARG(g,"g")
		HX_STACK_LINE(1532)
		::nape::constraint::WeldJoint tmp = this->outer_zn;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(1532)
		::nape::constraint::WeldJoint me = tmp;		HX_STACK_VAR(me,"me");
		HX_STACK_LINE(1533)
		...
		HX_STACK_LINE(1535)
		bool tmp11 = this->stiff;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(1535)
		bool tmp12 = !(tmp11);		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(1535)
		if ((tmp12)){
			HX_STACK_LINE(1536)
			::nape::geom::Vec2 tmp13 = a1;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(1536)
			::nape::geom::Vec2 tmp14 = a2->sub(tmp13,null());		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(1536)
			::nape::geom::Vec2 n = tmp14;		HX_STACK_VAR(n,"n");
			HX_STACK_LINE(1537)
			...
			HX_STACK_LINE(1537)
			{
				...
				Float tmp22 = (tmp18 + tmp21);		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(1537)
				tmp15 = ::Math_obj::sqrt(tmp22);
			}
			HX_STACK_LINE(1537)
			Float nl = tmp15;		HX_STACK_VAR(nl,"nl");
			HX_STACK_LINE(1538)
			bool tmp16 = (nl != (int)0);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(1538)
			if ((tmp16)){
				HX_STACK_LINE(1538)
				::nape::geom::Vec2 tmp17 = a1;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(1538)
				::nape::geom::Vec2 tmp18 = a2;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(1538)
				g->drawSpring(tmp17,tmp18,(int)16711935,null(),null());
			}
			HX_STACK_LINE(1539)
			{
				HX_STACK_LINE(1539)
			...
			HX_STACK_LINE(1541)
			Float tmp18 = (Float((int)5) / Float(tmp17));		HX_STACK_VAR(tmp18,"tmp18");
			HX_STACK_LINE(1541)
			Float tmp19 = (Float(tmp18) / Float((int)2));		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(1541)
			Float delrad = tmp19;		HX_STACK_VAR(delrad,"delrad");
			HX_STACK_LINE(1542)
			{
				HX_STACK_LINE(1543)
				...
				if ((tmp21)){
					...
					HX_STACK_LINE(1543)
					::zpp_nape::phys::ZPP_Body tmp23 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp23,"tmp23");
					HX_STACK_LINE(1543)
					tmp22 = tmp23->outer;
				}
				HX_STACK_LINE(1543)
				...
				{
					HX_STACK_LINE(1543)
					::zpp_nape::phys::ZPP_Body tmp24 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(1543)
					bool tmp25 = (tmp24 == null());		HX_STACK_VAR(tmp25,"tmp25");
					HX_STACK_LINE(1543)
					::nape::phys::Body tmp26;		HX_STACK_VAR(tmp26,"tmp26");
					HX_STACK_LINE(1543)
					if ((tmp25)){
						HX_STACK_LINE(1543)
						tmp26 = null();
					...
					HX_STACK_LINE(1543)
					::nape::phys::Body _this = tmp26;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(1543)
					...
					if ((tmp28)){
						...
						HX_STACK_LINE(1543)
						::zpp_nape::space::ZPP_Space tmp29 = _this->zpp_inner->space;		HX_STACK_VAR(tmp29,"tmp29");
						HX_STACK_LINE(1543)
						tmp23 = tmp29->outer;
					}
				}
				HX_STACK_LINE(1543)
				::nape::phys::Body tmp24 = tmp23->zpp_inner->__static;		HX_STACK_VAR(tmp24,"tmp24");
				HX_STACK_LINE(1543)
				bool tmp25 = (tmp22 != tmp24);		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(1543)
				if ((tmp25)){
					HX_STACK_LINE(1544)
					::zpp_nape::phys::ZPP_Body tmp26 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp26,"tmp26");
					HX_STACK_LINE(1544)
					...
					if ((tmp27)){
						...
						HX_STACK_LINE(1544)
						::zpp_nape::phys::ZPP_Body tmp29 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp29,"tmp29");
						HX_STACK_LINE(1544)
						tmp28 = tmp29->outer;
					}
					HX_STACK_LINE(1544)
					Float tmp29 = tmp28->zpp_inner->rot;		HX_STACK_VAR(tmp29,"tmp29");
					HX_STACK_LINE(1544)
					Float tmp30 = me->zpp_inner_zn->phase;		HX_STACK_VAR(tmp30,"tmp30");
					HX_STACK_LINE(1544)
					Float tmp31 = (tmp29 - tmp30);		HX_STACK_VAR(tmp31,"tmp31");
					HX_STACK_LINE(1544)
					Float max = tmp31;		HX_STACK_VAR(max,"max");
					HX_STACK_LINE(1545)
					::zpp_nape::phys::ZPP_Body tmp32 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp32,"tmp32");
					HX_STACK_LINE(1545)
					...
					if ((tmp33)){
						...
						HX_STACK_LINE(1545)
						::zpp_nape::phys::ZPP_Body tmp35 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp35,"tmp35");
						HX_STACK_LINE(1545)
						tmp34 = tmp35->outer;
					}
					HX_STACK_LINE(1545)
					Float tmp35 = tmp34->zpp_inner->rot;		HX_STACK_VAR(tmp35,"tmp35");
					HX_STACK_LINE(1545)
					Float min = tmp35;		HX_STACK_VAR(min,"min");
					HX_STACK_LINE(1546)
					bool tmp36 = (min > max);		HX_STACK_VAR(tmp36,"tmp36");
					HX_STACK_LINE(1546)
					if ((tmp36)){
						HX_STACK_LINE(1547)
					...
					HX_STACK_LINE(1551)
					Float tmp39 = min;		HX_STACK_VAR(tmp39,"tmp39");
					HX_STACK_LINE(1551)
					Float tmp40 = max;		HX_STACK_VAR(tmp40,"tmp40");
					HX_STACK_LINE(1551)
					int tmp41 = minrad;		HX_STACK_VAR(tmp41,"tmp41");
					HX_STACK_LINE(1551)
					Float tmp42 = (min - min);		HX_STACK_VAR(tmp42,"tmp42");
					HX_STACK_LINE(1551)
					Float tmp43 = delrad;		HX_STACK_VAR(tmp43,"tmp43");
					HX_STACK_LINE(1551)
					Float tmp44 = (tmp42 * tmp43);		HX_STACK_VAR(tmp44,"tmp44");
					HX_STACK_LINE(1551)
					Float tmp45 = (tmp41 + tmp44);		HX_STACK_VAR(tmp45,"tmp45");
					HX_STACK_LINE(1551)
					int tmp46 = minrad;		HX_STACK_VAR(tmp46,"tmp46");
					HX_STACK_LINE(1551)
					Float tmp47 = (max - min);		HX_STACK_VAR(tmp47,"tmp47");
					HX_STACK_LINE(1551)
					Float tmp48 = delrad;		HX_STACK_VAR(tmp48,"tmp48");
					HX_STACK_LINE(1551)
					Float tmp49 = (tmp47 * tmp48);		HX_STACK_VAR(tmp49,"tmp49");
					HX_STACK_LINE(1551)
					Float tmp50 = (tmp46 + tmp49);		HX_STACK_VAR(tmp50,"tmp50");
					HX_STACK_LINE(1551)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::drawSpiralSpring(tmp37,tmp38,tmp39,tmp40,tmp45,tmp50,(int)16711808,null());
					HX_STACK_LINE(1552)
					::nape::util::Debug tmp51 = g;		HX_STACK_VAR(tmp51,"tmp51");
					HX_STACK_LINE(1552)
					::nape::geom::Vec2 tmp52;		HX_STACK_VAR(tmp52,"tmp52");
					HX_STACK_LINE(1552)
					{
						HX_STACK_LINE(1552)
						::zpp_nape::phys::ZPP_Body tmp53 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp53,"tmp53");
						HX_STACK_LINE(1552)
						bool tmp54 = (tmp53 == null());		HX_STACK_VAR(tmp54,"tmp54");
						HX_STACK_LINE(1552)
						::nape::phys::Body tmp55;		HX_STACK_VAR(tmp55,"tmp55");
						HX_STACK_LINE(1552)
						if ((tmp54)){
							HX_STACK_LINE(1552)
							tmp55 = null();
							...
							HX_STACK_LINE(1552)
							::zpp_nape::phys::ZPP_Body tmp56 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp56,"tmp56");
							HX_STACK_LINE(1552)
							tmp55 = tmp56->outer;
						}
						HX_STACK_LINE(1552)
						::nape::phys::Body _this = tmp55;		HX_STACK_VAR(_this,"_this");
						HX_STACK_LINE(1552)
						::nape::geom::Vec2 tmp56 = _this->zpp_inner->wrap_pos;		HX_STACK_VAR(tmp56,"tmp56");
						HX_STACK_LINE(1552)
						...
						HX_STACK_LINE(1552)
						tmp52 = _this->zpp_inner->wrap_pos;
					}
					HX_STACK_LINE(1552)
					::zpp_nape::phys::ZPP_Body tmp53 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp53,"tmp53");
					HX_STACK_LINE(1552)
					...
					HX_STACK_LINE(1552)
					Float tmp56 = tmp55->zpp_inner->rot;		HX_STACK_VAR(tmp56,"tmp56");
					HX_STACK_LINE(1552)
					int tmp57 = minrad;		HX_STACK_VAR(tmp57,"tmp57");
					HX_STACK_LINE(1552)
					::zpp_nape::phys::ZPP_Body tmp58 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp58,"tmp58");
					HX_STACK_LINE(1552)
					bool tmp59 = (tmp58 == null());		HX_STACK_VAR(tmp59,"tmp59");
					HX_STACK_LINE(1552)
					::nape::phys::Body tmp60;		HX_STACK_VAR(tmp60,"tmp60");
					HX_STACK_LINE(1552)
					if ((tmp59)){
						HX_STACK_LINE(1552)
						tmp60 = null();
						...
						HX_STACK_LINE(1552)
						::zpp_nape::phys::ZPP_Body tmp61 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp61,"tmp61");
						HX_STACK_LINE(1552)
						tmp60 = tmp61->outer;
					}
					HX_STACK_LINE(1552)
					Float tmp61 = tmp60->zpp_inner->rot;		HX_STACK_VAR(tmp61,"tmp61");
					HX_STACK_LINE(1552)
					Float tmp62 = min;		HX_STACK_VAR(tmp62,"tmp62");
					HX_STACK_LINE(1552)
					Float tmp63 = (tmp61 - tmp62);		HX_STACK_VAR(tmp63,"tmp63");
					HX_STACK_LINE(1552)
					Float tmp64 = delrad;		HX_STACK_VAR(tmp64,"tmp64");
					HX_STACK_LINE(1552)
					Float tmp65 = (tmp63 * tmp64);		HX_STACK_VAR(tmp65,"tmp65");
					HX_STACK_LINE(1552)
					Float tmp66 = (tmp57 + tmp65);		HX_STACK_VAR(tmp66,"tmp66");
					HX_STACK_LINE(1552)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::indicator(tmp51,tmp52,tmp56,tmp66,(int)16711808);
				}
			}
			HX_STACK_LINE(1555)
			{
				HX_STACK_LINE(1556)
				::zpp_nape::phys::ZPP_Body tmp20 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(1556)
				bool tmp21 = (tmp20 == null());		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(1556)
				::nape::phys::Body tmp22;		HX_STACK_VAR(tmp22,"tmp22");
				...
				if ((tmp21)){
					...
					HX_STACK_LINE(1556)
					::zpp_nape::phys::ZPP_Body tmp23 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp23,"tmp23");
					HX_STACK_LINE(1556)
					tmp22 = tmp23->outer;
				}
				HX_STACK_LINE(1556)
				...
				{
					HX_STACK_LINE(1556)
					::zpp_nape::phys::ZPP_Body tmp24 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp24,"tmp24");
					HX_STACK_LINE(1556)
					bool tmp25 = (tmp24 == null());		HX_STACK_VAR(tmp25,"tmp25");
					HX_STACK_LINE(1556)
					::nape::phys::Body tmp26;		HX_STACK_VAR(tmp26,"tmp26");
					...
					if ((tmp25)){
						...
						HX_STACK_LINE(1556)
						::zpp_nape::phys::ZPP_Body tmp27 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp27,"tmp27");
						HX_STACK_LINE(1556)
						tmp26 = tmp27->outer;
					}
					HX_STACK_LINE(1556)
				...
				if ((tmp25)){
					HX_STACK_LINE(1557)
					Float tmp26 = me->zpp_inner_zn->phase;		HX_STACK_VAR(tmp26,"tmp26");
					HX_STACK_LINE(1557)
					::zpp_nape::phys::ZPP_Body tmp27 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp27,"tmp27");
					HX_STACK_LINE(1557)
					bool tmp28 = (tmp27 == null());		HX_STACK_VAR(tmp28,"tmp28");
					...
					Float max = tmp31;		HX_STACK_VAR(max,"max");
					HX_STACK_LINE(1558)
					::zpp_nape::phys::ZPP_Body tmp32 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp32,"tmp32");
					HX_STACK_LINE(1558)
					bool tmp33 = (tmp32 == null());		HX_STACK_VAR(tmp33,"tmp33");
					HX_STACK_LINE(1558)
					::nape::phys::Body tmp34;		HX_STACK_VAR(tmp34,"tmp34");
					...
					if ((tmp33)){
						...
						HX_STACK_LINE(1558)
						::zpp_nape::phys::ZPP_Body tmp35 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp35,"tmp35");
						HX_STACK_LINE(1558)
						tmp34 = tmp35->outer;
					}
					HX_STACK_LINE(1558)
					...
					Float tmp50 = (tmp46 + tmp49);		HX_STACK_VAR(tmp50,"tmp50");
					HX_STACK_LINE(1564)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::drawSpiralSpring(tmp37,tmp38,tmp39,tmp40,tmp45,tmp50,(int)8388863,null());
					HX_STACK_LINE(1565)
					::nape::util::Debug tmp51 = g;		HX_STACK_VAR(tmp51,"tmp51");
					HX_STACK_LINE(1565)
					::nape::geom::Vec2 tmp52;		HX_STACK_VAR(tmp52,"tmp52");
					...
					{
						HX_STACK_LINE(1565)
						::zpp_nape::phys::ZPP_Body tmp53 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp53,"tmp53");
						HX_STACK_LINE(1565)
						bool tmp54 = (tmp53 == null());		HX_STACK_VAR(tmp54,"tmp54");
						HX_STACK_LINE(1565)
						::nape::phys::Body tmp55;		HX_STACK_VAR(tmp55,"tmp55");
						...
						if ((tmp54)){
							...
							HX_STACK_LINE(1565)
							::zpp_nape::phys::ZPP_Body tmp56 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp56,"tmp56");
							HX_STACK_LINE(1565)
							tmp55 = tmp56->outer;
						}
						HX_STACK_LINE(1565)
					...
					int tmp57 = minrad;		HX_STACK_VAR(tmp57,"tmp57");
					HX_STACK_LINE(1565)
					::zpp_nape::phys::ZPP_Body tmp58 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp58,"tmp58");
					HX_STACK_LINE(1565)
					bool tmp59 = (tmp58 == null());		HX_STACK_VAR(tmp59,"tmp59");
					HX_STACK_LINE(1565)
					::nape::phys::Body tmp60;		HX_STACK_VAR(tmp60,"tmp60");
					...
					if ((tmp59)){
						...
						HX_STACK_LINE(1565)
						::zpp_nape::phys::ZPP_Body tmp61 = me->zpp_inner_zn->b2;		HX_STACK_VAR(tmp61,"tmp61");
						HX_STACK_LINE(1565)
						tmp60 = tmp61->outer;
					}
					HX_STACK_LINE(1565)
					...
					Float tmp66 = (tmp57 + tmp65);		HX_STACK_VAR(tmp66,"tmp66");
					HX_STACK_LINE(1565)
					::zpp_nape::constraint::ZPP_AngleDraw_obj::indicator(tmp51,tmp52,tmp56,tmp66,(int)8388863);
				}
			}
		}
		HX_STACK_LINE(1569)
		::nape::geom::Vec2 tmp13 = a1;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(1569)
		g->drawFilledCircle(tmp13,(int)2,(int)255);
		HX_STACK_LINE(1570)
		::nape::geom::Vec2 tmp14 = a2;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(1570)
		g->drawFilledCircle(tmp14,(int)2,(int)16711680);
		HX_STACK_LINE(1571)
		{
			HX_STACK_LINE(1571)
