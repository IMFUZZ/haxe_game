...
Void ZPP_LineJoint_obj::draw( ::nape::util::Debug g){
{
		...
		HX_STACK_ARG(g,"g")
		HX_STACK_LINE(1572)
		::nape::constraint::LineJoint tmp = this->outer_zn;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(1572)
		::nape::constraint::LineJoint me = tmp;		HX_STACK_VAR(me,"me");
		HX_STACK_LINE(1573)
		...
		if ((tmp12)){
			...
			HX_STACK_LINE(1575)
			::zpp_nape::phys::ZPP_Body tmp14 = me->zpp_inner_zn->b1;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(1575)
			tmp13 = tmp14->outer;
		}
		HX_STACK_LINE(1575)
		...
		{
			HX_STACK_LINE(1575)
			::nape::geom::Vec2 tmp15 = me->zpp_inner_zn->wrap_n;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(1575)
			...
			HX_STACK_LINE(1575)
			tmp14 = me->zpp_inner_zn->wrap_n;
		}
		HX_STACK_LINE(1575)
		::nape::geom::Vec2 tmp15 = tmp13->localVectorToWorld(tmp14,null());		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(1575)
		::nape::geom::Vec2 dir = tmp15;		HX_STACK_VAR(dir,"dir");
		HX_STACK_LINE(1576)
		...
		dir->muleq(tmp17);
		HX_STACK_LINE(1577)
		Float tmp18 = me->zpp_inner_zn->jointMin;		HX_STACK_VAR(tmp18,"tmp18");
		HX_STACK_LINE(1577)
		Float min = tmp18;		HX_STACK_VAR(min,"min");
		HX_STACK_LINE(1578)
		Float tmp19 = me->zpp_inner_zn->jointMax;		HX_STACK_VAR(tmp19,"tmp19");
		HX_STACK_LINE(1578)
		Float max = tmp19;		HX_STACK_VAR(max,"max");
		HX_STACK_LINE(1579)
		Float tmp20 = min;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(1579)
		Float tmp21 = ::Math_obj::NEGATIVE_INFINITY;		HX_STACK_VAR(tmp21,"tmp21");
		HX_STACK_LINE(1579)
		...
		HX_STACK_LINE(1580)
		Float tmp23 = max;		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(1580)
		Float tmp24 = ::Math_obj::POSITIVE_INFINITY;		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(1580)
		...
		HX_STACK_LINE(1581)
		::nape::geom::Vec2 tmp26 = a1;		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(1581)
		::nape::geom::Vec2 tmp27 = a2->sub(tmp26,null());		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(1581)
		::nape::geom::Vec2 del = tmp27;		HX_STACK_VAR(del,"del");
		HX_STACK_LINE(1582)
		::nape::geom::Vec2 tmp28 = dir;		HX_STACK_VAR(tmp28,"tmp28");
		HX_STACK_LINE(1582)
		Float tmp29 = del->dot(tmp28);		HX_STACK_VAR(tmp29,"tmp29");
		HX_STACK_LINE(1582)
		Float pn = tmp29;		HX_STACK_VAR(pn,"pn");
		HX_STACK_LINE(1583)
		{
			HX_STACK_LINE(1583)
			...
			HX_STACK_LINE(1583)
			{
				...
				{
					HX_STACK_LINE(1583)
					bool tmp30 = (o->outer != null());		HX_STACK_VAR(tmp30,"tmp30");
					HX_STACK_LINE(1583)
					if ((tmp30)){
						HX_STACK_LINE(1583)
		...
		HX_STACK_LINE(1584)
		Float tmp30 = min;		HX_STACK_VAR(tmp30,"tmp30");
		HX_STACK_LINE(1584)
		::nape::geom::Vec2 tmp31 = dir->mul(tmp30,true);		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(1584)
		::nape::geom::Vec2 tmp32 = a1->add(tmp31,null());		HX_STACK_VAR(tmp32,"tmp32");
		HX_STACK_LINE(1584)
		::nape::geom::Vec2 e1 = tmp32;		HX_STACK_VAR(e1,"e1");
		HX_STACK_LINE(1585)
		Float tmp33 = max;		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(1585)
		::nape::geom::Vec2 tmp34 = dir->mul(tmp33,true);		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(1585)
		::nape::geom::Vec2 tmp35 = a1->add(tmp34,null());		HX_STACK_VAR(tmp35,"tmp35");
		HX_STACK_LINE(1585)
		::nape::geom::Vec2 e2 = tmp35;		HX_STACK_VAR(e2,"e2");
		HX_STACK_LINE(1586)
		bool tmp36 = (pn > min);		HX_STACK_VAR(tmp36,"tmp36");
		HX_STACK_LINE(1586)
		if ((tmp36)){
			HX_STACK_LINE(1586)
			::nape::geom::Vec2 tmp37 = e1;		HX_STACK_VAR(tmp37,"tmp37");
			HX_STACK_LINE(1586)
			...
			HX_STACK_LINE(1586)
			{
				...
				HX_STACK_LINE(1589)
				bool tmp39 = (x < y);		HX_STACK_VAR(tmp39,"tmp39");
				HX_STACK_LINE(1589)
				if ((tmp39)){
					HX_STACK_LINE(1589)
					tmp38 = x;
			...
			HX_STACK_LINE(1586)
			::nape::geom::Vec2 tmp39 = dir->mul(tmp38,true);		HX_STACK_VAR(tmp39,"tmp39");
			HX_STACK_LINE(1586)
			::nape::geom::Vec2 tmp40 = a1->add(tmp39,true);		HX_STACK_VAR(tmp40,"tmp40");
			HX_STACK_LINE(1586)
			g->drawLine(tmp37,tmp40,(int)16776960);
		}
		HX_STACK_LINE(1591)
		bool tmp37 = (pn < max);		HX_STACK_VAR(tmp37,"tmp37");
		HX_STACK_LINE(1591)
		if ((tmp37)){
			HX_STACK_LINE(1591)
			Float tmp38;		HX_STACK_VAR(tmp38,"tmp38");
			...
			::nape::geom::Vec2 tmp40 = a1->add(tmp39,true);		HX_STACK_VAR(tmp40,"tmp40");
			HX_STACK_LINE(1595)
			::nape::geom::Vec2 tmp41 = e2;		HX_STACK_VAR(tmp41,"tmp41");
			HX_STACK_LINE(1591)
			g->drawLine(tmp40,tmp41,(int)65535);
		}
		HX_STACK_LINE(1596)
		...
		if ((tmp39)){
			HX_STACK_LINE(1597)
			Float tmp40 = pn;		HX_STACK_VAR(tmp40,"tmp40");
			HX_STACK_LINE(1597)
			Float tmp41 = this->jointMin;		HX_STACK_VAR(tmp41,"tmp41");
			HX_STACK_LINE(1597)
			...
			if ((tmp42)){
				...
				HX_STACK_LINE(1598)
				Float tmp44 = pn;		HX_STACK_VAR(tmp44,"tmp44");
				HX_STACK_LINE(1598)
				...
				if ((tmp46)){
					...
					HX_STACK_LINE(1598)
					{
						...
						HX_STACK_LINE(1598)
						{
							...
							HX_STACK_LINE(1598)
							tmp47 = e2->zpp_inner->x;
						}
						HX_STACK_LINE(1598)
						Float x = tmp47;		HX_STACK_VAR(x,"x");
						HX_STACK_LINE(1598)
					...
					HX_STACK_LINE(1599)
					Float tmp47 = pn;		HX_STACK_VAR(tmp47,"tmp47");
					HX_STACK_LINE(1599)
					::nape::geom::Vec2 tmp48 = dir->mul(tmp47,true);		HX_STACK_VAR(tmp48,"tmp48");
					HX_STACK_LINE(1599)
					tmp43 = a1->add(tmp48,null());
				}
			}
			HX_STACK_LINE(1597)
			::nape::geom::Vec2 anch = tmp43;		HX_STACK_VAR(anch,"anch");
			HX_STACK_LINE(1600)
			::nape::geom::Vec2 tmp44 = anch;		HX_STACK_VAR(tmp44,"tmp44");
			HX_STACK_LINE(1600)
			::nape::geom::Vec2 tmp45 = a2;		HX_STACK_VAR(tmp45,"tmp45");
			HX_STACK_LINE(1600)
			g->drawSpring(tmp44,tmp45,(int)16711935,null(),null());
			HX_STACK_LINE(1601)
			{
				HX_STACK_LINE(1601)
				...
				HX_STACK_LINE(1601)
				{
					...
					{
						HX_STACK_LINE(1601)
						bool tmp46 = (o->outer != null());		HX_STACK_VAR(tmp46,"tmp46");
						HX_STACK_LINE(1601)
						if ((tmp46)){
							HX_STACK_LINE(1601)
							o->outer->zpp_inner = null();
		...
		HX_STACK_LINE(1603)
		::nape::geom::Vec2 tmp40 = a1;		HX_STACK_VAR(tmp40,"tmp40");
		HX_STACK_LINE(1603)
		g->drawFilledCircle(tmp40,(int)2,(int)255);
		HX_STACK_LINE(1604)
		::nape::geom::Vec2 tmp41 = a2;		HX_STACK_VAR(tmp41,"tmp41");
		HX_STACK_LINE(1604)
		g->drawFilledCircle(tmp41,(int)2,(int)16711680);
		HX_STACK_LINE(1605)
		{
			HX_STACK_LINE(1605)
			...
			HX_STACK_LINE(1605)
			{
				...
				{
					HX_STACK_LINE(1605)
					bool tmp42 = (o->outer != null());		HX_STACK_VAR(tmp42,"tmp42");
					HX_STACK_LINE(1605)
					if ((tmp42)){
						HX_STACK_LINE(1605)
						o->outer->zpp_inner = null();
