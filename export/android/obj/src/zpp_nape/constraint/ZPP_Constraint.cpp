...
Void ZPP_Constraint_obj::copyto( ::nape::constraint::Constraint ret){
{
		...
		HX_STACK_LINE(545)
		{
			...
			{
				HX_STACK_LINE(545)
				Float tmp2 = ret->zpp_inner->maxError;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(545)
				Float tmp3 = maxError;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(545)
				bool tmp4 = (tmp2 != tmp3);		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(545)
				if ((tmp4)){
		...
		HX_STACK_LINE(546)
		{
			...
			{
				HX_STACK_LINE(546)
				Float tmp2 = ret->zpp_inner->maxForce;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(546)
				Float tmp3 = maxForce;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(546)
				bool tmp4 = (tmp2 != tmp3);		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(546)
				if ((tmp4)){
		...
		HX_STACK_LINE(547)
		{
			...
			{
				HX_STACK_LINE(547)
				Float tmp2 = ret->zpp_inner->damping;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(547)
				Float tmp3 = damping;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(547)
				bool tmp4 = (tmp2 != tmp3);		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(547)
				if ((tmp4)){
					...
					HX_STACK_LINE(547)
					bool tmp5 = ret->zpp_inner->stiff;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(547)
		...
		HX_STACK_LINE(548)
		{
			...
			{
				HX_STACK_LINE(548)
				Float tmp2 = ret->zpp_inner->frequency;		HX_STACK_VAR(tmp2,"tmp2");
				HX_STACK_LINE(548)
				Float tmp3 = frequency;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(548)
				bool tmp4 = (tmp2 != tmp3);		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(548)
				if ((tmp4)){
