		...
		if ((tmp)){
			...
			if ((tmp2)){
				...
				if ((tmp5)){
					...
					HX_STACK_LINE(239)
					::zpp_nape::geom::ZPP_Vec2 p0 = tmp7;		HX_STACK_VAR(p0,"p0");
					HX_STACK_LINE(239)
					{
						HX_STACK_LINE(239)
					...
					HX_STACK_LINE(239)
					{
						...
						while((true)){
							...
							HX_STACK_LINE(239)
							{
								...
								HX_STACK_LINE(239)
								Float tmp12 = _this->aabb->minx;		HX_STACK_VAR(tmp12,"tmp12");
								HX_STACK_LINE(239)
								...
								HX_STACK_LINE(239)
								Float tmp15 = _this->aabb->maxx;		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(239)
								...
								HX_STACK_LINE(239)
								Float tmp18 = _this->aabb->miny;		HX_STACK_VAR(tmp18,"tmp18");
								HX_STACK_LINE(239)
								...
								HX_STACK_LINE(239)
								Float tmp21 = _this->aabb->maxy;		HX_STACK_VAR(tmp21,"tmp21");
								HX_STACK_LINE(239)
...
Void ZPP_Shape_obj::getworldCOM( ){
{
		...
		HX_STACK_LINE(318)
		{
			...
			HX_STACK_LINE(320)
			Float tmp2 = this->worldCOMy;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(320)
