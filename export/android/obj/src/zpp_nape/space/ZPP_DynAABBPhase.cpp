													...
													HX_STACK_LINE(1016)
													{
														...
														if ((tmp20)){
															...
															if ((tmp23)){
																...
																HX_STACK_LINE(1016)
																::zpp_nape::geom::ZPP_Vec2 tmp25 = tmp24->next;		HX_STACK_VAR(tmp25,"tmp25");
																HX_STACK_LINE(1016)
																...
																if ((tmp26)){
																	...
																	::zpp_nape::geom::ZPP_Vec2 tmp27 = _this1->lverts->next;		HX_STACK_VAR(tmp27,"tmp27");
																	HX_STACK_LINE(1016)
																	::zpp_nape::geom::ZPP_Vec2 tmp28 = tmp27->next->next;		HX_STACK_VAR(tmp28,"tmp28");
																	HX_STACK_LINE(1016)
																	...
																	if ((tmp29)){
																		...
																		HX_STACK_LINE(1016)
																		{
																			...
																			::zpp_nape::geom::ZPP_Vec2 tmp30 = _this1->lverts->next;		HX_STACK_VAR(tmp30,"tmp30");
																			HX_STACK_LINE(1016)
																			Float tmp31 = tmp30->next->x;		HX_STACK_VAR(tmp31,"tmp31");
																			HX_STACK_LINE(1016)
																			...
																			HX_STACK_LINE(1016)
																			Float tmp35 = tmp34->next->y;		HX_STACK_VAR(tmp35,"tmp35");
																			HX_STACK_LINE(1016)
																		...
																		HX_STACK_LINE(1016)
																		{
																			...
																			::zpp_nape::geom::ZPP_Vec2 tmp30 = _this1->lverts->next;		HX_STACK_VAR(tmp30,"tmp30");
																			HX_STACK_LINE(1016)
																			::zpp_nape::geom::ZPP_Vec2 cx_ite = tmp30;		HX_STACK_VAR(cx_ite,"cx_ite");
																			HX_STACK_LINE(1016)
																			::zpp_nape::geom::ZPP_Vec2 u = cx_ite;		HX_STACK_VAR(u,"u");
																			HX_STACK_LINE(1016)
																			cx_ite = cx_ite->next;
																			...
																			HX_STACK_LINE(1016)
																			{
																				...
																				Float tmp32 = v->x;		HX_STACK_VAR(tmp32,"tmp32");
																				HX_STACK_LINE(1016)
																				Float tmp33 = (w1->y - u->y);		HX_STACK_VAR(tmp33,"tmp33");
																				HX_STACK_LINE(1016)
																				Float tmp34 = (tmp32 * tmp33);		HX_STACK_VAR(tmp34,"tmp34");
																				HX_STACK_LINE(1016)
																				hx::AddEq(area,tmp34);
																				HX_STACK_LINE(1016)
																				Float tmp35 = (w1->y * v->x);		HX_STACK_VAR(tmp35,"tmp35");
																				HX_STACK_LINE(1016)
																				Float tmp36 = (w1->x * v->y);		HX_STACK_VAR(tmp36,"tmp36");
																				HX_STACK_LINE(1016)
																				Float tmp37 = (tmp35 - tmp36);		HX_STACK_VAR(tmp37,"tmp37");
																				HX_STACK_LINE(1016)
																				Float cf = tmp37;		HX_STACK_VAR(cf,"cf");
																				HX_STACK_LINE(1016)
																				Float tmp38 = (v->x + w1->x);		HX_STACK_VAR(tmp38,"tmp38");
																				HX_STACK_LINE(1016)
																				Float tmp39 = cf;		HX_STACK_VAR(tmp39,"tmp39");
																				HX_STACK_LINE(1016)
																				Float tmp40 = (tmp38 * tmp39);		HX_STACK_VAR(tmp40,"tmp40");
																				...
																				hx::AddEq(_this1->localCOMx,tmp40);
																				HX_STACK_LINE(1016)
																				Float tmp41 = (v->y + w1->y);		HX_STACK_VAR(tmp41,"tmp41");
																				HX_STACK_LINE(1016)
																				Float tmp42 = cf;		HX_STACK_VAR(tmp42,"tmp42");
																				HX_STACK_LINE(1016)
																				Float tmp43 = (tmp41 * tmp42);		HX_STACK_VAR(tmp43,"tmp43");
																		...
																		HX_STACK_LINE(1016)
																		Float tmp30 = ((int)3 * area);		HX_STACK_VAR(tmp30,"tmp30");
																		HX_STACK_LINE(1016)
	...
	while((true)){
		...
		if ((tmp10)){
			...
			if ((tmp13)){
				...
				if ((tmp18)){
					HX_STACK_LINE(2886)
					Float tmp19 = result->zpp_inner->toiDistance;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(2886)
					mint = tmp19;
					HX_STACK_LINE(2887)
