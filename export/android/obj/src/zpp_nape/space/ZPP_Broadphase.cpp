														...
														if ((tmp19)){
															...
															if ((tmp22)){
																HX_STACK_LINE(189)
																{
																	...
																	HX_STACK_LINE(189)
																	_this2->localCOMx = tmp23->x;
																	HX_STACK_LINE(189)
																	::zpp_nape::geom::ZPP_Vec2 tmp24 = _this2->lverts->next;		HX_STACK_VAR(tmp24,"tmp24");
																	HX_STACK_LINE(189)
																	_this2->localCOMy = tmp24->y;
																	HX_STACK_LINE(189)
																	{
																	}
																}
																HX_STACK_LINE(189)
																{
																	...
																	Float tmp26 = (tmp24 * tmp25);		HX_STACK_VAR(tmp26,"tmp26");
																	HX_STACK_LINE(189)
																	hx::AddEq(_this2->localCOMx,tmp26);
																	HX_STACK_LINE(189)
																	::zpp_nape::geom::ZPP_Vec2 tmp27 = _this2->lverts->next;		HX_STACK_VAR(tmp27,"tmp27");
																	HX_STACK_LINE(189)
																	...
																	Float tmp30 = (tmp28 * tmp29);		HX_STACK_VAR(tmp30,"tmp30");
																	HX_STACK_LINE(189)
																	hx::AddEq(_this2->localCOMy,tmp30);
																}
																HX_STACK_LINE(189)
																{
																	HX_STACK_LINE(189)
																...
																HX_STACK_LINE(189)
																{
																	...
																	while((true)){
																		...
																		HX_STACK_LINE(189)
																		{
																			...
																			Float tmp34 = (tmp32 * tmp33);		HX_STACK_VAR(tmp34,"tmp34");
																			HX_STACK_LINE(189)
																			hx::AddEq(_this2->localCOMx,tmp34);
																			HX_STACK_LINE(189)
																			...
																			HX_STACK_LINE(189)
																			hx::AddEq(_this2->localCOMy,tmp37);
																		}
																		HX_STACK_LINE(189)
																		u = v;
																		HX_STACK_LINE(189)
												...
												if ((tmp16)){
													...
													if ((tmp19)){
														...
														HX_STACK_LINE(227)
														{
															...
															Float tmp23 = (tmp21 * tmp22);		HX_STACK_VAR(tmp23,"tmp23");
															HX_STACK_LINE(227)
															hx::AddEq(_this2->localCOMx,tmp23);
															HX_STACK_LINE(227)
															::zpp_nape::geom::ZPP_Vec2 tmp24 = _this2->lverts->next;		HX_STACK_VAR(tmp24,"tmp24");
															HX_STACK_LINE(227)
															...
															Float tmp27 = (tmp25 * tmp26);		HX_STACK_VAR(tmp27,"tmp27");
															HX_STACK_LINE(227)
															hx::AddEq(_this2->localCOMy,tmp27);
														}
														HX_STACK_LINE(227)
														{
															HX_STACK_LINE(227)
														...
														HX_STACK_LINE(227)
														{
															...
															HX_STACK_LINE(227)
															{
																...
																Float tmp30 = (tmp28 * tmp29);		HX_STACK_VAR(tmp30,"tmp30");
																HX_STACK_LINE(227)
																hx::AddEq(_this2->localCOMx,tmp30);
																HX_STACK_LINE(227)
																...
																Float tmp33 = (tmp31 * tmp32);		HX_STACK_VAR(tmp33,"tmp33");
																HX_STACK_LINE(227)
																hx::AddEq(_this2->localCOMy,tmp33);
															}
															HX_STACK_LINE(227)
															u = v;
															HX_STACK_LINE(227)
