...
bool ZPP_Flags_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"id_CbEvent_END") ) { id_CbEvent_END=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_CbEvent_PRE") ) { id_CbEvent_PRE=ioValue.Cast< int >(); return true; }
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"id_CbEvent_WAKE") ) { id_CbEvent_WAKE=ioValue.Cast< int >(); return true; }
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"id_CbEvent_BEGIN") ) { id_CbEvent_BEGIN=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_CbEvent_SLEEP") ) { id_CbEvent_SLEEP=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_CbEvent_BREAK") ) { id_CbEvent_BREAK=ioValue.Cast< int >(); return true; }
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"id_MassMode_FIXED") ) { id_MassMode_FIXED=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_PreFlag_ACCEPT") ) { id_PreFlag_ACCEPT=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_PreFlag_IGNORE") ) { id_PreFlag_IGNORE=ioValue.Cast< int >(); return true; }
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"id_ImmState_ACCEPT") ) { id_ImmState_ACCEPT=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_ImmState_IGNORE") ) { id_ImmState_IGNORE=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_ImmState_ALWAYS") ) { id_ImmState_ALWAYS=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_BodyType_STATIC") ) { id_BodyType_STATIC=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_CbEvent_ONGOING") ) { id_CbEvent_ONGOING=ioValue.Cast< int >(); return true; }
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"id_MassMode_DEFAULT") ) { id_MassMode_DEFAULT=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_BodyType_DYNAMIC") ) { id_BodyType_DYNAMIC=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_ListenerType_PRE") ) { id_ListenerType_PRE=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_ShapeType_CIRCLE") ) { id_ShapeType_CIRCLE=ioValue.Cast< int >(); return true; }
		...
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"id_InertiaMode_FIXED") ) { id_InertiaMode_FIXED=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_ListenerType_BODY") ) { id_ListenerType_BODY=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_Winding_UNDEFINED") ) { id_Winding_UNDEFINED=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_Winding_CLOCKWISE") ) { id_Winding_CLOCKWISE=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_ShapeType_POLYGON") ) { id_ShapeType_POLYGON=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_ArbiterType_FLUID") ) { id_ArbiterType_FLUID=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"GravMassMode_DEFAULT") ) { GravMassMode_DEFAULT=ioValue.Cast< ::nape::phys::GravMassMode >(); return true; }
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"id_GravMassMode_FIXED") ) { id_GravMassMode_FIXED=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_BodyType_KINEMATIC") ) { id_BodyType_KINEMATIC=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_ArbiterType_SENSOR") ) { id_ArbiterType_SENSOR=ioValue.Cast< int >(); return true; }
		...
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"id_GravMassMode_SCALED") ) { id_GravMassMode_SCALED=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_InertiaMode_DEFAULT") ) { id_InertiaMode_DEFAULT=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_PreFlag_ACCEPT_ONCE") ) { id_PreFlag_ACCEPT_ONCE=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_PreFlag_IGNORE_ONCE") ) { id_PreFlag_IGNORE_ONCE=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_InteractionType_ANY") ) { id_InteractionType_ANY=ioValue.Cast< int >(); return true; }
		...
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"id_GravMassMode_DEFAULT") ) { id_GravMassMode_DEFAULT=ioValue.Cast< int >(); return true; }
		...
		break;
	case 24:
		if (HX_FIELD_EQ(inName,"id_InteractionType_FLUID") ) { id_InteractionType_FLUID=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_Winding_ANTICLOCKWISE") ) { id_Winding_ANTICLOCKWISE=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_ArbiterType_COLLISION") ) { id_ArbiterType_COLLISION=ioValue.Cast< int >(); return true; }
		...
		break;
	case 25:
		if (HX_FIELD_EQ(inName,"id_InteractionType_SENSOR") ) { id_InteractionType_SENSOR=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_ValidationResult_VALID") ) { id_ValidationResult_VALID=ioValue.Cast< int >(); return true; }
		...
		break;
	case 26:
		if (HX_FIELD_EQ(inName,"id_ListenerType_CONSTRAINT") ) { id_ListenerType_CONSTRAINT=ioValue.Cast< int >(); return true; }
		...
		break;
	case 27:
		if (HX_FIELD_EQ(inName,"id_ListenerType_INTERACTION") ) { id_ListenerType_INTERACTION=ioValue.Cast< int >(); return true; }
		if (HX_FIELD_EQ(inName,"id_ValidationResult_CONCAVE") ) { id_ValidationResult_CONCAVE=ioValue.Cast< int >(); return true; }
		...
		break;
	case 28:
		if (HX_FIELD_EQ(inName,"id_InteractionType_COLLISION") ) { id_InteractionType_COLLISION=ioValue.Cast< int >(); return true; }
		...
		break;
	case 29:
		if (HX_FIELD_EQ(inName,"id_Broadphase_SWEEP_AND_PRUNE") ) { id_Broadphase_SWEEP_AND_PRUNE=ioValue.Cast< int >(); return true; }
		break;
	case 30:
		if (HX_FIELD_EQ(inName,"id_ValidationResult_DEGENERATE") ) { id_ValidationResult_DEGENERATE=ioValue.Cast< int >(); return true; }
		break;
	case 31:
		if (HX_FIELD_EQ(inName,"id_Broadphase_DYNAMIC_AABB_TREE") ) { id_Broadphase_DYNAMIC_AABB_TREE=ioValue.Cast< int >(); return true; }
		break;
	case 34:
		...
		break;
	case 37:
		if (HX_FIELD_EQ(inName,"id_ValidationResult_SELF_INTERSECTING") ) { id_ValidationResult_SELF_INTERSECTING=ioValue.Cast< int >(); return true; }
	}
	return false;
}
