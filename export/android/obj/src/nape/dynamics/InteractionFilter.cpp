...
bool InteractionFilter_obj::shouldCollide( ::nape::dynamics::InteractionFilter filter){
	...
	HX_STACK_LINE(404)
	{
		...
		::zpp_nape::dynamics::ZPP_InteractionFilter tmp1 = this->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(404)
		::zpp_nape::dynamics::ZPP_InteractionFilter _this = tmp1;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(404)
		::zpp_nape::dynamics::ZPP_InteractionFilter x = filter->zpp_inner;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(404)
		int tmp2 = (int(_this->collisionMask) & int(x->collisionGroup));		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(404)
		bool tmp3 = (tmp2 != (int)0);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(404)
		if ((tmp3)){
			HX_STACK_LINE(404)
			int tmp4 = (int(x->collisionMask) & int(_this->collisionGroup));		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(404)
...
bool InteractionFilter_obj::shouldSense( ::nape::dynamics::InteractionFilter filter){
	...
	HX_STACK_LINE(420)
	{
		...
		::zpp_nape::dynamics::ZPP_InteractionFilter x = filter->zpp_inner;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(420)
		int tmp2 = (int(_this->sensorMask) & int(x->sensorGroup));		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(420)
		bool tmp3 = (tmp2 != (int)0);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(420)
		if ((tmp3)){
			HX_STACK_LINE(420)
			int tmp4 = (int(x->sensorMask) & int(_this->sensorGroup));		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(420)
			int tmp5 = tmp4;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(420)
			tmp = (tmp5 != (int)0);
...
bool InteractionFilter_obj::shouldFlow( ::nape::dynamics::InteractionFilter filter){
	...
	HX_STACK_LINE(436)
	{
		...
		::zpp_nape::dynamics::ZPP_InteractionFilter x = filter->zpp_inner;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(436)
		int tmp2 = (int(_this->fluidMask) & int(x->fluidGroup));		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(436)
		bool tmp3 = (tmp2 != (int)0);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(436)
		if ((tmp3)){
			HX_STACK_LINE(436)
			int tmp4 = (int(x->fluidMask) & int(_this->fluidGroup));		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(436)
			int tmp5 = tmp4;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(436)
			tmp = (tmp5 != (int)0);
