...
bool Arbiter_obj::get_isSleeping( ){
	...
	HX_STACK_LINE(196)
	bool tmp1 = tmp->sleeping;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(196)
	return tmp1;
}
...
::nape::shape::Shape Arbiter_obj::get_shape1( ){
	...
	::zpp_nape::dynamics::ZPP_Arbiter tmp = this->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(270)
	int tmp1 = tmp->ws1->id;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(270)
	::zpp_nape::dynamics::ZPP_Arbiter tmp2 = this->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(270)
	int tmp3 = tmp2->ws2->id;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(270)
...
::nape::callbacks::PreFlag Arbiter_obj::get_state( ){
	...
	HX_STACK_LINE(327)
	{
		...
		HX_STACK_LINE(327)
		int _g = tmp1->immState;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(327)
		{
			HX_STACK_LINE(327)
			...
			HX_STACK_LINE(328)
			int tmp3 = ::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ACCEPT;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(328)
			int tmp4 = ::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ALWAYS;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(328)
			...
			if ((tmp6)){
				HX_STACK_LINE(328)
				::nape::callbacks::PreFlag tmp7 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT;		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(328)
				...
				if ((tmp8)){
					...
					HX_STACK_LINE(328)
					::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT = tmp9;
					HX_STACK_LINE(328)
				...
				switch( (int)(tmp7)){
					case (int)1: {
						HX_STACK_LINE(329)
						::nape::callbacks::PreFlag tmp8 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT_ONCE;		HX_STACK_VAR(tmp8,"tmp8");
						HX_STACK_LINE(329)
						...
						if ((tmp9)){
							...
							HX_STACK_LINE(329)
							::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT_ONCE = tmp10;
							HX_STACK_LINE(329)
							::zpp_nape::util::ZPP_Flags_obj::internal = false;
						}
						HX_STACK_LINE(329)
						tmp = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT_ONCE;
					}
					;break;
					default: {
						HX_STACK_LINE(330)
						...
						HX_STACK_LINE(330)
						int tmp9 = ::zpp_nape::util::ZPP_Flags_obj::id_ImmState_IGNORE;		HX_STACK_VAR(tmp9,"tmp9");
						HX_STACK_LINE(330)
						int tmp10 = ::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ALWAYS;		HX_STACK_VAR(tmp10,"tmp10");
						HX_STACK_LINE(330)
						...
						if ((tmp12)){
							HX_STACK_LINE(330)
							::nape::callbacks::PreFlag tmp13 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(330)
							...
							if ((tmp14)){
								...
								::zpp_nape::util::ZPP_Flags_obj::internal = true;
								HX_STACK_LINE(330)
								::nape::callbacks::PreFlag tmp15 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(330)
								::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE = tmp15;
								HX_STACK_LINE(330)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(330)
							tmp = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE;
						}
						else{
							HX_STACK_LINE(331)
							::nape::callbacks::PreFlag tmp13 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE_ONCE;		HX_STACK_VAR(tmp13,"tmp13");
							HX_STACK_LINE(331)
							bool tmp14 = (tmp13 == null());		HX_STACK_VAR(tmp14,"tmp14");
							HX_STACK_LINE(331)
							if ((tmp14)){
								...
								::nape::callbacks::PreFlag tmp15 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp15,"tmp15");
								HX_STACK_LINE(331)
								::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE_ONCE = tmp15;
								HX_STACK_LINE(331)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(331)
							tmp = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE_ONCE;
						}
					}
				}
			}
...
::String Arbiter_obj::toString( ){
	...
	if ((tmp6)){
		...
		HX_STACK_LINE(379)
		int tmp9 = tmp8->ws1->id;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(379)
		::zpp_nape::dynamics::ZPP_Arbiter tmp10 = this->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(379)
		int tmp11 = tmp10->ws2->id;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(379)
		...
		if ((tmp12)){
			...
			HX_STACK_LINE(379)
			tmp13 = tmp14->ws2->outer;
		}
		else{
			HX_STACK_LINE(379)
			::zpp_nape::dynamics::ZPP_Arbiter tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(379)
			tmp13 = tmp14->ws1->outer;
		}
		HX_STACK_LINE(379)
		::String tmp14 = tmp13->toString();		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(379)
		::String tmp15 = (tmp7 + tmp14);		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(379)
		...
		HX_STACK_LINE(379)
		int tmp20 = tmp19->ws2->id;		HX_STACK_VAR(tmp20,"tmp20");
		HX_STACK_LINE(379)
		...
		if ((tmp21)){
			HX_STACK_LINE(379)
			::zpp_nape::dynamics::ZPP_Arbiter tmp23 = this->zpp_inner;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(379)
			tmp22 = tmp23->ws1->outer;
		}
		else{
			HX_STACK_LINE(379)
			::zpp_nape::dynamics::ZPP_Arbiter tmp23 = this->zpp_inner;		HX_STACK_VAR(tmp23,"tmp23");
			HX_STACK_LINE(379)
			tmp22 = tmp23->ws2->outer;
		}
		HX_STACK_LINE(379)
		::String tmp23 = tmp22->toString();		HX_STACK_VAR(tmp23,"tmp23");
		HX_STACK_LINE(379)
		::String tmp24 = (tmp16 + tmp23);		HX_STACK_VAR(tmp24,"tmp24");
		HX_STACK_LINE(379)
		::String tmp25 = (tmp24 + HX_HCSTRING(")","\x29","\x00","\x00","\x00"));		HX_STACK_VAR(tmp25,"tmp25");
		HX_STACK_LINE(379)
		::zpp_nape::dynamics::ZPP_Arbiter tmp26 = this->zpp_inner;		HX_STACK_VAR(tmp26,"tmp26");
		HX_STACK_LINE(379)
		int tmp27 = tmp26->type;		HX_STACK_VAR(tmp27,"tmp27");
		HX_STACK_LINE(379)
		...
		if ((tmp29)){
			HX_STACK_LINE(379)
			::zpp_nape::dynamics::ZPP_Arbiter tmp31 = this->zpp_inner;		HX_STACK_VAR(tmp31,"tmp31");
			HX_STACK_LINE(379)
			bool tmp32 = tmp31->colarb->stat;		HX_STACK_VAR(tmp32,"tmp32");
			HX_STACK_LINE(379)
			...
			HX_STACK_LINE(379)
			::String tmp34 = Array_obj< ::String >::__new().Add(HX_HCSTRING("SD","\x91","\x48","\x00","\x00")).Add(HX_HCSTRING("DD","\x80","\x3b","\x00","\x00"))->__get(tmp33);		HX_STACK_VAR(tmp34,"tmp34");
			HX_STACK_LINE(379)
			::String tmp35 = (HX_HCSTRING("[","\x5b","\x00","\x00","\x00") + tmp34);		HX_STACK_VAR(tmp35,"tmp35");
			HX_STACK_LINE(379)
			tmp30 = (tmp35 + HX_HCSTRING("]","\x5d","\x00","\x00","\x00"));
		}
		else{
			HX_STACK_LINE(379)
		...
		HX_STACK_LINE(379)
		::String tmp31 = (tmp25 + tmp30);		HX_STACK_VAR(tmp31,"tmp31");
		HX_STACK_LINE(379)
		::String tmp32 = (tmp31 + HX_HCSTRING("<-","\x71","\x34","\x00","\x00"));		HX_STACK_VAR(tmp32,"tmp32");
		HX_STACK_LINE(379)
		::nape::callbacks::PreFlag tmp33;		HX_STACK_VAR(tmp33,"tmp33");
		HX_STACK_LINE(379)
		{
			HX_STACK_LINE(379)
			::zpp_nape::dynamics::ZPP_Arbiter tmp34 = this->zpp_inner;		HX_STACK_VAR(tmp34,"tmp34");
			HX_STACK_LINE(379)
			int _g = tmp34->immState;		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(379)
			{
				HX_STACK_LINE(379)
				int x = _g;		HX_STACK_VAR(x,"x");
				...
				HX_STACK_LINE(379)
				int tmp36 = ::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ACCEPT;		HX_STACK_VAR(tmp36,"tmp36");
				HX_STACK_LINE(379)
				int tmp37 = ::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ALWAYS;		HX_STACK_VAR(tmp37,"tmp37");
				HX_STACK_LINE(379)
				...
				if ((tmp39)){
					HX_STACK_LINE(379)
					::nape::callbacks::PreFlag tmp40 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT;		HX_STACK_VAR(tmp40,"tmp40");
					HX_STACK_LINE(379)
					...
					if ((tmp41)){
						...
						::zpp_nape::util::ZPP_Flags_obj::internal = true;
						HX_STACK_LINE(379)
						::nape::callbacks::PreFlag tmp42 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp42,"tmp42");
						HX_STACK_LINE(379)
						::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT = tmp42;
						HX_STACK_LINE(379)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(379)
					tmp33 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT;
				}
				else{
					HX_STACK_LINE(379)
					int x1 = _g;		HX_STACK_VAR(x1,"x1");
					...
					switch( (int)(tmp40)){
						case (int)1: {
							HX_STACK_LINE(379)
							::nape::callbacks::PreFlag tmp41 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT_ONCE;		HX_STACK_VAR(tmp41,"tmp41");
							HX_STACK_LINE(379)
							...
							if ((tmp42)){
								...
								::zpp_nape::util::ZPP_Flags_obj::internal = true;
								HX_STACK_LINE(379)
								::nape::callbacks::PreFlag tmp43 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp43,"tmp43");
								HX_STACK_LINE(379)
								::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT_ONCE = tmp43;
								HX_STACK_LINE(379)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(379)
							tmp33 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_ACCEPT_ONCE;
						}
						;break;
						default: {
							HX_STACK_LINE(379)
							int tmp41 = x1;		HX_STACK_VAR(tmp41,"tmp41");
							HX_STACK_LINE(379)
							int tmp42 = ::zpp_nape::util::ZPP_Flags_obj::id_ImmState_IGNORE;		HX_STACK_VAR(tmp42,"tmp42");
							HX_STACK_LINE(379)
							int tmp43 = ::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ALWAYS;		HX_STACK_VAR(tmp43,"tmp43");
							HX_STACK_LINE(379)
							...
							if ((tmp45)){
								HX_STACK_LINE(379)
								::nape::callbacks::PreFlag tmp46 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE;		HX_STACK_VAR(tmp46,"tmp46");
								HX_STACK_LINE(379)
								...
								if ((tmp47)){
									...
									::zpp_nape::util::ZPP_Flags_obj::internal = true;
									HX_STACK_LINE(379)
									::nape::callbacks::PreFlag tmp48 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp48,"tmp48");
									HX_STACK_LINE(379)
									::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE = tmp48;
									HX_STACK_LINE(379)
									::zpp_nape::util::ZPP_Flags_obj::internal = false;
								}
								HX_STACK_LINE(379)
								tmp33 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE;
							}
							else{
								HX_STACK_LINE(379)
								::nape::callbacks::PreFlag tmp46 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE_ONCE;		HX_STACK_VAR(tmp46,"tmp46");
								HX_STACK_LINE(379)
								bool tmp47 = (tmp46 == null());		HX_STACK_VAR(tmp47,"tmp47");
								HX_STACK_LINE(379)
								if ((tmp47)){
									...
									::nape::callbacks::PreFlag tmp48 = ::nape::callbacks::PreFlag_obj::__new();		HX_STACK_VAR(tmp48,"tmp48");
									HX_STACK_LINE(379)
									::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE_ONCE = tmp48;
									HX_STACK_LINE(379)
									::zpp_nape::util::ZPP_Flags_obj::internal = false;
								}
								HX_STACK_LINE(379)
								tmp33 = ::zpp_nape::util::ZPP_Flags_obj::PreFlag_IGNORE_ONCE;
							}
						}
					}
				}
		...
		HX_STACK_LINE(379)
		::String tmp34 = tmp33->toString();		HX_STACK_VAR(tmp34,"tmp34");
		HX_STACK_LINE(379)
