...
::nape::dynamics::Arbiter ArbiterList_obj::at( int index){
	...
	if ((tmp2)){
		...
		if ((tmp7)){
			...
			HX_STACK_LINE(372)
			::zpp_nape::util::ZPP_ArbiterList tmp10 = tmp9;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp11 = tmp10->at_ite;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(372)
			tmp8 = (tmp11 == null());
		}
		else{
		...
		if ((tmp8)){
			...
			HX_STACK_LINE(374)
			::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp12 = tmp10->inner->iterator_at(tmp11);		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(374)
			...
			while((true)){
				...
				HX_STACK_LINE(379)
				::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp16 = tmp15->at_ite->next;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(379)
		...
		if ((tmp8)){
			...
			::zpp_nape::util::ZPP_ArbiterList tmp10 = this->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(386)
			::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp11 = tmp10->inner->head;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(386)
			...
			while((true)){
				...
				::zpp_nape::util::ZPP_ArbiterList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(388)
				::zpp_nape::dynamics::ZPP_Arbiter tmp14 = tmp13->at_ite->elt;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(388)
				::zpp_nape::dynamics::ZPP_Arbiter x = tmp14;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(389)
				...
				HX_STACK_LINE(390)
				::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp17 = tmp16->at_ite->next;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(390)
		...
		while((true)){
			...
			while((true)){
				...
				::zpp_nape::util::ZPP_ArbiterList tmp18 = this->zpp_inner;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(397)
				::zpp_nape::dynamics::ZPP_Arbiter tmp19 = tmp18->at_ite->elt;		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(397)
				::zpp_nape::dynamics::ZPP_Arbiter x = tmp19;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(398)
				...
				HX_STACK_LINE(399)
				::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp22 = tmp21->at_ite->next;		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_ArbiterList tmp23 = this->zpp_inner;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(399)
				tmp23->at_ite = tmp22;
			}
		}
	...
	::zpp_nape::util::ZPP_ArbiterList tmp3 = this->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(403)
	::zpp_nape::dynamics::ZPP_Arbiter tmp4 = tmp3->at_ite->elt;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(403)
	::nape::dynamics::Arbiter tmp5 = tmp4->wrapper();		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(403)
	return tmp5;
}
...
bool ArbiterList_obj::push( ::nape::dynamics::Arbiter obj){
	...
	if ((tmp3)){
		...
		::zpp_nape::util::ZPP_ArbiterList tmp5 = this->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(424)
		::nape::dynamics::Arbiter tmp6 = obj;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(424)
	...
	if ((tmp5)){
		...
		if ((tmp7)){
			...
			HX_STACK_LINE(426)
			::zpp_nape::dynamics::ZPP_Arbiter tmp9 = obj->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(426)
			tmp8->inner->add(tmp9);
		}
		else{
			...
			::zpp_nape::util::ZPP_ArbiterList tmp8 = this->zpp_inner;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(428)
			::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp9 = tmp8->push_ite;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(428)
			...
			::zpp_nape::util::ZPP_ArbiterList tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp13 = tmp12->push_ite;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(429)
			::zpp_nape::dynamics::ZPP_Arbiter tmp14 = obj->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp15 = tmp11->inner->insert(tmp13,tmp14);		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZPP_ArbiterList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(429)
		...
		if ((tmp11)){
			...
			::zpp_nape::util::ZPP_ArbiterList tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(432)
			::nape::dynamics::Arbiter tmp13 = obj;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(432)
...
::nape::dynamics::Arbiter ArbiterList_obj::pop( ){
	...
	if ((tmp2)){
		...
		ret = tmp4->elt;
		HX_STACK_LINE(492)
		::nape::dynamics::Arbiter tmp5 = ret->wrapper();		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(492)
		::nape::dynamics::Arbiter retx = tmp5;		HX_STACK_VAR(retx,"retx");
		HX_STACK_LINE(493)
		::zpp_nape::util::ZPP_ArbiterList tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(493)
		...
		if ((tmp8)){
			...
			::zpp_nape::util::ZPP_ArbiterList tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(493)
			::nape::dynamics::Arbiter tmp10 = retx;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(493)
			tmp9->subber(tmp10);
		}
		HX_STACK_LINE(494)
		...
		::zpp_nape::util::ZPP_ArbiterList tmp3 = this->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(497)
		::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp4 = tmp3->at_ite;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(497)
		...
		if ((tmp5)){
			...
			HX_STACK_LINE(497)
			::zpp_nape::util::ZPP_ArbiterList tmp8 = tmp7;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp9 = tmp8->at_ite->next;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp10 = tmp9;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(497)
			tmp6 = (tmp10 == null());
		}
		else{
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp9;		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(498)
		if ((tmp8)){
			HX_STACK_LINE(498)
			tmp9 = null();
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_Arbiter ite = tmp9;		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(499)
		bool tmp10 = (ite == null());		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(499)
		::zpp_nape::dynamics::ZPP_Arbiter tmp11;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(499)
		if ((tmp10)){
			HX_STACK_LINE(499)
			::zpp_nape::util::ZPP_ArbiterList tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(499)
			::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp13 = tmp12->inner->head;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(499)
			tmp11 = tmp13->elt;
		}
		else{
		...
		ret = tmp11;
		HX_STACK_LINE(500)
		::nape::dynamics::Arbiter tmp12 = ret->wrapper();		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(500)
		::nape::dynamics::Arbiter retx = tmp12;		HX_STACK_VAR(retx,"retx");
		HX_STACK_LINE(501)
		::zpp_nape::util::ZPP_ArbiterList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(501)
		...
		if ((tmp15)){
			...
			::zpp_nape::util::ZPP_ArbiterList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(501)
			::nape::dynamics::Arbiter tmp17 = retx;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(501)
			tmp16->subber(tmp17);
		}
		HX_STACK_LINE(502)
		...
		if ((tmp18)){
			...
			HX_STACK_LINE(502)
			::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp20 = ite;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(502)
	...
	tmp3->invalidate();
	HX_STACK_LINE(505)
	::nape::dynamics::Arbiter tmp4 = ret->wrapper();		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(505)
	::nape::dynamics::Arbiter retx = tmp4;		HX_STACK_VAR(retx,"retx");
	HX_STACK_LINE(506)
	::nape::dynamics::Arbiter tmp5 = retx;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(506)
	return tmp5;
}
...
bool ArbiterList_obj::remove( ::nape::dynamics::Arbiter obj){
	...
	HX_STACK_LINE(585)
	{
		...
		HX_STACK_LINE(587)
		{
			...
			::zpp_nape::util::ZPP_ArbiterList tmp1 = this->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_ZPP_Arbiter tmp2 = tmp1->inner->head;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(588)
...
Void ArbiterList_obj::merge( ::nape::dynamics::ArbiterList xs){
{
		...
		HX_STACK_ARG(xs,"xs")
		HX_STACK_LINE(688)
		::nape::dynamics::ArbiterIterator tmp = xs->iterator();		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(688)
		...
		while((true)){
			...
			HX_STACK_LINE(688)
			::nape::dynamics::Arbiter x = tmp3;		HX_STACK_VAR(x,"x");
			HX_STACK_LINE(689)
			::nape::dynamics::Arbiter tmp4 = x;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(689)
...
::nape::dynamics::ArbiterList ArbiterList_obj::foreach( Dynamic lambda){
	...
	::nape::dynamics::ArbiterIterator tmp = this->iterator();		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(736)
	::nape::dynamics::ArbiterIterator it = tmp;		HX_STACK_VAR(it,"it");
	HX_STACK_LINE(737)
	while((true)){
		HX_STACK_LINE(737)
		bool tmp1;		HX_STACK_VAR(tmp1,"tmp1");
		...
		{
			HX_STACK_LINE(737)
			::zpp_nape::util::ZPP_ArbiterList tmp2 = it->zpp_inner->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(737)
			tmp2->valmod();
			HX_STACK_LINE(737)
...
::nape::dynamics::ArbiterList ArbiterList_obj::filter( Dynamic lambda){
	...
	while((true)){
		...
		HX_STACK_LINE(785)
		::nape::dynamics::Arbiter tmp5 = this->at(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(785)
		::nape::dynamics::Arbiter x = tmp5;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(786)
		try
		{
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			HX_STACK_LINE(787)
			::nape::dynamics::Arbiter tmp6 = x;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(787)
