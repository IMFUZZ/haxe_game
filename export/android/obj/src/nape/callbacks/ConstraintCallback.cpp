...
::String ConstraintCallback_obj::toString( ){
	...
	HX_STACK_LINE(200)
	int tmp2 = ::zpp_nape::util::ZPP_Flags_obj::id_CbEvent_WAKE;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(200)
	int tmp3 = (tmp1 - tmp2);		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(200)
	::String tmp4 = Array_obj< ::String >::__new().Add(HX_HCSTRING("WAKE","\x24","\x24","\xb3","\x39")).Add(HX_HCSTRING("SLEEP","\xf7","\xf4","\xb2","\xfc")).Add(HX_HCSTRING("BREAK","\x9f","\x5c","\xda","\x36"))->__get(tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(200)
	hx::AddEq(ret,tmp4);
	HX_STACK_LINE(201)
	::zpp_nape::callbacks::ZPP_Callback tmp5 = this->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(201)
	::nape::constraint::Constraint tmp6 = tmp5->constraint->outer;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(201)
	::String tmp7 = tmp6->toString();		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(201)
	::String tmp8 = (HX_HCSTRING(":","\x3a","\x00","\x00","\x00") + tmp7);		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(201)
	hx::AddEq(ret,tmp8);
	HX_STACK_LINE(202)
	::zpp_nape::callbacks::ZPP_Callback tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(202)
	::nape::callbacks::Listener tmp10 = tmp9->listener->outer;		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(202)
	::String tmp11 = ::Std_obj::string(tmp10);		HX_STACK_VAR(tmp11,"tmp11");
	HX_STACK_LINE(202)
	::String tmp12 = (HX_HCSTRING(" : listener: ","\x60","\x26","\x46","\xe2") + tmp11);		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(202)
	hx::AddEq(ret,tmp12);
	HX_STACK_LINE(203)
	::String tmp13 = ret;		HX_STACK_VAR(tmp13,"tmp13");
	HX_STACK_LINE(203)
	return tmp13;
}
