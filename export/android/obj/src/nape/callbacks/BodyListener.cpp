...
int precedence = __o_precedence.Default(0);
{
	...
	HX_STACK_LINE(269)
	::zpp_nape::callbacks::ZPP_BodyListener tmp7 = ::zpp_nape::callbacks::ZPP_BodyListener_obj::__new(tmp4,tmp5,tmp6);		HX_STACK_VAR(tmp7,"tmp7");
	HX_STACK_LINE(269)
	this->zpp_inner_zn = tmp7;
	HX_STACK_LINE(270)
	::zpp_nape::callbacks::ZPP_BodyListener tmp8 = this->zpp_inner_zn;		HX_STACK_VAR(tmp8,"tmp8");
	HX_STACK_LINE(270)
	this->zpp_inner = tmp8;
	HX_STACK_LINE(271)
	...
	HX_STACK_LINE(272)
	::zpp_nape::callbacks::ZPP_BodyListener tmp10 = this->zpp_inner_zn;		HX_STACK_VAR(tmp10,"tmp10");
	HX_STACK_LINE(272)
