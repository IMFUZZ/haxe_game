...
::nape::geom::ConvexResult ConvexResultList_obj::at( int index){
	...
	if ((tmp3)){
		...
		if ((tmp8)){
			...
			::zpp_nape::util::ZPP_ConvexResultList tmp10 = this->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZPP_ConvexResultList tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZNPNode_ConvexResult tmp12 = tmp11->at_ite;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(372)
			tmp9 = (tmp12 == null());
		}
		else{
		...
		if ((tmp9)){
			...
			HX_STACK_LINE(374)
			::zpp_nape::util::ZNPNode_ConvexResult tmp13 = tmp11->inner->iterator_at(tmp12);		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(374)
			...
			while((true)){
				...
				HX_STACK_LINE(379)
				::zpp_nape::util::ZNPNode_ConvexResult tmp17 = tmp16->at_ite->next;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(379)
		...
		if ((tmp9)){
			...
			::zpp_nape::util::ZPP_ConvexResultList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(386)
			::zpp_nape::util::ZNPNode_ConvexResult tmp12 = tmp11->inner->head;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(386)
			...
			while((true)){
				...
				::zpp_nape::util::ZPP_ConvexResultList tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(388)
				::nape::geom::ConvexResult tmp15 = tmp14->at_ite->elt;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(388)
				::nape::geom::ConvexResult x = tmp15;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(389)
				break;
				HX_STACK_LINE(390)
				::zpp_nape::util::ZPP_ConvexResultList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
		...
		while((true)){
			...
			while((true)){
				...
				HX_STACK_LINE(397)
				::nape::geom::ConvexResult tmp20 = tmp19->at_ite->elt;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(397)
				::nape::geom::ConvexResult x = tmp20;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(398)
				break;
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_ConvexResultList tmp21 = this->zpp_inner;		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZNPNode_ConvexResult tmp22 = tmp21->at_ite->next;		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_ConvexResultList tmp23 = this->zpp_inner;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(399)
				tmp23->at_ite = tmp22;
			}
		}
	...
	::zpp_nape::util::ZPP_ConvexResultList tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(403)
	::nape::geom::ConvexResult tmp5 = tmp4->at_ite->elt;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(403)
	return tmp5;
}
...
bool ConvexResultList_obj::push( ::nape::geom::ConvexResult obj){
	...
	if ((tmp4)){
		...
		::zpp_nape::util::ZPP_ConvexResultList tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(424)
		::nape::geom::ConvexResult tmp7 = obj;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(424)
	...
	if ((tmp6)){
		...
		if ((tmp8)){
			...
			HX_STACK_LINE(426)
			::nape::geom::ConvexResult tmp10 = obj;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(426)
			...
			::zpp_nape::util::ZPP_ConvexResultList tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(428)
			::zpp_nape::util::ZNPNode_ConvexResult tmp10 = tmp9->push_ite;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(428)
			...
			if ((tmp11)){
				...
				HX_STACK_LINE(428)
				{
					...
					::zpp_nape::util::ZPP_ConvexResultList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(428)
					::zpp_nape::util::ZNPNode_ConvexResult tmp14 = tmp13->inner->head;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(428)
					tmp12 = (tmp14 == null());
				}
				HX_STACK_LINE(428)
			...
			::zpp_nape::util::ZPP_ConvexResultList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ConvexResult tmp14 = tmp13->push_ite;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(429)
			::nape::geom::ConvexResult tmp15 = obj;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ConvexResult tmp16 = tmp12->inner->insert(tmp14,tmp15);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZPP_ConvexResultList tmp17 = this->zpp_inner;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(429)
		...
		if ((tmp12)){
			...
			::zpp_nape::util::ZPP_ConvexResultList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(432)
			::nape::geom::ConvexResult tmp14 = obj;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(432)
...
::nape::geom::ConvexResult ConvexResultList_obj::pop( ){
	...
	if ((tmp3)){
		...
		if ((tmp8)){
			...
			::zpp_nape::util::ZPP_ConvexResultList tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(493)
			::nape::geom::ConvexResult tmp10 = retx;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(493)
			tmp9->subber(tmp10);
		}
		HX_STACK_LINE(494)
		...
		::zpp_nape::util::ZPP_ConvexResultList tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(497)
		::zpp_nape::util::ZNPNode_ConvexResult tmp5 = tmp4->at_ite;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(497)
		...
		if ((tmp6)){
			...
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ConvexResult tmp10 = tmp9->at_ite->next;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ConvexResult tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(497)
			tmp7 = (tmp11 == null());
		}
		else{
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ConvexResult tmp10;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(498)
		if ((tmp9)){
			HX_STACK_LINE(498)
			tmp10 = null();
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ConvexResult ite = tmp10;		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(499)
		bool tmp11 = (ite == null());		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(499)
		::nape::geom::ConvexResult tmp12;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(499)
		if ((tmp11)){
			HX_STACK_LINE(499)
			::zpp_nape::util::ZPP_ConvexResultList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
		...
		if ((tmp15)){
			...
			::zpp_nape::util::ZPP_ConvexResultList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(501)
			::nape::geom::ConvexResult tmp17 = retx;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(501)
			tmp16->subber(tmp17);
		}
		HX_STACK_LINE(502)
		...
		if ((tmp18)){
			...
			::zpp_nape::util::ZPP_ConvexResultList tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(502)
			::zpp_nape::util::ZNPNode_ConvexResult tmp20 = ite;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(502)
	...
	::nape::geom::ConvexResult retx = ret;		HX_STACK_VAR(retx,"retx");
	HX_STACK_LINE(506)
	::nape::geom::ConvexResult tmp5 = retx;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(506)
	return tmp5;
}
...
bool ConvexResultList_obj::remove( ::nape::geom::ConvexResult obj){
	...
	HX_STACK_LINE(585)
	{
		...
		HX_STACK_LINE(587)
		{
			...
			::zpp_nape::util::ZPP_ConvexResultList tmp2 = this->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_ConvexResult tmp3 = tmp2->inner->head;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_ConvexResult cx_ite = tmp3;		HX_STACK_VAR(cx_ite,"cx_ite");
			HX_STACK_LINE(589)
			while((true)){
				HX_STACK_LINE(589)
				...
				{
					HX_STACK_LINE(592)
					bool tmp6 = (x == obj);		HX_STACK_VAR(tmp6,"tmp6");
					HX_STACK_LINE(592)
					if ((tmp6)){
						HX_STACK_LINE(593)
						ret = true;
		...
		if ((tmp1)){
			...
			while((true)){
				...
				HX_STACK_LINE(619)
				{
					...
					::zpp_nape::util::ZPP_ConvexResultList tmp3 = this->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
					HX_STACK_LINE(619)
					::zpp_nape::util::ZNPNode_ConvexResult tmp4 = tmp3->inner->head;		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(619)
					tmp2 = (tmp4 == null());
				}
				HX_STACK_LINE(619)
...
Void ConvexResultList_obj::merge( ::nape::geom::ConvexResultList xs){
{
		...
		HX_STACK_LINE(688)
		{
			...
			xs->zpp_inner->valmod();
			HX_STACK_LINE(688)
			::nape::geom::ConvexResultList tmp1 = xs;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(688)
			tmp = ::nape::geom::ConvexResultIterator_obj::get(tmp1);
		}
		HX_STACK_LINE(688)
		...
		while((true)){
			...
			HX_STACK_LINE(688)
			::nape::geom::ConvexResult x = tmp3;		HX_STACK_VAR(x,"x");
			HX_STACK_LINE(689)
			::nape::geom::ConvexResult tmp4 = x;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(689)
...
::nape::geom::ConvexResultList ConvexResultList_obj::foreach( Dynamic lambda){
	...
	HX_STACK_LINE(736)
	::nape::geom::ConvexResultIterator it = tmp;		HX_STACK_VAR(it,"it");
	HX_STACK_LINE(737)
	while((true)){
		HX_STACK_LINE(737)
		bool tmp1;		HX_STACK_VAR(tmp1,"tmp1");
		...
		{
			HX_STACK_LINE(737)
			::zpp_nape::util::ZPP_ConvexResultList tmp2 = it->zpp_inner->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(737)
			tmp2->valmod();
			HX_STACK_LINE(737)
			int tmp3;		HX_STACK_VAR(tmp3,"tmp3");
...
::nape::geom::ConvexResultList ConvexResultList_obj::filter( Dynamic lambda){
	...
	while((true)){
		...
		HX_STACK_LINE(785)
		::nape::geom::ConvexResult tmp5 = this->at(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(785)
		::nape::geom::ConvexResult x = tmp5;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(786)
		try
		{
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			HX_STACK_LINE(787)
			::nape::geom::ConvexResult tmp6 = x;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(787)
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(788)
				::nape::geom::ConvexResult tmp8 = x;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(788)
				this->remove(tmp8);
			}
		}
