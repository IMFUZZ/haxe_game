...
Float Geom_obj::distanceBody( ::nape::phys::Body body1,::nape::phys::Body body2,::nape::geom::Vec2 out1,::nape::geom::Vec2 out2){
	...
	{
		HX_STACK_LINE(240)
		::zpp_nape::util::ZNPList_ZPP_Shape tmp = body1->zpp_inner->shapes;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(240)
		...
		while((true)){
			...
			HX_STACK_LINE(243)
			::zpp_nape::shape::ZPP_Shape tmp3 = i;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(243)
			::zpp_nape::geom::ZPP_Geom_obj::validateShape(tmp3);
			HX_STACK_LINE(244)
			cx_ite = cx_ite->next;
		}
	}
	...
	{
		HX_STACK_LINE(248)
		::zpp_nape::util::ZNPList_ZPP_Shape tmp = body2->zpp_inner->shapes;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(248)
		::zpp_nape::util::ZNPNode_ZPP_Shape cx_ite = tmp->head;		HX_STACK_VAR(cx_ite,"cx_ite");
		HX_STACK_LINE(249)
		while((true)){
	...
	HX_STACK_LINE(255)
	::zpp_nape::phys::ZPP_Body tmp = body1->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(255)
	::zpp_nape::phys::ZPP_Body tmp1 = body2->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(255)
	::zpp_nape::geom::ZPP_Vec2 tmp2 = out1->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(255)
	::zpp_nape::geom::ZPP_Vec2 tmp3 = out2->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(255)
	Float tmp4 = ::zpp_nape::geom::ZPP_SweepDistance_obj::distanceBody(tmp,tmp1,tmp2,tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(255)
	return tmp4;
}
...
Float Geom_obj::distance( ::nape::shape::Shape shape1,::nape::shape::Shape shape2,::nape::geom::Vec2 out1,::nape::geom::Vec2 out2){
	...
	HX_STACK_ARG(out2,"out2")
	HX_STACK_LINE(317)
	::zpp_nape::shape::ZPP_Shape tmp = shape1->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(317)
	::zpp_nape::geom::ZPP_Geom_obj::validateShape(tmp);
	HX_STACK_LINE(318)
	::zpp_nape::shape::ZPP_Shape tmp1 = shape2->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(318)
	::zpp_nape::geom::ZPP_Geom_obj::validateShape(tmp1);
	HX_STACK_LINE(319)
	...
	HX_STACK_LINE(320)
	{
		...
		if ((tmp4)){
			...
			tmp2 = tmp5;
			HX_STACK_LINE(329)
			::zpp_nape::geom::ZPP_Vec2_obj::zpp_pool = tmp2->next;
			HX_STACK_LINE(330)
			tmp2->next = null();
		}
		HX_STACK_LINE(335)
	...
	HX_STACK_LINE(337)
	{
		...
		if ((tmp7)){
			...
			HX_STACK_LINE(337)
			{
				...
				{
					HX_STACK_LINE(337)
					Float tmp8 = (c2->worldCOMx - c1->worldCOMx);		HX_STACK_VAR(tmp8,"tmp8");
					HX_STACK_LINE(337)
					nx = tmp8;
					HX_STACK_LINE(337)
					Float tmp9 = (c2->worldCOMy - c1->worldCOMy);		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(337)
					ny = tmp9;
				}
				HX_STACK_LINE(337)
				...
				HX_STACK_LINE(337)
				{
					...
					HX_STACK_LINE(337)
					tmp8 = ::Math_obj::sqrt(tmp11);
				}
				HX_STACK_LINE(337)
				Float len = tmp8;		HX_STACK_VAR(len,"len");
				HX_STACK_LINE(337)
				Float tmp9 = len;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(337)
				Float tmp10 = (c1->radius + c2->radius);		HX_STACK_VAR(tmp10,"tmp10");
				HX_STACK_LINE(337)
				Float tmp11 = (tmp9 - tmp10);		HX_STACK_VAR(tmp11,"tmp11");
				HX_STACK_LINE(337)
				dist = tmp11;
				HX_STACK_LINE(337)
				bool tmp12 = (dist < ((Float)1e100));		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(337)
				if ((tmp12)){
					HX_STACK_LINE(337)
					bool tmp13 = (len == (int)0);		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(337)
					if ((tmp13)){
						HX_STACK_LINE(337)
						nx = (int)1;
						...
						HX_STACK_LINE(337)
						Float tmp14 = (Float(((Float)1.0)) / Float(len));		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(337)
					...
					HX_STACK_LINE(337)
					{
						...
						HX_STACK_LINE(337)
						Float tmp14 = c1->worldCOMx;		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(337)
						Float tmp15 = (nx * t);		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(337)
						Float tmp16 = (tmp14 + tmp15);		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(337)
						w1->x = tmp16;
						HX_STACK_LINE(337)
						Float tmp17 = c1->worldCOMy;		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(337)
						Float tmp18 = (ny * t);		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(337)
					...
					{
						HX_STACK_LINE(337)
						Float tmp14 = c2->radius;		HX_STACK_VAR(tmp14,"tmp14");
						HX_STACK_LINE(337)
						Float tmp15 = -(tmp14);		HX_STACK_VAR(tmp15,"tmp15");
						HX_STACK_LINE(337)
						Float t = tmp15;		HX_STACK_VAR(t,"t");
						HX_STACK_LINE(337)
						Float tmp16 = c2->worldCOMx;		HX_STACK_VAR(tmp16,"tmp16");
						HX_STACK_LINE(337)
						Float tmp17 = (nx * t);		HX_STACK_VAR(tmp17,"tmp17");
						HX_STACK_LINE(337)
						Float tmp18 = (tmp16 + tmp17);		HX_STACK_VAR(tmp18,"tmp18");
						HX_STACK_LINE(337)
						w2->x = tmp18;
						HX_STACK_LINE(337)
						Float tmp19 = c2->worldCOMy;		HX_STACK_VAR(tmp19,"tmp19");
						HX_STACK_LINE(337)
						Float tmp20 = (ny * t);		HX_STACK_VAR(tmp20,"tmp20");
						HX_STACK_LINE(337)
			...
			if ((tmp11)){
				HX_STACK_LINE(337)
				::zpp_nape::shape::ZPP_Shape tmp12 = s1;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(337)
				s1 = s2;
				HX_STACK_LINE(337)
				s2 = tmp12;
			...
			HX_STACK_LINE(337)
			int tmp12 = s1->type;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(337)
			int tmp13 = ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_POLYGON;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(337)
			...
			if ((tmp14)){
				HX_STACK_LINE(337)
				int tmp16 = s2->type;		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(337)
			...
			if ((tmp15)){
				...
				if ((tmp18)){
					HX_STACK_LINE(337)
					Float tmp19 = tmp2->x;		HX_STACK_VAR(tmp19,"tmp19");
					HX_STACK_LINE(337)
					Float tmp20 = -(tmp19);		HX_STACK_VAR(tmp20,"tmp20");
					HX_STACK_LINE(337)
					tmp2->x = tmp20;
					HX_STACK_LINE(337)
					Float tmp21 = tmp2->y;		HX_STACK_VAR(tmp21,"tmp21");
					HX_STACK_LINE(337)
					...
					if ((tmp18)){
						...
						if ((tmp21)){
							...
							if ((tmp81)){
								...
								if ((tmp82)){
									HX_STACK_LINE(337)
									Float tmp83 = tmp2->x;		HX_STACK_VAR(tmp83,"tmp83");
									HX_STACK_LINE(337)
									Float tmp84 = -(tmp83);		HX_STACK_VAR(tmp84,"tmp84");
									HX_STACK_LINE(337)
									tmp2->x = tmp84;
									HX_STACK_LINE(337)
									Float tmp85 = tmp2->y;		HX_STACK_VAR(tmp85,"tmp85");
									HX_STACK_LINE(337)
	...
	{
		HX_STACK_LINE(339)
		::zpp_nape::geom::ZPP_Vec2 o = tmp2;		HX_STACK_VAR(o,"o");
		HX_STACK_LINE(348)
		{
			HX_STACK_LINE(348)
...
bool Geom_obj::intersectsBody( ::nape::phys::Body body1,::nape::phys::Body body2){
	...
	{
		HX_STACK_LINE(390)
		::zpp_nape::geom::ZPP_AABB tmp1 = body1->zpp_inner->aabb;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(390)
		::zpp_nape::geom::ZPP_AABB _this = tmp1;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(390)
		::zpp_nape::geom::ZPP_AABB tmp2 = body2->zpp_inner->aabb;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(390)
		::zpp_nape::geom::ZPP_AABB x = tmp2;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(390)
		bool tmp3 = (x->miny <= _this->maxy);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(390)
	...
	if ((tmp1)){
		...
		{
			HX_STACK_LINE(395)
			::zpp_nape::util::ZNPList_ZPP_Shape tmp2 = body1->zpp_inner->shapes;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(395)
			::zpp_nape::util::ZNPNode_ZPP_Shape cx_ite = tmp2->head;		HX_STACK_VAR(cx_ite,"cx_ite");
			HX_STACK_LINE(396)
			while((true)){
				HX_STACK_LINE(396)
				...
				{
					HX_STACK_LINE(400)
					::zpp_nape::util::ZNPList_ZPP_Shape tmp5 = body2->zpp_inner->shapes;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(400)
					::zpp_nape::util::ZNPNode_ZPP_Shape cx_ite1 = tmp5->head;		HX_STACK_VAR(cx_ite1,"cx_ite1");
					HX_STACK_LINE(401)
					while((true)){
						HX_STACK_LINE(401)
						bool tmp6 = (cx_ite1 != null());		HX_STACK_VAR(tmp6,"tmp6");
						HX_STACK_LINE(401)
						...
						HX_STACK_LINE(403)
						{
							...
							HX_STACK_LINE(404)
							::zpp_nape::shape::ZPP_Shape tmp9 = s2;		HX_STACK_VAR(tmp9,"tmp9");
							HX_STACK_LINE(404)
							bool tmp10 = ::zpp_nape::geom::ZPP_Collide_obj::testCollide_safe(tmp8,tmp9);		HX_STACK_VAR(tmp10,"tmp10");
							HX_STACK_LINE(404)
							if ((tmp10)){
								HX_STACK_LINE(405)
								return true;
...
bool Geom_obj::intersects( ::nape::shape::Shape shape1,::nape::shape::Shape shape2){
	...
	{
		HX_STACK_LINE(441)
		::zpp_nape::geom::ZPP_AABB tmp3 = shape1->zpp_inner->aabb;		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(441)
		::zpp_nape::geom::ZPP_AABB tmp4 = tmp3;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(441)
		::zpp_nape::geom::ZPP_AABB _this = tmp4;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(441)
		::zpp_nape::geom::ZPP_AABB tmp5 = shape2->zpp_inner->aabb;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(441)
		::zpp_nape::geom::ZPP_AABB tmp6 = tmp5;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(441)
		::zpp_nape::geom::ZPP_AABB x = tmp6;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(441)
		bool tmp7 = (x->miny <= _this->maxy);		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(441)
		...
		if ((tmp11)){
			HX_STACK_LINE(441)
			bool tmp12 = (_this->miny <= x->maxy);		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(441)
			tmp10 = tmp12;
		}
		else{
		...
		if ((tmp14)){
			HX_STACK_LINE(441)
			bool tmp15 = (x->minx <= _this->maxx);		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(441)
			tmp13 = tmp15;
		}
		else{
	...
	if ((tmp2)){
		HX_STACK_LINE(441)
		::zpp_nape::shape::ZPP_Shape tmp4 = shape1->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(441)
		::zpp_nape::shape::ZPP_Shape tmp5 = shape2->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(441)
		::zpp_nape::shape::ZPP_Shape tmp6 = tmp4;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(441)
		::zpp_nape::shape::ZPP_Shape tmp7 = tmp5;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(441)
		tmp3 = ::zpp_nape::geom::ZPP_Collide_obj::testCollide_safe(tmp6,tmp7);
	}
	else{
		HX_STACK_LINE(441)
		tmp3 = false;
...
bool Geom_obj::contains( ::nape::shape::Shape shape1,::nape::shape::Shape shape2){
	...
	::zpp_nape::geom::ZPP_Geom_obj::validateShape(tmp1);
	HX_STACK_LINE(462)
	::zpp_nape::shape::ZPP_Shape tmp2 = shape1->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(462)
	::zpp_nape::shape::ZPP_Shape tmp3 = shape2->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(462)
	bool tmp4 = ::zpp_nape::geom::ZPP_Collide_obj::containTest(tmp2,tmp3);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(462)
	return tmp4;
}
