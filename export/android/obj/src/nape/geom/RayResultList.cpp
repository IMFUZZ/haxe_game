...
::nape::geom::RayResult RayResultList_obj::at( int index){
	...
	if ((tmp3)){
		...
		if ((tmp8)){
			...
			::zpp_nape::util::ZPP_RayResultList tmp10 = this->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZPP_RayResultList tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZNPNode_RayResult tmp12 = tmp11->at_ite;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(372)
			tmp9 = (tmp12 == null());
		}
		else{
		...
		if ((tmp9)){
			...
			HX_STACK_LINE(374)
			::zpp_nape::util::ZNPNode_RayResult tmp13 = tmp11->inner->iterator_at(tmp12);		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(374)
			...
			while((true)){
				...
				HX_STACK_LINE(379)
				::zpp_nape::util::ZNPNode_RayResult tmp17 = tmp16->at_ite->next;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(379)
		...
		if ((tmp9)){
			...
			::zpp_nape::util::ZPP_RayResultList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(386)
			::zpp_nape::util::ZNPNode_RayResult tmp12 = tmp11->inner->head;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(386)
			...
			while((true)){
				...
				::zpp_nape::util::ZPP_RayResultList tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(388)
				::nape::geom::RayResult tmp15 = tmp14->at_ite->elt;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(388)
				::nape::geom::RayResult x = tmp15;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(389)
				break;
				HX_STACK_LINE(390)
				::zpp_nape::util::ZPP_RayResultList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
		...
		while((true)){
			...
			while((true)){
				...
				HX_STACK_LINE(397)
				::nape::geom::RayResult tmp20 = tmp19->at_ite->elt;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(397)
				::nape::geom::RayResult x = tmp20;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(398)
				break;
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_RayResultList tmp21 = this->zpp_inner;		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZNPNode_RayResult tmp22 = tmp21->at_ite->next;		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_RayResultList tmp23 = this->zpp_inner;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(399)
				tmp23->at_ite = tmp22;
			}
		}
	...
	::zpp_nape::util::ZPP_RayResultList tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(403)
	::nape::geom::RayResult tmp5 = tmp4->at_ite->elt;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(403)
	return tmp5;
}
...
bool RayResultList_obj::push( ::nape::geom::RayResult obj){
	...
	if ((tmp4)){
		...
		::zpp_nape::util::ZPP_RayResultList tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(424)
		::nape::geom::RayResult tmp7 = obj;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(424)
	...
	if ((tmp6)){
		...
		if ((tmp8)){
			...
			HX_STACK_LINE(426)
			::nape::geom::RayResult tmp10 = obj;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(426)
			...
			::zpp_nape::util::ZPP_RayResultList tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(428)
			::zpp_nape::util::ZNPNode_RayResult tmp10 = tmp9->push_ite;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(428)
			...
			if ((tmp11)){
				...
				HX_STACK_LINE(428)
				{
					...
					::zpp_nape::util::ZPP_RayResultList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(428)
					::zpp_nape::util::ZNPNode_RayResult tmp14 = tmp13->inner->head;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(428)
					tmp12 = (tmp14 == null());
				}
				HX_STACK_LINE(428)
			...
			::zpp_nape::util::ZPP_RayResultList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_RayResult tmp14 = tmp13->push_ite;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(429)
			::nape::geom::RayResult tmp15 = obj;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_RayResult tmp16 = tmp12->inner->insert(tmp14,tmp15);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZPP_RayResultList tmp17 = this->zpp_inner;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(429)
		...
		if ((tmp12)){
			...
			::zpp_nape::util::ZPP_RayResultList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(432)
			::nape::geom::RayResult tmp14 = obj;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(432)
...
::nape::geom::RayResult RayResultList_obj::pop( ){
	...
	if ((tmp3)){
		...
		if ((tmp8)){
			...
			::zpp_nape::util::ZPP_RayResultList tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(493)
			::nape::geom::RayResult tmp10 = retx;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(493)
			tmp9->subber(tmp10);
		}
		HX_STACK_LINE(494)
		...
		::zpp_nape::util::ZPP_RayResultList tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(497)
		::zpp_nape::util::ZNPNode_RayResult tmp5 = tmp4->at_ite;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(497)
		...
		if ((tmp6)){
			...
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_RayResult tmp10 = tmp9->at_ite->next;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_RayResult tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(497)
			tmp7 = (tmp11 == null());
		}
		else{
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_RayResult tmp10;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(498)
		if ((tmp9)){
			HX_STACK_LINE(498)
			tmp10 = null();
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_RayResult ite = tmp10;		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(499)
		bool tmp11 = (ite == null());		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(499)
		::nape::geom::RayResult tmp12;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(499)
		if ((tmp11)){
			HX_STACK_LINE(499)
			::zpp_nape::util::ZPP_RayResultList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
		...
		if ((tmp15)){
			...
			::zpp_nape::util::ZPP_RayResultList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(501)
			::nape::geom::RayResult tmp17 = retx;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(501)
			tmp16->subber(tmp17);
		}
		HX_STACK_LINE(502)
		...
		if ((tmp18)){
			...
			::zpp_nape::util::ZPP_RayResultList tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(502)
			::zpp_nape::util::ZNPNode_RayResult tmp20 = ite;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(502)
	...
	::nape::geom::RayResult retx = ret;		HX_STACK_VAR(retx,"retx");
	HX_STACK_LINE(506)
	::nape::geom::RayResult tmp5 = retx;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(506)
	return tmp5;
}
...
bool RayResultList_obj::remove( ::nape::geom::RayResult obj){
	...
	HX_STACK_LINE(585)
	{
		...
		HX_STACK_LINE(587)
		{
			...
			::zpp_nape::util::ZPP_RayResultList tmp2 = this->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_RayResult tmp3 = tmp2->inner->head;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_RayResult cx_ite = tmp3;		HX_STACK_VAR(cx_ite,"cx_ite");
			HX_STACK_LINE(589)
			while((true)){
				HX_STACK_LINE(589)
		...
		if ((tmp1)){
			...
			while((true)){
				...
				HX_STACK_LINE(619)
				{
					...
					::zpp_nape::util::ZPP_RayResultList tmp3 = this->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
					HX_STACK_LINE(619)
					::zpp_nape::util::ZNPNode_RayResult tmp4 = tmp3->inner->head;		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(619)
					tmp2 = (tmp4 == null());
				}
				HX_STACK_LINE(619)
...
Void RayResultList_obj::merge( ::nape::geom::RayResultList xs){
{
		...
		HX_STACK_LINE(688)
		{
			...
			xs->zpp_inner->valmod();
			HX_STACK_LINE(688)
			::nape::geom::RayResultList tmp1 = xs;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(688)
			tmp = ::nape::geom::RayResultIterator_obj::get(tmp1);
		}
		HX_STACK_LINE(688)
		...
		while((true)){
			...
			HX_STACK_LINE(688)
			::nape::geom::RayResult x = tmp3;		HX_STACK_VAR(x,"x");
			HX_STACK_LINE(689)
			::nape::geom::RayResult tmp4 = x;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(689)
...
::nape::geom::RayResultList RayResultList_obj::foreach( Dynamic lambda){
	...
	HX_STACK_LINE(736)
	::nape::geom::RayResultIterator it = tmp;		HX_STACK_VAR(it,"it");
	HX_STACK_LINE(737)
	while((true)){
		HX_STACK_LINE(737)
		bool tmp1;		HX_STACK_VAR(tmp1,"tmp1");
		...
		{
			HX_STACK_LINE(737)
			::zpp_nape::util::ZPP_RayResultList tmp2 = it->zpp_inner->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(737)
			tmp2->valmod();
			HX_STACK_LINE(737)
			int tmp3;		HX_STACK_VAR(tmp3,"tmp3");
...
::nape::geom::RayResultList RayResultList_obj::filter( Dynamic lambda){
	...
	while((true)){
		...
		HX_STACK_LINE(785)
		::nape::geom::RayResult tmp5 = this->at(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(785)
		::nape::geom::RayResult x = tmp5;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(786)
		try
		{
		HX_STACK_CATCHABLE(Dynamic, 0);
		{
			HX_STACK_LINE(787)
			::nape::geom::RayResult tmp6 = x;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(787)
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(788)
				::nape::geom::RayResult tmp8 = x;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(788)
				this->remove(tmp8);
			}
		}
