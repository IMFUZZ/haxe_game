...
bool AngleJoint_obj::isSlack( ){
	...
	HX_STACK_LINE(359)
	{
		...
		::zpp_nape::constraint::ZPP_AngleJoint tmp1 = this->zpp_inner_zn;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(359)
		::zpp_nape::constraint::ZPP_AngleJoint _this = tmp1;		HX_STACK_VAR(_this,"_this");
		HX_STACK_LINE(359)
		bool slack;		HX_STACK_VAR(slack,"slack");
		HX_STACK_LINE(359)
		{
			HX_STACK_LINE(359)
			Float tmp2 = _this->ratio;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(359)
			Float tmp3 = _this->b2->rot;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(359)
			Float tmp4 = (tmp2 * tmp3);		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(359)
			Float tmp5 = _this->b1->rot;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(359)
			Float tmp6 = (tmp4 - tmp5);		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(359)
			Float C = tmp6;		HX_STACK_VAR(C,"C");
			HX_STACK_LINE(359)
			bool tmp7 = _this->equal;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(359)
			if ((tmp7)){
				HX_STACK_LINE(359)
				...
				HX_STACK_LINE(359)
				bool tmp8 = (C < _this->jointMin);		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(359)
				if ((tmp8)){
					HX_STACK_LINE(359)
					Float tmp9 = (_this->jointMin - C);		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(359)
					C = tmp9;
					HX_STACK_LINE(359)
					_this->scale = ((Float)-1.0);
					...
					HX_STACK_LINE(359)
					bool tmp9 = (C > _this->jointMax);		HX_STACK_VAR(tmp9,"tmp9");
					HX_STACK_LINE(359)
					if ((tmp9)){
						HX_STACK_LINE(359)
						hx::SubEq(C,_this->jointMax);
...
::nape::geom::Vec3 AngleJoint_obj::bodyImpulse( ::nape::phys::Body body){
	...
	if ((tmp2)){
		HX_STACK_LINE(417)
		::nape::geom::Vec3 tmp3 = ::nape::geom::Vec3_obj::get((int)0,(int)0,(int)0);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(417)
		return tmp3;
	}
	else{
...
Void AngleJoint_obj::visitBodies( Dynamic lambda){
{
		...
		if ((tmp9)){
			...
			::zpp_nape::constraint::ZPP_AngleJoint tmp11 = this->zpp_inner_zn;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(435)
			::zpp_nape::constraint::ZPP_AngleJoint tmp12 = tmp11;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(435)
			::zpp_nape::phys::ZPP_Body tmp13 = tmp12->b2;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(435)
			bool tmp14 = (tmp13 == null());		HX_STACK_VAR(tmp14,"tmp14");
			...
			if ((tmp17)){
				...
				HX_STACK_LINE(435)
				::zpp_nape::constraint::ZPP_AngleJoint tmp18 = this->zpp_inner_zn;		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(435)
				::zpp_nape::constraint::ZPP_AngleJoint tmp19 = tmp18;		HX_STACK_VAR(tmp19,"tmp19");
				HX_STACK_LINE(435)
			...
			if ((tmp24)){
				...
				HX_STACK_LINE(435)
				::zpp_nape::constraint::ZPP_AngleJoint tmp25 = this->zpp_inner_zn;		HX_STACK_VAR(tmp25,"tmp25");
				HX_STACK_LINE(435)
				::zpp_nape::constraint::ZPP_AngleJoint tmp26 = tmp25;		HX_STACK_VAR(tmp26,"tmp26");
				HX_STACK_LINE(435)
