...
::nape::space::Space Constraint_obj::set_space( ::nape::space::Space space){
	...
	HX_STACK_LINE(252)
	{
		...
		if ((tmp5)){
			...
			::zpp_nape::constraint::ZPP_Constraint tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(259)
			::zpp_nape::space::ZPP_Component tmp7 = tmp6->component;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(259)
			bool tmp8 = (tmp7 != null());		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(259)
			if ((tmp8)){
			...
			if ((tmp12)){
				...
				HX_STACK_LINE(262)
				::nape::space::Space tmp14 = tmp13->space->outer;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(262)
				::nape::constraint::ConstraintList tmp15 = tmp14->zpp_inner->wrap_constraints;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(262)
				tmp15->remove(hx::ObjectPtr<OBJ_>(this));
			...
			HX_STACK_LINE(264)
			bool tmp13 = (space != null());		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(264)
			if ((tmp13)){
				HX_STACK_LINE(265)
				::nape::constraint::ConstraintList tmp14 = space->zpp_inner->wrap_constraints;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(265)
				::nape::constraint::ConstraintList _this = tmp14;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(265)
...
Float Constraint_obj::set_frequency( Float frequency){
	...
	HX_STACK_LINE(406)
	{
		...
		if ((tmp3)){
			...
			::zpp_nape::constraint::ZPP_Constraint tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(416)
			tmp4->frequency = frequency;
			HX_STACK_LINE(417)
			::zpp_nape::constraint::ZPP_Constraint tmp5 = this->zpp_inner;		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(417)
			bool tmp6 = tmp5->stiff;		HX_STACK_VAR(tmp6,"tmp6");
			HX_STACK_LINE(417)
...
Float Constraint_obj::set_damping( Float damping){
	...
	HX_STACK_LINE(443)
	{
		...
		Float tmp1 = tmp->damping;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(452)
		Float tmp2 = damping;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(452)
		bool tmp3 = (tmp1 != tmp2);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(452)
		if ((tmp3)){
...
Float Constraint_obj::set_maxForce( Float maxForce){
	...
	HX_STACK_LINE(479)
	{
		...
		Float tmp1 = tmp->maxForce;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(488)
		Float tmp2 = maxForce;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(488)
		bool tmp3 = (tmp1 != tmp2);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(488)
		if ((tmp3)){
...
Float Constraint_obj::set_maxError( Float maxError){
	...
	HX_STACK_LINE(513)
	{
		...
		Float tmp1 = tmp->maxError;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(522)
		Float tmp2 = maxError;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(522)
		bool tmp3 = (tmp1 != tmp2);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(522)
		if ((tmp3)){
