...
Float viscosity = __o_viscosity.Default(1);
{
	...
	HX_STACK_LINE(241)
	{
		HX_STACK_LINE(241)
		{
			...
			if ((tmp7)){
				...
				HX_STACK_LINE(241)
				::zpp_nape::phys::ZPP_FluidProperties tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(241)
				tmp12->density = tmp11;
				HX_STACK_LINE(241)
	...
	HX_STACK_LINE(242)
	{
		HX_STACK_LINE(242)
		{
			...
			if ((tmp7)){
				HX_STACK_LINE(242)
				Float tmp8 = viscosity;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(242)
					...
					HX_STACK_LINE(257)
					{
						...
						if ((tmp26)){
							...
							HX_STACK_LINE(257)
							{
								...
								::zpp_nape::geom::ZPP_Vec2 _this1 = _this->zpp_inner;		HX_STACK_VAR(_this1,"_this1");
								HX_STACK_LINE(257)
								bool tmp27 = (_this1->_invalidate != null());		HX_STACK_VAR(tmp27,"tmp27");
								HX_STACK_LINE(257)
								if ((tmp27)){
									HX_STACK_LINE(257)
									::zpp_nape::geom::ZPP_Vec2 tmp28 = _this1;		HX_STACK_VAR(tmp28,"tmp28");
									HX_STACK_LINE(257)
									_this1->_invalidate(tmp28);
								}
							}
						}
						HX_STACK_LINE(257)
...
Float FluidProperties_obj::set_viscosity( Float viscosity){
	...
	HX_STACK_LINE(297)
	{
		...
		if ((tmp6)){
			HX_STACK_LINE(303)
			Float tmp7 = viscosity;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(303)
