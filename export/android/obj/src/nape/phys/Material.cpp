...
Float rollingFriction = __o_rollingFriction.Default(((Float)0.001));
{
	...
	HX_STACK_LINE(248)
	{
		HX_STACK_LINE(248)
		{
			...
			if ((tmp7)){
				HX_STACK_LINE(248)
				Float tmp8 = elasticity;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(248)
				...
				HX_STACK_LINE(248)
				::zpp_nape::phys::ZPP_Material tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(248)
				tmp12->elasticity = tmp11;
				HX_STACK_LINE(248)
				::zpp_nape::phys::ZPP_Material tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(248)
				int tmp14 = ::zpp_nape::phys::ZPP_Material_obj::WAKE;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(248)
				int tmp15 = ::zpp_nape::phys::ZPP_Material_obj::ARBITERS;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(248)
				int tmp16 = (int(tmp14) | int(tmp15));		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(248)
				tmp13->invalidate(tmp16);
			}
		}
		HX_STACK_LINE(248)
	...
	HX_STACK_LINE(249)
	{
		HX_STACK_LINE(249)
		{
			...
			if ((tmp7)){
				HX_STACK_LINE(249)
				Float tmp8 = dynamicFriction;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(249)
				bool tmp9 = false;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(249)
				int tmp10;		HX_STACK_VAR(tmp10,"tmp10");
				...
				::zpp_nape::phys::ZPP_Material tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
				HX_STACK_LINE(249)
				tmp12->dynamicFriction = tmp11;
				HX_STACK_LINE(249)
				::zpp_nape::phys::ZPP_Material tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
				HX_STACK_LINE(249)
				int tmp14 = ::zpp_nape::phys::ZPP_Material_obj::WAKE;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(249)
				int tmp15 = ::zpp_nape::phys::ZPP_Material_obj::ANGDRAG;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(249)
				int tmp16 = (int(tmp14) | int(tmp15));		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(249)
				int tmp17 = ::zpp_nape::phys::ZPP_Material_obj::ARBITERS;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(249)
				int tmp18 = (int(tmp16) | int(tmp17));		HX_STACK_VAR(tmp18,"tmp18");
				HX_STACK_LINE(249)
				tmp13->invalidate(tmp18);
			}
		}
		HX_STACK_LINE(249)
		::zpp_nape::phys::ZPP_Material tmp1 = this->zpp_inner;		HX_STACK_VAR(tmp1,"tmp1");
	...
	HX_STACK_LINE(250)
	{
		HX_STACK_LINE(250)
		{
			...
			if ((tmp7)){
				HX_STACK_LINE(250)
				Float tmp8 = staticFriction;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(250)
				bool tmp9 = false;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(250)
				int tmp10;		HX_STACK_VAR(tmp10,"tmp10");
	...
	HX_STACK_LINE(251)
	{
		HX_STACK_LINE(251)
		{
			...
			if ((tmp7)){
				HX_STACK_LINE(251)
				Float tmp8 = density;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(251)
				...
				int tmp14 = ::zpp_nape::phys::ZPP_Material_obj::WAKE;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(251)
				int tmp15 = ::zpp_nape::phys::ZPP_Material_obj::PROPS;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(251)
				int tmp16 = (int(tmp14) | int(tmp15));		HX_STACK_VAR(tmp16,"tmp16");
				HX_STACK_LINE(251)
				tmp13->invalidate(tmp16);
	...
	HX_STACK_LINE(252)
	{
		HX_STACK_LINE(252)
		{
			...
			if ((tmp7)){
				HX_STACK_LINE(252)
				Float tmp8 = rollingFriction;		HX_STACK_VAR(tmp8,"tmp8");
				HX_STACK_LINE(252)
				bool tmp9 = false;		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(252)
				int tmp10;		HX_STACK_VAR(tmp10,"tmp10");
...
Float Material_obj::set_elasticity( Float elasticity){
	...
	HX_STACK_LINE(290)
	{
		...
		if ((tmp6)){
			HX_STACK_LINE(297)
			Float tmp7 = elasticity;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(297)
			...
			HX_STACK_LINE(297)
			::zpp_nape::phys::ZPP_Material tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(297)
			tmp11->elasticity = tmp10;
			HX_STACK_LINE(298)
			::zpp_nape::phys::ZPP_Material tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(298)
			int tmp13 = ::zpp_nape::phys::ZPP_Material_obj::WAKE;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(298)
			int tmp14 = ::zpp_nape::phys::ZPP_Material_obj::ARBITERS;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(298)
			int tmp15 = (int(tmp13) | int(tmp14));		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(298)
			tmp12->invalidate(tmp15);
		}
	}
	HX_STACK_LINE(301)
	::zpp_nape::phys::ZPP_Material tmp = this->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
...
Float Material_obj::set_dynamicFriction( Float dynamicFriction){
	...
	HX_STACK_LINE(320)
	{
		...
		if ((tmp6)){
			HX_STACK_LINE(327)
			Float tmp7 = dynamicFriction;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(327)
			bool tmp8 = false;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(327)
			int tmp9;		HX_STACK_VAR(tmp9,"tmp9");
			...
			::zpp_nape::phys::ZPP_Material tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(327)
			tmp11->dynamicFriction = tmp10;
			HX_STACK_LINE(328)
			::zpp_nape::phys::ZPP_Material tmp12 = this->zpp_inner;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(328)
			int tmp13 = ::zpp_nape::phys::ZPP_Material_obj::WAKE;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(328)
			int tmp14 = ::zpp_nape::phys::ZPP_Material_obj::ANGDRAG;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(328)
			int tmp15 = (int(tmp13) | int(tmp14));		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(328)
			int tmp16 = ::zpp_nape::phys::ZPP_Material_obj::ARBITERS;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(328)
			int tmp17 = (int(tmp15) | int(tmp16));		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(328)
			tmp12->invalidate(tmp17);
		}
	}
	HX_STACK_LINE(331)
	::zpp_nape::phys::ZPP_Material tmp = this->zpp_inner;		HX_STACK_VAR(tmp,"tmp");
...
Float Material_obj::set_staticFriction( Float staticFriction){
	...
	HX_STACK_LINE(350)
	{
		...
		if ((tmp6)){
			HX_STACK_LINE(357)
			Float tmp7 = staticFriction;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(357)
			bool tmp8 = false;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(357)
			int tmp9;		HX_STACK_VAR(tmp9,"tmp9");
...
Float Material_obj::set_density( Float density){
	...
	HX_STACK_LINE(378)
	{
		...
		if ((tmp6)){
			HX_STACK_LINE(385)
			Float tmp7 = density;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(385)
			...
			int tmp13 = ::zpp_nape::phys::ZPP_Material_obj::WAKE;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(386)
			int tmp14 = ::zpp_nape::phys::ZPP_Material_obj::PROPS;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(386)
			int tmp15 = (int(tmp13) | int(tmp14));		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(386)
			tmp12->invalidate(tmp15);
...
Float Material_obj::set_rollingFriction( Float rollingFriction){
	...
	HX_STACK_LINE(409)
	{
		...
		if ((tmp6)){
			HX_STACK_LINE(416)
			Float tmp7 = rollingFriction;		HX_STACK_VAR(tmp7,"tmp7");
			HX_STACK_LINE(416)
			bool tmp8 = false;		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(416)
			int tmp9;		HX_STACK_VAR(tmp9,"tmp9");
