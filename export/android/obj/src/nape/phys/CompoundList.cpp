...
::nape::phys::Compound CompoundList_obj::at( int index){
	...
	if ((tmp3)){
		...
		if ((tmp8)){
			...
			::zpp_nape::util::ZPP_CompoundList tmp10 = this->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZPP_CompoundList tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(372)
			::zpp_nape::util::ZNPNode_ZPP_Compound tmp12 = tmp11->at_ite;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(372)
			tmp9 = (tmp12 == null());
		}
		else{
		...
		if ((tmp9)){
			...
			HX_STACK_LINE(374)
			::zpp_nape::util::ZNPNode_ZPP_Compound tmp13 = tmp11->inner->iterator_at(tmp12);		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(374)
			...
			while((true)){
				...
				HX_STACK_LINE(379)
				::zpp_nape::util::ZNPNode_ZPP_Compound tmp17 = tmp16->at_ite->next;		HX_STACK_VAR(tmp17,"tmp17");
				HX_STACK_LINE(379)
		...
		if ((tmp9)){
			...
			::zpp_nape::util::ZPP_CompoundList tmp11 = this->zpp_inner;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(386)
			::zpp_nape::util::ZNPNode_ZPP_Compound tmp12 = tmp11->inner->head;		HX_STACK_VAR(tmp12,"tmp12");
			HX_STACK_LINE(386)
			...
			while((true)){
				...
				::zpp_nape::util::ZPP_CompoundList tmp14 = this->zpp_inner;		HX_STACK_VAR(tmp14,"tmp14");
				HX_STACK_LINE(388)
				::zpp_nape::phys::ZPP_Compound tmp15 = tmp14->at_ite->elt;		HX_STACK_VAR(tmp15,"tmp15");
				HX_STACK_LINE(388)
				::zpp_nape::phys::ZPP_Compound x = tmp15;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(389)
				break;
				HX_STACK_LINE(390)
				::zpp_nape::util::ZPP_CompoundList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
		...
		while((true)){
			...
			while((true)){
				...
				HX_STACK_LINE(397)
				::zpp_nape::phys::ZPP_Compound tmp20 = tmp19->at_ite->elt;		HX_STACK_VAR(tmp20,"tmp20");
				HX_STACK_LINE(397)
				::zpp_nape::phys::ZPP_Compound x = tmp20;		HX_STACK_VAR(x,"x");
				HX_STACK_LINE(398)
				break;
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_CompoundList tmp21 = this->zpp_inner;		HX_STACK_VAR(tmp21,"tmp21");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZNPNode_ZPP_Compound tmp22 = tmp21->at_ite->next;		HX_STACK_VAR(tmp22,"tmp22");
				HX_STACK_LINE(399)
				::zpp_nape::util::ZPP_CompoundList tmp23 = this->zpp_inner;		HX_STACK_VAR(tmp23,"tmp23");
				HX_STACK_LINE(399)
				tmp23->at_ite = tmp22;
			}
		}
	...
	::zpp_nape::util::ZPP_CompoundList tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(403)
	::zpp_nape::phys::ZPP_Compound tmp5 = tmp4->at_ite->elt;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(403)
	::nape::phys::Compound tmp6 = tmp5->outer;		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(403)
	return tmp6;
}
...
bool CompoundList_obj::push( ::nape::phys::Compound obj){
	...
	if ((tmp4)){
		...
		::zpp_nape::util::ZPP_CompoundList tmp6 = this->zpp_inner;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(424)
		::nape::phys::Compound tmp7 = obj;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(424)
	...
	if ((tmp6)){
		...
		if ((tmp8)){
			...
			HX_STACK_LINE(426)
			::zpp_nape::phys::ZPP_Compound tmp10 = obj->zpp_inner;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(426)
			...
			::zpp_nape::util::ZPP_CompoundList tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(428)
			::zpp_nape::util::ZNPNode_ZPP_Compound tmp10 = tmp9->push_ite;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(428)
			...
			if ((tmp11)){
				...
				HX_STACK_LINE(428)
				{
					...
					::zpp_nape::util::ZPP_CompoundList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
					HX_STACK_LINE(428)
					::zpp_nape::util::ZNPNode_ZPP_Compound tmp14 = tmp13->inner->head;		HX_STACK_VAR(tmp14,"tmp14");
					HX_STACK_LINE(428)
					tmp12 = (tmp14 == null());
				}
				HX_STACK_LINE(428)
			...
			::zpp_nape::util::ZPP_CompoundList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_Compound tmp14 = tmp13->push_ite;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(429)
			::zpp_nape::phys::ZPP_Compound tmp15 = obj->zpp_inner;		HX_STACK_VAR(tmp15,"tmp15");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZNPNode_ZPP_Compound tmp16 = tmp12->inner->insert(tmp14,tmp15);		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(429)
			::zpp_nape::util::ZPP_CompoundList tmp17 = this->zpp_inner;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(429)
		...
		if ((tmp12)){
			...
			::zpp_nape::util::ZPP_CompoundList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
			HX_STACK_LINE(432)
			::nape::phys::Compound tmp14 = obj;		HX_STACK_VAR(tmp14,"tmp14");
			HX_STACK_LINE(432)
...
::nape::phys::Compound CompoundList_obj::pop( ){
	...
	if ((tmp3)){
		...
		if ((tmp8)){
			...
			::zpp_nape::util::ZPP_CompoundList tmp9 = this->zpp_inner;		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(493)
			::nape::phys::Compound tmp10 = retx;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(493)
			tmp9->subber(tmp10);
		}
		HX_STACK_LINE(494)
		...
		::zpp_nape::util::ZPP_CompoundList tmp4 = this->zpp_inner;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(497)
		::zpp_nape::util::ZNPNode_ZPP_Compound tmp5 = tmp4->at_ite;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(497)
		...
		if ((tmp6)){
			...
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ZPP_Compound tmp10 = tmp9->at_ite->next;		HX_STACK_VAR(tmp10,"tmp10");
			HX_STACK_LINE(497)
			::zpp_nape::util::ZNPNode_ZPP_Compound tmp11 = tmp10;		HX_STACK_VAR(tmp11,"tmp11");
			HX_STACK_LINE(497)
			tmp7 = (tmp11 == null());
		}
		else{
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_Compound tmp10;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(498)
		if ((tmp9)){
			HX_STACK_LINE(498)
			tmp10 = null();
		...
		HX_STACK_LINE(498)
		::zpp_nape::util::ZNPNode_ZPP_Compound ite = tmp10;		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(499)
		bool tmp11 = (ite == null());		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(499)
		::zpp_nape::phys::ZPP_Compound tmp12;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(499)
		if ((tmp11)){
			HX_STACK_LINE(499)
			::zpp_nape::util::ZPP_CompoundList tmp13 = this->zpp_inner;		HX_STACK_VAR(tmp13,"tmp13");
		...
		if ((tmp15)){
			...
			::zpp_nape::util::ZPP_CompoundList tmp16 = this->zpp_inner;		HX_STACK_VAR(tmp16,"tmp16");
			HX_STACK_LINE(501)
			::nape::phys::Compound tmp17 = retx;		HX_STACK_VAR(tmp17,"tmp17");
			HX_STACK_LINE(501)
			tmp16->subber(tmp17);
		}
		HX_STACK_LINE(502)
		...
		if ((tmp18)){
			...
			::zpp_nape::util::ZPP_CompoundList tmp19 = this->zpp_inner;		HX_STACK_VAR(tmp19,"tmp19");
			HX_STACK_LINE(502)
			::zpp_nape::util::ZNPNode_ZPP_Compound tmp20 = ite;		HX_STACK_VAR(tmp20,"tmp20");
			HX_STACK_LINE(502)
	...
	::nape::phys::Compound retx = ret->outer;		HX_STACK_VAR(retx,"retx");
	HX_STACK_LINE(506)
	::nape::phys::Compound tmp5 = retx;		HX_STACK_VAR(tmp5,"tmp5");
	HX_STACK_LINE(506)
	return tmp5;
}
...
bool CompoundList_obj::remove( ::nape::phys::Compound obj){
	...
	HX_STACK_LINE(585)
	{
		...
		HX_STACK_LINE(587)
		{
			...
			::zpp_nape::util::ZPP_CompoundList tmp2 = this->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_ZPP_Compound tmp3 = tmp2->inner->head;		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(588)
			::zpp_nape::util::ZNPNode_ZPP_Compound cx_ite = tmp3;		HX_STACK_VAR(cx_ite,"cx_ite");
			HX_STACK_LINE(589)
			while((true)){
				HX_STACK_LINE(589)
		...
		if ((tmp1)){
			...
			while((true)){
				...
				HX_STACK_LINE(619)
				{
					...
					::zpp_nape::util::ZPP_CompoundList tmp3 = this->zpp_inner;		HX_STACK_VAR(tmp3,"tmp3");
					HX_STACK_LINE(619)
					::zpp_nape::util::ZNPNode_ZPP_Compound tmp4 = tmp3->inner->head;		HX_STACK_VAR(tmp4,"tmp4");
					HX_STACK_LINE(619)
					tmp2 = (tmp4 == null());
				}
				HX_STACK_LINE(619)
...
Void CompoundList_obj::merge( ::nape::phys::CompoundList xs){
{
		...
		HX_STACK_LINE(688)
		{
			...
			xs->zpp_inner->valmod();
			HX_STACK_LINE(688)
			::nape::phys::CompoundList tmp1 = xs;		HX_STACK_VAR(tmp1,"tmp1");
			HX_STACK_LINE(688)
			tmp = ::nape::phys::CompoundIterator_obj::get(tmp1);
		}
		HX_STACK_LINE(688)
		...
		while((true)){
			...
			HX_STACK_LINE(688)
			::nape::phys::Compound x = tmp3;		HX_STACK_VAR(x,"x");
			HX_STACK_LINE(689)
			::nape::phys::Compound tmp4 = x;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(689)
...
::nape::phys::CompoundList CompoundList_obj::foreach( Dynamic lambda){
	...
	HX_STACK_LINE(736)
	::nape::phys::CompoundIterator it = tmp;		HX_STACK_VAR(it,"it");
	HX_STACK_LINE(737)
	while((true)){
		HX_STACK_LINE(737)
		bool tmp1;		HX_STACK_VAR(tmp1,"tmp1");
		...
		{
			HX_STACK_LINE(737)
			::zpp_nape::util::ZPP_CompoundList tmp2 = it->zpp_inner->zpp_inner;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(737)
			tmp2->valmod();
			HX_STACK_LINE(737)
			int tmp3;		HX_STACK_VAR(tmp3,"tmp3");
...
::nape::phys::CompoundList CompoundList_obj::filter( Dynamic lambda){
	...
	while((true)){
		...
		HX_STACK_LINE(785)
		::nape::phys::Compound tmp5 = this->at(tmp4);		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(785)
		::nape::phys::Compound x = tmp5;		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(786)
		try
		{
		HX_STACK_CATCHABLE(Dynamic, 0);
