...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(52)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)0,tmp22,HX_HCSTRING("haxeflixel_experimentation","\x1b","\xdf","\x6f","\x1e"),null(),null());
	}
return null();
}
