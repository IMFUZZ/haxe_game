...
::flixel::addons::nape::FlxNapeSpace PluginFrontEnd_obj::add_flixel_addons_nape_FlxNapeSpace( ::flixel::addons::nape::FlxNapeSpace Plugin){
	HX_STACK_FRAME("flixel.system.frontEnds.PluginFrontEnd","add_flixel_addons_nape_FlxNapeSpace",0x67a685ed,"flixel.system.frontEnds.PluginFrontEnd.add_flixel_addons_nape_FlxNapeSpace","flixel/system/frontEnds/PluginFrontEnd.hx",24,0xbff70e9e)
	HX_STACK_THIS(this)
		...
		while((true)){
			...
			HX_STACK_LINE(28)
			{
				...
				HX_STACK_LINE(28)
				{
					...
					HX_STACK_LINE(28)
					::flixel::addons::nape::FlxNapeSpace tmp5 = Plugin;		HX_STACK_VAR(tmp5,"tmp5");
					HX_STACK_LINE(28)
					...
					if ((tmp6)){
						...
						HX_STACK_LINE(28)
						::flixel::addons::nape::FlxNapeSpace tmp7 = Plugin;		HX_STACK_VAR(tmp7,"tmp7");
						HX_STACK_LINE(28)
			...
			if ((tmp3)){
				HX_STACK_LINE(30)
				::flixel::addons::nape::FlxNapeSpace tmp4 = Plugin;		HX_STACK_VAR(tmp4,"tmp4");
				HX_STACK_LINE(30)
				return tmp4;
			}
		}
	...
	HX_STACK_LINE(35)
	::flixel::addons::nape::FlxNapeSpace tmp = Plugin;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(35)
	this->list->__Field(HX_HCSTRING("push","\xda","\x11","\x61","\x4a"), hx::paccDynamic )(tmp);
	HX_STACK_LINE(36)
	::flixel::addons::nape::FlxNapeSpace tmp1 = Plugin;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(36)
	return tmp1;
}


HX_DEFINE_DYNAMIC_FUNC1(PluginFrontEnd_obj,add_flixel_addons_nape_FlxNapeSpace,return )
...
Dynamic PluginFrontEnd_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 33:
		...
		break;
	case 35:
		if (HX_FIELD_EQ(inName,"add_flixel_addons_nape_FlxNapeSpace") ) { return add_flixel_addons_nape_FlxNapeSpace_dyn(); }
	}
...
static ::String sMemberFields[] = {
	HX_HCSTRING("add_flixel_addons_nape_FlxNapeSpace","\x9c","\xaf","\x79","\x7a"),
