...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/character_properties.json", __ASSET__assets_data_character_properties_json);
		...
		className.set ("assets/ui/main_menu.xml", __ASSET__assets_ui_main_menu_xml);
		...
		className.set (id, __ASSET__assets_fonts_consolas_ttf);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_character_properties_json extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_data_goes_here_txt extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_fonts_consolas_ttf extends flash.text.Font { }
...
@:keep @:bind #if display private #end class __ASSET__assets_ui_main_menu_xml extends flash.utils.ByteArray { }
...
@:file("assets/data/character_properties.json") #if display private #end class __ASSET__assets_data_character_properties_json extends lime.utils.Bytes {}
@:file("assets/data/data-goes-here.txt") #if display private #end class __ASSET__assets_data_data_goes_here_txt extends lime.utils.Bytes {}
@:font("assets/fonts/consolas.ttf") #if display private #end class __ASSET__assets_fonts_consolas_ttf extends lime.text.Font {}
...
@:file("assets/ui/main.xml") #if display private #end class __ASSET__assets_ui_main_xml extends lime.utils.Bytes {}
@:file("assets/ui/main_menu.xml") #if display private #end class __ASSET__assets_ui_main_menu_xml extends lime.utils.Bytes {}
@:file("/usr/share/haxe/lib/flixel/4,0,1/assets/sounds/flixel.mp3") #if display private #end class __ASSET__flixel_sounds_flixel_mp3 extends lime.utils.Bytes {}
@:file("/usr/share/haxe/lib/flixel/4,0,1/assets/sounds/beep.mp3") #if display private #end class __ASSET__flixel_sounds_beep_mp3 extends lime.utils.Bytes {}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_consolas_ttf extends openfl.text.Font { public function new () { var font = new __ASSET__assets_fonts_consolas_ttf (); src = font.src; name = font.name; super (); }}
