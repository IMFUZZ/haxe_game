...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/data/character_properties.json", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/data/data-goes-here.txt", "assets/data/data-goes-here.txt");
			type.set ("assets/data/data-goes-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/fonts/consolas.ttf", "assets/fonts/consolas.ttf");
			type.set ("assets/fonts/consolas.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
			path.set ("assets/gfx/ui/light.png", "assets/gfx/ui/light.png");
			type.set ("assets/gfx/ui/light.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/inventoryBar.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/xml/InGame.xml", Reflect.field (AssetType, "text".toUpperCase ()));
