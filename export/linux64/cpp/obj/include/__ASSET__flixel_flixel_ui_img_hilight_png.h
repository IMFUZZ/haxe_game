...
class HXCPP_CLASS_ATTRIBUTES __ASSET__flixel_flixel_ui_img_hilight_png_obj : public  ::openfl::_legacy::display::BitmapData_obj
{
	public:
	...
	public:
		...
		static hx::ObjectPtr< __ASSET__flixel_flixel_ui_img_hilight_png_obj > __new(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA);
		static hx::ObjectPtr< __ASSET__flixel_flixel_ui_img_hilight_png_obj > __alloc(hx::Ctx *_hx_ctx,int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA);
