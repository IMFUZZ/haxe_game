...
HXLINE(  12)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,hx::ClassOf< ::states::TitleScreenState >(),(int)1,(int)60,(int)60,false,true));
HXLINE(  13)		this->addChild( ::debug::SystemUsage_obj::__alloc( HX_CTX ,null(),null(),null()));
            	}
