...
HX_DEFINE_STACK_FRAME(_hx_pos_c36f9452ac2b554a_30_update,"items.Item","update",0x3d892676,"items.Item.update","items/Item.hx",30,0x0d88731c)
HX_DEFINE_STACK_FRAME(_hx_pos_c36f9452ac2b554a_39_stack,"items.Item","stack",0xffb2737b,"items.Item.stack","items/Item.hx",39,0x0d88731c)
HX_DEFINE_STACK_FRAME(_hx_pos_c36f9452ac2b554a_48_highlight,"items.Item","highlight",0xf48cf7e7,"items.Item.highlight","items/Item.hx",48,0x0d88731c)
HX_DEFINE_STACK_FRAME(_hx_pos_c36f9452ac2b554a_52_onMouseDown,"items.Item","onMouseDown",0x8e44487b,"items.Item.onMouseDown","items/Item.hx",52,0x0d88731c)
HX_DEFINE_STACK_FRAME(_hx_pos_c36f9452ac2b554a_56_onMouseUp,"items.Item","onMouseUp",0x9faa4e34,"items.Item.onMouseUp","items/Item.hx",56,0x0d88731c)
HX_DEFINE_STACK_FRAME(_hx_pos_c36f9452ac2b554a_60_onMouseOver,"items.Item","onMouseOver",0x958ee16d,"items.Item.onMouseOver","items/Item.hx",60,0x0d88731c)
HX_DEFINE_STACK_FRAME(_hx_pos_c36f9452ac2b554a_64_onMouseOut,"items.Item","onMouseOut",0x15559695,"items.Item.onMouseOut","items/Item.hx",64,0x0d88731c)
namespace items{
...
void Item_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_c36f9452ac2b554a_30_update)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(elapsed,"elapsed")
HXLINE(  31)		this->super::update(elapsed);
HXLINE(  32)		if (this->mouseIsOver) {
HXLINE(  33)			HX_VARI(  ::flixel::FlxSprite,SpriteA) = ::Shared_obj::player->character;
HXDLIN(  33)			HX_VARI( Float,dx) = ((SpriteA->x + SpriteA->origin->x) - (this->x + this->origin->x));
HXDLIN(  33)			HX_VARI( Float,dy) = ((SpriteA->y + SpriteA->origin->y) - (this->y + this->origin->y));
HXDLIN(  33)			this->highlight((::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy)))) < (int)128));
            		}
            		else {
HXLINE(  35)			this->highlight(false);
            		}
            	}


bool Item_obj::stack( ::items::Item item){
            	HX_STACKFRAME(&_hx_pos_c36f9452ac2b554a_39_stack)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(item,"item")
HXLINE(  40)		bool _hx_tmp;
HXDLIN(  40)		if ((item->name == this->name)) {
HXLINE(  40)			_hx_tmp = (this->quantity >= this->stackSize);
            		}
            		else {
...
void Item_obj::highlight(bool val){
            	HX_STACKFRAME(&_hx_pos_c36f9452ac2b554a_48_highlight)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(val,"val")
HXLINE(  48)		int _hx_tmp;
HXDLIN(  48)		if (val) {
HXLINE(  48)			_hx_tmp = (int)16777215;
            		}
            		else {
HXLINE(  48)			_hx_tmp = (int)13421772;
            		}
HXDLIN(  48)		this->set_color(_hx_tmp);
            	}
...
void Item_obj::onMouseDown( ::flixel::FlxSprite sprite){
            	HX_STACKFRAME(&_hx_pos_c36f9452ac2b554a_52_onMouseDown)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sprite,"sprite")
HXLINE(  52)		::Shared_obj::player->character->takeItem(hx::ObjectPtr<OBJ_>(this));
            	}
...
void Item_obj::onMouseUp( ::flixel::FlxSprite sprite){
            	HX_STACKFRAME(&_hx_pos_c36f9452ac2b554a_56_onMouseUp)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sprite,"sprite")
HXLINE(  56)		::haxe::Log_obj::trace(HX_("MouseUp",c0,1b,c4,8d),hx::SourceInfo(HX_("Item.hx",6b,d3,ac,ac),56,HX_("items.Item",61,74,8b,61),HX_("onMouseUp",81,ac,1d,98)));
            	}
...
void Item_obj::onMouseOver( ::flixel::FlxSprite sprite){
            	HX_STACKFRAME(&_hx_pos_c36f9452ac2b554a_60_onMouseOver)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sprite,"sprite")
HXLINE(  60)		this->mouseIsOver = true;
            	}
...
void Item_obj::onMouseOut( ::flixel::FlxSprite sprite){
            	HX_STACKFRAME(&_hx_pos_c36f9452ac2b554a_64_onMouseOut)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(sprite,"sprite")
HXLINE(  64)		this->mouseIsOver = false;
            	}
