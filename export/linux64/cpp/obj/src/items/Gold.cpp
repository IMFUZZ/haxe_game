...
HX_DEFINE_STACK_FRAME(_hx_pos_996ab03219c1b674_6_new,"items.Gold","new",0x528371e0,"items.Gold.new","items/Gold.hx",6,0xbc6fdbaf)
namespace items{
...
Float a_y = __o_a_y.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_996ab03219c1b674_6_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(a_x,"a_x")
            	HX_STACK_ARG(a_y,"a_y")
HXLINE(   7)		super::__construct(a_x,a_y,(int)10000,HX_("assets/images/gold.png",86,fa,9f,aa),false,false);
HXLINE(   8)		if (hx::IsNull( ::zpp_nape::util::ZPP_Flags_obj::BodyType_STATIC )) {
HXLINE(   8)			::zpp_nape::util::ZPP_Flags_obj::internal = true;
HXDLIN(   8)			::zpp_nape::util::ZPP_Flags_obj::BodyType_STATIC =  ::nape::phys::BodyType_obj::__alloc( HX_CTX );
HXDLIN(   8)			::zpp_nape::util::ZPP_Flags_obj::internal = false;
            		}
HXDLIN(   8)		this->createCircularBody((int)8,::zpp_nape::util::ZPP_Flags_obj::BodyType_STATIC);
HXLINE(   9)		{
...
HXLINE(  10)		this->name = HX_("Gold",c0,be,42,2f);
HXLINE(  11)		this->icon =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(int)0,(int)0,HX_("assets/images/gold.png",86,fa,9f,aa));
            	}
