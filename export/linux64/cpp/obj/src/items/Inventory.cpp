...
HX_DEFINE_STACK_FRAME(_hx_pos_0cc7e8a45b68efd7_54_as,"items.Inventory","as",0x9e987cd2,"items.Inventory.as","items/Inventory.hx",54,0xe4590071)
HX_DEFINE_STACK_FRAME(_hx_pos_0cc7e8a45b68efd7_65_addItem,"items.Inventory","addItem",0x776853f4,"items.Inventory.addItem","items/Inventory.hx",65,0xe4590071)
HX_DEFINE_STACK_FRAME(_hx_pos_0cc7e8a45b68efd7_77_getSize,"items.Inventory","getSize",0x14419c97,"items.Inventory.getSize","items/Inventory.hx",77,0xe4590071)
namespace items{
...
HXLINE(  19)		if (((int)0 <= pos)) {
HXLINE(  19)			return (pos < this->items->length);
            		}
            		else {
...
HXDLIN(  45)				 ::items::Item _hx_tmp1 = ( ( ::items::Item)(_hx_array_unsafe_get(this->items,index)) );
HXDLIN(  45)				_hx_tmp(_hx_tmp1,hx::SourceInfo(HX_("Inventory.hx",c2,21,8a,bb),45,HX_("items.Inventory",8e,8c,06,31),HX_("getAvailableIndex",bf,47,2b,52)));
HXLINE(  46)				if (hx::IsNull( ( ( ::items::Item)(_hx_array_unsafe_get(this->items,index)) ) )) {
HXLINE(  47)					::haxe::Log_obj::trace(HX_("items[index] == null",cd,f6,07,02),hx::SourceInfo(HX_("Inventory.hx",c2,21,8a,bb),47,HX_("items.Inventory",8e,8c,06,31),HX_("getAvailableIndex",bf,47,2b,52)));
HXLINE(  48)					return index;
            				}
            			}
            		}
...
int Inventory_obj::as( ::items::Item item){
            	HX_STACKFRAME(&_hx_pos_0cc7e8a45b68efd7_54_as)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(item,"item")
HXLINE(  55)		{
HXLINE(  55)			HX_VARI( int,_g1) = (int)0;
HXDLIN(  55)			HX_VARI( int,_g) = this->items->length;
HXDLIN(  55)			while((_g1 < _g)){
HXLINE(  55)				_g1 = (_g1 + (int)1);
HXDLIN(  55)				HX_VARI( int,index) = (_g1 - (int)1);
HXLINE(  56)				if (hx::IsNotNull( ( ( ::items::Item)(_hx_array_unsafe_get(this->items,index)) ) )) {
HXLINE(  57)					 ::items::Item _hx_tmp = ( ( ::items::Item)(_hx_array_unsafe_get(this->items,index)) );
HXDLIN(  57)					if ((_hx_tmp->name == item->name)) {
HXLINE(  58)						return index;
            					}
            				}
            			}
            		}
...
bool Inventory_obj::addItem( ::items::Item item){
            	HX_STACKFRAME(&_hx_pos_0cc7e8a45b68efd7_65_addItem)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(item,"item")
HXLINE(  66)		HX_VARI( int,pos) = this->as(item);
HXLINE(  67)		HX_VARI( bool,itemAdded) = false;
HXLINE(  68)		if (this->indexIsValid(pos)) {
HXLINE(  69)			itemAdded = ( ( ::items::Item)(_hx_array_unsafe_get(this->items,pos)) )->stack(item);
            		}
HXLINE(  71)		if (!(itemAdded)) {
HXLINE(  72)			itemAdded = this->insert(this->getAvailableIndex(),item);
            		}
HXLINE(  74)		return itemAdded;
            	}
...
int Inventory_obj::getSize(){
            	HX_STACKFRAME(&_hx_pos_0cc7e8a45b68efd7_77_getSize)
            	HX_STACK_THIS(this)
HXLINE(  78)		HX_VARI( int,numberOfItems) = (int)0;
HXLINE(  79)		{
HXLINE(  79)			HX_VARI( int,_g1) = (int)0;
HXDLIN(  79)			HX_VARI( int,_g) = this->items->length;
HXDLIN(  79)			while((_g1 < _g)){
HXLINE(  79)				_g1 = (_g1 + (int)1);
HXDLIN(  79)				HX_VARI( int,index) = (_g1 - (int)1);
HXLINE(  80)				if (hx::IsNotNull( ( ( ::items::Item)(_hx_array_unsafe_get(this->items,index)) ) )) {
HXLINE(  81)					 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  81)					::String _hx_tmp1 = ((((HX_("slot #",81,f5,07,74) + index) + HX_(" : ",c6,7a,18,00)) + ( ( ::items::Item)(_hx_array_unsafe_get(this->items,index)) )->name) + HX_(" | Quantity : ",37,be,24,6e));
HXDLIN(  81)					::String _hx_tmp2 = (_hx_tmp1 + ( ( ::items::Item)(_hx_array_unsafe_get(this->items,index)) )->quantity);
HXDLIN(  81)					_hx_tmp(_hx_tmp2,hx::SourceInfo(HX_("Inventory.hx",c2,21,8a,bb),81,HX_("items.Inventory",8e,8c,06,31),HX_("getSize",77,50,d6,1e)));
HXLINE(  82)					numberOfItems = (numberOfItems + (int)1);
            				}
            			}
            		}
HXLINE(  85)		return numberOfItems;
            	}
