...
HXLINE(  29)		::openfl::_legacy::Lib_obj::setPackage(HX_("HaxeFlixel",42,8f,0c,ac),HX_("haxeflixel_experimentation",1b,df,6f,1e),HX_("com.example.myapp",84,30,57,c1),HX_("0.0.1",35,3d,c8,c1));
HXLINE(  52)		::openfl::_legacy::Lib_obj::create( ::Dynamic(new _hx_Closure_0()),(int)1280,(int)720,(int)60,(int)0,((int)((int)((int)((int)((int)((int)((int)((int)((int)((int)::openfl::_legacy::Lib_obj::HARDWARE | (int)(int)0) | (int)(int)0) | (int)(int)0) | (int)(int)0) | (int)::openfl::_legacy::Lib_obj::RESIZABLE) | (int)(int)0) | (int)::openfl::_legacy::Lib_obj::VSYNC) | (int)::openfl::_legacy::Lib_obj::FULLSCREEN) | (int)(int)0) | (int)(int)0),HX_("haxeflixel_experimentation",1b,df,6f,1e),null(),null());
            	}
