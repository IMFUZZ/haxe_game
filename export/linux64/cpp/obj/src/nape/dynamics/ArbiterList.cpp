...
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_264_get_length,"nape.dynamics.ArbiterList","get_length",0x4c1d1a8a,"nape.dynamics.ArbiterList.get_length","nape/dynamics/ArbiterList.hx",264,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_269_zpp_gl,"nape.dynamics.ArbiterList","zpp_gl",0x9d3c9fe5,"nape.dynamics.ArbiterList.zpp_gl","nape/dynamics/ArbiterList.hx",269,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_292_zpp_vm,"nape.dynamics.ArbiterList","zpp_vm",0x9d3cacf7,"nape.dynamics.ArbiterList.zpp_vm","nape/dynamics/ArbiterList.hx",292,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_346_has,"nape.dynamics.ArbiterList","has",0xbcb27c1f,"nape.dynamics.ArbiterList.has","nape/dynamics/ArbiterList.hx",346,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_363_at,"nape.dynamics.ArbiterList","at",0xbbf797ce,"nape.dynamics.ArbiterList.at","nape/dynamics/ArbiterList.hx",363,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_416_push,"nape.dynamics.ArbiterList","push",0x64d30175,"nape.dynamics.ArbiterList.push","nape/dynamics/ArbiterList.hx",416,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_447_unshift,"nape.dynamics.ArbiterList","unshift",0x1b5566ce,"nape.dynamics.ArbiterList.unshift","nape/dynamics/ArbiterList.hx",447,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_478_pop,"nape.dynamics.ArbiterList","pop",0xbcb89a56,"nape.dynamics.ArbiterList.pop","nape/dynamics/ArbiterList.hx",478,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_519_shift,"nape.dynamics.ArbiterList","shift",0x8562a487,"nape.dynamics.ArbiterList.shift","nape/dynamics/ArbiterList.hx",519,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_564_add,"nape.dynamics.ArbiterList","add",0xbcad2ee6,"nape.dynamics.ArbiterList.add","nape/dynamics/ArbiterList.hx",564,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_576_remove,"nape.dynamics.ArbiterList","remove",0x1309e89f,"nape.dynamics.ArbiterList.remove","nape/dynamics/ArbiterList.hx",576,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_618_clear,"nape.dynamics.ArbiterList","clear",0x519b2992,"nape.dynamics.ArbiterList.clear","nape/dynamics/ArbiterList.hx",618,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_634_empty,"nape.dynamics.ArbiterList","empty",0x7919f292,"nape.dynamics.ArbiterList.empty","nape/dynamics/ArbiterList.hx",634,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_647_iterator,"nape.dynamics.ArbiterList","iterator",0x3e4ba309,"nape.dynamics.ArbiterList.iterator","nape/dynamics/ArbiterList.hx",647,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_662_copy,"nape.dynamics.ArbiterList","copy",0x5c36ab50,"nape.dynamics.ArbiterList.copy","nape/dynamics/ArbiterList.hx",662,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_688_merge,"nape.dynamics.ArbiterList","merge",0x0f065abd,"nape.dynamics.ArbiterList.merge","nape/dynamics/ArbiterList.hx",688,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_702_toString,"nape.dynamics.ArbiterList","toString",0xe32029c7,"nape.dynamics.ArbiterList.toString","nape/dynamics/ArbiterList.hx",702,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_732_foreach,"nape.dynamics.ArbiterList","foreach",0x7c8680cf,"nape.dynamics.ArbiterList.foreach","nape/dynamics/ArbiterList.hx",732,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_779_filter,"nape.dynamics.ArbiterList","filter",0x93b66c13,"nape.dynamics.ArbiterList.filter","nape/dynamics/ArbiterList.hx",779,0xfd301dcb)
HX_DEFINE_STACK_FRAME(_hx_pos_d82b1fe398a12d67_304_fromArray,"nape.dynamics.ArbiterList","fromArray",0x8a94f654,"nape.dynamics.ArbiterList.fromArray","nape/dynamics/ArbiterList.hx",304,0xfd301dcb)
namespace nape{
namespace dynamics{
...
bool ArbiterList_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x610568e7;
}
...
HXLINE( 273)			{
HXLINE( 274)				this->zpp_inner->user_length = (int)0;
HXLINE( 275)				{
HXLINE( 276)					HX_VARI(  ::zpp_nape::util::ZNPNode_ZPP_Arbiter,cx_ite) = this->zpp_inner->inner->head;
...
HXLINE( 489)		HX_VARI(  ::zpp_nape::dynamics::ZPP_Arbiter,ret) = null();
HXLINE( 490)		if (this->zpp_inner->reverse_flag) {
HXLINE( 491)			ret = this->zpp_inner->inner->head->elt;
HXLINE( 492)			HX_VARI(  ::nape::dynamics::Arbiter,retx) = ret->wrapper();
...
HXLINE( 498)			HX_VAR(  ::zpp_nape::util::ZNPNode_ZPP_Arbiter,ite);
HXDLIN( 498)			if ((this->zpp_gl() == (int)1)) {
HXLINE( 498)				ite = null();
            			}
            			else {
HXLINE( 498)				HX_VARI_NAME(  ::zpp_nape::util::ZNPList_ZPP_Arbiter,ite1,"ite") = this->zpp_inner->inner;
...
HXLINE( 500)			HX_VARI_NAME(  ::nape::dynamics::Arbiter,retx1,"retx") = ret->wrapper();
...
HXLINE( 530)		HX_VARI(  ::zpp_nape::dynamics::ZPP_Arbiter,ret) = null();
...
HXLINE( 533)			HX_VAR(  ::zpp_nape::util::ZNPNode_ZPP_Arbiter,ite);
HXDLIN( 533)			if ((this->zpp_gl() == (int)1)) {
HXLINE( 533)				ite = null();
            			}
            			else {
HXLINE( 533)				HX_VARI_NAME(  ::zpp_nape::util::ZNPList_ZPP_Arbiter,ite1,"ite") = this->zpp_inner->inner;
...
HXLINE( 535)			HX_VARI(  ::nape::dynamics::Arbiter,retx) = ret->wrapper();
...
HXLINE( 541)			HX_VARI_NAME(  ::nape::dynamics::Arbiter,retx1,"retx") = ret->wrapper();
...
HXLINE( 587)			{
HXLINE( 588)				HX_VARI(  ::zpp_nape::util::ZNPNode_ZPP_Arbiter,cx_ite) = this->zpp_inner->inner->head;
...
void ArbiterList_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_d82b1fe398a12d67_618_clear)
            	HX_STACK_THIS(this)
...
HXLINE( 663)		HX_VARI(  ::nape::dynamics::ArbiterList,ret) =  ::nape::dynamics::ArbiterList_obj::__alloc( HX_CTX );
HXLINE( 664)		{
HXLINE( 664)			HX_VARI(  ::nape::dynamics::ArbiterIterator,_g) = this->iterator();
...
HXDLIN( 664)				HX_VARI(  ::nape::dynamics::Arbiter,i) = _g->zpp_inner->at(_g->zpp_i++);
HXDLIN( 664)				 ::nape::dynamics::Arbiter _hx_tmp1;
HXDLIN( 664)				if (deep) {
...
void ArbiterList_obj::merge( ::nape::dynamics::ArbiterList xs){
            	HX_STACKFRAME(&_hx_pos_d82b1fe398a12d67_688_merge)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(xs,"xs")
HXLINE( 688)		HX_VARI(  ::nape::dynamics::ArbiterIterator,_g) = xs->iterator();
HXDLIN( 688)		while(true){
HXLINE( 688)			_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 688)			HX_VARI( int,length) = _g->zpp_inner->zpp_gl();
...
HXDLIN( 688)			HX_VARI(  ::nape::dynamics::Arbiter,x) = _g->zpp_inner->at(_g->zpp_i++);
...
HXLINE( 705)		{
HXLINE( 705)			HX_VARI(  ::nape::dynamics::ArbiterIterator,_g) = this->iterator();
HXDLIN( 705)			while(true){
HXLINE( 705)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 705)				HX_VARI( int,length) = _g->zpp_inner->zpp_gl();
...
HXDLIN( 705)				HX_VARI(  ::nape::dynamics::Arbiter,i) = _g->zpp_inner->at(_g->zpp_i++);
HXLINE( 706)				if (!(fst)) {
...
HXLINE( 736)		HX_VARI(  ::nape::dynamics::ArbiterIterator,it) = this->iterator();
HXLINE( 737)		while(true){
HXLINE( 737)			it->zpp_inner->zpp_inner->valmod();
HXDLIN( 737)			HX_VARI( int,length) = it->zpp_inner->zpp_gl();
...
HXLINE( 785)			HX_VARI(  ::nape::dynamics::Arbiter,x) = this->at(i);
HXLINE( 786)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXLINE( 310)		HX_VARI(  ::nape::dynamics::ArbiterList,ret) =  ::nape::dynamics::ArbiterList_obj::__alloc( HX_CTX );
HXLINE( 311)		{
HXLINE( 311)			HX_VARI( int,_g) = (int)0;
HXDLIN( 311)			while((_g < array->length)){
HXLINE( 311)				HX_VARI(  ::nape::dynamics::Arbiter,i) = array->__get(_g).StaticCast<  ::nape::dynamics::Arbiter >();
...
static void ArbiterList_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ArbiterList_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ArbiterList_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new ArbiterList_obj;
	ArbiterList_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = ArbiterList_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = ArbiterList_obj_sVisitStatics;
#endif
