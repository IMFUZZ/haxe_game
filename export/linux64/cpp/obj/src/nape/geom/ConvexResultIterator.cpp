...
HX_DEFINE_STACK_FRAME(_hx_pos_20ed74055c775b27_240_hasNext,"nape.geom.ConvexResultIterator","hasNext",0xeae5b6bd,"nape.geom.ConvexResultIterator.hasNext","nape/geom/ConvexResultIterator.hx",240,0xbabefb60)
HX_DEFINE_STACK_FRAME(_hx_pos_20ed74055c775b27_264_next,"nape.geom.ConvexResultIterator","next",0xa75e81a3,"nape.geom.ConvexResultIterator.next","nape/geom/ConvexResultIterator.hx",264,0xbabefb60)
HX_DEFINE_STACK_FRAME(_hx_pos_20ed74055c775b27_217_get,"nape.geom.ConvexResultIterator","get",0x5116a9e6,"nape.geom.ConvexResultIterator.get","nape/geom/ConvexResultIterator.hx",217,0xbabefb60)
HX_DEFINE_STACK_FRAME(_hx_pos_20ed74055c775b27_194_boot,"nape.geom.ConvexResultIterator","boot",0x9f7780e2,"nape.geom.ConvexResultIterator.boot","nape/geom/ConvexResultIterator.hx",194,0xbabefb60)
namespace nape{
namespace geom{
...
HXLINE( 244)		HX_VARI(  ::nape::geom::ConvexResultList,_this) = this->zpp_inner;
...
HXLINE( 218)		HX_VAR(  ::nape::geom::ConvexResultIterator,ret);
...
HXLINE( 220)			HX_VARI_NAME(  ::nape::geom::ConvexResultIterator,ret1,"ret") =  ::nape::geom::ConvexResultIterator_obj::__alloc( HX_CTX );
HXLINE( 221)			::zpp_nape::util::ZPP_ConvexResultList_obj::internal = false;
HXLINE( 218)			ret = ret1;
            		}
            		else {
HXLINE( 225)			HX_VARI(  ::nape::geom::ConvexResultIterator,r) = ::nape::geom::ConvexResultIterator_obj::zpp_pool;
...
{
	hx::Object *dummy = new ConvexResultIterator_obj;
	ConvexResultIterator_obj::_hx_vtable = *(void **)dummy;
