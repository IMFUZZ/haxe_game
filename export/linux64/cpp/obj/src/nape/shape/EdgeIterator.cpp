...
HX_DEFINE_STACK_FRAME(_hx_pos_06be798f927e8484_240_hasNext,"nape.shape.EdgeIterator","hasNext",0xeae07d9d,"nape.shape.EdgeIterator.hasNext","nape/shape/EdgeIterator.hx",240,0x3593e45e)
HX_DEFINE_STACK_FRAME(_hx_pos_06be798f927e8484_264_next,"nape.shape.EdgeIterator","next",0xf2e4aec3,"nape.shape.EdgeIterator.next","nape/shape/EdgeIterator.hx",264,0x3593e45e)
HX_DEFINE_STACK_FRAME(_hx_pos_06be798f927e8484_217_get,"nape.shape.EdgeIterator","get",0xa8ac80c6,"nape.shape.EdgeIterator.get","nape/shape/EdgeIterator.hx",217,0x3593e45e)
HX_DEFINE_STACK_FRAME(_hx_pos_06be798f927e8484_194_boot,"nape.shape.EdgeIterator","boot",0xeafdae02,"nape.shape.EdgeIterator.boot","nape/shape/EdgeIterator.hx",194,0x3593e45e)
namespace nape{
namespace shape{
...
bool EdgeIterator_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x57d1ef80;
}
...
HXLINE( 244)		HX_VARI(  ::nape::shape::EdgeList,_this) = this->zpp_inner;
...
HXLINE( 218)		HX_VAR(  ::nape::shape::EdgeIterator,ret);
HXDLIN( 218)		if (hx::IsNull( ::nape::shape::EdgeIterator_obj::zpp_pool )) {
HXLINE( 219)			::zpp_nape::util::ZPP_EdgeList_obj::internal = true;
HXLINE( 220)			HX_VARI_NAME(  ::nape::shape::EdgeIterator,ret1,"ret") =  ::nape::shape::EdgeIterator_obj::__alloc( HX_CTX );
HXLINE( 221)			::zpp_nape::util::ZPP_EdgeList_obj::internal = false;
HXLINE( 218)			ret = ret1;
            		}
            		else {
HXLINE( 225)			HX_VARI(  ::nape::shape::EdgeIterator,r) = ::nape::shape::EdgeIterator_obj::zpp_pool;
...
{
	hx::Object *dummy = new EdgeIterator_obj;
	EdgeIterator_obj::_hx_vtable = *(void **)dummy;
