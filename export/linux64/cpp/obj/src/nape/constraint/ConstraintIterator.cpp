...
HX_DEFINE_STACK_FRAME(_hx_pos_4aaad320581fbd10_240_hasNext,"nape.constraint.ConstraintIterator","hasNext",0xb3bc17f5,"nape.constraint.ConstraintIterator.hasNext","nape/constraint/ConstraintIterator.hx",240,0xd109e3e8)
HX_DEFINE_STACK_FRAME(_hx_pos_4aaad320581fbd10_264_next,"nape.constraint.ConstraintIterator","next",0xee87ad6b,"nape.constraint.ConstraintIterator.next","nape/constraint/ConstraintIterator.hx",264,0xd109e3e8)
HX_DEFINE_STACK_FRAME(_hx_pos_4aaad320581fbd10_217_get,"nape.constraint.ConstraintIterator","get",0x8f660f1e,"nape.constraint.ConstraintIterator.get","nape/constraint/ConstraintIterator.hx",217,0xd109e3e8)
HX_DEFINE_STACK_FRAME(_hx_pos_4aaad320581fbd10_194_boot,"nape.constraint.ConstraintIterator","boot",0xe6a0acaa,"nape.constraint.ConstraintIterator.boot","nape/constraint/ConstraintIterator.hx",194,0xd109e3e8)
namespace nape{
...
HXLINE( 244)		HX_VARI(  ::nape::constraint::ConstraintList,_this) = this->zpp_inner;
...
HXLINE( 218)		HX_VAR(  ::nape::constraint::ConstraintIterator,ret);
...
HXLINE( 220)			HX_VARI_NAME(  ::nape::constraint::ConstraintIterator,ret1,"ret") =  ::nape::constraint::ConstraintIterator_obj::__alloc( HX_CTX );
HXLINE( 221)			::zpp_nape::util::ZPP_ConstraintList_obj::internal = false;
HXLINE( 218)			ret = ret1;
            		}
            		else {
HXLINE( 225)			HX_VARI(  ::nape::constraint::ConstraintIterator,r) = ::nape::constraint::ConstraintIterator_obj::zpp_pool;
...
{
	hx::Object *dummy = new ConstraintIterator_obj;
	ConstraintIterator_obj::_hx_vtable = *(void **)dummy;
