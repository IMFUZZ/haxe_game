...
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_244_get_length,"nape.callbacks.ListenerList","get_length",0xa38fc225,"nape.callbacks.ListenerList.get_length","nape/callbacks/ListenerList.hx",244,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_346_has,"nape.callbacks.ListenerList","has",0x5f306f24,"nape.callbacks.ListenerList.has","nape/callbacks/ListenerList.hx",346,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_363_at,"nape.callbacks.ListenerList","at",0x4b0bac69,"nape.callbacks.ListenerList.at","nape/callbacks/ListenerList.hx",363,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_416_push,"nape.callbacks.ListenerList","push",0xf089b2d0,"nape.callbacks.ListenerList.push","nape/callbacks/ListenerList.hx",416,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_447_unshift,"nape.callbacks.ListenerList","unshift",0x8049c053,"nape.callbacks.ListenerList.unshift","nape/callbacks/ListenerList.hx",447,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_478_pop,"nape.callbacks.ListenerList","pop",0x5f368d5b,"nape.callbacks.ListenerList.pop","nape/callbacks/ListenerList.hx",478,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_519_shift,"nape.callbacks.ListenerList","shift",0x398722cc,"nape.callbacks.ListenerList.shift","nape/callbacks/ListenerList.hx",519,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_564_add,"nape.callbacks.ListenerList","add",0x5f2b21eb,"nape.callbacks.ListenerList.add","nape/callbacks/ListenerList.hx",564,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_576_remove,"nape.callbacks.ListenerList","remove",0xfed3e6ba,"nape.callbacks.ListenerList.remove","nape/callbacks/ListenerList.hx",576,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_618_clear,"nape.callbacks.ListenerList","clear",0x05bfa7d7,"nape.callbacks.ListenerList.clear","nape/callbacks/ListenerList.hx",618,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_633_empty,"nape.callbacks.ListenerList","empty",0x2d3e70d7,"nape.callbacks.ListenerList.empty","nape/callbacks/ListenerList.hx",633,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_647_iterator,"nape.callbacks.ListenerList","iterator",0x2f259de4,"nape.callbacks.ListenerList.iterator","nape/callbacks/ListenerList.hx",647,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_662_copy,"nape.callbacks.ListenerList","copy",0xe7ed5cab,"nape.callbacks.ListenerList.copy","nape/callbacks/ListenerList.hx",662,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_688_merge,"nape.callbacks.ListenerList","merge",0xc32ad902,"nape.callbacks.ListenerList.merge","nape/callbacks/ListenerList.hx",688,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_702_toString,"nape.callbacks.ListenerList","toString",0xd3fa24a2,"nape.callbacks.ListenerList.toString","nape/callbacks/ListenerList.hx",702,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_732_foreach,"nape.callbacks.ListenerList","foreach",0xe17ada54,"nape.callbacks.ListenerList.foreach","nape/callbacks/ListenerList.hx",732,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_779_filter,"nape.callbacks.ListenerList","filter",0x7f806a2e,"nape.callbacks.ListenerList.filter","nape/callbacks/ListenerList.hx",779,0xef884184)
HX_DEFINE_STACK_FRAME(_hx_pos_d0b80a353801bb6b_304_fromArray,"nape.callbacks.ListenerList","fromArray",0x58767b19,"nape.callbacks.ListenerList.fromArray","nape/callbacks/ListenerList.hx",304,0xef884184)
namespace nape{
namespace callbacks{
...
bool ListenerList_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0b7c400c;
}
...
HXLINE( 489)		HX_VARI(  ::zpp_nape::callbacks::ZPP_Listener,ret) = null();
...
HXLINE( 498)			HX_VAR(  ::zpp_nape::util::ZNPNode_ZPP_Listener,ite);
...
HXLINE( 498)				HX_VARI_NAME(  ::zpp_nape::util::ZNPList_ZPP_Listener,ite1,"ite") = this->zpp_inner->inner;
HXDLIN( 498)				this->zpp_inner->valmod();
HXDLIN( 498)				if (this->zpp_inner->zip_length) {
HXLINE( 498)					this->zpp_inner->zip_length = false;
HXDLIN( 498)					this->zpp_inner->user_length = this->zpp_inner->inner->length;
...
HXLINE( 530)		HX_VARI(  ::zpp_nape::callbacks::ZPP_Listener,ret) = null();
...
HXLINE( 533)			HX_VAR(  ::zpp_nape::util::ZNPNode_ZPP_Listener,ite);
...
HXLINE( 533)				HX_VARI_NAME(  ::zpp_nape::util::ZNPList_ZPP_Listener,ite1,"ite") = this->zpp_inner->inner;
HXDLIN( 533)				this->zpp_inner->valmod();
HXDLIN( 533)				if (this->zpp_inner->zip_length) {
HXLINE( 533)					this->zpp_inner->zip_length = false;
HXDLIN( 533)					this->zpp_inner->user_length = this->zpp_inner->inner->length;
...
HXLINE( 587)			{
HXLINE( 588)				HX_VARI(  ::zpp_nape::util::ZNPNode_ZPP_Listener,cx_ite) = this->zpp_inner->inner->head;
...
void ListenerList_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_d0b80a353801bb6b_618_clear)
            	HX_STACK_THIS(this)
...
HXLINE( 663)		HX_VARI(  ::nape::callbacks::ListenerList,ret) =  ::nape::callbacks::ListenerList_obj::__alloc( HX_CTX );
HXLINE( 664)		{
HXLINE( 664)			this->zpp_inner->valmod();
HXDLIN( 664)			HX_VARI(  ::nape::callbacks::ListenerIterator,_g) = ::nape::callbacks::ListenerIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 664)			while(true){
HXLINE( 664)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 664)				HX_VARI(  ::nape::callbacks::ListenerList,_this) = _g->zpp_inner;
...
HXDLIN( 664)				HX_VARI(  ::nape::callbacks::Listener,i) = _g->zpp_inner->at(_g->zpp_i++);
HXDLIN( 664)				 ::nape::callbacks::Listener _hx_tmp1;
HXDLIN( 664)				if (deep) {
...
void ListenerList_obj::merge( ::nape::callbacks::ListenerList xs){
            	HX_STACKFRAME(&_hx_pos_d0b80a353801bb6b_688_merge)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(xs,"xs")
HXLINE( 688)		xs->zpp_inner->valmod();
HXDLIN( 688)		HX_VARI(  ::nape::callbacks::ListenerIterator,_g) = ::nape::callbacks::ListenerIterator_obj::get(xs);
HXDLIN( 688)		while(true){
HXLINE( 688)			_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 688)			HX_VARI(  ::nape::callbacks::ListenerList,_this) = _g->zpp_inner;
...
HXDLIN( 688)			HX_VARI(  ::nape::callbacks::Listener,x) = _g->zpp_inner->at(_g->zpp_i++);
...
HXDLIN( 705)			HX_VARI(  ::nape::callbacks::ListenerIterator,_g) = ::nape::callbacks::ListenerIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 705)			while(true){
HXLINE( 705)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 705)				HX_VARI(  ::nape::callbacks::ListenerList,_this) = _g->zpp_inner;
...
HXDLIN( 705)				HX_VARI(  ::nape::callbacks::Listener,i) = _g->zpp_inner->at(_g->zpp_i++);
HXLINE( 706)				if (!(fst)) {
...
HXDLIN( 736)		HX_VARI(  ::nape::callbacks::ListenerIterator,it) = ::nape::callbacks::ListenerIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXLINE( 737)		while(true){
HXLINE( 737)			it->zpp_inner->zpp_inner->valmod();
HXDLIN( 737)			HX_VARI(  ::nape::callbacks::ListenerList,_this) = it->zpp_inner;
...
HXLINE( 785)			HX_VARI(  ::nape::callbacks::Listener,x) = this->at(i);
HXLINE( 786)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXLINE( 310)		HX_VARI(  ::nape::callbacks::ListenerList,ret) =  ::nape::callbacks::ListenerList_obj::__alloc( HX_CTX );
HXLINE( 311)		{
HXLINE( 311)			HX_VARI( int,_g) = (int)0;
HXDLIN( 311)			while((_g < array->length)){
HXLINE( 311)				HX_VARI(  ::nape::callbacks::Listener,i) = array->__get(_g).StaticCast<  ::nape::callbacks::Listener >();
...
static void ListenerList_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ListenerList_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ListenerList_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new ListenerList_obj;
	ListenerList_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = ListenerList_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = ListenerList_obj_sVisitStatics;
#endif
