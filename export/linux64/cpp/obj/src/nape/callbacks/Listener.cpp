...
HX_DEFINE_STACK_FRAME(_hx_pos_9a987b32df585753_181_new,"nape.callbacks.Listener","new",0x194abbac,"nape.callbacks.Listener.new","nape/callbacks/Listener.hx",181,0x82b91542)
HX_DEFINE_STACK_FRAME(_hx_pos_9a987b32df585753_188_get_type,"nape.callbacks.Listener","get_type",0xb8f84f77,"nape.callbacks.Listener.get_type","nape/callbacks/Listener.hx",188,0x82b91542)
HX_DEFINE_STACK_FRAME(_hx_pos_9a987b32df585753_196_get_event,"nape.callbacks.Listener","get_event",0x7b4690bd,"nape.callbacks.Listener.get_event","nape/callbacks/Listener.hx",196,0x82b91542)
HX_DEFINE_STACK_FRAME(_hx_pos_9a987b32df585753_198_set_event,"nape.callbacks.Listener","set_event",0x5e977cc9,"nape.callbacks.Listener.set_event","nape/callbacks/Listener.hx",198,0x82b91542)
HX_DEFINE_STACK_FRAME(_hx_pos_9a987b32df585753_223_get_precedence,"nape.callbacks.Listener","get_precedence",0xe231fe87,"nape.callbacks.Listener.get_precedence","nape/callbacks/Listener.hx",223,0x82b91542)
HX_DEFINE_STACK_FRAME(_hx_pos_9a987b32df585753_225_set_precedence,"nape.callbacks.Listener","set_precedence",0x0251e6fb,"nape.callbacks.Listener.set_precedence","nape/callbacks/Listener.hx",225,0x82b91542)
HX_DEFINE_STACK_FRAME(_hx_pos_9a987b32df585753_255_get_space,"nape.callbacks.Listener","get_space",0x86e85569,"nape.callbacks.Listener.get_space","nape/callbacks/Listener.hx",255,0x82b91542)
HX_DEFINE_STACK_FRAME(_hx_pos_9a987b32df585753_257_set_space,"nape.callbacks.Listener","set_space",0x6a394175,"nape.callbacks.Listener.set_space","nape/callbacks/Listener.hx",257,0x82b91542)
HX_DEFINE_STACK_FRAME(_hx_pos_9a987b32df585753_276_toString,"nape.callbacks.Listener","toString",0x24a371e0,"nape.callbacks.Listener.toString","nape/callbacks/Listener.hx",276,0x82b91542)
...
void Listener_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_9a987b32df585753_181_new)
            	HX_STACK_THIS(this)
...
bool Listener_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::nape::callbacks::ListenerType Listener_obj::get_type(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 188)		return ::zpp_nape::callbacks::ZPP_Listener_obj::types->__get(this->zpp_inner->type).StaticCast<  ::nape::callbacks::ListenerType >();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Listener_obj,get_type,return )
 ...
 ::nape::callbacks::CbEvent Listener_obj::get_event(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 196)		return ::zpp_nape::callbacks::ZPP_Listener_obj::events->__get(this->zpp_inner->event).StaticCast<  ::nape::callbacks::CbEvent >();
            	}
...
HXLINE( 206)									xevent = (int)5;
            								}
            								else {
HXLINE( 206)									xevent = (int)4;
            								}
            							}
            						}
            					}
...
int Listener_obj::get_precedence(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 223)		return this->zpp_inner->precedence;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Listener_obj,set_precedence,return )
 ...
 ::nape::space::Space Listener_obj::get_space(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 255)		if (hx::IsNull( this->zpp_inner->space )) {
HXLINE( 255)			return null();
            		}
            		else {
HXLINE( 255)			return this->zpp_inner->space->outer;
            		}
...
HXLINE( 264)				HX_VARI(  ::nape::callbacks::ListenerList,_this) = space->zpp_inner->wrap_listeners;
...
::String Listener_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 277)		HX_VARI( ::String,event) = ::Array_obj< ::String >::fromData( _hx_array_data_3708b5ba_9,7)->__get(this->zpp_inner->event);
HXLINE( 278)		if ((this->zpp_inner->type == (int)0)) {
...
HXLINE( 282)			if ((this->zpp_inner->type == (int)1)) {
...
HXLINE( 287)				HX_VARI(  ::zpp_nape::callbacks::ZPP_InteractionListener,con) = this->zpp_inner->interaction;
HXLINE( 288)				HX_VAR( ::String,itype);
...
HXDLIN( 294)				if ((this->zpp_inner->type == (int)2)) {
...
hx::Val Listener_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"event") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_event(inValue) ); }
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"precedence") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_precedence(inValue) ); }
	}
