...
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_244_get_length,"nape.callbacks.CbTypeList","get_length",0x484a3cc0,"nape.callbacks.CbTypeList.get_length","nape/callbacks/CbTypeList.hx",244,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_346_has,"nape.callbacks.CbTypeList","has",0x8f2a2f29,"nape.callbacks.CbTypeList.has","nape/callbacks/CbTypeList.hx",346,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_363_at,"nape.callbacks.CbTypeList","at",0x11dc9404,"nape.callbacks.CbTypeList.at","nape/callbacks/CbTypeList.hx",363,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_416_push,"nape.callbacks.CbTypeList","push",0xbb17f72b,"nape.callbacks.CbTypeList.push","nape/callbacks/CbTypeList.hx",416,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_447_unshift,"nape.callbacks.CbTypeList","unshift",0x712466d8,"nape.callbacks.CbTypeList.unshift","nape/callbacks/CbTypeList.hx",447,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_478_pop,"nape.callbacks.CbTypeList","pop",0x8f304d60,"nape.callbacks.CbTypeList.pop","nape/callbacks/CbTypeList.hx",478,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_519_shift,"nape.callbacks.CbTypeList","shift",0xab74ae11,"nape.callbacks.CbTypeList.shift","nape/callbacks/CbTypeList.hx",519,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_564_add,"nape.callbacks.CbTypeList","add",0x8f24e1f0,"nape.callbacks.CbTypeList.add","nape/callbacks/CbTypeList.hx",564,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_576_remove,"nape.callbacks.CbTypeList","remove",0x3cc037d5,"nape.callbacks.CbTypeList.remove","nape/callbacks/CbTypeList.hx",576,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_618_clear,"nape.callbacks.CbTypeList","clear",0x77ad331c,"nape.callbacks.CbTypeList.clear","nape/callbacks/CbTypeList.hx",618,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_633_empty,"nape.callbacks.CbTypeList","empty",0x9f2bfc1c,"nape.callbacks.CbTypeList.empty","nape/callbacks/CbTypeList.hx",633,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_647_iterator,"nape.callbacks.CbTypeList","iterator",0xfd9cabbf,"nape.callbacks.CbTypeList.iterator","nape/callbacks/CbTypeList.hx",647,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_662_copy,"nape.callbacks.CbTypeList","copy",0xb27ba106,"nape.callbacks.CbTypeList.copy","nape/callbacks/CbTypeList.hx",662,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_688_merge,"nape.callbacks.CbTypeList","merge",0x35186447,"nape.callbacks.CbTypeList.merge","nape/callbacks/CbTypeList.hx",688,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_702_toString,"nape.callbacks.CbTypeList","toString",0xa271327d,"nape.callbacks.CbTypeList.toString","nape/callbacks/CbTypeList.hx",702,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_732_foreach,"nape.callbacks.CbTypeList","foreach",0xd25580d9,"nape.callbacks.CbTypeList.foreach","nape/callbacks/CbTypeList.hx",732,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_779_filter,"nape.callbacks.CbTypeList","filter",0xbd6cbb49,"nape.callbacks.CbTypeList.filter","nape/callbacks/CbTypeList.hx",779,0x80c6cd9f)
HX_DEFINE_STACK_FRAME(_hx_pos_ac43c169fca36e70_304_fromArray,"nape.callbacks.CbTypeList","fromArray",0x322b8cde,"nape.callbacks.CbTypeList.fromArray","nape/callbacks/CbTypeList.hx",304,0x80c6cd9f)
namespace nape{
namespace callbacks{
...
bool CbTypeList_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x23502859;
}
...
HXLINE( 489)		HX_VARI(  ::zpp_nape::callbacks::ZPP_CbType,ret) = null();
...
HXLINE( 498)			HX_VAR(  ::zpp_nape::util::ZNPNode_ZPP_CbType,ite);
...
HXLINE( 498)				HX_VARI_NAME(  ::zpp_nape::util::ZNPList_ZPP_CbType,ite1,"ite") = this->zpp_inner->inner;
HXDLIN( 498)				this->zpp_inner->valmod();
HXDLIN( 498)				if (this->zpp_inner->zip_length) {
HXLINE( 498)					this->zpp_inner->zip_length = false;
HXDLIN( 498)					this->zpp_inner->user_length = this->zpp_inner->inner->length;
...
HXLINE( 530)		HX_VARI(  ::zpp_nape::callbacks::ZPP_CbType,ret) = null();
...
HXLINE( 533)			HX_VAR(  ::zpp_nape::util::ZNPNode_ZPP_CbType,ite);
...
HXLINE( 533)				HX_VARI_NAME(  ::zpp_nape::util::ZNPList_ZPP_CbType,ite1,"ite") = this->zpp_inner->inner;
HXDLIN( 533)				this->zpp_inner->valmod();
HXDLIN( 533)				if (this->zpp_inner->zip_length) {
HXLINE( 533)					this->zpp_inner->zip_length = false;
HXDLIN( 533)					this->zpp_inner->user_length = this->zpp_inner->inner->length;
...
HXLINE( 587)			{
HXLINE( 588)				HX_VARI(  ::zpp_nape::util::ZNPNode_ZPP_CbType,cx_ite) = this->zpp_inner->inner->head;
...
void CbTypeList_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_ac43c169fca36e70_618_clear)
            	HX_STACK_THIS(this)
...
HXLINE( 663)		HX_VARI(  ::nape::callbacks::CbTypeList,ret) =  ::nape::callbacks::CbTypeList_obj::__alloc( HX_CTX );
HXLINE( 664)		{
HXLINE( 664)			this->zpp_inner->valmod();
HXDLIN( 664)			HX_VARI(  ::nape::callbacks::CbTypeIterator,_g) = ::nape::callbacks::CbTypeIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 664)			while(true){
HXLINE( 664)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 664)				HX_VARI(  ::nape::callbacks::CbTypeList,_this) = _g->zpp_inner;
...
HXDLIN( 664)				HX_VARI(  ::nape::callbacks::CbType,i) = _g->zpp_inner->at(_g->zpp_i++);
HXDLIN( 664)				 ::nape::callbacks::CbType _hx_tmp1;
HXDLIN( 664)				if (deep) {
...
void CbTypeList_obj::merge( ::nape::callbacks::CbTypeList xs){
            	HX_STACKFRAME(&_hx_pos_ac43c169fca36e70_688_merge)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(xs,"xs")
HXLINE( 688)		xs->zpp_inner->valmod();
HXDLIN( 688)		HX_VARI(  ::nape::callbacks::CbTypeIterator,_g) = ::nape::callbacks::CbTypeIterator_obj::get(xs);
HXDLIN( 688)		while(true){
HXLINE( 688)			_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 688)			HX_VARI(  ::nape::callbacks::CbTypeList,_this) = _g->zpp_inner;
...
HXDLIN( 688)			HX_VARI(  ::nape::callbacks::CbType,x) = _g->zpp_inner->at(_g->zpp_i++);
...
HXDLIN( 705)			HX_VARI(  ::nape::callbacks::CbTypeIterator,_g) = ::nape::callbacks::CbTypeIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 705)			while(true){
HXLINE( 705)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 705)				HX_VARI(  ::nape::callbacks::CbTypeList,_this) = _g->zpp_inner;
...
HXDLIN( 705)				HX_VARI(  ::nape::callbacks::CbType,i) = _g->zpp_inner->at(_g->zpp_i++);
HXLINE( 706)				if (!(fst)) {
...
HXDLIN( 736)		HX_VARI(  ::nape::callbacks::CbTypeIterator,it) = ::nape::callbacks::CbTypeIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXLINE( 737)		while(true){
HXLINE( 737)			it->zpp_inner->zpp_inner->valmod();
HXDLIN( 737)			HX_VARI(  ::nape::callbacks::CbTypeList,_this) = it->zpp_inner;
...
HXLINE( 785)			HX_VARI(  ::nape::callbacks::CbType,x) = this->at(i);
HXLINE( 786)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXLINE( 310)		HX_VARI(  ::nape::callbacks::CbTypeList,ret) =  ::nape::callbacks::CbTypeList_obj::__alloc( HX_CTX );
HXLINE( 311)		{
HXLINE( 311)			HX_VARI( int,_g) = (int)0;
HXDLIN( 311)			while((_g < array->length)){
HXLINE( 311)				HX_VARI(  ::nape::callbacks::CbType,i) = array->__get(_g).StaticCast<  ::nape::callbacks::CbType >();
...
static void CbTypeList_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(CbTypeList_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void CbTypeList_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new CbTypeList_obj;
	CbTypeList_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = CbTypeList_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = CbTypeList_obj_sVisitStatics;
#endif
