...
HX_DEFINE_STACK_FRAME(_hx_pos_9659669d894e388a_240_hasNext,"nape.callbacks.ListenerIterator","hasNext",0x79f634c7,"nape.callbacks.ListenerIterator.hasNext","nape/callbacks/ListenerIterator.hx",240,0x5711eff4)
HX_DEFINE_STACK_FRAME(_hx_pos_9659669d894e388a_264_next,"nape.callbacks.ListenerIterator","next",0x63a73959,"nape.callbacks.ListenerIterator.next","nape/callbacks/ListenerIterator.hx",264,0x5711eff4)
HX_DEFINE_STACK_FRAME(_hx_pos_9659669d894e388a_217_get,"nape.callbacks.ListenerIterator","get",0x02b8daf0,"nape.callbacks.ListenerIterator.get","nape/callbacks/ListenerIterator.hx",217,0x5711eff4)
HX_DEFINE_STACK_FRAME(_hx_pos_9659669d894e388a_194_boot,"nape.callbacks.ListenerIterator","boot",0x5bc03898,"nape.callbacks.ListenerIterator.boot","nape/callbacks/ListenerIterator.hx",194,0x5711eff4)
namespace nape{
namespace callbacks{
...
bool ListenerIterator_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x41630748;
}
...
HXLINE( 244)		HX_VARI(  ::nape::callbacks::ListenerList,_this) = this->zpp_inner;
...
HXLINE( 218)		HX_VAR(  ::nape::callbacks::ListenerIterator,ret);
...
HXLINE( 220)			HX_VARI_NAME(  ::nape::callbacks::ListenerIterator,ret1,"ret") =  ::nape::callbacks::ListenerIterator_obj::__alloc( HX_CTX );
HXLINE( 221)			::zpp_nape::util::ZPP_ListenerList_obj::internal = false;
HXLINE( 218)			ret = ret1;
            		}
            		else {
HXLINE( 225)			HX_VARI(  ::nape::callbacks::ListenerIterator,r) = ::nape::callbacks::ListenerIterator_obj::zpp_pool;
...
{
	hx::Object *dummy = new ListenerIterator_obj;
	ListenerIterator_obj::_hx_vtable = *(void **)dummy;
