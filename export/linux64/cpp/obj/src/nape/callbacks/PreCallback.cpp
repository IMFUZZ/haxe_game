...
HX_DEFINE_STACK_FRAME(_hx_pos_e5cf6054a047c71d_197_get_arbiter,"nape.callbacks.PreCallback","get_arbiter",0xfb267914,"nape.callbacks.PreCallback.get_arbiter","nape/callbacks/PreCallback.hx",197,0x4a2c4f3e)
HX_DEFINE_STACK_FRAME(_hx_pos_e5cf6054a047c71d_208_get_int1,"nape.callbacks.PreCallback","get_int1",0x9a05f257,"nape.callbacks.PreCallback.get_int1","nape/callbacks/PreCallback.hx",208,0x4a2c4f3e)
HX_DEFINE_STACK_FRAME(_hx_pos_e5cf6054a047c71d_219_get_int2,"nape.callbacks.PreCallback","get_int2",0x9a05f258,"nape.callbacks.PreCallback.get_int2","nape/callbacks/PreCallback.hx",219,0x4a2c4f3e)
HX_DEFINE_STACK_FRAME(_hx_pos_e5cf6054a047c71d_233_get_swapped,"nape.callbacks.PreCallback","get_swapped",0x58a88147,"nape.callbacks.PreCallback.get_swapped","nape/callbacks/PreCallback.hx",233,0x4a2c4f3e)
HX_DEFINE_STACK_FRAME(_hx_pos_e5cf6054a047c71d_238_toString,"nape.callbacks.PreCallback","toString",0x0cfec318,"nape.callbacks.PreCallback.toString","nape/callbacks/PreCallback.hx",238,0x4a2c4f3e)
namespace nape{
namespace callbacks{
...
bool PreCallback_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::nape::dynamics::Arbiter PreCallback_obj::get_arbiter(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 197)		return this->zpp_inner->pre_arbiter->wrapper();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(PreCallback_obj,get_arbiter,return )
 ...
 ::nape::phys::Interactor PreCallback_obj::get_int1(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 208)		return this->zpp_inner->int1->outer_i;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(PreCallback_obj,get_int1,return )
 ...
 ::nape::phys::Interactor PreCallback_obj::get_int2(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 219)		return this->zpp_inner->int2->outer_i;
            	}
...
bool PreCallback_obj::get_swapped(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 233)		return this->zpp_inner->pre_swapped;
            	}
...
::String PreCallback_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 239)		HX_VARI( ::String,ret) = HX_("Cb:PRE:",f2,9c,74,ab);
HXLINE( 240)		ret = (HX_("Cb:PRE:",f2,9c,74,ab) + (((HX_(":",3a,00,00,00) + this->zpp_inner->int1->outer_i->toString()) + HX_("/",2f,00,00,00)) + this->zpp_inner->int2->outer_i->toString()));
...
static void PreCallback_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(PreCallback_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void PreCallback_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new PreCallback_obj;
	PreCallback_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = PreCallback_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = PreCallback_obj_sVisitStatics;
#endif
