...
HX_DEFINE_STACK_FRAME(_hx_pos_a67c68fe8300d194_195_get_options,"nape.callbacks.ConstraintListener","get_options",0x196e273e,"nape.callbacks.ConstraintListener.get_options","nape/callbacks/ConstraintListener.hx",195,0xd5b745e5)
HX_DEFINE_STACK_FRAME(_hx_pos_a67c68fe8300d194_197_set_options,"nape.callbacks.ConstraintListener","set_options",0x23db2e4a,"nape.callbacks.ConstraintListener.set_options","nape/callbacks/ConstraintListener.hx",197,0xd5b745e5)
HX_DEFINE_STACK_FRAME(_hx_pos_a67c68fe8300d194_209_get_handler,"nape.callbacks.ConstraintListener","get_handler",0x7f45a3aa,"nape.callbacks.ConstraintListener.get_handler","nape/callbacks/ConstraintListener.hx",209,0xd5b745e5)
HX_DEFINE_STACK_FRAME(_hx_pos_a67c68fe8300d194_211_set_handler,"nape.callbacks.ConstraintListener","set_handler",0x89b2aab6,"nape.callbacks.ConstraintListener.set_handler","nape/callbacks/ConstraintListener.hx",211,0xd5b745e5)
namespace nape{
namespace callbacks{
...
HXDLIN( 264)				if (hx::IsEq( event,::zpp_nape::util::ZPP_Flags_obj::CbEvent_BREAK )) {
HXLINE( 264)					xevent = (int)4;
            				}
            			}
            		}
...
bool ConstraintListener_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x65d6373a) {
		...
		return inClassId==(int)0x73ad8c37;
	}
}
...
static void ConstraintListener_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ConstraintListener_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ConstraintListener_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new ConstraintListener_obj;
	ConstraintListener_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = ConstraintListener_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = ConstraintListener_obj_sVisitStatics;
#endif
