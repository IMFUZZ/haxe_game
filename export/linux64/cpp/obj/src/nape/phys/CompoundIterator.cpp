...
HX_DEFINE_STACK_FRAME(_hx_pos_ab2db9b80b31b15c_240_hasNext,"nape.phys.CompoundIterator","hasNext",0x10348cae,"nape.phys.CompoundIterator.hasNext","nape/phys/CompoundIterator.hx",240,0x30e99b0f)
HX_DEFINE_STACK_FRAME(_hx_pos_ab2db9b80b31b15c_264_next,"nape.phys.CompoundIterator","next",0x6cdffb12,"nape.phys.CompoundIterator.next","nape/phys/CompoundIterator.hx",264,0x30e99b0f)
HX_DEFINE_STACK_FRAME(_hx_pos_ab2db9b80b31b15c_217_get,"nape.phys.CompoundIterator","get",0x8c857357,"nape.phys.CompoundIterator.get","nape/phys/CompoundIterator.hx",217,0x30e99b0f)
HX_DEFINE_STACK_FRAME(_hx_pos_ab2db9b80b31b15c_194_boot,"nape.phys.CompoundIterator","boot",0x64f8fa51,"nape.phys.CompoundIterator.boot","nape/phys/CompoundIterator.hx",194,0x30e99b0f)
namespace nape{
namespace phys{
...
bool CompoundIterator_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x22c38153;
}
...
HXLINE( 244)		HX_VARI(  ::nape::phys::CompoundList,_this) = this->zpp_inner;
...
HXLINE( 218)		HX_VAR(  ::nape::phys::CompoundIterator,ret);
...
HXLINE( 220)			HX_VARI_NAME(  ::nape::phys::CompoundIterator,ret1,"ret") =  ::nape::phys::CompoundIterator_obj::__alloc( HX_CTX );
HXLINE( 221)			::zpp_nape::util::ZPP_CompoundList_obj::internal = false;
HXLINE( 218)			ret = ret1;
            		}
            		else {
HXLINE( 225)			HX_VARI(  ::nape::phys::CompoundIterator,r) = ::nape::phys::CompoundIterator_obj::zpp_pool;
...
{
	hx::Object *dummy = new CompoundIterator_obj;
	CompoundIterator_obj::_hx_vtable = *(void **)dummy;
