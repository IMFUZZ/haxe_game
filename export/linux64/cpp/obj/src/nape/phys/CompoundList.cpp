...
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_244_get_length,"nape.phys.CompoundList","get_length",0xfdc7241e,"nape.phys.CompoundList.get_length","nape/phys/CompoundList.hx",244,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_346_has,"nape.phys.CompoundList","has",0xb741080b,"nape.phys.CompoundList.has","nape/phys/CompoundList.hx",346,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_363_at,"nape.phys.CompoundList","at",0xb633ed62,"nape.phys.CompoundList.at","nape/phys/CompoundList.hx",363,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_416_push,"nape.phys.CompoundList","push",0xa6fee409,"nape.phys.CompoundList.push","nape/phys/CompoundList.hx",416,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_447_unshift,"nape.phys.CompoundList","unshift",0x0a1658ba,"nape.phys.CompoundList.unshift","nape/phys/CompoundList.hx",447,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_478_pop,"nape.phys.CompoundList","pop",0xb7472642,"nape.phys.CompoundList.pop","nape/phys/CompoundList.hx",478,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_519_shift,"nape.phys.CompoundList","shift",0x299d0373,"nape.phys.CompoundList.shift","nape/phys/CompoundList.hx",519,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_564_add,"nape.phys.CompoundList","add",0xb73bbad2,"nape.phys.CompoundList.add","nape/phys/CompoundList.hx",564,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_576_remove,"nape.phys.CompoundList","remove",0x21e29833,"nape.phys.CompoundList.remove","nape/phys/CompoundList.hx",576,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_618_clear,"nape.phys.CompoundList","clear",0xf5d5887e,"nape.phys.CompoundList.clear","nape/phys/CompoundList.hx",618,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_633_empty,"nape.phys.CompoundList","empty",0x1d54517e,"nape.phys.CompoundList.empty","nape/phys/CompoundList.hx",633,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_647_iterator,"nape.phys.CompoundList","iterator",0x385e5f9d,"nape.phys.CompoundList.iterator","nape/phys/CompoundList.hx",647,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_662_copy,"nape.phys.CompoundList","copy",0x9e628de4,"nape.phys.CompoundList.copy","nape/phys/CompoundList.hx",662,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_688_merge,"nape.phys.CompoundList","merge",0xb340b9a9,"nape.phys.CompoundList.merge","nape/phys/CompoundList.hx",688,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_702_toString,"nape.phys.CompoundList","toString",0xdd32e65b,"nape.phys.CompoundList.toString","nape/phys/CompoundList.hx",702,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_732_foreach,"nape.phys.CompoundList","foreach",0x6b4772bb,"nape.phys.CompoundList.foreach","nape/phys/CompoundList.hx",732,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_779_filter,"nape.phys.CompoundList","filter",0xa28f1ba7,"nape.phys.CompoundList.filter","nape/phys/CompoundList.hx",779,0xaf0f831f)
HX_DEFINE_STACK_FRAME(_hx_pos_3054e882b2f2b6b8_304_fromArray,"nape.phys.CompoundList","fromArray",0x60e73b40,"nape.phys.CompoundList.fromArray","nape/phys/CompoundList.hx",304,0xaf0f831f)
namespace nape{
namespace phys{
...
HXLINE( 489)		HX_VARI(  ::zpp_nape::phys::ZPP_Compound,ret) = null();
...
HXLINE( 498)			HX_VAR(  ::zpp_nape::util::ZNPNode_ZPP_Compound,ite);
...
HXLINE( 498)				HX_VARI_NAME(  ::zpp_nape::util::ZNPList_ZPP_Compound,ite1,"ite") = this->zpp_inner->inner;
HXDLIN( 498)				this->zpp_inner->valmod();
HXDLIN( 498)				if (this->zpp_inner->zip_length) {
HXLINE( 498)					this->zpp_inner->zip_length = false;
HXDLIN( 498)					this->zpp_inner->user_length = this->zpp_inner->inner->length;
...
HXLINE( 530)		HX_VARI(  ::zpp_nape::phys::ZPP_Compound,ret) = null();
...
HXLINE( 533)			HX_VAR(  ::zpp_nape::util::ZNPNode_ZPP_Compound,ite);
...
HXLINE( 533)				HX_VARI_NAME(  ::zpp_nape::util::ZNPList_ZPP_Compound,ite1,"ite") = this->zpp_inner->inner;
HXDLIN( 533)				this->zpp_inner->valmod();
HXDLIN( 533)				if (this->zpp_inner->zip_length) {
HXLINE( 533)					this->zpp_inner->zip_length = false;
HXDLIN( 533)					this->zpp_inner->user_length = this->zpp_inner->inner->length;
...
HXLINE( 587)			{
HXLINE( 588)				HX_VARI(  ::zpp_nape::util::ZNPNode_ZPP_Compound,cx_ite) = this->zpp_inner->inner->head;
...
void CompoundList_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_3054e882b2f2b6b8_618_clear)
            	HX_STACK_THIS(this)
...
HXLINE( 663)		HX_VARI(  ::nape::phys::CompoundList,ret) =  ::nape::phys::CompoundList_obj::__alloc( HX_CTX );
HXLINE( 664)		{
HXLINE( 664)			this->zpp_inner->valmod();
HXDLIN( 664)			HX_VARI(  ::nape::phys::CompoundIterator,_g) = ::nape::phys::CompoundIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 664)			while(true){
HXLINE( 664)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 664)				HX_VARI(  ::nape::phys::CompoundList,_this) = _g->zpp_inner;
...
HXDLIN( 664)				HX_VARI(  ::nape::phys::Compound,i) = _g->zpp_inner->at(_g->zpp_i++);
...
void CompoundList_obj::merge( ::nape::phys::CompoundList xs){
            	HX_STACKFRAME(&_hx_pos_3054e882b2f2b6b8_688_merge)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(xs,"xs")
HXLINE( 688)		xs->zpp_inner->valmod();
HXDLIN( 688)		HX_VARI(  ::nape::phys::CompoundIterator,_g) = ::nape::phys::CompoundIterator_obj::get(xs);
HXDLIN( 688)		while(true){
HXLINE( 688)			_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 688)			HX_VARI(  ::nape::phys::CompoundList,_this) = _g->zpp_inner;
...
HXDLIN( 688)			HX_VARI(  ::nape::phys::Compound,x) = _g->zpp_inner->at(_g->zpp_i++);
...
HXDLIN( 705)			HX_VARI(  ::nape::phys::CompoundIterator,_g) = ::nape::phys::CompoundIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 705)			while(true){
HXLINE( 705)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 705)				HX_VARI(  ::nape::phys::CompoundList,_this) = _g->zpp_inner;
...
HXDLIN( 705)				HX_VARI(  ::nape::phys::Compound,i) = _g->zpp_inner->at(_g->zpp_i++);
HXLINE( 706)				if (!(fst)) {
...
HXDLIN( 736)		HX_VARI(  ::nape::phys::CompoundIterator,it) = ::nape::phys::CompoundIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXLINE( 737)		while(true){
HXLINE( 737)			it->zpp_inner->zpp_inner->valmod();
HXDLIN( 737)			HX_VARI(  ::nape::phys::CompoundList,_this) = it->zpp_inner;
...
HXLINE( 785)			HX_VARI(  ::nape::phys::Compound,x) = this->at(i);
HXLINE( 786)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXLINE( 310)		HX_VARI(  ::nape::phys::CompoundList,ret) =  ::nape::phys::CompoundList_obj::__alloc( HX_CTX );
HXLINE( 311)		{
HXLINE( 311)			HX_VARI( int,_g) = (int)0;
HXDLIN( 311)			while((_g < array->length)){
HXLINE( 311)				HX_VARI(  ::nape::phys::Compound,i) = array->__get(_g).StaticCast<  ::nape::phys::Compound >();
...
static void CompoundList_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(CompoundList_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void CompoundList_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new CompoundList_obj;
	CompoundList_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = CompoundList_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = CompoundList_obj_sVisitStatics;
#endif
