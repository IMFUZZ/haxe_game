...
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_244_get_length,"nape.phys.InteractorList","get_length",0x4b405370,"nape.phys.InteractorList.get_length","nape/phys/InteractorList.hx",244,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_346_has,"nape.phys.InteractorList","has",0x686c2279,"nape.phys.InteractorList.has","nape/phys/InteractorList.hx",346,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_363_at,"nape.phys.InteractorList","at",0xab847ab4,"nape.phys.InteractorList.at","nape/phys/InteractorList.hx",363,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_416_push,"nape.phys.InteractorList","push",0xfb8ae9db,"nape.phys.InteractorList.push","nape/phys/InteractorList.hx",416,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_447_unshift,"nape.phys.InteractorList","unshift",0xedea4228,"nape.phys.InteractorList.unshift","nape/phys/InteractorList.hx",447,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_478_pop,"nape.phys.InteractorList","pop",0x687240b0,"nape.phys.InteractorList.pop","nape/phys/InteractorList.hx",478,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_519_shift,"nape.phys.InteractorList","shift",0xcf961561,"nape.phys.InteractorList.shift","nape/phys/InteractorList.hx",519,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_564_add,"nape.phys.InteractorList","add",0x6866d540,"nape.phys.InteractorList.add","nape/phys/InteractorList.hx",564,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_576_remove,"nape.phys.InteractorList","remove",0xb5d93685,"nape.phys.InteractorList.remove","nape/phys/InteractorList.hx",576,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_618_clear,"nape.phys.InteractorList","clear",0x9bce9a6c,"nape.phys.InteractorList.clear","nape/phys/InteractorList.hx",618,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_633_empty,"nape.phys.InteractorList","empty",0xc34d636c,"nape.phys.InteractorList.empty","nape/phys/InteractorList.hx",633,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_647_iterator,"nape.phys.InteractorList","iterator",0xadf6b66f,"nape.phys.InteractorList.iterator","nape/phys/InteractorList.hx",647,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_662_copy,"nape.phys.InteractorList","copy",0xf2ee93b6,"nape.phys.InteractorList.copy","nape/phys/InteractorList.hx",662,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_688_merge,"nape.phys.InteractorList","merge",0x5939cb97,"nape.phys.InteractorList.merge","nape/phys/InteractorList.hx",688,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_702_toString,"nape.phys.InteractorList","toString",0x52cb3d2d,"nape.phys.InteractorList.toString","nape/phys/InteractorList.hx",702,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_732_foreach,"nape.phys.InteractorList","foreach",0x4f1b5c29,"nape.phys.InteractorList.foreach","nape/phys/InteractorList.hx",732,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_779_filter,"nape.phys.InteractorList","filter",0x3685b9f9,"nape.phys.InteractorList.filter","nape/phys/InteractorList.hx",779,0x3e1b3871)
HX_DEFINE_STACK_FRAME(_hx_pos_4bcfa1918a55ab15_304_fromArray,"nape.phys.InteractorList","fromArray",0xd09adc2e,"nape.phys.InteractorList.fromArray","nape/phys/InteractorList.hx",304,0x3e1b3871)
namespace nape{
namespace phys{
...
bool InteractorList_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x472bb9b1;
}
...
HXLINE( 489)		HX_VARI(  ::zpp_nape::phys::ZPP_Interactor,ret) = null();
...
HXLINE( 498)			HX_VAR(  ::zpp_nape::util::ZNPNode_ZPP_Interactor,ite);
...
HXLINE( 498)				HX_VARI_NAME(  ::zpp_nape::util::ZNPList_ZPP_Interactor,ite1,"ite") = this->zpp_inner->inner;
HXDLIN( 498)				this->zpp_inner->valmod();
HXDLIN( 498)				if (this->zpp_inner->zip_length) {
HXLINE( 498)					this->zpp_inner->zip_length = false;
HXDLIN( 498)					this->zpp_inner->user_length = this->zpp_inner->inner->length;
...
HXLINE( 530)		HX_VARI(  ::zpp_nape::phys::ZPP_Interactor,ret) = null();
...
HXLINE( 533)			HX_VAR(  ::zpp_nape::util::ZNPNode_ZPP_Interactor,ite);
...
HXLINE( 533)				HX_VARI_NAME(  ::zpp_nape::util::ZNPList_ZPP_Interactor,ite1,"ite") = this->zpp_inner->inner;
HXDLIN( 533)				this->zpp_inner->valmod();
HXDLIN( 533)				if (this->zpp_inner->zip_length) {
HXLINE( 533)					this->zpp_inner->zip_length = false;
HXDLIN( 533)					this->zpp_inner->user_length = this->zpp_inner->inner->length;
...
HXLINE( 587)			{
HXLINE( 588)				HX_VARI(  ::zpp_nape::util::ZNPNode_ZPP_Interactor,cx_ite) = this->zpp_inner->inner->head;
HXLINE( 589)				while(hx::IsNotNull( cx_ite )){
HXLINE( 592)					if (hx::IsEq( cx_ite->elt,obj->zpp_inner_i )) {
HXLINE( 593)						ret = true;
...
void InteractorList_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_4bcfa1918a55ab15_618_clear)
            	HX_STACK_THIS(this)
...
HXLINE( 663)		HX_VARI(  ::nape::phys::InteractorList,ret) =  ::nape::phys::InteractorList_obj::__alloc( HX_CTX );
HXLINE( 664)		{
HXLINE( 664)			this->zpp_inner->valmod();
HXDLIN( 664)			HX_VARI(  ::nape::phys::InteractorIterator,_g) = ::nape::phys::InteractorIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 664)			while(true){
HXLINE( 664)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 664)				HX_VARI(  ::nape::phys::InteractorList,_this) = _g->zpp_inner;
...
HXDLIN( 664)				HX_VARI(  ::nape::phys::Interactor,i) = _g->zpp_inner->at(_g->zpp_i++);
HXDLIN( 664)				 ::nape::phys::Interactor _hx_tmp1;
HXDLIN( 664)				if (deep) {
...
void InteractorList_obj::merge( ::nape::phys::InteractorList xs){
            	HX_STACKFRAME(&_hx_pos_4bcfa1918a55ab15_688_merge)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(xs,"xs")
HXLINE( 688)		xs->zpp_inner->valmod();
HXDLIN( 688)		HX_VARI(  ::nape::phys::InteractorIterator,_g) = ::nape::phys::InteractorIterator_obj::get(xs);
HXDLIN( 688)		while(true){
HXLINE( 688)			_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 688)			HX_VARI(  ::nape::phys::InteractorList,_this) = _g->zpp_inner;
...
HXDLIN( 688)			HX_VARI(  ::nape::phys::Interactor,x) = _g->zpp_inner->at(_g->zpp_i++);
...
HXDLIN( 705)			HX_VARI(  ::nape::phys::InteractorIterator,_g) = ::nape::phys::InteractorIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXDLIN( 705)			while(true){
HXLINE( 705)				_g->zpp_inner->zpp_inner->valmod();
HXDLIN( 705)				HX_VARI(  ::nape::phys::InteractorList,_this) = _g->zpp_inner;
...
HXDLIN( 705)				HX_VARI(  ::nape::phys::Interactor,i) = _g->zpp_inner->at(_g->zpp_i++);
HXLINE( 706)				if (!(fst)) {
...
HXDLIN( 736)		HX_VARI(  ::nape::phys::InteractorIterator,it) = ::nape::phys::InteractorIterator_obj::get(hx::ObjectPtr<OBJ_>(this));
HXLINE( 737)		while(true){
HXLINE( 737)			it->zpp_inner->zpp_inner->valmod();
HXDLIN( 737)			HX_VARI(  ::nape::phys::InteractorList,_this) = it->zpp_inner;
...
HXLINE( 785)			HX_VARI(  ::nape::phys::Interactor,x) = this->at(i);
HXLINE( 786)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXLINE( 310)		HX_VARI(  ::nape::phys::InteractorList,ret) =  ::nape::phys::InteractorList_obj::__alloc( HX_CTX );
HXLINE( 311)		{
HXLINE( 311)			HX_VARI( int,_g) = (int)0;
HXDLIN( 311)			while((_g < array->length)){
HXLINE( 311)				HX_VARI(  ::nape::phys::Interactor,i) = array->__get(_g).StaticCast<  ::nape::phys::Interactor >();
...
static void InteractorList_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(InteractorList_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void InteractorList_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new InteractorList_obj;
	InteractorList_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = InteractorList_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = InteractorList_obj_sVisitStatics;
#endif
