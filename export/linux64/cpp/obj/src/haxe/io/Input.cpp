...
HX_DEFINE_STACK_FRAME(_hx_pos_254a12b9e3136e41_48_readByte,"haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","/usr/share/haxe/std/haxe/io/Input.hx",48,0x1cc3d0af)
HX_DEFINE_STACK_FRAME(_hx_pos_254a12b9e3136e41_89_close,"haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","/usr/share/haxe/std/haxe/io/Input.hx",89,0x1cc3d0af)
HX_DEFINE_STACK_FRAME(_hx_pos_254a12b9e3136e41_174_readLine,"haxe.io.Input","readLine",0x54789cae,"haxe.io.Input.readLine","/usr/share/haxe/std/haxe/io/Input.hx",174,0x1cc3d0af)
namespace haxe{
namespace io{
...
int Input_obj::readByte(){
            	HX_STACKFRAME(&_hx_pos_254a12b9e3136e41_48_readByte)
            	HX_STACK_THIS(this)
...
void Input_obj::close(){
            	HX_STACKFRAME(&_hx_pos_254a12b9e3136e41_89_close)
            	HX_STACK_THIS(this)
            	}
...
::String Input_obj::readLine(){
            	HX_GC_STACKFRAME(&_hx_pos_254a12b9e3136e41_174_readLine)
            	HX_STACK_THIS(this)
HXLINE( 175)		HX_VARI(  ::haxe::io::BytesBuffer,buf) =  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX );
...
HXLINE( 182)			if (hx::IsEq( s.charCodeAt((s.length - (int)1)),(int)13 )) {
