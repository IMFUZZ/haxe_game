...
HX_DEFINE_STACK_FRAME(_hx_pos_82fb9a78bb7ac900_477_new,"haxe._Unserializer.NullResolver","new",0x49a2304b,"haxe._Unserializer.NullResolver.new","/usr/share/haxe/std/haxe/Unserializer.hx",477,0x4786e765)
HX_DEFINE_STACK_FRAME(_hx_pos_82fb9a78bb7ac900_478_resolveClass,"haxe._Unserializer.NullResolver","resolveClass",0xc4a78861,"haxe._Unserializer.NullResolver.resolveClass","/usr/share/haxe/std/haxe/Unserializer.hx",478,0x4786e765)
HX_DEFINE_STACK_FRAME(_hx_pos_82fb9a78bb7ac900_479_resolveEnum,"haxe._Unserializer.NullResolver","resolveEnum",0x5f3252f8,"haxe._Unserializer.NullResolver.resolveEnum","/usr/share/haxe/std/haxe/Unserializer.hx",479,0x4786e765)
namespace haxe{
namespace _Unserializer{

void NullResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_82fb9a78bb7ac900_477_new)
            	HX_STACK_THIS(this)
            	}
...
hx::Class NullResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_82fb9a78bb7ac900_478_resolveClass)
            	HX_STACK_THIS(this)
...
hx::Class NullResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_82fb9a78bb7ac900_479_resolveEnum)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(name,"name")
