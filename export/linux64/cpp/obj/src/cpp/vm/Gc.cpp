...
HX_DEFINE_STACK_FRAME(_hx_pos_011ad5156d552c19_38_run,"cpp.vm.Gc","run",0x3d3e0d65,"cpp.vm.Gc.run","/usr/share/haxe/std/cpp/vm/Gc.hx",38,0x80f841d1)
namespace cpp{
namespace vm{
...
void Gc_obj::run(bool major){
            	HX_STACKFRAME(&_hx_pos_011ad5156d552c19_38_run)
