...
HX_DEFINE_STACK_FRAME(_hx_pos_d93ce7f2488caead_20_startTime,"gametime.Clock","startTime",0x89cfa160,"gametime.Clock.startTime","gametime/Clock.hx",20,0x9c699820)
HX_DEFINE_STACK_FRAME(_hx_pos_d93ce7f2488caead_24__onComplete,"gametime.Clock","_onComplete",0xef535428,"gametime.Clock._onComplete","gametime/Clock.hx",24,0x9c699820)
HX_DEFINE_STACK_FRAME(_hx_pos_d93ce7f2488caead_27_addDays,"gametime.Clock","addDays",0xada2b2e9,"gametime.Clock.addDays","gametime/Clock.hx",27,0x9c699820)
HX_DEFINE_STACK_FRAME(_hx_pos_d93ce7f2488caead_39_update,"gametime.Clock","update",0x6dfa0d98,"gametime.Clock.update","gametime/Clock.hx",39,0x9c699820)
HX_DEFINE_STACK_FRAME(_hx_pos_d93ce7f2488caead_43_getCurrentYear,"gametime.Clock","getCurrentYear",0x2ea5242f,"gametime.Clock.getCurrentYear","gametime/Clock.hx",43,0x9c699820)
HX_DEFINE_STACK_FRAME(_hx_pos_d93ce7f2488caead_47_getCurrentMonth,"gametime.Clock","getCurrentMonth",0xbfb1908e,"gametime.Clock.getCurrentMonth","gametime/Clock.hx",47,0x9c699820)
HX_DEFINE_STACK_FRAME(_hx_pos_d93ce7f2488caead_51_getCurrentSeason,"gametime.Clock","getCurrentSeason",0x9736c715,"gametime.Clock.getCurrentSeason","gametime/Clock.hx",51,0x9c699820)
HX_DEFINE_STACK_FRAME(_hx_pos_d93ce7f2488caead_55_getCurrentDay,"gametime.Clock","getCurrentDay",0x5081702a,"gametime.Clock.getCurrentDay","gametime/Clock.hx",55,0x9c699820)
HX_DEFINE_STACK_FRAME(_hx_pos_d93ce7f2488caead_59_getCurrentHour,"gametime.Clock","getCurrentHour",0x23702b96,"gametime.Clock.getCurrentHour","gametime/Clock.hx",59,0x9c699820)
HX_DEFINE_STACK_FRAME(_hx_pos_d93ce7f2488caead_63_getCurrentMinute,"gametime.Clock","getCurrentMinute",0x87463dc6,"gametime.Clock.getCurrentMinute","gametime/Clock.hx",63,0x9c699820)
HX_DEFINE_STACK_FRAME(_hx_pos_d93ce7f2488caead_67_createTimeStamp,"gametime.Clock","createTimeStamp",0x234c8cab,"gametime.Clock.createTimeStamp","gametime/Clock.hx",67,0x9c699820)
namespace gametime{
...
void Clock_obj::startTime(){
            	HX_STACKFRAME(&_hx_pos_d93ce7f2488caead_20_startTime)
            	HX_STACK_THIS(this)
HXLINE(  20)		this->super::start(this->_secondsInADay,this->_onComplete_dyn(),(int)0);
            	}


HX_DEFINE_DYNAMIC_FUNC0(Clock_obj,startTime,(void))

void Clock_obj::_onComplete( ::flixel::util::FlxTimer timer){
            	HX_STACKFRAME(&_hx_pos_d93ce7f2488caead_24__onComplete)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(timer,"timer")
HXLINE(  24)		this->addDays((int)1);
            	}
...
void Clock_obj::addDays(int numberOfDays){
            	HX_STACKFRAME(&_hx_pos_d93ce7f2488caead_27_addDays)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(numberOfDays,"numberOfDays")
HXLINE(  28)		 ::gametime::Clock _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  28)		_hx_tmp->currentDay = (_hx_tmp->currentDay + numberOfDays);
HXLINE(  29)		if ((hx::Mod(this->currentDay,this->_daysInMonth) == (int)0)) {
HXLINE(  30)			 ::gametime::Clock _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  30)			int _hx_tmp2 = _hx_tmp1->currentMonth;
HXDLIN(  30)			int _hx_tmp3 = ::Std_obj::_hx_int(((Float)this->currentDay / (Float)this->_daysInMonth));
HXDLIN(  30)			_hx_tmp1->currentMonth = (_hx_tmp2 + hx::Mod(_hx_tmp3,this->_monthsInYear));
HXLINE(  31)			if ((hx::Mod(this->currentMonth,this->_monthsInYear) == (int)0)) {
HXLINE(  32)				 ::gametime::Clock _hx_tmp4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  32)				int _hx_tmp5 = _hx_tmp4->currentYear;
HXDLIN(  32)				_hx_tmp4->currentYear = (_hx_tmp5 + ::Std_obj::_hx_int(((Float)this->currentDay / (Float)(this->_daysInMonth * this->_monthsInYear))));
HXLINE(  33)				this->currentDay = hx::Mod(this->currentDay,(this->_daysInMonth * this->_monthsInYear));
            			}
            		}
            	}
...
void Clock_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_d93ce7f2488caead_39_update)
            	HX_STACK_THIS(this)
...
int Clock_obj::getCurrentYear(){
            	HX_STACKFRAME(&_hx_pos_d93ce7f2488caead_43_getCurrentYear)
            	HX_STACK_THIS(this)
HXLINE(  43)		return this->currentYear;
            	}
...
int Clock_obj::getCurrentMonth(){
            	HX_STACKFRAME(&_hx_pos_d93ce7f2488caead_47_getCurrentMonth)
            	HX_STACK_THIS(this)
HXLINE(  47)		return this->currentMonth;
            	}
...
::String Clock_obj::getCurrentSeason(){
            	HX_STACKFRAME(&_hx_pos_d93ce7f2488caead_51_getCurrentSeason)
            	HX_STACK_THIS(this)
HXLINE(  51)		return this->_seasons->__get(::Std_obj::_hx_int(((Float)((Float)this->currentDay / (Float)(this->_daysInMonth * this->_monthsInYear)) / (Float)this->_seasons->length)));
            	}
...
int Clock_obj::getCurrentDay(){
            	HX_STACKFRAME(&_hx_pos_d93ce7f2488caead_55_getCurrentDay)
            	HX_STACK_THIS(this)
HXLINE(  55)		return this->currentDay;
            	}
...
int Clock_obj::getCurrentHour(){
            	HX_STACKFRAME(&_hx_pos_d93ce7f2488caead_59_getCurrentHour)
            	HX_STACK_THIS(this)
HXLINE(  59)		Float _hx_tmp;
HXDLIN(  59)		if ((this->time > (int)0)) {
HXLINE(  59)			_hx_tmp = ((Float)this->_timeCounter / (Float)this->time);
            		}
            		else {
HXLINE(  59)			_hx_tmp = (int)0;
            		}
HXDLIN(  59)		return ::Std_obj::_hx_int((_hx_tmp * (int)24));
            	}
...
int Clock_obj::getCurrentMinute(){
            	HX_STACKFRAME(&_hx_pos_d93ce7f2488caead_63_getCurrentMinute)
            	HX_STACK_THIS(this)
HXLINE(  63)		Float _hx_tmp;
HXDLIN(  63)		if ((this->time > (int)0)) {
HXLINE(  63)			_hx_tmp = ((Float)this->_timeCounter / (Float)this->time);
            		}
            		else {
HXLINE(  63)			_hx_tmp = (int)0;
            		}
HXDLIN(  63)		return ::Std_obj::_hx_int(((_hx_tmp * (int)1440) - (this->getCurrentHour() * (int)60)));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Clock_obj,getCurrentMinute,return )
 ...
 ::gametime::TimeStamp Clock_obj::createTimeStamp(){
            	HX_GC_STACKFRAME(&_hx_pos_d93ce7f2488caead_67_createTimeStamp)
            	HX_STACK_THIS(this)
HXLINE(  67)		return  ::gametime::TimeStamp_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this));
            	}
...
hx::Val Clock_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"startTime") ) { return hx::Val( startTime_dyn()); }
		break;
	case 10:
