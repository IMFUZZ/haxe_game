...
HX_DEFINE_STACK_FRAME(_hx_pos_0f9ac110bd093a4e_38_match,"EReg","match",0x18fda1a6,"EReg.match","/usr/share/haxe/std/cpp/_std/EReg.hx",38,0x3bcaa0cb)
HX_DEFINE_STACK_FRAME(_hx_pos_0f9ac110bd093a4e_49_matched,"EReg","matched",0x8ce62f85,"EReg.matched","/usr/share/haxe/std/cpp/_std/EReg.hx",49,0x3bcaa0cb)
HX_DEFINE_STACK_FRAME(_hx_pos_0f9ac110bd093a4e_64_matchedPos,"EReg","matchedPos",0x7007a70f,"EReg.matchedPos","/usr/share/haxe/std/cpp/_std/EReg.hx",64,0x3bcaa0cb)
HX_DEFINE_STACK_FRAME(_hx_pos_0f9ac110bd093a4e_76_split,"EReg","split",0x9749433b,"EReg.split","/usr/share/haxe/std/cpp/_std/EReg.hx",76,0x3bcaa0cb)
HX_DEFINE_STACK_FRAME(_hx_pos_0f9ac110bd093a4e_100_replace,"EReg","replace",0xae923ad5,"EReg.replace","/usr/share/haxe/std/cpp/_std/EReg.hx",100,0x3bcaa0cb)
...
::String EReg_obj::matched(int n){
            	HX_STACKFRAME(&_hx_pos_0f9ac110bd093a4e_49_matched)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(n,"n")
...
HXLINE(  88)				p->__SetField(HX_("pos",94,5d,55,00),(( (int)(p->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic)) ) + (int)1),hx::paccDynamic);
            			}
