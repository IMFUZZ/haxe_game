...
void Clock_obj::__construct(){
            	HX_STACK_FRAME("clock.Clock","new",0x8279ab00,"clock.Clock.new","clock/Clock.hx",5,0x541a1d71)
            	HX_STACK_THIS(this)
...
void Clock_obj::_onComplete( ::flixel::util::FlxTimer timer){
            	HX_STACK_FRAME("clock.Clock","_onComplete",0x497a1cb7,"clock.Clock._onComplete","clock/Clock.hx",21,0x541a1d71)
            	HX_STACK_THIS(this)
...
void Clock_obj::addDays(Int numberOfDays){
            	HX_STACK_FRAME("clock.Clock","addDays",0xf1d847f8,"clock.Clock.addDays","clock/Clock.hx",24,0x541a1d71)
            	HX_STACK_THIS(this)
...
void Clock_obj::update(Float elapsed){
            	HX_STACK_FRAME("clock.Clock","update",0xac460f69,"clock.Clock.update","clock/Clock.hx",36,0x541a1d71)
            	HX_STACK_THIS(this)
...
Int Clock_obj::getCurrentYear(){
            	HX_STACK_FRAME("clock.Clock","getCurrentYear",0xc170df00,"clock.Clock.getCurrentYear","clock/Clock.hx",40,0x541a1d71)
            	HX_STACK_THIS(this)
...
Int Clock_obj::getCurrentMonth(){
            	HX_STACK_FRAME("clock.Clock","getCurrentMonth",0x9f294c9d,"clock.Clock.getCurrentMonth","clock/Clock.hx",44,0x541a1d71)
            	HX_STACK_THIS(this)
...
::String Clock_obj::getCurrentSeason(){
            	HX_STACK_FRAME("clock.Clock","getCurrentSeason",0x40839826,"clock.Clock.getCurrentSeason","clock/Clock.hx",48,0x541a1d71)
            	HX_STACK_THIS(this)
...
Int Clock_obj::getCurrentDay(){
            	HX_STACK_FRAME("clock.Clock","getCurrentDay",0x9856ba79,"clock.Clock.getCurrentDay","clock/Clock.hx",52,0x541a1d71)
            	HX_STACK_THIS(this)
...
Int Clock_obj::getCurrentHour(){
            	HX_STACK_FRAME("clock.Clock","getCurrentHour",0xb63be667,"clock.Clock.getCurrentHour","clock/Clock.hx",56,0x541a1d71)
            	HX_STACK_THIS(this)
...
Int Clock_obj::getCurrentMinute(){
            	HX_STACK_FRAME("clock.Clock","getCurrentMinute",0x30930ed7,"clock.Clock.getCurrentMinute","clock/Clock.hx",60,0x541a1d71)
            	HX_STACK_THIS(this)
...
HX_DEFINE_DYNAMIC_FUNC0(Clock_obj,getCurrentMinute,return )
 ...
 ::clock::TimeStamp Clock_obj::createTimeStamp(){
            	HX_STACK_FRAME("clock.Clock","createTimeStamp",0x02c448ba,"clock.Clock.createTimeStamp","clock/Clock.hx",64,0x541a1d71)
            	HX_STACK_THIS(this)
HXLINE(  64)		return  ::clock::TimeStamp_obj::__new(hx::ObjectPtr<OBJ_>(this));
            	}
...
void Clock_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("clock.Clock","\x0e","\x6b","\x10","\x2c");
