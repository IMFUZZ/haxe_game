...
void TimeStamp_obj::__construct( ::clock::Clock clock1){
            	HX_STACK_FRAME("clock.TimeStamp","new",0x9de819e8,"clock.TimeStamp.new","clock/TimeStamp.hx",11,0x43041809)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(clock1,"clock1")
HXLINE(  12)		this->hours = clock1->getCurrentHour();
HXLINE(  13)		this->minutes = clock1->getCurrentMinute();
HXLINE(  14)		this->day = clock1->getCurrentDay();
HXLINE(  15)		this->year = clock1->getCurrentYear();
            	}

Dynamic TimeStamp_obj::__CreateEmpty() { return new TimeStamp_obj; }

hx::ObjectPtr< TimeStamp_obj > TimeStamp_obj::__new( ::clock::Clock clock1)
{
	hx::ObjectPtr< TimeStamp_obj > _hx_result = new TimeStamp_obj();
	_hx_result->__construct(clock1);
	return _hx_result;
}
...
void TimeStamp_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("clock.TimeStamp","\xf6","\x45","\x13","\xaf");
