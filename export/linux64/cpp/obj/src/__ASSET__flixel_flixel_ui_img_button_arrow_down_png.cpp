...
HX_DEFINE_STACK_FRAME(_hx_pos_603fb37d8a5a0be3_2010_new,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png","new",0x3b7e342a,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_71f21b48f52ae898_1_boot,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png","boot",0xcb087128,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png.boot","?",1,0x0000003f)

void __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ::Dynamic transparent = __o_transparent.Default(true);
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_603fb37d8a5a0be3_2010_new)
            	HX_STACK_THIS(this)
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::resourceName));
...
hx::ObjectPtr< __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj > __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::__new(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
...
hx::ObjectPtr< __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj > __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::__alloc(hx::Ctx *_hx_ctx,int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA) {
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap___ASSET__flixel_flixel_ui_img_button_arrow_down_png",92,30,13,44);
            	}
}
