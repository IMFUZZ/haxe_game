...
HX_DEFINE_STACK_FRAME(_hx_pos_b60f7c4079efb172_17322_valmod,"zpp_nape.util.ZPP_ArbiterList","valmod",0xf3166f58,"zpp_nape.util.ZPP_ArbiterList.valmod","zpp_nape/util/Lists.hx",17322,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_b60f7c4079efb172_17332_modified,"zpp_nape.util.ZPP_ArbiterList","modified",0x761573e0,"zpp_nape.util.ZPP_ArbiterList.modified","zpp_nape/util/Lists.hx",17332,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_b60f7c4079efb172_17337_modify_test,"zpp_nape.util.ZPP_ArbiterList","modify_test",0x58d2f540,"zpp_nape.util.ZPP_ArbiterList.modify_test","zpp_nape/util/Lists.hx",17337,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_b60f7c4079efb172_17343_validate,"zpp_nape.util.ZPP_ArbiterList","validate",0x6431692d,"zpp_nape.util.ZPP_ArbiterList.validate","zpp_nape/util/Lists.hx",17343,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_b60f7c4079efb172_17348_invalidate,"zpp_nape.util.ZPP_ArbiterList","invalidate",0x878045d2,"zpp_nape.util.ZPP_ArbiterList.invalidate","zpp_nape/util/Lists.hx",17348,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_b60f7c4079efb172_17315_get,"zpp_nape.util.ZPP_ArbiterList","get",0xcbf5af5f,"zpp_nape.util.ZPP_ArbiterList.get","zpp_nape/util/Lists.hx",17315,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_b60f7c4079efb172_17309_boot,"zpp_nape.util.ZPP_ArbiterList","boot",0xa7bd4549,"zpp_nape.util.ZPP_ArbiterList.boot","zpp_nape/util/Lists.hx",17309,0x9f4e6754)
namespace zpp_nape{
namespace util{
...
void ZPP_ArbiterList_obj::modify_test(){
            	HX_STACKFRAME(&_hx_pos_b60f7c4079efb172_17337_modify_test)
            	HX_STACK_THIS(this)
            	}
...
void ZPP_ArbiterList_obj::validate(){
            	...
            	HX_STACK_THIS(this)
HXLINE(17343)		if (this->_invalidated) {
...
HXLINE(17316)		HX_VARI(  ::nape::dynamics::ArbiterList,ret) =  ::nape::dynamics::ArbiterList_obj::__alloc( HX_CTX );
...
{
	hx::Object *dummy = new ZPP_ArbiterList_obj;
	ZPP_ArbiterList_obj::_hx_vtable = *(void **)dummy;
