...
HX_DEFINE_STACK_FRAME(_hx_pos_7fcb986a6051c76b_16867_new,"zpp_nape.util.ZPP_Vec2List","new",0xeb4045fe,"zpp_nape.util.ZPP_Vec2List.new","zpp_nape/util/Lists.hx",16867,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_7fcb986a6051c76b_16888_valmod,"zpp_nape.util.ZPP_Vec2List","valmod",0xbeab5ba3,"zpp_nape.util.ZPP_Vec2List.valmod","zpp_nape/util/Lists.hx",16888,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_7fcb986a6051c76b_16898_modified,"zpp_nape.util.ZPP_Vec2List","modified",0x01f648eb,"zpp_nape.util.ZPP_Vec2List.modified","zpp_nape/util/Lists.hx",16898,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_7fcb986a6051c76b_16903_modify_test,"zpp_nape.util.ZPP_Vec2List","modify_test",0x4aaa9915,"zpp_nape.util.ZPP_Vec2List.modify_test","zpp_nape/util/Lists.hx",16903,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_7fcb986a6051c76b_16909_validate,"zpp_nape.util.ZPP_Vec2List","validate",0xf0123e38,"zpp_nape.util.ZPP_Vec2List.validate","zpp_nape/util/Lists.hx",16909,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_7fcb986a6051c76b_16914_invalidate,"zpp_nape.util.ZPP_Vec2List","invalidate",0x6d08b39d,"zpp_nape.util.ZPP_Vec2List.invalidate","zpp_nape/util/Lists.hx",16914,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_7fcb986a6051c76b_16881_get,"zpp_nape.util.ZPP_Vec2List","get",0xeb3af634,"zpp_nape.util.ZPP_Vec2List.get","zpp_nape/util/Lists.hx",16881,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_7fcb986a6051c76b_16875_boot,"zpp_nape.util.ZPP_Vec2List","boot",0xe515f8d4,"zpp_nape.util.ZPP_Vec2List.boot","zpp_nape/util/Lists.hx",16875,0x9f4e6754)
namespace zpp_nape{
namespace util{

void ZPP_Vec2List_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_7fcb986a6051c76b_16867_new)
            	HX_STACK_THIS(this)
HXLINE(16922)		this->user_length = (int)0;
HXLINE(16921)		this->zip_length = false;
HXLINE(16920)		this->push_ite = null();
HXLINE(16919)		this->at_ite = null();
HXLINE(16918)		this->at_index = (int)0;
...
HXLINE(16924)		this->inner =  ::zpp_nape::util::ZNPList_ZPP_Vec2_obj::__alloc( HX_CTX );
...
bool ZPP_Vec2List_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x71ffc150;
}

void ZPP_Vec2List_obj::valmod(){
            	HX_STACKFRAME(&_hx_pos_7fcb986a6051c76b_16888_valmod)
            	HX_STACK_THIS(this)
...
void ZPP_Vec2List_obj::modified(){
            	HX_STACKFRAME(&_hx_pos_7fcb986a6051c76b_16898_modified)
            	HX_STACK_THIS(this)
...
void ZPP_Vec2List_obj::modify_test(){
            	HX_STACKFRAME(&_hx_pos_7fcb986a6051c76b_16903_modify_test)
            	HX_STACK_THIS(this)
            	}
...
void ZPP_Vec2List_obj::validate(){
            	HX_STACKFRAME(&_hx_pos_7fcb986a6051c76b_16909_validate)
            	HX_STACK_THIS(this)
HXLINE(16909)		if (this->_invalidated) {
...
void ZPP_Vec2List_obj::invalidate(){
            	HX_STACKFRAME(&_hx_pos_7fcb986a6051c76b_16914_invalidate)
            	HX_STACK_THIS(this)
...
bool imm = __o_imm.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_7fcb986a6051c76b_16881_get)
            	HX_STACK_ARG(list,"list")
            	HX_STACK_ARG(imm,"imm")
HXLINE(16882)		HX_VARI(  ::nape::geom::Vec2List,ret) =  ::nape::geom::Vec2List_obj::__alloc( HX_CTX );
...
{
	hx::Object *dummy = new ZPP_Vec2List_obj;
	ZPP_Vec2List_obj::_hx_vtable = *(void **)dummy;
...
{
{
            	HX_STACKFRAME(&_hx_pos_7fcb986a6051c76b_16875_boot)
HXLINE(16875)		internal = false;
            	}
}
