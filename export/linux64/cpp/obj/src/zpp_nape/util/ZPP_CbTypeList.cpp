...
HX_DEFINE_STACK_FRAME(_hx_pos_747f21effecdb147_16805_new,"zpp_nape.util.ZPP_CbTypeList","new",0x34f3ce99,"zpp_nape.util.ZPP_CbTypeList.new","zpp_nape/util/Lists.hx",16805,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_747f21effecdb147_16826_valmod,"zpp_nape.util.ZPP_CbTypeList","valmod",0x9250e5e8,"zpp_nape.util.ZPP_CbTypeList.valmod","zpp_nape/util/Lists.hx",16826,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_747f21effecdb147_16836_modified,"zpp_nape.util.ZPP_CbTypeList","modified",0x31c6ae70,"zpp_nape.util.ZPP_CbTypeList.modified","zpp_nape/util/Lists.hx",16836,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_747f21effecdb147_16841_modify_test,"zpp_nape.util.ZPP_CbTypeList","modify_test",0xf750b4b0,"zpp_nape.util.ZPP_CbTypeList.modify_test","zpp_nape/util/Lists.hx",16841,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_747f21effecdb147_16847_validate,"zpp_nape.util.ZPP_CbTypeList","validate",0x1fe2a3bd,"zpp_nape.util.ZPP_CbTypeList.validate","zpp_nape/util/Lists.hx",16847,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_747f21effecdb147_16852_invalidate,"zpp_nape.util.ZPP_CbTypeList","invalidate",0x7de14462,"zpp_nape.util.ZPP_CbTypeList.invalidate","zpp_nape/util/Lists.hx",16852,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_747f21effecdb147_16819_get,"zpp_nape.util.ZPP_CbTypeList","get",0x34ee7ecf,"zpp_nape.util.ZPP_CbTypeList.get","zpp_nape/util/Lists.hx",16819,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_747f21effecdb147_16813_boot,"zpp_nape.util.ZPP_CbTypeList","boot",0x1879f7d9,"zpp_nape.util.ZPP_CbTypeList.boot","zpp_nape/util/Lists.hx",16813,0x9f4e6754)
namespace zpp_nape{
namespace util{

void ZPP_CbTypeList_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_747f21effecdb147_16805_new)
            	HX_STACK_THIS(this)
HXLINE(16860)		this->user_length = (int)0;
HXLINE(16859)		this->zip_length = false;
HXLINE(16858)		this->push_ite = null();
HXLINE(16857)		this->at_ite = null();
HXLINE(16856)		this->at_index = (int)0;
...
HXLINE(16862)		this->inner =  ::zpp_nape::util::ZNPList_ZPP_CbType_obj::__alloc( HX_CTX );
...
bool ZPP_CbTypeList_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x3002396b;
}

void ZPP_CbTypeList_obj::valmod(){
            	HX_STACKFRAME(&_hx_pos_747f21effecdb147_16826_valmod)
            	HX_STACK_THIS(this)
...
void ZPP_CbTypeList_obj::modified(){
            	HX_STACKFRAME(&_hx_pos_747f21effecdb147_16836_modified)
            	HX_STACK_THIS(this)
...
void ZPP_CbTypeList_obj::modify_test(){
            	HX_STACKFRAME(&_hx_pos_747f21effecdb147_16841_modify_test)
            	HX_STACK_THIS(this)
            	}
...
void ZPP_CbTypeList_obj::validate(){
            	HX_STACKFRAME(&_hx_pos_747f21effecdb147_16847_validate)
            	HX_STACK_THIS(this)
HXLINE(16847)		if (this->_invalidated) {
...
void ZPP_CbTypeList_obj::invalidate(){
            	HX_STACKFRAME(&_hx_pos_747f21effecdb147_16852_invalidate)
            	HX_STACK_THIS(this)
...
bool imm = __o_imm.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_747f21effecdb147_16819_get)
            	HX_STACK_ARG(list,"list")
            	HX_STACK_ARG(imm,"imm")
HXLINE(16820)		HX_VARI(  ::nape::callbacks::CbTypeList,ret) =  ::nape::callbacks::CbTypeList_obj::__alloc( HX_CTX );
...
{
	hx::Object *dummy = new ZPP_CbTypeList_obj;
	ZPP_CbTypeList_obj::_hx_vtable = *(void **)dummy;
...
{
{
            	HX_STACKFRAME(&_hx_pos_747f21effecdb147_16813_boot)
HXLINE(16813)		internal = false;
            	}
}
