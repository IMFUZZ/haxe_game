...
HX_DEFINE_STACK_FRAME(_hx_pos_d397b31de2dadc38_17363_new,"zpp_nape.util.ZPP_ContactList","new",0x5af5c8e0,"zpp_nape.util.ZPP_ContactList.new","zpp_nape/util/Lists.hx",17363,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_d397b31de2dadc38_17384_valmod,"zpp_nape.util.ZPP_ContactList","valmod",0xd1355201,"zpp_nape.util.ZPP_ContactList.valmod","zpp_nape/util/Lists.hx",17384,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_d397b31de2dadc38_17394_modified,"zpp_nape.util.ZPP_ContactList","modified",0x43b112c9,"zpp_nape.util.ZPP_ContactList.modified","zpp_nape/util/Lists.hx",17394,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_d397b31de2dadc38_17399_modify_test,"zpp_nape.util.ZPP_ContactList","modify_test",0xc7d0cdf7,"zpp_nape.util.ZPP_ContactList.modify_test","zpp_nape/util/Lists.hx",17399,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_d397b31de2dadc38_17405_validate,"zpp_nape.util.ZPP_ContactList","validate",0x31cd0816,"zpp_nape.util.ZPP_ContactList.validate","zpp_nape/util/Lists.hx",17405,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_d397b31de2dadc38_17410_invalidate,"zpp_nape.util.ZPP_ContactList","invalidate",0xaa7030fb,"zpp_nape.util.ZPP_ContactList.invalidate","zpp_nape/util/Lists.hx",17410,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_d397b31de2dadc38_17377_get,"zpp_nape.util.ZPP_ContactList","get",0x5af07916,"zpp_nape.util.ZPP_ContactList.get","zpp_nape/util/Lists.hx",17377,0x9f4e6754)
HX_DEFINE_STACK_FRAME(_hx_pos_d397b31de2dadc38_17371_boot,"zpp_nape.util.ZPP_ContactList","boot",0x3432fbb2,"zpp_nape.util.ZPP_ContactList.boot","zpp_nape/util/Lists.hx",17371,0x9f4e6754)
namespace zpp_nape{
namespace util{

void ZPP_ContactList_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_d397b31de2dadc38_17363_new)
            	HX_STACK_THIS(this)
HXLINE(17418)		this->user_length = (int)0;
HXLINE(17417)		this->zip_length = false;
HXLINE(17416)		this->push_ite = null();
HXLINE(17415)		this->at_ite = null();
HXLINE(17414)		this->at_index = (int)0;
...
HXLINE(17420)		this->inner =  ::zpp_nape::dynamics::ZPP_Contact_obj::__alloc( HX_CTX );
...
bool ZPP_ContactList_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7f53f376;
}

void ZPP_ContactList_obj::valmod(){
            	HX_STACKFRAME(&_hx_pos_d397b31de2dadc38_17384_valmod)
            	HX_STACK_THIS(this)
...
void ZPP_ContactList_obj::modified(){
            	HX_STACKFRAME(&_hx_pos_d397b31de2dadc38_17394_modified)
            	HX_STACK_THIS(this)
...
void ZPP_ContactList_obj::modify_test(){
            	HX_STACKFRAME(&_hx_pos_d397b31de2dadc38_17399_modify_test)
            	HX_STACK_THIS(this)
            	}
...
void ZPP_ContactList_obj::validate(){
            	HX_STACKFRAME(&_hx_pos_d397b31de2dadc38_17405_validate)
            	HX_STACK_THIS(this)
HXLINE(17405)		if (this->_invalidated) {
...
void ZPP_ContactList_obj::invalidate(){
            	HX_STACKFRAME(&_hx_pos_d397b31de2dadc38_17410_invalidate)
            	HX_STACK_THIS(this)
...
bool imm = __o_imm.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_d397b31de2dadc38_17377_get)
            	HX_STACK_ARG(list,"list")
            	HX_STACK_ARG(imm,"imm")
HXLINE(17378)		HX_VARI(  ::nape::dynamics::ContactList,ret) =  ::nape::dynamics::ContactList_obj::__alloc( HX_CTX );
...
{
	hx::Object *dummy = new ZPP_ContactList_obj;
	ZPP_ContactList_obj::_hx_vtable = *(void **)dummy;
...
{
{
            	HX_STACKFRAME(&_hx_pos_d397b31de2dadc38_17371_boot)
HXLINE(17371)		internal = false;
            	}
}
