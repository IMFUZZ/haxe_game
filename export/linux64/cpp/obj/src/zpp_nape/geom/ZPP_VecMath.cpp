...
HX_DEFINE_STACK_FRAME(_hx_pos_48696f23572a9a7f_176_vec_dsq,"zpp_nape.geom.ZPP_VecMath","vec_dsq",0xb07d1caf,"zpp_nape.geom.ZPP_VecMath.vec_dsq","zpp_nape/geom/VecMath.hx",176,0x9d2cc613)
HX_DEFINE_STACK_FRAME(_hx_pos_48696f23572a9a7f_186_vec_distance,"zpp_nape.geom.ZPP_VecMath","vec_distance",0x98be6968,"zpp_nape.geom.ZPP_VecMath.vec_distance","zpp_nape/geom/VecMath.hx",186,0x9d2cc613)
namespace zpp_nape{
namespace geom{
...
Float ZPP_VecMath_obj::vec_dsq(Float ax,Float ay,Float bx,Float by){
            	...
            	HX_STACK_ARG(bx,"bx")
            	HX_STACK_ARG(by,"by")
HXLINE( 177)		HX_VARI( Float,dx) = ((Float)0.0);
HXLINE( 178)		HX_VARI( Float,dy) = ((Float)0.0);
HXLINE( 179)		{
HXLINE( 180)			dx = (ax - bx);
HXLINE( 181)			dy = (ay - by);
            		}
...
Float ZPP_VecMath_obj::vec_distance(Float ax,Float ay,Float bx,Float by){
            	...
            	HX_STACK_ARG(bx,"bx")
            	HX_STACK_ARG(by,"by")
HXLINE( 187)		HX_VARI( Float,dx) = ((Float)0.0);
HXLINE( 188)		HX_VARI( Float,dy) = ((Float)0.0);
HXLINE( 189)		{
HXLINE( 190)			dx = (ax - bx);
HXLINE( 191)			dy = (ay - by);
            		}
...
static void ZPP_VecMath_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ZPP_VecMath_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ZPP_VecMath_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new ZPP_VecMath_obj;
	ZPP_VecMath_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = ZPP_VecMath_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = ZPP_VecMath_obj_sVisitStatics;
#endif
