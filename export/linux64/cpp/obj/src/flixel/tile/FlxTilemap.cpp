...
HXLINE( 996)							 ::openfl::_legacy::geom::Point _hx_tmp4 = this->_flashPoint;
HXDLIN( 996)							_hx_tmp4->x = (_hx_tmp4->x + this->_tileWidth);
            						}
HXLINE( 997)						columnIndex = (columnIndex + (int)1);
            					}
            				}
HXLINE(1000)				if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1001)					 ::openfl::_legacy::geom::Point _hx_tmp5 = this->_flashPoint;
HXDLIN(1001)					_hx_tmp5->y = (_hx_tmp5->y + this->_tileHeight);
            				}
