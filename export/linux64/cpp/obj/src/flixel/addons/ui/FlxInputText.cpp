...
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_236_destroy,"flixel.addons.ui.FlxInputText","destroy",0x8dd65262,"flixel.addons.ui.FlxInputText.destroy","flixel/addons/ui/FlxInputText.hx",236,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_261_draw,"flixel.addons.ui.FlxInputText","draw",0x11b0159c,"flixel.addons.ui.FlxInputText.draw","flixel/addons/ui/FlxInputText.hx",261,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_282_drawSprite,"flixel.addons.ui.FlxInputText","drawSprite",0x07ac82c1,"flixel.addons.ui.FlxInputText.drawSprite","flixel/addons/ui/FlxInputText.hx",282,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_294_update,"flixel.addons.ui.FlxInputText","update",0x954505a1,"flixel.addons.ui.FlxInputText.update","flixel/addons/ui/FlxInputText.hx",294,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_323_onKeyDown,"flixel.addons.ui.FlxInputText","onKeyDown",0xeda471aa,"flixel.addons.ui.FlxInputText.onKeyDown","flixel/addons/ui/FlxInputText.hx",323,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_406_onChange,"flixel.addons.ui.FlxInputText","onChange",0x53f01d87,"flixel.addons.ui.FlxInputText.onChange","flixel/addons/ui/FlxInputText.hx",406,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_421_insertSubstring,"flixel.addons.ui.FlxInputText","insertSubstring",0xe0c1ad40,"flixel.addons.ui.FlxInputText.insertSubstring","flixel/addons/ui/FlxInputText.hx",421,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_439_getCaretIndex,"flixel.addons.ui.FlxInputText","getCaretIndex",0xfe00362d,"flixel.addons.ui.FlxInputText.getCaretIndex","flixel/addons/ui/FlxInputText.hx",439,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_450_getCharBoundaries,"flixel.addons.ui.FlxInputText","getCharBoundaries",0x38cd7cdc,"flixel.addons.ui.FlxInputText.getCharBoundaries","flixel/addons/ui/FlxInputText.hx",450,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_467_set_text,"flixel.addons.ui.FlxInputText","set_text",0x37e27742,"flixel.addons.ui.FlxInputText.set_text","flixel/addons/ui/FlxInputText.hx",467,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_514_getCharIndexAtPoint,"flixel.addons.ui.FlxInputText","getCharIndexAtPoint",0xf4438f7f,"flixel.addons.ui.FlxInputText.getCharIndexAtPoint","flixel/addons/ui/FlxInputText.hx",514,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_562_prepareCharBoundaries,"flixel.addons.ui.FlxInputText","prepareCharBoundaries",0x33edc58d,"flixel.addons.ui.FlxInputText.prepareCharBoundaries","flixel/addons/ui/FlxInputText.hx",562,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_589_onSetTextCheck,"flixel.addons.ui.FlxInputText","onSetTextCheck",0x14902030,"flixel.addons.ui.FlxInputText.onSetTextCheck","flixel/addons/ui/FlxInputText.hx",589,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_629_calcFrame,"flixel.addons.ui.FlxInputText","calcFrame",0x733ee2c0,"flixel.addons.ui.FlxInputText.calcFrame","flixel/addons/ui/FlxInputText.hx",629,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_715_toggleCaret,"flixel.addons.ui.FlxInputText","toggleCaret",0x6f59aab7,"flixel.addons.ui.FlxInputText.toggleCaret","flixel/addons/ui/FlxInputText.hx",715,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_723_filter,"flixel.addons.ui.FlxInputText","filter",0x93749f50,"flixel.addons.ui.FlxInputText.filter","flixel/addons/ui/FlxInputText.hx",723,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_751_set_params,"flixel.addons.ui.FlxInputText","set_params",0xe3d3351b,"flixel.addons.ui.FlxInputText.set_params","flixel/addons/ui/FlxInputText.hx",751,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_763_set_x,"flixel.addons.ui.FlxInputText","set_x",0x02dc16c3,"flixel.addons.ui.FlxInputText.set_x","flixel/addons/ui/FlxInputText.hx",763,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_776_set_y,"flixel.addons.ui.FlxInputText","set_y",0x02dc16c4,"flixel.addons.ui.FlxInputText.set_y","flixel/addons/ui/FlxInputText.hx",776,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_789_set_hasFocus,"flixel.addons.ui.FlxInputText","set_hasFocus",0xf91bc333,"flixel.addons.ui.FlxInputText.set_hasFocus","flixel/addons/ui/FlxInputText.hx",789,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_816_getAlignStr,"flixel.addons.ui.FlxInputText","getAlignStr",0xf6458f0a,"flixel.addons.ui.FlxInputText.getAlignStr","flixel/addons/ui/FlxInputText.hx",816,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_825_set_caretIndex,"flixel.addons.ui.FlxInputText","set_caretIndex",0x5b1dfee4,"flixel.addons.ui.FlxInputText.set_caretIndex","flixel/addons/ui/FlxInputText.hx",825,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_898_set_forceCase,"flixel.addons.ui.FlxInputText","set_forceCase",0x119aa786,"flixel.addons.ui.FlxInputText.set_forceCase","flixel/addons/ui/FlxInputText.hx",898,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_905_set_size,"flixel.addons.ui.FlxInputText","set_size",0x373c4b56,"flixel.addons.ui.FlxInputText.set_size","flixel/addons/ui/FlxInputText.hx",905,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_912_set_maxLength,"flixel.addons.ui.FlxInputText","set_maxLength",0x992e7ff5,"flixel.addons.ui.FlxInputText.set_maxLength","flixel/addons/ui/FlxInputText.hx",912,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_922_set_lines,"flixel.addons.ui.FlxInputText","set_lines",0x15ae75ca,"flixel.addons.ui.FlxInputText.set_lines","flixel/addons/ui/FlxInputText.hx",922,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_941_get_passwordMode,"flixel.addons.ui.FlxInputText","get_passwordMode",0x890c263f,"flixel.addons.ui.FlxInputText.get_passwordMode","flixel/addons/ui/FlxInputText.hx",941,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_945_set_passwordMode,"flixel.addons.ui.FlxInputText","set_passwordMode",0xdf4e13b3,"flixel.addons.ui.FlxInputText.set_passwordMode","flixel/addons/ui/FlxInputText.hx",945,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_952_set_filterMode,"flixel.addons.ui.FlxInputText","set_filterMode",0xd267a390,"flixel.addons.ui.FlxInputText.set_filterMode","flixel/addons/ui/FlxInputText.hx",952,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_959_set_fieldBorderColor,"flixel.addons.ui.FlxInputText","set_fieldBorderColor",0x31131c52,"flixel.addons.ui.FlxInputText.set_fieldBorderColor","flixel/addons/ui/FlxInputText.hx",959,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_966_set_fieldBorderThickness,"flixel.addons.ui.FlxInputText","set_fieldBorderThickness",0x8f7f3fe3,"flixel.addons.ui.FlxInputText.set_fieldBorderThickness","flixel/addons/ui/FlxInputText.hx",966,0x19fbd1e7)
HX_DEFINE_STACK_FRAME(_hx_pos_75fddae7e64ce41a_973_set_backgroundColor,"flixel.addons.ui.FlxInputText","set_backgroundColor",0x1e95b220,"flixel.addons.ui.FlxInputText.set_backgroundColor","flixel/addons/ui/FlxInputText.hx",973,0x19fbd1e7)
...
HXLINE( 282)			_hx_tmp = Sprite->visible;
            		}
            		else {
...
HXLINE( 299)		if ((::flixel::FlxG_obj::mouse->_leftButton->current == (int)2)) {
HXLINE( 301)			HX_VARI( bool,hadFocus) = this->hasFocus;
...
void FlxInputText_obj::onKeyDown( ::openfl::_legacy::events::KeyboardEvent e){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(e,"e")
HXLINE( 324)		HX_VARI( int,key) = e->keyCode;
...
HXLINE( 337)						{
HXLINE( 337)							HX_VARI(  ::flixel::addons::ui::FlxInputText,_g) = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 337)							_g->set_caretIndex((_g->caretIndex - (int)1));
            						}
...
HXLINE( 345)							{
HXLINE( 345)								HX_VARI_NAME(  ::flixel::addons::ui::FlxInputText,_g1,"_g") = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 345)								_g1->set_caretIndex((_g1->caretIndex + (int)1));
            							}
...
HXLINE( 366)										{
HXLINE( 366)											HX_VARI_NAME(  ::flixel::addons::ui::FlxInputText,_g2,"_g") = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 366)											_g2->set_caretIndex((_g2->caretIndex - (int)1));
            										}
HXLINE( 367)										::String _hx_tmp3 = this->text.substring((int)0,this->caretIndex);
HXDLIN( 367)										this->set_text((_hx_tmp3 + this->text.substring((this->caretIndex + (int)1),null())));
...
HXLINE( 376)											::String _hx_tmp5 = this->text.substring((int)0,this->caretIndex);
HXDLIN( 376)											this->set_text((_hx_tmp5 + this->text.substring((this->caretIndex + (int)1),null())));
...
HXLINE( 392)											HX_VARI( ::String,newText) = this->filter(::String::fromCharCode(e->charCode));
...
HXLINE( 397)												{
HXLINE( 397)													HX_VARI_NAME(  ::flixel::addons::ui::FlxInputText,_g3,"_g") = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 397)													_g3->set_caretIndex((_g3->caretIndex + (int)1));
            												}
...
HXLINE( 406)		if (hx::IsNotNull( this->callback )) {
...
HXLINE( 424)			HX_VARI_NAME( ::String,Original1,"Original") = (Original.substring((int)0,Index) + Insert);
...
int FlxInputText_obj::getCaretIndex(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 441)		Float X = (::flixel::FlxG_obj::mouse->x - this->x);
HXDLIN( 441)		Float Y = (::flixel::FlxG_obj::mouse->y - this->y);
HXDLIN( 441)		HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set(X,Y);
HXDLIN( 441)		point->_inPool = false;
HXLINE( 442)		return this->getCharIndexAtPoint(point->x,point->y);
            	}
...
HXLINE( 453)			HX_VARI(  ::openfl::_legacy::geom::Rectangle,r) =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
HXLINE( 454)			if ((charIndex >= this->_charBoundaries->length)) {
HXLINE( 456)				HX_VARI(  ::flixel::math::FlxRect,_this) = this->_charBoundaries->__get((this->_charBoundaries->length - (int)1)).StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 456)				HX_VARI(  ::openfl::_legacy::geom::Rectangle,FlashRect) = r;
HXDLIN( 456)				if (hx::IsNull( r )) {
...
HXLINE( 459)				HX_VARI_NAME(  ::flixel::math::FlxRect,_this1,"_this") = this->_charBoundaries->__get(charIndex).StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 459)				HX_VARI_NAME(  ::openfl::_legacy::geom::Rectangle,FlashRect1,"FlashRect") = r;
HXDLIN( 459)				if (hx::IsNull( r )) {
...
HXLINE( 474)		HX_VARI( ::String,return_text) = this->super::set_text(Text);
HXLINE( 476)		if (hx::IsNull( this->textField )) {
HXLINE( 478)			return return_text;
            		}
HXLINE( 481)		HX_VARI( int,numChars) = Text.length;
HXLINE( 482)		this->prepareCharBoundaries(numChars);
HXLINE( 483)		this->textField->set_text(HX_("",00,00,00,00));
HXLINE( 484)		HX_VARI( Float,textH) = (int)0;
HXLINE( 485)		HX_VARI( Float,textW) = (int)0;
HXLINE( 486)		HX_VARI( Float,lastW) = (int)0;
HXLINE( 491)		HX_VARI( Float,magicX) = (int)2;
HXLINE( 492)		HX_VARI( Float,magicY) = (int)2;
HXLINE( 494)		{
HXLINE( 494)			HX_VARI( int,_g1) = (int)0;
HXDLIN( 494)			while((_g1 < numChars)){
HXLINE( 494)				_g1 = (_g1 + (int)1);
HXDLIN( 494)				HX_VARI( int,i) = (_g1 - (int)1);
...
int FlxInputText_obj::getCharIndexAtPoint(Float X,Float Y){
            	...
            	HX_STACK_ARG(X,"X")
            	HX_STACK_ARG(Y,"Y")
HXLINE( 515)		HX_VARI( int,i) = (int)0;
...
HXLINE( 529)					HX_VARI_NAME( Float,X1,"X") = (X - ((Float)this->textField->get_width() / (Float)(int)2));
HXDLIN( 529)					X = (X1 + ((Float)this->textField->get_textWidth() / (Float)(int)2));
HXDLIN( 529)					goto _hx_goto_16;
            				}
            				if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 527)					HX_VARI_NAME( Float,X2,"X") = (X - this->textField->get_width());
...
HXDLIN( 538)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->_charBoundaries;
HXDLIN( 538)			while((_g < _g1->length)){
HXLINE( 538)				HX_VARI(  ::flixel::math::FlxRect,r) = _g1->__get(_g).StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 538)				_g = (_g + (int)1);
...
HXLINE( 570)			HX_VARI( int,diff) = (this->_charBoundaries->length - numChars);
HXLINE( 571)			{
HXLINE( 571)				HX_VARI( int,_g1) = (int)0;
HXDLIN( 571)				while((_g1 < diff)){
...
HXLINE( 577)		{
HXLINE( 577)			HX_VARI_NAME( int,_g11,"_g1") = (int)0;
HXDLIN( 577)			while((_g11 < numChars)){
HXLINE( 577)				_g11 = (_g11 + (int)1);
HXLINE( 579)				if (((this->_charBoundaries->length - (int)1) < (_g11 - (int)1))) {
HXLINE( 581)					::Array< ::Dynamic> _hx_tmp = this->_charBoundaries;
HXDLIN( 581)					HX_VARI(  ::flixel::math::FlxRect,_this) = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 581)					_this->x = (int)0;
HXDLIN( 581)					_this->y = (int)0;
HXDLIN( 581)					_this->width = (int)0;
HXDLIN( 581)					_this->height = (int)0;
HXDLIN( 581)					_this->_inPool = false;
HXDLIN( 581)					_hx_tmp->push(_this);
            				}
            			}
            		}
            	}
...
void FlxInputText_obj::onSetTextCheck(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 591)		HX_VARI(  ::openfl::_legacy::geom::Rectangle,boundary) = null();
...
HXLINE( 603)			HX_VARI( int,diffW) = (int)0;
...
HXLINE( 606)				HX_VARI_NAME( Float,diffW1,"diffW") = (this->textField->get_width() - (int)2);
HXDLIN( 606)				diffW = -(::Std_obj::_hx_int((diffW1 - boundary->get_right())));
            			}
            			else {
HXLINE( 607)				if ((boundary->get_left() < this->lastScroll)) {
...
HXLINE( 637)				this->fieldBorderSprite->set_x((this->x - this->fieldBorderThickness));
HXLINE( 638)				this->fieldBorderSprite->set_y((this->y - this->fieldBorderThickness));
            			}
            			else {
...
HXLINE( 665)			HX_VARI( int,cw) = this->caretWidth;
HXLINE( 666)			HX_VARI( int,ch) = ::Std_obj::_hx_int((::Std_obj::_hx_int(this->_defaultFormat->size) + (int)2));
HXLINE( 669)			HX_VARI( int,borderC) = ((int)(int)-16777216 | (int)((int)this->borderColor & (int)(int)16777215));
HXLINE( 670)			HX_VARI( int,caretC) = ((int)(int)-16777216 | (int)((int)this->caretColor & (int)(int)16777215));
...
HXDLIN( 673)			HX_VARI_NAME( ::String,caretKey1,"caretKey") = (((caretKey + this->borderSize) + HX_(",",2c,00,00,00)) + borderC);
HXLINE( 674)			switch((int)(_hx_getEnumValueIndex(this->borderStyle))){
            				case (int)0: {
HXLINE( 678)					this->caret->makeGraphic(cw,ch,caretC,false,caretKey1);
HXLINE( 679)					 ::flixel::math::FlxPoint _hx_tmp8 = this->caret->offset;
HXDLIN( 679)					_hx_tmp8->set_x(this->caret->offset->set_y((int)0));
            				}
            				break;
            				case (int)1: {
...
HXLINE( 686)					HX_VARI( Float,r) = this->borderSize;
HXDLIN( 686)					HX_VARI_NAME( Float,r1,"r") = this->borderSize;
HXDLIN( 686)					HX_VARI_NAME( int,r2,"r") = this->caretWidth;
HXDLIN( 686)					HX_VARI_NAME(  ::openfl::_legacy::geom::Rectangle,r3,"r") =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,r,r1,r2,::Std_obj::_hx_int((::Std_obj::_hx_int(this->_defaultFormat->size) + (int)2)));
...
HXLINE( 690)					 ::flixel::math::FlxPoint _hx_tmp9 = this->caret->offset;
HXDLIN( 690)					_hx_tmp9->set_x(this->caret->offset->set_y((int)0));
            				}
            				break;
...
HXLINE( 697)					HX_VARI_NAME( Float,r4,"r") = this->borderSize;
HXDLIN( 697)					HX_VARI_NAME( Float,r5,"r") = this->borderSize;
HXDLIN( 697)					HX_VARI_NAME( int,r6,"r") = this->caretWidth;
HXDLIN( 697)					HX_VARI_NAME(  ::openfl::_legacy::geom::Rectangle,r7,"r") =  ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,r4,r5,r6,::Std_obj::_hx_int((::Std_obj::_hx_int(this->_defaultFormat->size) + (int)2)));
HXLINE( 698)					this->caret->get_pixels()->fillRect(r7,caretC);
HXLINE( 700)					 ::flixel::math::FlxPoint _hx_tmp10 = this->caret->offset;
HXDLIN( 700)					_hx_tmp10->set_x(this->caret->offset->set_y(this->borderSize));
            				}
            				break;
            			}
...
HXLINE( 715)		this->caret->set_visible(!(this->caret->visible));
            	}
...
HXLINE( 735)			HX_VAR(  ::EReg,pattern);
...
HXLINE( 758)		this->params->push( ::Dynamic(hx::Anon_obj::Create(2)
...
HXLINE( 766)			this->fieldBorderSprite->set_x((X - this->fieldBorderThickness));
            		}
...
HXLINE( 779)			this->fieldBorderSprite->set_y((Y - this->fieldBorderThickness));
            		}
...
::String FlxInputText_obj::getAlignStr(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 817)		HX_VARI( ::String,alignStr) = HX_("left",07,08,b0,47);
...
HXLINE( 826)		HX_VARI( Float,offx) = (int)0;
HXLINE( 830)		::String _hx_switch_0 = this->getAlignStr();
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE( 837)			HX_VARI_NAME( Float,offx1,"offx") = (this->textField->get_width() - (int)2);
HXDLIN( 837)			HX_VARI_NAME( Float,offx2,"offx") = ((Float)(offx1 - this->textField->get_textWidth()) / (Float)(int)2);
...
HXLINE( 835)			goto _hx_goto_31;
            		...
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 832)			HX_VARI_NAME( Float,offx3,"offx") = (this->textField->get_width() - (int)2);
...
HXLINE( 847)		if ((this->caretIndex > (this->text.length + (int)1))) {
HXLINE( 849)			this->caretIndex = (int)-1;
            		}
HXLINE( 853)		if ((this->caretIndex != (int)-1)) {
HXLINE( 855)			HX_VARI(  ::openfl::_legacy::geom::Rectangle,boundaries) = null();
...
HXLINE( 862)					this->caret->set_x(((offx + boundaries->get_left()) + this->x));
HXLINE( 863)					this->caret->set_y((boundaries->get_top() + this->y));
            				}
            			}
            			else {
HXLINE( 868)				boundaries = this->getCharBoundaries((this->caretIndex - (int)1));
HXLINE( 869)				if (hx::IsNotNull( boundaries )) {
HXLINE( 871)					this->caret->set_x(((offx + boundaries->get_right()) + this->x));
HXLINE( 872)					this->caret->set_y((boundaries->get_top() + this->y));
            				}
            				else {
HXLINE( 875)					if ((this->text.length == (int)0)) {
HXLINE( 878)						this->caret->set_x(((this->x + offx) + (int)2));
HXLINE( 879)						this->caret->set_y((this->y + (int)2));
            					}
            				}
            			}
            		}
HXLINE( 885)		{
HXLINE( 885)			HX_VARI(  ::flixel::FlxSprite,_g) = this->caret;
HXDLIN( 885)			HX_VARI_NAME( Float,_g1,"_g") = _g->x;
HXDLIN( 885)			_g->set_x((_g1 - this->textField->get_scrollH()));
            		}
HXLINE( 889)		bool _hx_tmp;
HXDLIN( 889)		if ((this->lines == (int)1)) {
HXLINE( 889)			Float _hx_tmp1 = this->caret->x;
HXDLIN( 889)			Float _hx_tmp2 = (_hx_tmp1 + this->caret->get_width());
HXDLIN( 889)			Float _hx_tmp3 = this->x;
HXDLIN( 889)			_hx_tmp = (_hx_tmp2 > (_hx_tmp3 + this->get_width()));
            		}
            		else {
HXLINE( 889)			_hx_tmp = false;
            		}
HXDLIN( 889)		if (_hx_tmp) {
HXLINE( 891)			 ::flixel::FlxSprite _hx_tmp4 = this->caret;
HXDLIN( 891)			Float _hx_tmp5 = this->x;
HXDLIN( 891)			_hx_tmp4->set_x(((_hx_tmp5 + this->get_width()) - (int)2));
            		}
...
bool FlxInputText_obj::get_passwordMode(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 941)		return this->textField->get_displayAsPassword();
            	}
