...
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_282_selectSomething,"flixel.addons.ui.FlxUIDropDownMenu","selectSomething",0xd0a071d5,"flixel.addons.ui.FlxUIDropDownMenu.selectSomething","flixel/addons/ui/FlxUIDropDownMenu.hx",282,0x238549da)
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_291_makeListButton,"flixel.addons.ui.FlxUIDropDownMenu","makeListButton",0xfb84f067,"flixel.addons.ui.FlxUIDropDownMenu.makeListButton","flixel/addons/ui/FlxUIDropDownMenu.hx",291,0x238549da)
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_288_makeListButton,"flixel.addons.ui.FlxUIDropDownMenu","makeListButton",0xfb84f067,"flixel.addons.ui.FlxUIDropDownMenu.makeListButton","flixel/addons/ui/FlxUIDropDownMenu.hx",288,0x238549da)
...
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_321_changeLabelByIndex,"flixel.addons.ui.FlxUIDropDownMenu","changeLabelByIndex",0xa18ac820,"flixel.addons.ui.FlxUIDropDownMenu.changeLabelByIndex","flixel/addons/ui/FlxUIDropDownMenu.hx",321,0x238549da)
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_328_changeLabelById,"flixel.addons.ui.FlxUIDropDownMenu","changeLabelById",0x75719a0d,"flixel.addons.ui.FlxUIDropDownMenu.changeLabelById","flixel/addons/ui/FlxUIDropDownMenu.hx",328,0x238549da)
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_335_getBtnByIndex,"flixel.addons.ui.FlxUIDropDownMenu","getBtnByIndex",0x24b02f2c,"flixel.addons.ui.FlxUIDropDownMenu.getBtnByIndex","flixel/addons/ui/FlxUIDropDownMenu.hx",335,0x238549da)
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_342_getBtnById,"flixel.addons.ui.FlxUIDropDownMenu","getBtnById",0xae1a9381,"flixel.addons.ui.FlxUIDropDownMenu.getBtnById","flixel/addons/ui/FlxUIDropDownMenu.hx",342,0x238549da)
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_352_update,"flixel.addons.ui.FlxUIDropDownMenu","update",0x4f8d24f2,"flixel.addons.ui.FlxUIDropDownMenu.update","flixel/addons/ui/FlxUIDropDownMenu.hx",352,0x238549da)
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_367_destroy,"flixel.addons.ui.FlxUIDropDownMenu","destroy",0xd2a999f1,"flixel.addons.ui.FlxUIDropDownMenu.destroy","flixel/addons/ui/FlxUIDropDownMenu.hx",367,0x238549da)
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_378_showList,"flixel.addons.ui.FlxUIDropDownMenu","showList",0x6015cb24,"flixel.addons.ui.FlxUIDropDownMenu.showList","flixel/addons/ui/FlxUIDropDownMenu.hx",378,0x238549da)
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_391_onDropdown,"flixel.addons.ui.FlxUIDropDownMenu","onDropdown",0x6af20fb9,"flixel.addons.ui.FlxUIDropDownMenu.onDropdown","flixel/addons/ui/FlxUIDropDownMenu.hx",391,0x238549da)
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_395_onClickItem,"flixel.addons.ui.FlxUIDropDownMenu","onClickItem",0xc144c8d3,"flixel.addons.ui.FlxUIDropDownMenu.onClickItem","flixel/addons/ui/FlxUIDropDownMenu.hx",395,0x238549da)
HX_DEFINE_STACK_FRAME(_hx_pos_032c27c33f94f39d_417_makeStrIdLabelArray,"flixel.addons.ui.FlxUIDropDownMenu","makeStrIdLabelArray",0xab19023a,"flixel.addons.ui.FlxUIDropDownMenu.makeStrIdLabelArray","flixel/addons/ui/FlxUIDropDownMenu.hx",417,0x238549da)
...
HXLINE( 255)						HX_VARI(  ::flixel::addons::ui::FlxUIButton,t) = this->makeListButton(i,data->label,data->name);
...
HXLINE( 265)				HX_VARI( int,_g1) = DataList->length;
HXDLIN( 265)				HX_VARI_NAME( int,_g2,"_g") = this->list->length;
HXDLIN( 265)				while((_g1 < _g2)){
HXLINE( 265)					_g1 = (_g1 + (int)1);
HXLINE( 266)					HX_VARI(  ::flixel::addons::ui::FlxUIButton,b) = this->list->pop().StaticCast<  ::flixel::addons::ui::FlxUIButton >();
...
HXLINE( 291)			f(i1);
            	...
            	HX_STACK_ARG(Label,"Label")
            	HX_STACK_ARG(Name,"Name")
HXLINE( 289)		HX_VARI(  ::flixel::addons::ui::FlxUIButton,t) =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,(int)0,(int)0,Label,null(),null(),null(),null());
...
HXLINE( 297)		{
HXLINE( 297)			HX_VARI(  ::flixel::math::FlxPoint,_g) = t->labelOffsets->__get((int)2).StaticCast<  ::flixel::math::FlxPoint >();
...
HXLINE( 309)		{
HXLINE( 309)			HX_VARI_NAME( int,_g1,"_g") = (int)0;
HXDLIN( 309)			HX_VARI_NAME( ::Array< ::Dynamic>,_g11,"_g1") = t->labelOffsets;
HXDLIN( 309)			while((_g1 < _g11->length)){
HXLINE( 309)				HX_VARI(  ::flixel::math::FlxPoint,offset) = _g11->__get(_g1).StaticCast<  ::flixel::math::FlxPoint >();
HXDLIN( 309)				_g1 = (_g1 + (int)1);
HXLINE( 311)				offset->set_x((offset->x + (int)2));
            			}
            		}
HXLINE( 314)		return t;
            	}
...
HXLINE( 322)		HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn) = this->getBtnByIndex(i);
...
void FlxUIDropDownMenu_obj::changeLabelById(::String name,::String NewLabel){
            	...
            	HX_STACK_ARG(name,"name")
            	HX_STACK_ARG(NewLabel,"NewLabel")
HXLINE( 329)		HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn) = this->getBtnById(name);
...
HXDLIN( 343)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->list;
HXDLIN( 343)			while((_g < _g1->length)){
HXLINE( 343)				HX_VARI(  ::flixel::addons::ui::FlxUIButton,btn) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
...
HXLINE( 356)			_hx_tmp = (::flixel::FlxG_obj::mouse->_leftButton->current == (int)2);
            		}
            		else {
...
HXDLIN( 379)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->list;
HXDLIN( 379)			while((_g < _g1->length)){
HXLINE( 379)				HX_VARI(  ::flixel::addons::ui::FlxUIButton,button) = _g1->__get(_g).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
...
void FlxUIDropDownMenu_obj::onDropdown(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 391)		if (this->dropPanel->visible) {
HXLINE( 391)			this->showList(false);
            		}
            		else {
HXLINE( 391)			this->showList(true);
            		}
            	}
...
void FlxUIDropDownMenu_obj::onClickItem(int i){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(i,"i")
HXLINE( 396)		HX_VARI(  ::flixel::addons::ui::FlxUIButton,item) = this->list->__get(i).StaticCast<  ::flixel::addons::ui::FlxUIButton >();
...
HXLINE( 418)		HX_VARI( ::Array< ::Dynamic>,strIdArray) = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 419)		{
HXLINE( 419)			HX_VARI( int,_g1) = (int)0;
HXDLIN( 419)			HX_VARI( int,_g) = StringArray->length;
HXDLIN( 419)			while((_g1 < _g)){
HXLINE( 419)				_g1 = (_g1 + (int)1);
HXDLIN( 419)				HX_VARI( int,i) = (_g1 - (int)1);
HXLINE( 421)				HX_VARI( ::String,ID) = StringArray->__get(i);
