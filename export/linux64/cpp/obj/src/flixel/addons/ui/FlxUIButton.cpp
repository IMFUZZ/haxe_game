...
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_106_setLabelFormat,"flixel.addons.ui.FlxUIButton","setLabelFormat",0xd4f36830,"flixel.addons.ui.FlxUIButton.setLabelFormat","flixel/addons/ui/FlxUIButton.hx",106,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_124_autoCenterLabel,"flixel.addons.ui.FlxUIButton","autoCenterLabel",0xdc3a6269,"flixel.addons.ui.FlxUIButton.autoCenterLabel","flixel/addons/ui/FlxUIButton.hx",124,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_128_clone,"flixel.addons.ui.FlxUIButton","clone",0xd3700fd6,"flixel.addons.ui.FlxUIButton.clone","flixel/addons/ui/FlxUIButton.hx",128,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_135_copyStyle,"flixel.addons.ui.FlxUIButton","copyStyle",0xb0cff635,"flixel.addons.ui.FlxUIButton.copyStyle","flixel/addons/ui/FlxUIButton.hx",135,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_169_setLabel,"flixel.addons.ui.FlxUIButton","setLabel",0x4416cc19,"flixel.addons.ui.FlxUIButton.setLabel","flixel/addons/ui/FlxUIButton.hx",169,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_170_getLabel,"flixel.addons.ui.FlxUIButton","getLabel",0x95b972a5,"flixel.addons.ui.FlxUIButton.getLabel","flixel/addons/ui/FlxUIButton.hx",170,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_176_resize,"flixel.addons.ui.FlxUIButton","resize",0x28cb475b,"flixel.addons.ui.FlxUIButton.resize","flixel/addons/ui/FlxUIButton.hx",176,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_180_addIcon,"flixel.addons.ui.FlxUIButton","addIcon",0xa78ff6f3,"flixel.addons.ui.FlxUIButton.addIcon","flixel/addons/ui/FlxUIButton.hx",180,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_211_removeIcon,"flixel.addons.ui.FlxUIButton","removeIcon",0xfc624ec4,"flixel.addons.ui.FlxUIButton.removeIcon","flixel/addons/ui/FlxUIButton.hx",211,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_225_changeIcon,"flixel.addons.ui.FlxUIButton","changeIcon",0x598c49f0,"flixel.addons.ui.FlxUIButton.changeIcon","flixel/addons/ui/FlxUIButton.hx",225,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_231_destroy,"flixel.addons.ui.FlxUIButton","destroy",0x4a25f9b3,"flixel.addons.ui.FlxUIButton.destroy","flixel/addons/ui/FlxUIButton.hx",231,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_239_loadDefaultGraphic,"flixel.addons.ui.FlxUIButton","loadDefaultGraphic",0xa27a0494,"flixel.addons.ui.FlxUIButton.loadDefaultGraphic","flixel/addons/ui/FlxUIButton.hx",239,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_247_resetHelpers,"flixel.addons.ui.FlxUIButton","resetHelpers",0x11dffddd,"flixel.addons.ui.FlxUIButton.resetHelpers","flixel/addons/ui/FlxUIButton.hx",247,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_259_onDownHandler,"flixel.addons.ui.FlxUIButton","onDownHandler",0x9da54a22,"flixel.addons.ui.FlxUIButton.onDownHandler","flixel/addons/ui/FlxUIButton.hx",259,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_283_onOverHandler,"flixel.addons.ui.FlxUIButton","onOverHandler",0x790d9370,"flixel.addons.ui.FlxUIButton.onOverHandler","flixel/addons/ui/FlxUIButton.hx",283,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_307_onOutHandler,"flixel.addons.ui.FlxUIButton","onOutHandler",0x7e879b82,"flixel.addons.ui.FlxUIButton.onOutHandler","flixel/addons/ui/FlxUIButton.hx",307,0xbb6c9298)
HX_DEFINE_STACK_FRAME(_hx_pos_8344d6e231fc33c4_331_onUpHandler,"flixel.addons.ui.FlxUIButton","onUpHandler",0xc867c2c9,"flixel.addons.ui.FlxUIButton.onUpHandler","flixel/addons/ui/FlxUIButton.hx",331,0xbb6c9298)
namespace flixel{
namespace addons{
namespace ui{
...
void FlxUIButton_obj::autoCenterLabel(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 124)		this->super::autoCenterLabel();
            	}
...
HXDLIN( 129)		HX_VARI_NAME(  ::flixel::addons::ui::FlxUIButton,newButton1,"newButton") =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,(int)0,(int)0,newButton,this->onUp->callback,false,null(),null());
...
HXLINE( 138)			HX_VARI(  ::flixel::addons::ui::FlxUIButton,fuib) = ( ( ::flixel::addons::ui::FlxUIButton)(other) );
...
HXLINE( 148)			HX_VARI(  ::flixel::addons::ui::FlxUIText,t) = ( ( ::flixel::addons::ui::FlxUIText)(fuib->label) );
HXLINE( 150)			HX_VARI(  ::openfl::_legacy::text::TextFormat,tf) = t->textField->get_defaultTextFormat();
HXLINE( 152)			if ((t->_font.indexOf(::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,null()) == (int)-1)) {
HXLINE( 154)				HX_VARI(  ::flixel::addons::ui::FontDef,fd) = ::flixel::addons::ui::FontDef_obj::copyFromFlxText(t);
HXLINE( 155)				fd->apply(null(),( ( ::flixel::text::FlxText)(this->label) ));
            			}
            			else {
HXLINE( 159)				HX_VARI( ::String,flxAlign) = ::flixel::text::_FlxText::FlxTextAlign_Impl__obj::fromOpenFL(tf->align);
...
HXDLIN( 162)				HX_VARI_NAME(  ::Dynamic,tf1,"tf") = tf->color;
HXDLIN( 162)				HX_VARI_NAME(  ::flixel::text::FlxTextBorderStyle,t1,"t") = t->borderStyle;
HXDLIN( 162)				HX_VARI_NAME( int,t2,"t") = t->borderColor;
HXDLIN( 162)				_hx_tmp->setFormat(null(),_hx_tmp1,tf1,flxAlign,t1,t2,t->textField->set_embedFonts(true));
 ...
 ::flixel::addons::ui::FlxUIText FlxUIButton_obj::setLabel( ::flixel::addons::ui::FlxUIText t){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(t,"t")
HXLINE( 169)		this->set_label(t);
HXDLIN( 169)		return this->label;
            	}
...
void FlxUIButton_obj::resize(Float W,Float H){
            	...
            	HX_STACK_ARG(W,"W")
            	HX_STACK_ARG(H,"H")
HXLINE( 176)		this->super::resize(W,H);
            	}
...
HXLINE( 185)		HX_VARI(  ::openfl::_legacy::display::BitmapData,newBmp) = this->_noIconGraphicsBkup->clone();
HXLINE( 189)		HX_VARI(  ::flixel::graphics::FlxGraphic,newGraphic) = ::flixel::FlxG_obj::bitmap->add(newBmp,false,((this->graphic->key + HX_(",icon:",f5,82,8b,4e)) + icon->graphic->key));
...
void FlxUIButton_obj::removeIcon(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 211)		if (hx::IsNotNull( this->_noIconGraphicsBkup )) {
...
HXDLIN( 215)			int _hx_tmp4 = this->_noIconGraphicsBkup->get_height();
HXDLIN( 215)			_hx_tmp1->copyPixels(_hx_tmp2, ::openfl::_legacy::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,_hx_tmp3,_hx_tmp4), ::openfl::_legacy::geom::Point_obj::__alloc( HX_CTX ,null(),null()),null(),null(),null());
