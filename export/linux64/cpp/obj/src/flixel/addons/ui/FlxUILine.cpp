...
HX_DEFINE_STACK_FRAME(_hx_pos_eda242b6f279b347_27_set_axis,"flixel.addons.ui.FlxUILine","set_axis",0x4e054fc3,"flixel.addons.ui.FlxUILine.set_axis","flixel/addons/ui/FlxUILine.hx",27,0xd6550ed6)
HX_DEFINE_STACK_FRAME(_hx_pos_eda242b6f279b347_34_set_length,"flixel.addons.ui.FlxUILine","set_length",0x4e605488,"flixel.addons.ui.FlxUILine.set_length","flixel/addons/ui/FlxUILine.hx",34,0xd6550ed6)
HX_DEFINE_STACK_FRAME(_hx_pos_eda242b6f279b347_41_set_thickness,"flixel.addons.ui.FlxUILine","set_thickness",0x7ce42312,"flixel.addons.ui.FlxUILine.set_thickness","flixel/addons/ui/FlxUILine.hx",41,0xd6550ed6)
HX_DEFINE_STACK_FRAME(_hx_pos_eda242b6f279b347_47_refresh,"flixel.addons.ui.FlxUILine","refresh",0x58e48756,"flixel.addons.ui.FlxUILine.refresh","flixel/addons/ui/FlxUILine.hx",47,0xd6550ed6)
HX_DEFINE_STACK_FRAME(_hx_pos_eda242b6f279b347_60_resize,"flixel.addons.ui.FlxUILine","resize",0xa51734d9,"flixel.addons.ui.FlxUILine.resize","flixel/addons/ui/FlxUILine.hx",60,0xd6550ed6)
namespace flixel{
namespace addons{
namespace ui{
...
HXLINE(  50)			this->scale->set((((Float)0.5) * this->length),(((Float)0.5) * this->thickness));
            		}
            		else {
HXLINE(  54)			this->scale->set((((Float)0.5) * this->thickness),(((Float)0.5) * this->length));
            		}
...
HXLINE(  60)		if (hx::IsEq( this->axis,::flixel::addons::ui::LineAxis_obj::HORIZONTAL_dyn() )) {
