...
HX_DEFINE_STACK_FRAME(_hx_pos_7ec0642bbae75140_42_resize,"flixel.addons.ui.FlxUISpriteButton","resize",0xe723fe56,"flixel.addons.ui.FlxUISpriteButton.resize","flixel/addons/ui/FlxUISpriteButton.hx",42,0xcd05ded3)
HX_DEFINE_STACK_FRAME(_hx_pos_7ec0642bbae75140_48_autoCenterLabel,"flixel.addons.ui.FlxUISpriteButton","autoCenterLabel",0x0d1e740e,"flixel.addons.ui.FlxUISpriteButton.autoCenterLabel","flixel/addons/ui/FlxUISpriteButton.hx",48,0xcd05ded3)
namespace flixel{
namespace addons{
namespace ui{
...
void FlxUISpriteButton_obj::autoCenterLabel(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  48)		if (hx::IsNotNull( ( ( ::flixel::FlxSprite)(this->label) ) )) {
HXLINE(  49)			if (::Std_obj::is(this->label,hx::ClassOf< ::flixel::group::FlxTypedSpriteGroup >())) {
HXLINE(  50)				HX_VARI(  ::flixel::group::FlxTypedSpriteGroup,g) = ( ( ::flixel::group::FlxTypedSpriteGroup)(this->label) );
HXLINE(  51)				{
HXLINE(  51)					HX_VARI( int,_g) = (int)0;
HXDLIN(  51)					HX_VARI( ::Array< ::Dynamic>,_g1) = g->group->members;
HXDLIN(  51)					while((_g < _g1->length)){
HXLINE(  51)						HX_VARI(  ::flixel::FlxSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
...
HXLINE(  58)				HX_VARI( Float,W) = g->get_width();
HXLINE(  59)				HX_VARI( Float,H) = g->get_height();
HXLINE(  61)				{
HXLINE(  61)					HX_VARI_NAME( int,_g2,"_g") = (int)0;
HXDLIN(  61)					HX_VARI_NAME( ::Array< ::Dynamic>,_g11,"_g1") = g->group->members;
HXDLIN(  61)					while((_g2 < _g11->length)){
HXLINE(  61)						HX_VARI_NAME(  ::flixel::FlxSprite,sprite1,"sprite") = _g11->__get(_g2).StaticCast<  ::flixel::FlxSprite >();
