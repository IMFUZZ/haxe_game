...
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_214_stripFontExtensions,"flixel.addons.ui.FontDef","stripFontExtensions",0x4ace96d2,"flixel.addons.ui.FontDef.stripFontExtensions","flixel/addons/ui/FontDef.hx",214,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_224_getFontExtension,"flixel.addons.ui.FontDef","getFontExtension",0x3c4339c3,"flixel.addons.ui.FontDef.getFontExtension","flixel/addons/ui/FontDef.hx",224,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_235_fixFontName,"flixel.addons.ui.FontDef","fixFontName",0x0fe78ac6,"flixel.addons.ui.FontDef.fixFontName","flixel/addons/ui/FontDef.hx",235,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_266_getFontStyle,"flixel.addons.ui.FontDef","getFontStyle",0x0566d975,"flixel.addons.ui.FontDef.getFontStyle","flixel/addons/ui/FontDef.hx",266,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_282_setFontStyle,"flixel.addons.ui.FontDef","setFontStyle",0x1a5ffce9,"flixel.addons.ui.FontDef.setFontStyle","flixel/addons/ui/FontDef.hx",282,0x96f2befa)
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_333_toString,"flixel.addons.ui.FontDef","toString",0xb186cc35,"flixel.addons.ui.FontDef.toString","flixel/addons/ui/FontDef.hx",333,0x96f2befa)
...
HX_DEFINE_STACK_FRAME(_hx_pos_6202c8c3d680a662_301_fromXML,"flixel.addons.ui.FontDef","fromXML",0x8e85ab24,"flixel.addons.ui.FontDef.fromXML","flixel/addons/ui/FontDef.hx",301,0x96f2befa)
...
HXDLIN( 165)			HX_VARI( ::Array< ::String >,_g1) = ::flixel::addons::ui::FontDef_obj::EXTENSIONS;
HXDLIN( 165)			while((_g < _g1->length)){
HXLINE( 165)				HX_VARI( ::String,ext) = _g1->__get(_g);
HXDLIN( 165)				_g = (_g + (int)1);
HXLINE( 166)				if ((str.indexOf(ext,null()) != (int)-1)) {
HXLINE( 167)					if (::openfl::_legacy::Assets_obj::exists((str + HX_("",00,00,00,00)),::openfl::_legacy::AssetType_obj::FONT_dyn())) {
HXLINE( 168)						this->name = ::StringTools_obj::replace(str,HX_("",00,00,00,00),HX_("",00,00,00,00));
...
HXLINE( 178)			HX_VARI_NAME( int,_g2,"_g") = (int)0;
HXDLIN( 178)			HX_VARI_NAME( ::Array< ::String >,_g11,"_g1") = ::flixel::addons::ui::FontDef_obj::EXTENSIONS;
HXDLIN( 178)			while((_g2 < _g11->length)){
HXLINE( 178)				HX_VARI_NAME( ::String,ext1,"ext") = _g11->__get(_g2);
...
HXLINE( 192)			if ((this->getFontStyle(str) != HX_("",00,00,00,00))) {
...
HXDLIN( 216)			HX_VARI( ::Array< ::String >,_g1) = ::flixel::addons::ui::FontDef_obj::EXTENSIONS;
HXDLIN( 216)			while((_g < _g1->length)){
HXLINE( 216)				HX_VARI( ::String,ext) = _g1->__get(_g);
...
HXDLIN( 226)			HX_VARI( ::Array< ::String >,_g1) = ::flixel::addons::ui::FontDef_obj::EXTENSIONS;
HXDLIN( 226)			while((_g < _g1->length)){
HXLINE( 226)				HX_VARI( ::String,ext) = _g1->__get(_g);
...
void FontDef_obj::fixFontName(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 236)		HX_VARI( ::String,fontStyle) = this->getFontStyle(this->file);
HXLINE( 237)		HX_VARI( ::String,extension) = this->getFontExtension(this->file);
HXLINE( 238)		HX_VARI( ::String,fontbase) = this->stripFontExtensions(this->file);
HXLINE( 239)		if ((fontStyle != HX_("",00,00,00,00))) {
HXLINE( 241)			fontbase = fontbase.substr((int)0,(fontbase.length - (int)1));
            		}
HXLINE( 243)		HX_VARI( ::String,styleStr) = HX_("",00,00,00,00);
...
HXLINE( 269)		HX_VARI( ::String,lastChar) = str.substr((str.length - (int)1),(int)1);
...
::String FontDef_obj::toString(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 333)		::String _hx_tmp = ((HX_("{name:",34,f1,69,c4) + this->name) + HX_(",size:",ad,e8,8c,14));
...
HXLINE( 302)		HX_VARI( ::String,fontFace) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("font",cf,5d,c0,43),null(),null());
HXLINE( 303)		HX_VARI( ::String,fontStyle) = ::flixel::addons::ui::U_obj::xml_str(data,HX_("style",31,a5,1d,84),null(),null());
HXLINE( 304)		HX_VARI( ::String,fontFile) = null();
HXLINE( 305)		if ((fontFace != HX_("",00,00,00,00))) {
HXLINE( 307)			fontFile = ::flixel::addons::ui::FlxUI_obj::font(fontFace,fontStyle,null());
            		}
HXLINE( 309)		HX_VARI_NAME( ::String,fontStyle1,"fontStyle") = ::flixel::addons::ui::U_obj::xml_str(data,HX_("style",31,a5,1d,84),null(),null());
HXLINE( 310)		HX_VARI( int,fontSize) = ::flixel::addons::ui::FlxUI_obj::fontSize(fontFile,::flixel::addons::ui::U_obj::xml_i(data,HX_("size",c1,a0,53,4c),(int)8));
HXLINE( 311)		HX_VARI( int,fontColor) = ::flixel::addons::ui::U_obj::xml_color(data,HX_("color",63,71,5c,4a),true,(int)-1);
HXLINE( 313)		HX_VAR( ::String,align);
HXDLIN( 313)		::String _hx_switch_0 = ::flixel::addons::ui::U_obj::xml_str(data,HX_("align",c5,56,91,21),null(),null()).toLowerCase();
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
...
HXLINE( 313)			align = HX_("left",07,08,b0,47);
            		...
            		_hx_goto_23:;
HXLINE( 321)		HX_VARI(  ::flixel::addons::ui::FontDef,fd) =  ::flixel::addons::ui::FontDef_obj::__alloc( HX_CTX ,::flixel::addons::ui::U_obj::xml_str(data,HX_("font",cf,5d,c0,43),null(),null()),HX_(".ttf",78,3b,c0,1e),fontFile,null(),null());
