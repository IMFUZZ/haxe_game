...
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_164_destroy,"flixel.addons.ui.FlxUIList","destroy",0xade358df,"flixel.addons.ui.FlxUIList.destroy","flixel/addons/ui/FlxUIList.hx",164,0xc14028ac)
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_174_setSize,"flixel.addons.ui.FlxUIList","setSize",0x9b350d68,"flixel.addons.ui.FlxUIList.setSize","flixel/addons/ui/FlxUIList.hx",174,0xc14028ac)
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_188_add,"flixel.addons.ui.FlxUIList","add",0x65000786,"flixel.addons.ui.FlxUIList.add","flixel/addons/ui/FlxUIList.hx",188,0xc14028ac)
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_198_safeAdd,"flixel.addons.ui.FlxUIList","safeAdd",0xfdf2e6b9,"flixel.addons.ui.FlxUIList.safeAdd","flixel/addons/ui/FlxUIList.hx",198,0xc14028ac)
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_204_getMoreString,"flixel.addons.ui.FlxUIList","getMoreString",0x93c9dc21,"flixel.addons.ui.FlxUIList.getMoreString","flixel/addons/ui/FlxUIList.hx",204,0xc14028ac)
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_213_set_visible,"flixel.addons.ui.FlxUIList","set_visible",0x451d61fa,"flixel.addons.ui.FlxUIList.set_visible","flixel/addons/ui/FlxUIList.hx",213,0xc14028ac)
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_219_onClick,"flixel.addons.ui.FlxUIList","onClick",0x67f9468e,"flixel.addons.ui.FlxUIList.onClick","flixel/addons/ui/FlxUIList.hx",219,0xc14028ac)
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_224_refreshList,"flixel.addons.ui.FlxUIList","refreshList",0x4de02e3e,"flixel.addons.ui.FlxUIList.refreshList","flixel/addons/ui/FlxUIList.hx",224,0xc14028ac)
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_318_get_width,"flixel.addons.ui.FlxUIList","get_width",0x89f7c182,"flixel.addons.ui.FlxUIList.get_width","flixel/addons/ui/FlxUIList.hx",318,0xc14028ac)
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_322_get_height,"flixel.addons.ui.FlxUIList","get_height",0xe52108eb,"flixel.addons.ui.FlxUIList.get_height","flixel/addons/ui/FlxUIList.hx",322,0xc14028ac)
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_325_set_width,"flixel.addons.ui.FlxUIList","set_width",0x6d48ad8e,"flixel.addons.ui.FlxUIList.set_width","flixel/addons/ui/FlxUIList.hx",325,0xc14028ac)
HX_DEFINE_STACK_FRAME(_hx_pos_a5e703d0cd5c8e74_331_set_height,"flixel.addons.ui.FlxUIList","set_height",0xe89ea75f,"flixel.addons.ui.FlxUIList.set_height","flixel/addons/ui/FlxUIList.hx",331,0xc14028ac)
...
HXDLIN(  89)			HX_VARI(  ::flixel::addons::ui::FlxUIButton,pButton) =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,(int)0,(int)0,HX_(" ",20,00,00,00), ::Dynamic(new _hx_Closure_0(f)),null(),null(),null());
...
HXDLIN( 123)			HX_VARI(  ::flixel::addons::ui::FlxUIButton,nButton) =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,(int)0,(int)0,HX_(" ",20,00,00,00), ::Dynamic(new _hx_Closure_3(f3)),null(),null(),null());
...
HXLINE( 127)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,nButton2,"nButton") = ( ( ::flixel::addons::ui::FlxUIText)(nButton->label) );
...
HXLINE( 132)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,nButton3,"nButton") = ( ( ::flixel::addons::ui::FlxUIText)(nButton->label) );
HXDLIN( 132)				nButton3->set_width(( ( ::flixel::text::FlxText)(nButton->label) )->set_fieldWidth((int)100));
HXLINE( 133)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,nButton4,"nButton") = ( ( ::flixel::addons::ui::FlxUIText)(nButton->label) );
...
HXDLIN( 145)				( ( ::flixel::addons::ui::FlxUIButton)(this->nextButton) )->onUp->callback = _hx_tmp6;
            			}
...
HXDLIN( 150)				( ( ::flixel::addons::ui::FlxUISpriteButton)(this->nextButton) )->onUp->callback = _hx_tmp7;
            			}
            		}
HXLINE( 154)		if (hx::IsNull( this->prevButtonOffset )) {
HXLINE( 155)			HX_VARI(  ::flixel::math::FlxPoint,point) = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 155)			point->_inPool = false;
HXDLIN( 155)			this->prevButtonOffset = point;
            		}
HXLINE( 157)		if (hx::IsNull( this->nextButtonOffset )) {
HXLINE( 158)			HX_VARI_NAME(  ::flixel::math::FlxPoint,point1,"point") = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
void FlxUIList_obj::setSize(Float W,Float H){
            	...
            	HX_STACK_ARG(W,"W")
            	HX_STACK_ARG(H,"H")
HXLINE( 175)		HX_VARI( bool,flip) = false;
...
HXLINE( 189)		HX_VARI(  ::flixel::FlxSprite,Object) = ( ( ::flixel::FlxSprite)(_tmp_Object) );
...
HXLINE( 198)		return this->super::add(Object);
            	}
...
::String FlxUIList_obj::getMoreString(int i){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(i,"i")
HXLINE( 205)		HX_VARI( ::String,newString) = this->moreString;
...
void FlxUIList_obj::onClick(int i){
            	...
            	HX_STACK_ARG(i,"i")
HXLINE( 220)		{
HXLINE( 220)			HX_VARI(  ::flixel::addons::ui::FlxUIList,_g) = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 238)		HX_VARI( Float,XX) = (int)0;
HXLINE( 239)		HX_VARI( Float,YY) = (int)0;
HXLINE( 241)		HX_VARI( int,i) = (int)0;
HXLINE( 242)		HX_VARI( bool,inBounds) = true;
HXLINE( 244)		if ((this->stacking == (int)0)) {
HXLINE( 245)			 ::Dynamic _hx_tmp = this->prevButton->__Field(HX_("set_x",5b,9b,2f,7a),hx::paccDynamic);
HXDLIN( 245)			Float _hx_tmp1 = this->prevButtonOffset->x;
HXDLIN( 245)			_hx_tmp(((_hx_tmp1 - ( (Float)(this->prevButton->__Field(HX_("get_width",5d,12,0c,0e),hx::paccDynamic)()) )) - (int)2));
HXLINE( 246)			this->prevButton->__Field(HX_("set_y",5c,9b,2f,7a),hx::paccDynamic)(this->prevButtonOffset->y);
HXLINE( 247)			this->nextButton->__Field(HX_("set_x",5b,9b,2f,7a),hx::paccDynamic)(((this->nextButtonOffset->x + this->get_width()) + (int)2));
HXLINE( 248)			this->nextButton->__Field(HX_("set_y",5c,9b,2f,7a),hx::paccDynamic)(this->nextButtonOffset->y);
            		}
            		else {
HXLINE( 250)			this->prevButton->__Field(HX_("set_x",5b,9b,2f,7a),hx::paccDynamic)(this->prevButtonOffset->x);
HXLINE( 251)			 ::Dynamic _hx_tmp2 = this->prevButton->__Field(HX_("set_y",5c,9b,2f,7a),hx::paccDynamic);
HXDLIN( 251)			Float _hx_tmp3 = this->prevButtonOffset->y;
HXDLIN( 251)			_hx_tmp2(((_hx_tmp3 - ( (Float)(this->prevButton->__Field(HX_("get_height",b0,77,d3,f2),hx::paccDynamic)()) )) - (int)2));
HXLINE( 252)			this->nextButton->__Field(HX_("set_x",5b,9b,2f,7a),hx::paccDynamic)(this->nextButtonOffset->x);
HXLINE( 253)			this->nextButton->__Field(HX_("set_y",5c,9b,2f,7a),hx::paccDynamic)(((this->nextButtonOffset->y + this->get_height()) + (int)2));
            		}
HXLINE( 256)		 ::Dynamic _hx_tmp4 = this->prevButton->__Field(HX_("set_x",5b,9b,2f,7a),hx::paccDynamic);
HXDLIN( 256)		_hx_tmp4(::Std_obj::_hx_int(( (Float)(this->prevButton->__Field(HX_("x",78,00,00,00),hx::paccDynamic)) )));
HXLINE( 257)		 ::Dynamic _hx_tmp5 = this->prevButton->__Field(HX_("set_y",5c,9b,2f,7a),hx::paccDynamic);
HXDLIN( 257)		_hx_tmp5(::Std_obj::_hx_int(( (Float)(this->prevButton->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) )));
HXLINE( 258)		 ::Dynamic _hx_tmp6 = this->nextButton->__Field(HX_("set_x",5b,9b,2f,7a),hx::paccDynamic);
HXDLIN( 258)		_hx_tmp6(::Std_obj::_hx_int(( (Float)(this->nextButton->__Field(HX_("x",78,00,00,00),hx::paccDynamic)) )));
HXLINE( 259)		 ::Dynamic _hx_tmp7 = this->nextButton->__Field(HX_("set_y",5c,9b,2f,7a),hx::paccDynamic);
HXDLIN( 259)		_hx_tmp7(::Std_obj::_hx_int(( (Float)(this->nextButton->__Field(HX_("y",79,00,00,00),hx::paccDynamic)) )));
HXLINE( 261)		HX_VARI( int,highestIndex) = (int)0;
HXLINE( 263)		{
HXLINE( 263)			HX_VARI( int,_g) = (int)0;
HXDLIN( 263)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->group->members;
HXDLIN( 263)			while((_g < _g1->length)){
HXLINE( 263)				HX_VARI(  ::flixel::FlxSprite,widget) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 263)				_g = (_g + (int)1);
HXLINE( 264)				inBounds = false;
HXLINE( 265)				if ((i >= this->scrollIndex)) {
HXLINE( 267)					if ((this->stacking == (int)1)) {
HXLINE( 268)						HX_VARI_NAME( Float,inBounds1,"inBounds") = (YY + widget->get_height());
...
HXLINE( 270)						HX_VARI_NAME( Float,inBounds2,"inBounds") = (XX + widget->get_width());
...
HXLINE( 297)		this->amountNext = (this->group->members->get_length() - (highestIndex + (int)1));
HXLINE( 299)		HX_VAR(  ::flixel::addons::ui::FlxUIButton,fuibutton);
...
HXLINE( 305)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,fuibutton1,"fuibutton") = ( ( ::flixel::addons::ui::FlxUIText)(fuibutton->label) );
...
HXLINE( 312)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,fuibutton2,"fuibutton") = ( ( ::flixel::addons::ui::FlxUIText)(fuibutton->label) );
