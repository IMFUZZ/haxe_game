...
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_250__onPlus,"flixel.addons.ui.FlxUINumericStepper","_onPlus",0xcab59143,"flixel.addons.ui.FlxUINumericStepper._onPlus","flixel/addons/ui/FlxUINumericStepper.hx",250,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_256__onMinus,"flixel.addons.ui.FlxUINumericStepper","_onMinus",0xd7f4da67,"flixel.addons.ui.FlxUINumericStepper._onMinus","flixel/addons/ui/FlxUINumericStepper.hx",256,0xbef22206)
HX_DEFINE_STACK_FRAME(_hx_pos_b3434b006136ea9e_263__doCallback,"flixel.addons.ui.FlxUINumericStepper","_doCallback",0xf5f9d69a,"flixel.addons.ui.FlxUINumericStepper._doCallback","flixel/addons/ui/FlxUINumericStepper.hx",263,0xbef22206)
...
HXLINE( 229)		HX_VARI( int,numDecimals) = (int)0;
HXLINE( 230)		{
HXLINE( 230)			HX_VARI( int,_g1) = (int)0;
HXDLIN( 230)			HX_VARI( int,_g) = text.length;
HXDLIN( 230)			while((_g1 < _g)){
HXLINE( 230)				_g1 = (_g1 + (int)1);
HXLINE( 233)				if ((text.charAt((_g1 - (int)1)) == HX_(".",2e,00,00,00))) {
HXLINE( 235)					numDecimals = (numDecimals + (int)1);
            				}
            			}
            		}
HXLINE( 239)		HX_VAR( bool,justAddedDecimal);
HXDLIN( 239)		if ((numDecimals == (int)1)) {
HXLINE( 239)			HX_VARI_NAME( int,justAddedDecimal1,"justAddedDecimal") = text.indexOf(HX_(".",2e,00,00,00),null());
...
void FlxUINumericStepper_obj::_onPlus(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 251)		{
HXLINE( 251)			HX_VARI(  ::flixel::addons::ui::FlxUINumericStepper,_g) = hx::ObjectPtr<OBJ_>(this);
...
void FlxUINumericStepper_obj::_onMinus(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 257)		{
HXLINE( 257)			HX_VARI(  ::flixel::addons::ui::FlxUINumericStepper,_g) = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 263)		if (this->broadcastToFlxUI) {
