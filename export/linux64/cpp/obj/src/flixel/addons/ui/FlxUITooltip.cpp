...
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_43_show,"flixel.addons.ui.FlxUITooltip","show",0x46accc3d,"flixel.addons.ui.FlxUITooltip.show","flixel/addons/ui/FlxUITooltip.hx",43,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_224_get_height,"flixel.addons.ui.FlxUITooltip","get_height",0x50de5ef0,"flixel.addons.ui.FlxUITooltip.get_height","flixel/addons/ui/FlxUITooltip.hx",224,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_253_hide,"flixel.addons.ui.FlxUITooltip","hide",0x3f682c02,"flixel.addons.ui.FlxUITooltip.hide","flixel/addons/ui/FlxUITooltip.hx",253,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_261_set_anchor,"flixel.addons.ui.FlxUITooltip","set_anchor",0xb2812ff2,"flixel.addons.ui.FlxUITooltip.set_anchor","flixel/addons/ui/FlxUITooltip.hx",261,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_272_set_style,"flixel.addons.ui.FlxUITooltip","set_style",0x4b15ae54,"flixel.addons.ui.FlxUITooltip.set_style","flixel/addons/ui/FlxUITooltip.hx",272,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_278_set_title,"flixel.addons.ui.FlxUITooltip","set_title",0xd7331ebb,"flixel.addons.ui.FlxUITooltip.set_title","flixel/addons/ui/FlxUITooltip.hx",278,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_284_set_body,"flixel.addons.ui.FlxUITooltip","set_body",0xdcfa26df,"flixel.addons.ui.FlxUITooltip.set_body","flixel/addons/ui/FlxUITooltip.hx",284,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_299_refresh,"flixel.addons.ui.FlxUITooltip","refresh",0x9e68ea9b,"flixel.addons.ui.FlxUITooltip.refresh","flixel/addons/ui/FlxUITooltip.hx",299,0xb6bba58f)
...
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_392_refreshBkg,"flixel.addons.ui.FlxUITooltip","refreshBkg",0x652bdaa3,"flixel.addons.ui.FlxUITooltip.refreshBkg","flixel/addons/ui/FlxUITooltip.hx",392,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_414_getStyleKey,"flixel.addons.ui.FlxUITooltip","getStyleKey",0x6e476464,"flixel.addons.ui.FlxUITooltip.getStyleKey","flixel/addons/ui/FlxUITooltip.hx",414,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_418_makeArrowBkg,"flixel.addons.ui.FlxUITooltip","makeArrowBkg",0x668c4783,"flixel.addons.ui.FlxUITooltip.makeArrowBkg","flixel/addons/ui/FlxUITooltip.hx",418,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_468_getArrowAnchor,"flixel.addons.ui.FlxUITooltip","getArrowAnchor",0x379dff68,"flixel.addons.ui.FlxUITooltip.getArrowAnchor","flixel/addons/ui/FlxUITooltip.hx",468,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_549_styleFix,"flixel.addons.ui.FlxUITooltip","styleFix",0xca970064,"flixel.addons.ui.FlxUITooltip.styleFix","flixel/addons/ui/FlxUITooltip.hx",549,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_665_cloneStyle,"flixel.addons.ui.FlxUITooltip","cloneStyle",0xdd1e97d4,"flixel.addons.ui.FlxUITooltip.cloneStyle","flixel/addons/ui/FlxUITooltip.hx",665,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_693_fillFontDefNulls,"flixel.addons.ui.FlxUITooltip","fillFontDefNulls",0x74a2ef59,"flixel.addons.ui.FlxUITooltip.fillFontDefNulls","flixel/addons/ui/FlxUITooltip.hx",693,0xb6bba58f)
HX_DEFINE_STACK_FRAME(_hx_pos_7b5caaba09e0a704_701_fillFormatNulls,"flixel.addons.ui.FlxUITooltip","fillFormatNulls",0x253ee452,"flixel.addons.ui.FlxUITooltip.fillFormatNulls","flixel/addons/ui/FlxUITooltip.hx",701,0xb6bba58f)
namespace flixel{
namespace addons{
namespace ui{
...
HXLINE(  95)		HX_VARI( int,titleHeight) = ::Std_obj::_hx_int((this->_titleText->textField->get_textHeight() + (int)4));
...
HXLINE( 108)		HX_VARI( int,W) = ::Std_obj::_hx_int(this->_bkg->get_width());
HXLINE( 109)		HX_VARI( int,H) = ::Std_obj::_hx_int(this->_bkg->get_height());
HXLINE( 111)		if (AutoSizeHorizontal) {
HXLINE( 113)			HX_VAR( Float,tw);
HXDLIN( 113)			if ((this->_titleText->text != HX_("",00,00,00,00))) {
HXLINE( 113)				HX_VARI_NAME( Float,tw1,"tw") = this->_titleText->x;
HXDLIN( 113)				tw = (tw1 + this->_titleText->get_width());
            			}
            			else {
HXLINE( 113)				tw = (int)0;
            			}
HXLINE( 114)			HX_VAR( Float,bw);
HXDLIN( 114)			if ((this->_bodyText->text != HX_("",00,00,00,00))) {
HXLINE( 114)				HX_VARI_NAME( Float,bw1,"bw") = this->_bodyText->x;
...
HXLINE( 120)			HX_VAR( Float,th);
HXDLIN( 120)			if ((this->_titleText->text != HX_("",00,00,00,00))) {
HXLINE( 120)				HX_VARI_NAME( Float,th1,"th") = this->_titleText->y;
HXDLIN( 120)				th = (th1 + this->_titleText->get_height());
            			}
            			else {
HXLINE( 120)				th = (int)0;
            			}
HXLINE( 121)			HX_VAR( Float,bh);
HXDLIN( 121)			if ((this->_bodyText->text != HX_("",00,00,00,00))) {
HXLINE( 121)				HX_VARI_NAME( Float,bh1,"bh") = this->_bodyText->y;
...
HXLINE( 140)		HX_VARI( int,oldOffX) = ::Std_obj::_hx_int(this->_anchorArrow->x->offset);
HXLINE( 141)		HX_VARI( int,oldOffY) = ::Std_obj::_hx_int(this->_anchorArrow->y->offset);
...
HXLINE( 156)			HX_VARI( int,xx) = ::Std_obj::_hx_int(::Math_obj::abs(this->_arrow->x));
HXLINE( 157)			{
HXLINE( 157)				HX_VARI(  ::flixel::FlxSprite,_g) = this->_bkg;
HXDLIN( 157)				_g->set_x((_g->x + xx));
            			}
HXLINE( 158)			{
HXLINE( 158)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,_g1,"_g") = this->_titleText;
HXDLIN( 158)				_g1->set_x((_g1->x + xx));
            			}
HXLINE( 159)			{
HXLINE( 159)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,_g2,"_g") = this->_bodyText;
HXDLIN( 159)				_g2->set_x((_g2->x + xx));
            			}
HXLINE( 160)			this->_arrow->set_x((int)0);
            		}
HXLINE( 162)		if ((this->_arrow->y < (int)0)) {
HXLINE( 164)			HX_VARI( int,yy) = ::Std_obj::_hx_int(::Math_obj::abs(this->_arrow->y));
HXLINE( 165)			{
HXLINE( 165)				HX_VARI_NAME(  ::flixel::FlxSprite,_g3,"_g") = this->_bkg;
HXDLIN( 165)				_g3->set_y((_g3->y + yy));
            			}
HXLINE( 166)			{
HXLINE( 166)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,_g4,"_g") = this->_titleText;
HXDLIN( 166)				_g4->set_y((_g4->y + yy));
            			}
HXLINE( 167)			{
HXLINE( 167)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,_g5,"_g") = this->_bodyText;
...
HXLINE( 177)			HX_VARI( int,titleOnlyOffset) = ::Std_obj::_hx_int(((Float)((H - (this->style->__Field(HX_("topPadding",bc,47,4b,3c),hx::paccDynamic) + this->style->__Field(HX_("bottomPadding",26,1e,2d,2b),hx::paccDynamic))) - titleHeight) / (Float)(int)2));
HXLINE( 178)			{
HXLINE( 178)				HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,_g6,"_g") = this->_titleText;
HXDLIN( 178)				_g6->set_y((_g6->y + titleOnlyOffset));
            			}
            		}
HXLINE( 182)		{
HXLINE( 182)			HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,_g7,"_g") = this->_titleText;
HXDLIN( 182)			_g7->set_x((_g7->x + this->style->__Field(HX_("leftPadding",8a,98,10,d0),hx::paccDynamic)));
            		}
HXLINE( 183)		{
HXLINE( 183)			HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,_g8,"_g") = this->_bodyText;
HXDLIN( 183)			_g8->set_x((_g8->x + this->style->__Field(HX_("leftPadding",8a,98,10,d0),hx::paccDynamic)));
            		}
HXLINE( 185)		{
HXLINE( 185)			HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,_g9,"_g") = this->_titleText;
HXDLIN( 185)			_g9->set_y((_g9->y + this->style->__Field(HX_("topPadding",bc,47,4b,3c),hx::paccDynamic)));
            		}
HXLINE( 186)		{
HXLINE( 186)			HX_VARI_NAME(  ::flixel::addons::ui::FlxUIText,_g10,"_g") = this->_bodyText;
...
HXLINE( 230)		HX_VARI( Float,minY) = ::Math_obj::POSITIVE_INFINITY;
HXLINE( 231)		HX_VARI( Float,maxY) = ::Math_obj::NEGATIVE_INFINITY;
HXLINE( 233)		{
HXLINE( 233)			HX_VARI( int,_g) = (int)0;
HXDLIN( 233)			HX_VARI( ::Array< ::Dynamic>,_g1) = this->_sprites;
HXDLIN( 233)			while((_g < _g1->length)){
HXLINE( 233)				HX_VARI(  ::flixel::FlxSprite,member) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
...
HXLINE( 237)				HX_VARI( Float,minMemberY) = member->y;
HXLINE( 238)				HX_VARI( Float,maxMemberY) = (minMemberY + member->get_height());
...
void FlxUITooltip_obj::refresh(int Width,int Height,::String Title,::String Body, ::flixel::addons::ui::Anchor Anchor_, ::Dynamic Style){
            	...
            	HX_STACK_ARG(Anchor_,"Anchor_")
            	HX_STACK_ARG(Style,"Style")
HXLINE( 301)		HX_VARI( bool,newBkg) = hx::IsNull( this->_bkg );
HXLINE( 302)		HX_VARI( bool,newArrow) = hx::IsNull( this->_arrow );
HXLINE( 303)		HX_VARI( bool,newTitle) = hx::IsNull( this->_titleText );
HXLINE( 304)		HX_VARI( bool,newBody) = hx::IsNull( this->_bodyText );
...
HXLINE( 343)		HX_VARI(  ::flixel::graphics::FlxGraphic,test) = ::flixel::FlxG_obj::bitmap->add( ::Dynamic(Style->__Field(HX_("arrow",c9,79,8f,25),hx::paccDynamic)),null(),null());
...
void FlxUITooltip_obj::refreshBkg(int Width,int Height, ::Dynamic Style){
            	...
            	HX_STACK_ARG(Height,"Height")
            	HX_STACK_ARG(Style,"Style")
HXLINE( 394)		HX_VARI( ::String,key) = this->getStyleKey(Width,Height,Style);
HXLINE( 395)		if (hx::IsNull( ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(::flixel::FlxG_obj::bitmap->_cache,key)) ) )) {
HXLINE( 397)			HX_VARI(  ::openfl::_legacy::display::BitmapData,pix) = null();
...
::String FlxUITooltip_obj::getStyleKey(int W,int H, ::Dynamic Style){
            	...
            	HX_STACK_ARG(H,"H")
            	HX_STACK_ARG(Style,"Style")
HXLINE( 414)		HX_VARI_NAME( int,this1,"this") = ( (int)(Style->__Field(HX_("background",ee,93,1d,26),hx::paccDynamic)) );
HXDLIN( 414)		::String _hx_tmp;
HXDLIN( 414)		_hx_tmp = ::StringTools_obj::hex(((int)((int)this1 >> (int)(int)24) & (int)(int)255),(int)2);
HXDLIN( 414)		::String _hx_tmp1 = ((HX_("0x",48,2a,00,00) + _hx_tmp) + ::StringTools_obj::hex(((int)((int)this1 >> (int)(int)16) & (int)(int)255),(int)2));
HXDLIN( 414)		::String _hx_tmp2 = (_hx_tmp1 + ::StringTools_obj::hex(((int)((int)this1 >> (int)(int)8) & (int)(int)255),(int)2));
HXDLIN( 414)		::String _hx_tmp3 = (((((W + HX_(",",2c,00,00,00)) + H) + HX_(",",2c,00,00,00)) + (_hx_tmp2 + ::StringTools_obj::hex(((int)this1 & (int)(int)255),(int)2))) + HX_(",",2c,00,00,00));
HXDLIN( 414)		::String _hx_tmp4 = ((_hx_tmp3 + Style->__Field(HX_("borderSize",cd,ff,ed,06),hx::paccDynamic)) + HX_(",",2c,00,00,00));
HXDLIN( 414)		HX_VARI_NAME( int,this2,"this") = ( (int)(Style->__Field(HX_("borderColor",d7,3c,d5,d6),hx::paccDynamic)) );
HXDLIN( 414)		::String _hx_tmp5;
HXDLIN( 414)		_hx_tmp5 = ::StringTools_obj::hex(((int)((int)this2 >> (int)(int)24) & (int)(int)255),(int)2);
HXDLIN( 414)		::String _hx_tmp6 = ((HX_("0x",48,2a,00,00) + _hx_tmp5) + ::StringTools_obj::hex(((int)((int)this2 >> (int)(int)16) & (int)(int)255),(int)2));
HXDLIN( 414)		::String _hx_tmp7 = (_hx_tmp6 + ::StringTools_obj::hex(((int)((int)this2 >> (int)(int)8) & (int)(int)255),(int)2));
HXDLIN( 414)		return (_hx_tmp4 + (_hx_tmp7 + ::StringTools_obj::hex(((int)this2 & (int)(int)255),(int)2)));
            	}
...
HXLINE( 423)		HX_VAR( ::String,animName);
...
HXLINE( 425)		HX_VARI( ::String,key) = (((((((HX_("arrowBkg:",65,32,bc,fc) + this->style->__Field(HX_("background",ee,93,1d,26),hx::paccDynamic)) + HX_(",",2c,00,00,00)) + this->style->__Field(HX_("borderSize",cd,ff,ed,06),hx::paccDynamic)) + HX_(",",2c,00,00,00)) + this->style->__Field(HX_("borderColor",d7,3c,d5,d6),hx::paccDynamic)) + HX_(",",2c,00,00,00)) + animName);
HXLINE( 427)		if (hx::IsNull( ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(::flixel::FlxG_obj::bitmap->_cache,key)) ) )) {
HXLINE( 429)			HX_VARI(  ::Dynamic,bs) = this->style->__Field(HX_("borderSize",cd,ff,ed,06),hx::paccDynamic);
...
HXLINE( 435)			HX_VARI( int,W) = ::Std_obj::_hx_int((this->_arrow->get_width() + bs));
HXLINE( 438)			HX_VARI(  ::openfl::_legacy::display::BitmapData,bd) =  ::openfl::_legacy::display::BitmapData_obj::__alloc( HX_CTX ,W,::Std_obj::_hx_int((this->_arrow->get_height() + bs)),true,(int)0,null());
HXLINE( 439)			::flixel::FlxG_obj::bitmap->add(bd,false,key);
HXLINE( 440)			b->loadGraphic(key,null(),null(),null(),null(),null());
HXLINE( 442)			HX_VARI( int,oldColor) = this->_arrow->color;
HXLINE( 444)			this->_arrow->set_color(( (int)(this->style->__Field(HX_("borderColor",d7,3c,d5,d6),hx::paccDynamic)) ));
HXLINE( 447)			 ::openfl::_legacy::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null())->identity();
HXLINE( 448)			{
HXLINE( 448)				HX_VARI( int,_g) = (int)0;
HXDLIN( 448)				while((_g < (int)3)){
HXLINE( 448)					_g = (_g + (int)1);
HXDLIN( 448)					HX_VARI( int,yy) = (_g - (int)1);
HXLINE( 450)					{
HXLINE( 450)						HX_VARI( int,_g1) = (int)0;
HXDLIN( 450)						while((_g1 < (int)3)){
HXLINE( 450)							_g1 = (_g1 + (int)1);
HXDLIN( 450)							HX_VARI( int,xx) = (_g1 - (int)1);
...
HXLINE( 454)								b->stamp(this->_arrow,(xx * this->style->__Field(HX_("borderSize",cd,ff,ed,06),hx::paccDynamic)),(yy * this->style->__Field(HX_("borderSize",cd,ff,ed,06),hx::paccDynamic)));
            							}
            						}
            					}
            				}
...
HXLINE( 470)		HX_VAR( bool,touchHorz);
...
HXLINE( 471)		HX_VAR( bool,touchVert);
...
HXLINE( 473)		HX_VAR( bool,matchHorz);
...
HXLINE( 474)		HX_VAR( bool,matchVert);
...
HXLINE( 476)		HX_VAR( bool,touchBoth);
...
HXLINE( 477)		HX_VAR( bool,matchBoth);
...
HXLINE( 479)		HX_VARI( int,off) = ( (int)(this->style->__Field(HX_("borderSize",cd,ff,ed,06),hx::paccDynamic)) );
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxUITooltip_obj,styleFix,return )
 ...
 ::Dynamic FlxUITooltip_obj::cloneStyle( ::Dynamic s){
            	...
            	HX_STACK_ARG(s,"s")
HXLINE( 666)		HX_VAR(  ::flixel::addons::ui::FontDef,tf);
...
HXLINE( 667)		HX_VAR(  ::flixel::addons::ui::FontDef,bf);
...
HXLINE( 672)		HX_VARI_NAME(  ::Dynamic,s1,"s") = s->__Field(HX_("borderSize",cd,ff,ed,06),hx::paccDynamic);
HXLINE( 673)		HX_VARI_NAME(  ::Dynamic,s2,"s") = s->__Field(HX_("titleWidth",4e,c9,47,dc),hx::paccDynamic);
HXLINE( 674)		HX_VARI_NAME(  ::Dynamic,s3,"s") = s->__Field(HX_("bodyWidth",04,e0,6a,8a),hx::paccDynamic);
HXLINE( 675)		HX_VARI_NAME(  ::Dynamic,s4,"s") = s->__Field(HX_("background",ee,93,1d,26),hx::paccDynamic);
HXLINE( 676)		HX_VARI_NAME(  ::Dynamic,s5,"s") = s->__Field(HX_("borderColor",d7,3c,d5,d6),hx::paccDynamic);
HXLINE( 677)		HX_VARI_NAME(  ::Dynamic,s6,"s") =  ::Dynamic(s->__Field(HX_("arrow",c9,79,8f,25),hx::paccDynamic));
HXLINE( 678)		HX_VARI(  ::flixel::math::FlxPoint,obj) = ( ( ::flixel::math::FlxPoint)(s->__Field(HX_("titleOffset",4b,63,cb,f6),hx::paccDynamic)) )->copyTo(null());
HXLINE( 679)		HX_VARI_NAME(  ::flixel::math::FlxPoint,obj1,"obj") = ( ( ::flixel::math::FlxPoint)(s->__Field(HX_("bodyOffset",d5,2b,5c,a7),hx::paccDynamic)) )->copyTo(null());
HXLINE( 689)		return  ::Dynamic(hx::Anon_obj::Create(18)
