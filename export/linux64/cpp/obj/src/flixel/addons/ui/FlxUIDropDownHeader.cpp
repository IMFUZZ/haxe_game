...
HX_DEFINE_STACK_FRAME(_hx_pos_015f8e5857f13f23_500_destroy,"flixel.addons.ui.FlxUIDropDownHeader","destroy",0x07c8b95f,"flixel.addons.ui.FlxUIDropDownHeader.destroy","flixel/addons/ui/FlxUIDropDownMenu.hx",500,0x238549da)
namespace flixel{
namespace addons{
namespace ui{
...
HXLINE( 483)		{
HXLINE( 483)			HX_VARI(  ::flixel::math::FlxPoint,_g) = this->button->offset;
HXDLIN( 483)			_g->set_x((_g->x - (Width - this->button->frameWidth)));
            		}
HXLINE( 484)		this->button->set_x(this->offset->x);
HXLINE( 485)		{
HXLINE( 485)			HX_VARI_NAME(  ::flixel::math::FlxPoint,_g1,"_g") = ( ( ::flixel::FlxSprite)(this->button->label) )->offset;
HXDLIN( 485)			_g1->set_x((_g1->x + this->button->offset->x));
            		}
