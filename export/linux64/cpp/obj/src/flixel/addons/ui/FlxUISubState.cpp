...
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_69_forceFocus,"flixel.addons.ui.FlxUISubState","forceFocus",0x1fc1bf75,"flixel.addons.ui.FlxUISubState.forceFocus","flixel/addons/ui/FlxUISubState.hx",69,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_79_create,"flixel.addons.ui.FlxUISubState","create",0x3e177884,"flixel.addons.ui.FlxUISubState.create","flixel/addons/ui/FlxUISubState.hx",79,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_145_onCursorEvent,"flixel.addons.ui.FlxUISubState","onCursorEvent",0x2ce8edfd,"flixel.addons.ui.FlxUISubState.onCursorEvent","flixel/addons/ui/FlxUISubState.hx",145,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_149_onShowTooltip,"flixel.addons.ui.FlxUISubState","onShowTooltip",0x756b161f,"flixel.addons.ui.FlxUISubState.onShowTooltip","flixel/addons/ui/FlxUISubState.hx",149,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_154_onResize,"flixel.addons.ui.FlxUISubState","onResize",0x497dd3fb,"flixel.addons.ui.FlxUISubState.onResize","flixel/addons/ui/FlxUISubState.hx",154,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_161_update,"flixel.addons.ui.FlxUISubState","update",0x490d9791,"flixel.addons.ui.FlxUISubState.update","flixel/addons/ui/FlxUISubState.hx",161,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_174_destroy,"flixel.addons.ui.FlxUISubState","destroy",0x298d7272,"flixel.addons.ui.FlxUISubState.destroy","flixel/addons/ui/FlxUISubState.hx",174,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_192_getEvent,"flixel.addons.ui.FlxUISubState","getEvent",0x36f15b2c,"flixel.addons.ui.FlxUISubState.getEvent","flixel/addons/ui/FlxUISubState.hx",192,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_198_getRequest,"flixel.addons.ui.FlxUISubState","getRequest",0x1849dae1,"flixel.addons.ui.FlxUISubState.getRequest","flixel/addons/ui/FlxUISubState.hx",198,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_201_getText,"flixel.addons.ui.FlxUISubState","getText",0x2483c1db,"flixel.addons.ui.FlxUISubState.getText","flixel/addons/ui/FlxUISubState.hx",201,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_215_cleanup,"flixel.addons.ui.FlxUISubState","cleanup",0xb049519c,"flixel.addons.ui.FlxUISubState.cleanup","flixel/addons/ui/FlxUISubState.hx",215,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_224_createCursor,"flixel.addons.ui.FlxUISubState","createCursor",0x5d8fb67a,"flixel.addons.ui.FlxUISubState.createCursor","flixel/addons/ui/FlxUISubState.hx",224,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_231_createUI,"flixel.addons.ui.FlxUISubState","createUI",0x8d49ebd8,"flixel.addons.ui.FlxUISubState.createUI","flixel/addons/ui/FlxUISubState.hx",231,0x21143c79)
HX_DEFINE_STACK_FRAME(_hx_pos_7cb0bdd552c3a9aa_234_reloadUI,"flixel.addons.ui.FlxUISubState","reloadUI",0x9a336975,"flixel.addons.ui.FlxUISubState.reloadUI","flixel/addons/ui/FlxUISubState.hx",234,0x21143c79)
namespace flixel{
namespace addons{
namespace ui{
...
HXDLIN(  59)				HX_VARI( ::Array< ::Dynamic>,_g1) = this->_ui->group->members;
HXDLIN(  59)				while((_g < _g1->length)){
HXLINE(  59)					HX_VARI(  ::flixel::FlxSprite,w) = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
...
HXLINE(  69)		if (hx::IsNotNull( this->_ui )) {
HXLINE(  70)			if (b) {
...
HXLINE( 100)			HX_VARI(  ::haxe::xml::Fast,data) = ( ( ::haxe::xml::Fast)(::flixel::addons::ui::U_obj::xml(this->_xml_id,null(),null(),null())) );
...
HXLINE( 154)		if (this->reload_ui_on_resize) {
...
HXLINE( 206)			return this->getTextFallback(Flag,Context,Safe);
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxUISubState_obj,cleanup,(void))
 ...
 ::flixel::addons::ui::FlxUICursor FlxUISubState_obj::createCursor(){
            	...
            	HX_STACK_THIS(this)
HXLINE( 224)		return  ::flixel::addons::ui::FlxUICursor_obj::__alloc( HX_CTX ,this->onCursorEvent_dyn(),null(),null(),null());
            	}
...
HXLINE( 231)		return  ::flixel::addons::ui::FlxUI_obj::__alloc( HX_CTX ,data,ptr,superIndex_,tongue_,liveFilePath_,null());
            	}
...
HXLINE( 244)		HX_VARI(  ::haxe::xml::Fast,data) = ( ( ::haxe::xml::Fast)(::flixel::addons::ui::U_obj::xml(this->_xml_id,null(),null(),null())) );
