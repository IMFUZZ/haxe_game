...
HX_DEFINE_STACK_FRAME(_hx_pos_658f4b014982005f_22_checkJustPressed,"flixel.addons.ui.FlxMultiKey","checkJustPressed",0xc8ef0cb5,"flixel.addons.ui.FlxMultiKey.checkJustPressed","flixel/addons/ui/FlxMultiKey.hx",22,0x3ae44138)
HX_DEFINE_STACK_FRAME(_hx_pos_658f4b014982005f_27_checkJustReleased,"flixel.addons.ui.FlxMultiKey","checkJustReleased",0x0f121f4a,"flixel.addons.ui.FlxMultiKey.checkJustReleased","flixel/addons/ui/FlxMultiKey.hx",27,0x3ae44138)
HX_DEFINE_STACK_FRAME(_hx_pos_658f4b014982005f_32_checkPressed,"flixel.addons.ui.FlxMultiKey","checkPressed",0xd9303601,"flixel.addons.ui.FlxMultiKey.checkPressed","flixel/addons/ui/FlxMultiKey.hx",32,0x3ae44138)
HX_DEFINE_STACK_FRAME(_hx_pos_658f4b014982005f_37_checkCombos,"flixel.addons.ui.FlxMultiKey","checkCombos",0xf37c89e6,"flixel.addons.ui.FlxMultiKey.checkCombos","flixel/addons/ui/FlxMultiKey.hx",37,0x3ae44138)
HX_DEFINE_STACK_FRAME(_hx_pos_658f4b014982005f_42_checkForbiddens,"flixel.addons.ui.FlxMultiKey","checkForbiddens",0x4d39935b,"flixel.addons.ui.FlxMultiKey.checkForbiddens","flixel/addons/ui/FlxMultiKey.hx",42,0x3ae44138)
namespace flixel{
namespace addons{
namespace ui{
...
bool FlxMultiKey_obj::checkJustPressed(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  22)		return ::flixel::FlxG_obj::keys->checkStatus(this->input,(int)2);
            	}
...
bool FlxMultiKey_obj::checkJustReleased(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  27)		return ::flixel::FlxG_obj::keys->checkStatus(this->input,(int)-1);
            	}
...
bool FlxMultiKey_obj::checkPressed(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  32)		return ::flixel::FlxG_obj::keys->checkStatus(this->input,(int)1);
            	}
...
HXLINE(  37)		return (::flixel::FlxG_obj::keys->checkKeyArrayState(this->combos,(int)1) == value);
            	}
...
bool FlxMultiKey_obj::checkForbiddens(bool value){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(value,"value")
HXLINE(  42)		return (::flixel::FlxG_obj::keys->checkKeyArrayState(this->forbiddens,(int)1) == value);
            	}
