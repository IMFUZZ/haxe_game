...
HX_DEFINE_STACK_FRAME(_hx_pos_a3896e68573bc9ad_42_clone,"flixel.addons.ui.FlxUIBar","clone",0x58fea36d,"flixel.addons.ui.FlxUIBar.clone","flixel/addons/ui/FlxUIBar.hx",42,0xaa1a78bf)
HX_DEFINE_STACK_FRAME(_hx_pos_a3896e68573bc9ad_62_set_style,"flixel.addons.ui.FlxUIBar","set_style",0x8f24c5a4,"flixel.addons.ui.FlxUIBar.set_style","flixel/addons/ui/FlxUIBar.hx",62,0xaa1a78bf)
HX_DEFINE_STACK_FRAME(_hx_pos_a3896e68573bc9ad_69_resize,"flixel.addons.ui.FlxUIBar","resize",0x7ffdd7e4,"flixel.addons.ui.FlxUIBar.resize","flixel/addons/ui/FlxUIBar.hx",69,0xaa1a78bf)
...
HX_DEFINE_STACK_FRAME(_hx_pos_a3896e68573bc9ad_111_set_params,"flixel.addons.ui.FlxUIBar","set_params",0x88b03f73,"flixel.addons.ui.FlxUIBar.set_params","flixel/addons/ui/FlxUIBar.hx",111,0xaa1a78bf)
namespace flixel{
namespace addons{
namespace ui{
...
HXLINE(  38)		super::__construct(x,y,direction,width,height,parentRef,variable,min,max,showBorder);
            	}
...
void *FlxUIBar_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::FlxSprite FlxUIBar_obj::clone(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  43)		HX_VARI( int,w) = ::Std_obj::_hx_int(this->get_width());
HXLINE(  44)		HX_VARI( int,h) = ::Std_obj::_hx_int(this->get_height());
HXLINE(  45)		HX_VAR( bool,showBorder);
...
HXLINE(  51)		HX_VARI(  ::flixel::addons::ui::FlxUIBar,b) =  ::flixel::addons::ui::FlxUIBar_obj::__alloc( HX_CTX ,this->x,this->y,this->fillDirection,w,h,this->parent,this->parentVariable,this->min,this->max,showBorder);
