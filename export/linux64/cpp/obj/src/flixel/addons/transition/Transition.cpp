...
HX_DEFINE_STACK_FRAME(_hx_pos_ab83fa44df0ac8ad_38_update,"flixel.addons.transition.Transition","update",0x58ffabd2,"flixel.addons.transition.Transition.update","flixel/addons/transition/Transition.hx",38,0x569ccdd8)
HX_DEFINE_STACK_FRAME(_hx_pos_ab83fa44df0ac8ad_43_destroy,"flixel.addons.transition.Transition","destroy",0x0d6d1711,"flixel.addons.transition.Transition.destroy","flixel/addons/transition/Transition.hx",43,0x569ccdd8)
HX_DEFINE_STACK_FRAME(_hx_pos_ab83fa44df0ac8ad_52_start,"flixel.addons.transition.Transition","start",0x818adab9,"flixel.addons.transition.Transition.start","flixel/addons/transition/Transition.hx",52,0x569ccdd8)
HX_DEFINE_STACK_FRAME(_hx_pos_ab83fa44df0ac8ad_57_setStatus,"flixel.addons.transition.Transition","setStatus",0x85aa3a4b,"flixel.addons.transition.Transition.setStatus","flixel/addons/transition/Transition.hx",57,0x569ccdd8)
HX_DEFINE_STACK_FRAME(_hx_pos_ab83fa44df0ac8ad_62_createEffect,"flixel.addons.transition.Transition","createEffect",0x4cf6bd36,"flixel.addons.transition.Transition.createEffect","flixel/addons/transition/Transition.hx",62,0x569ccdd8)
HX_DEFINE_STACK_FRAME(_hx_pos_ab83fa44df0ac8ad_71_get_finishCallback,"flixel.addons.transition.Transition","get_finishCallback",0xc796b14a,"flixel.addons.transition.Transition.get_finishCallback","flixel/addons/transition/Transition.hx",71,0x569ccdd8)
HX_DEFINE_STACK_FRAME(_hx_pos_ab83fa44df0ac8ad_80_set_finishCallback,"flixel.addons.transition.Transition","set_finishCallback",0xa445e3be,"flixel.addons.transition.Transition.set_finishCallback","flixel/addons/transition/Transition.hx",80,0x569ccdd8)
namespace flixel{
namespace addons{
...
HXLINE(  52)		this->_effect->start(NewStatus);
            	}
...
void Transition_obj::setStatus(int NewStatus){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(NewStatus,"NewStatus")
HXLINE(  57)		this->_effect->setStatus(NewStatus);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Transition_obj,setStatus,(void))
 ...
 ::flixel::addons::transition::TransitionEffect Transition_obj::createEffect( ::flixel::addons::transition::TransitionData Data){
            	...
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(Data,"Data")
HXLINE(  62)		::String _hx_switch_0 = Data->type;
...
hx::Val Transition_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"finishCallback") ) { if (inCallProp == hx::paccAlways) return hx::Val( set_finishCallback(inValue) ); }
	}
