...
HX_DEFINE_STACK_FRAME(_hx_pos_e4ba1574ac323b28_1_boot,"flixel.addons.transition.GraphicTransTileSquare","boot",0x10bf24a5,"flixel.addons.transition.GraphicTransTileSquare.boot","?",1,0x0000003f)
namespace flixel{
namespace addons{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::addons::transition::GraphicTransTileSquare_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_addons_transition_GraphicTransTileSquare",06,2a,6a,6d);
            	}
}
