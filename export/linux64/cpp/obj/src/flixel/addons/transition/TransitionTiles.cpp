...
HX_DEFINE_STACK_FRAME(_hx_pos_260f396e6842cd39_90_destroy,"flixel.addons.transition.TransitionTiles","destroy",0x85541e4c,"flixel.addons.transition.TransitionTiles.destroy","flixel/addons/transition/TransitionTiles.hx",90,0x085b791f)
HX_DEFINE_STACK_FRAME(_hx_pos_260f396e6842cd39_103_start,"flixel.addons.transition.TransitionTiles","start",0x0ae40d34,"flixel.addons.transition.TransitionTiles.start","flixel/addons/transition/TransitionTiles.hx",103,0x085b791f)
HX_DEFINE_STACK_FRAME(_hx_pos_260f396e6842cd39_96_start,"flixel.addons.transition.TransitionTiles","start",0x0ae40d34,"flixel.addons.transition.TransitionTiles.start","flixel/addons/transition/TransitionTiles.hx",96,0x085b791f)
HX_DEFINE_STACK_FRAME(_hx_pos_260f396e6842cd39_114_setStatus,"flixel.addons.transition.TransitionTiles","setStatus",0x0acdc646,"flixel.addons.transition.TransitionTiles.setStatus","flixel/addons/transition/TransitionTiles.hx",114,0x085b791f)
HX_DEFINE_STACK_FRAME(_hx_pos_260f396e6842cd39_109_setStatus,"flixel.addons.transition.TransitionTiles","setStatus",0x0acdc646,"flixel.addons.transition.TransitionTiles.setStatus","flixel/addons/transition/TransitionTiles.hx",109,0x085b791f)
HX_DEFINE_STACK_FRAME(_hx_pos_260f396e6842cd39_120_update,"flixel.addons.transition.TransitionTiles","update",0xfdb2a4f7,"flixel.addons.transition.TransitionTiles.update","flixel/addons/transition/TransitionTiles.hx",120,0x085b791f)
namespace flixel{
namespace addons{
...
HXLINE(  23)		HX_VARI( Float,delay) = (int)0;
...
HXLINE(  32)		HX_VARI( int,tilesX) = ::Math_obj::ceil(((Float)region->width / (Float)( (int)(data->tileData->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)) )));
HXLINE(  33)		HX_VARI( int,tilesY) = ::Math_obj::ceil(((Float)region->height / (Float)( (int)(data->tileData->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)) )));
...
HXLINE(  37)		HX_VARI( Float,dTime) = ((Float)data->duration / (Float)maxTiles);
...
HXLINE(  45)		HX_VARI( int,tx) = (int)0;
HXLINE(  46)		HX_VARI( int,ty) = (int)0;
...
HXDLIN(  64)			while((_g1 < tilesY)){
HXLINE(  64)				_g1 = (_g1 + (int)1);
HXDLIN(  64)				HX_VARI( int,iy) = (_g1 - (int)1);
HXLINE(  66)				{
HXLINE(  66)					HX_VARI( int,_g3) = (int)0;
HXDLIN(  66)					while((_g3 < tilesX)){
HXLINE(  66)						_g3 = (_g3 + (int)1);
HXLINE(  68)						HX_VARI( int,frameRate) = (int)40;
...
HXLINE(  73)						HX_VARI(  ::flixel::addons::transition::FlxTransitionSprite,ts) =  ::flixel::addons::transition::FlxTransitionSprite_obj::__alloc( HX_CTX ,tx,ty,delay, ::Dynamic(data->tileData->__Field(HX_("asset",f0,69,39,26),hx::paccDynamic)), ::Dynamic(data->tileData->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic(data->tileData->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)),frameRate);
...
HXLINE( 124)			HX_VARI( bool,allDone) = true;
HXLINE( 125)			{
HXLINE( 125)				HX_VARI( int,_g) = (int)0;
HXDLIN( 125)				HX_VARI( ::Array< ::Dynamic>,_g1) = this->_grpSprites->group->members;
HXDLIN( 125)				while((_g < _g1->length)){
HXLINE( 125)					HX_VARI(  ::flixel::addons::transition::FlxTransitionSprite,sprite) = _g1->__get(_g).StaticCast<  ::flixel::addons::transition::FlxTransitionSprite >();
