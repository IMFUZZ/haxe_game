...
HX_DEFINE_STACK_FRAME(_hx_pos_b87c2629ea53f92d_1_boot,"flixel.addons.transition.GraphicTransTileCircle","boot",0x00949252,"flixel.addons.transition.GraphicTransTileCircle.boot","?",1,0x0000003f)
namespace flixel{
namespace addons{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::addons::transition::GraphicTransTileCircle_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_addons_transition_GraphicTransTileCircle",79,9b,85,6a);
            	}
}
