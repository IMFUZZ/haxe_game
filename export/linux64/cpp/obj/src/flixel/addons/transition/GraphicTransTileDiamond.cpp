...
HX_DEFINE_STACK_FRAME(_hx_pos_bd8fe69546e7b6bc_1_boot,"flixel.addons.transition.GraphicTransTileDiamond","boot",0xfb57124a,"flixel.addons.transition.GraphicTransTileDiamond.boot","?",1,0x0000003f)
namespace flixel{
namespace addons{
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::addons::transition::GraphicTransTileDiamond_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_addons_transition_GraphicTransTileDiamond",cb,79,c6,30);
            	}
}
