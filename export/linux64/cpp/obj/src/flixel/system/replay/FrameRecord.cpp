...
::String FrameRecord_obj::save(){
            	...
            	HX_STACK_THIS(this)
HXLINE(  62)		::String output = (this->frame + HX_("k",6b,00,00,00));
HXLINE(  64)		if (hx::IsNotNull( this->keys )) {
HXLINE(  66)			::flixel::_hx_system::replay::CodeValuePair object;
HXLINE(  67)			Int i = (int)0;
HXLINE(  68)			Int l = this->keys->length;
HXLINE(  69)			while((i < l)){
HXLINE(  71)				if ((i > (int)0)) {
HXLINE(  73)					hx::AddEq(output,HX_(",",2c,00,00,00));
            				}
HXLINE(  75)				Int _hx_tmp = i++;
HXDLIN(  75)				object = this->keys->__get(_hx_tmp).StaticCast< ::flixel::_hx_system::replay::CodeValuePair >();
HXLINE(  76)				hx::AddEq(output,((object->code + HX_(":",3a,00,00,00)) + object->value));
            			}
            		}
HXLINE(  80)		hx::AddEq(output,HX_("m",6d,00,00,00));
HXLINE(  81)		if (hx::IsNotNull( this->mouse )) {
...
HXLINE(  95)		Int i;
HXLINE(  96)		Int l;
HXLINE(  99)		::Array< ::String > array = Data.split(HX_("k",6b,00,00,00));
HXLINE( 100)		this->frame = ::Std_obj::parseInt(array->__get((int)0));
HXLINE( 103)		array = array->__get((int)1).split(HX_("m",6d,00,00,00));
HXLINE( 104)		::String keyData = array->__get((int)0);
HXLINE( 105)		::String mouseData = array->__get((int)1);
HXLINE( 108)		Bool _hx_tmp = (keyData.length > (int)0);
HXDLIN( 108)		if (_hx_tmp) {
HXLINE( 111)			array = keyData.split(HX_(",",2c,00,00,00));
HXLINE( 114)			::Array< ::String > keyPair;
HXLINE( 115)			i = (int)0;
HXLINE( 116)			l = array->length;
HXLINE( 117)			while((i < l)){
HXLINE( 119)				Int _hx_tmp1 = i++;
HXDLIN( 119)				keyPair = array->__get(_hx_tmp1).split(HX_(":",3a,00,00,00));
HXLINE( 120)				Bool _hx_tmp2 = (keyPair->length == (int)2);
HXDLIN( 120)				if (_hx_tmp2) {
HXLINE( 122)					if (hx::IsNull( this->keys )) {
HXLINE( 124)						this->keys = ::Array_obj< ::Dynamic>::__new();
            					}
HXLINE( 126)					 ::Dynamic _hx_tmp3 = ::Std_obj::parseInt(keyPair->__get((int)0));
HXDLIN( 126)					 ::Dynamic _hx_tmp4 = ::Std_obj::parseInt(keyPair->__get((int)1));
HXDLIN( 126)					this->keys->push(::flixel::_hx_system::replay::CodeValuePair_obj::__new(_hx_tmp3,_hx_tmp4));
            				}
            			}
            		}
HXLINE( 132)		Bool _hx_tmp5 = (mouseData.length > (int)0);
HXDLIN( 132)		if (_hx_tmp5) {
HXLINE( 134)			array = mouseData.split(HX_(",",2c,00,00,00));
HXLINE( 135)			Bool _hx_tmp6 = (array->length >= (int)4);
HXDLIN( 135)			if (_hx_tmp6) {
HXLINE( 137)				 ::Dynamic _hx_tmp7 = ::Std_obj::parseInt(array->__get((int)0));
HXDLIN( 137)				 ::Dynamic _hx_tmp8 = ::Std_obj::parseInt(array->__get((int)1));
HXDLIN( 137)				 ::Dynamic _hx_tmp9 = ::Std_obj::parseInt(array->__get((int)2));
HXDLIN( 137)				 ::Dynamic _hx_tmp10 = ::Std_obj::parseInt(array->__get((int)3));
HXDLIN( 137)				this->mouse = ::flixel::_hx_system::replay::MouseRecord_obj::__new(_hx_tmp7,_hx_tmp8,_hx_tmp9,_hx_tmp10);
            			}
            		}
