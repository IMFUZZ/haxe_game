...
HXLINE(2078)		::haxe::io::Bytes _hx_tmp = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::_Window::GraphicCloseButton_obj::resourceName);
HXDLIN(2078)		::openfl::_legacy::utils::ByteArray byteArray = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(_hx_tmp);
...
{
{
            	HX_STACK_FRAME("flixel.system.debug._Window.GraphicCloseButton","boot",0xf17d32b7,"flixel.system.debug._Window.GraphicCloseButton.boot","openfl/_legacy/display/BitmapData.hx",22,0x0b92a012)
HXLINE(  22)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug__Window_GraphicCloseButton",f1,96,ca,34);
            	}
}
