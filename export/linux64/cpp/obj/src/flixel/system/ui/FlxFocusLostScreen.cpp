...
HXLINE(  14)		this->draw();
HXLINE(  16)		HX_VARI(  ::openfl::_legacy::display::Sprite,logo) =  ::openfl::_legacy::display::Sprite_obj::__alloc( HX_CTX );
...
HXLINE(  33)		HX_VARI( int,screenWidth) = ::Std_obj::_hx_int(::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageWidth());
HXLINE(  34)		HX_VARI( int,screenHeight) = ::Std_obj::_hx_int(::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_stageHeight());
HXLINE(  37)		gfx->clear();
