...
HX_DEFINE_STACK_FRAME(_hx_pos_92aefff3e5e0a292_1_boot,"__ASSET__flixel_flixel_ui_xml_defaults_xml","boot",0xb3f88dd3,"__ASSET__flixel_flixel_ui_xml_defaults_xml.boot","?",1,0x0000003f)
...
HXLINE(2188)		{
HXLINE(2188)			HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_flixel_ui_xml_defaults_xml_obj::resourceName);
...
HXLINE(   1)		resourceName = HX_("__ASSET__:file___ASSET__flixel_flixel_ui_xml_defaults_xml",66,61,52,48);
            	}
}
