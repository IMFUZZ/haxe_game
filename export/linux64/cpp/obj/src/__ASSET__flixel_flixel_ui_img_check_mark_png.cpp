...
HX_DEFINE_STACK_FRAME(_hx_pos_f8f937521e0ad88f_1_boot,"__ASSET__flixel_flixel_ui_img_check_mark_png","boot",0xab43435b,"__ASSET__flixel_flixel_ui_img_check_mark_png.boot","?",1,0x0000003f)
...
HXLINE(2078)		HX_VARI(  ::openfl::_legacy::utils::ByteArray,byteArray) = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_flixel_ui_img_check_mark_png_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap___ASSET__flixel_flixel_ui_img_check_mark_png",4b,b1,dd,61);
            	}
}
