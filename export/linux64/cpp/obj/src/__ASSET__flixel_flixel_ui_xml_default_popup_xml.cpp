...
HX_DEFINE_STACK_FRAME(_hx_pos_6b5082872e225421_2181_new,"__ASSET__flixel_flixel_ui_xml_default_popup_xml","new",0x52c31055,"__ASSET__flixel_flixel_ui_xml_default_popup_xml.new","openfl/_legacy/Assets.hx",2181,0x9276b055)
HX_DEFINE_STACK_FRAME(_hx_pos_7548fa0b825b2df0_1_boot,"__ASSET__flixel_flixel_ui_xml_default_popup_xml","boot",0x10043a9d,"__ASSET__flixel_flixel_ui_xml_default_popup_xml.boot","?",1,0x0000003f)

void __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::__construct( ::Dynamic __o_size){
 ::Dynamic size = __o_size.Default(0);
            	HX_STACKFRAME(&_hx_pos_6b5082872e225421_2181_new)
            	HX_STACK_THIS(this)
            	HX_STACK_ARG(size,"size")
HXLINE(2183)		super::__construct(null());
HXLINE(2188)		{
HXLINE(2188)			HX_VARI(  ::haxe::io::Bytes,bytes) = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::resourceName);
...
bool __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x140d0a90) {
		if (inClassId<=(int)0x035f4237) {
			...
			return inClassId==(int)0x140d0a90;
		}
	} else {
...
hx::ObjectPtr< __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj > __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::__new( ::Dynamic __o_size) {
...
hx::ObjectPtr< __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj > __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::__alloc(hx::Ctx *_hx_ctx, ::Dynamic __o_size) {
...
HXLINE(   1)		resourceName = HX_("__ASSET__:file___ASSET__flixel_flixel_ui_xml_default_popup_xml",4a,b4,43,80);
            	}
}
